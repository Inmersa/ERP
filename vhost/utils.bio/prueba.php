...
$file_name = 'Localizaciones_marcas2.txt';

// if (!isset($fecha) OR !isset($file_name) OR !strcasecmp(wol_db::formatear_fecha($fecha),'null') ) {
...
<td align="right">
<?php echo 'Alm: '.$aArt['id_almacen_logico']; ?></td>
</td>
</tr>
