...
$font_loc="/usr/share/fonts/truetype/Times_New_Roman.ttf";
$font_loc="/usr/share/fonts/truetype/ttf-dejavu/DejaVuSerif.ttf";
...
$genbarcode_loc="../../../bin/genbarcode/genbarcode";
...
function barcode_outimage($text, $bars, $scale = 1, $mode = "png",
    ...
    if ($scale<1) $scale=2;
    $total_y=(int)($total_y);
    if ($total_y<1) $total_y=(int)($scale * 44);
    if (!$space)
...
function barcode_print($code, $encoding="ANY", $scale = 2 ,$mode = "png", $height = 0 ){
