...
<body bgcolor="#FFFFFF" text="#000000">
 ...
 <tr> <td class="titocho" align="right">Inmersa Empresa: NSF</td>
<td class="titocho" align="right"><a href="?logout=1"
class="accesos">Quitter</a>
 </tr>
...
<form method="post" action="?seccion=pda_cliente" name="clienteid">
 <td class="acceso_directo" align="left">Commande-ID Client:</td>
 <td><input type="text" border="cccccc" name="id_cliente" class="insertext" size="5"><input type="submit" value="Accepter">
 </td>
</form>
 </tr>
<tr> 
...
<input type="hidden" name="nom_bus" value="recorridos_search">
 <td class="acceso_directo" align="left">Date Route :</td>
 <td><input type="text" border="cccccc" name="fecha" class="insertext" size="10"
 value="@%get:st_fecha;%@"><input type="submit" value="Accepter"></td>
</form>
 </tr>
<tr>
<td height="10">
...
<a href="?id_recorrido=@%db:Recorridos.id_recorrido%@&iniciar=1" class="accesos">Commencer Route</a>
@%set:estado_noiniciado=1;%@
@%else:%@
@%end-if:%@
@%if:esta_vacio;Recorridos.h_fin;estado_noiniciado;%@
<a href="?seccion=pda_cierre_ruta&id_recorrido=@%get:id_recorrido_act;%@" class="accesos">Fermer route</a>
...
<td height="10"></td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
<td class="titul1" align="left">Clients Route:</td>
</tr>
<tr>
<td height="10"></td>
</tr>
...
<tr> <td class="accesos" align="right">
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
<td class="titul1" align="left" colspan="2">Autre Parcours:</td>
</tr>
<tr>
...
<tr><td class="acceso_directo" colspan="2"><input type="submit" value="Voir"></td></tr>
</form>
@%end-if:%@
<tr> <td class="accesos" align="right">
</td>
