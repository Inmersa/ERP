...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td class="titocho" align="left" width="92">Visité</td>
 <td class="titocho" align="left" width="108"> <input type="checkbox" name="registro[visitado]" value="1">
</td>
 </tr>
 <tr>
 <td align="left" class="insertext" width="92">Moyen</td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td align="left" class="titocho" width="123">Observationes</td>
 </tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
 <td align="left" class="insertext" width="123">Date prochaine visite</td>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr>
 <td align="left" class="titocho" width="123">Comentaire proche Citation</td>
 </tr>
<tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <tr>
 <td align="left" class="insertext" width="123">Moyen proche Citation</td>
...
<tr> <td class="accesos" align="right"><!-- a href="javascript:document.forms['cita'].submit();" class="accesos">Fermer</a --><input type="submit" 
value="Fermer"></td>
 </tr>
