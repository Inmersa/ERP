...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td class="titocho" align="left" width="92">Visit done</td>
 <td class="titocho" align="left" width="108"> <input type="checkbox" name="registro[visitado]" value="1">
</td>
 </tr>
 <tr>
 <td align="left" class="insertext" width="92">Media</td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td align="left" class="titocho" width="123">Remarks</td>
 </tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
 <td align="left" class="insertext" width="123">Next appoinment date</td>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr>
 <td align="left" class="titocho" width="123">Remark next appoinment</td>
 </tr>
<tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <tr>
 <td align="left" class="insertext" width="123">Next appoinment media</td>
...
<tr> <td class="accesos" align="right"><!-- a href="javascript:document.forms['cita'].submit();" class="accesos">Close</a --><input type="submit" 
value="Close"></td>
 </tr>
