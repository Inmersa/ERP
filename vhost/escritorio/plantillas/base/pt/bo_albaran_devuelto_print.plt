...
<td class="left">
	<table class="firmas">
	<tr><td class="etiqueta">Notas</td></tr>
...
<table class="full">
 ...
 <tr><td class="etiqueta">Montante Total:</td><td >@%db:importe%@ @%db:leyenda_divisa;%@</td></tr>
</table>
@%end-where:%@
...
<td class="right" width="33%">
	<table class="firmas">
	<tr><td class="etiqueta">Cliente de acordo</td></tr>
	<tr><td >&nbsp;</td></tr>
	</table>
</td>
</tr>
