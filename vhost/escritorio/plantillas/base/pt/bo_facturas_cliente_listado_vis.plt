 ...
 <td ><a href="?_search_sort=Forma_pago.nombre" >Modo de Pagamento<img src="imag/pixel.png" class="@%func:class_searchsort;Forma_pago.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Tarifas.nombre" >Tarifa<img src="imag/pixel.png" class="@%func:class_searchsort;Tarifas.nombre;%@" /></a></td>
