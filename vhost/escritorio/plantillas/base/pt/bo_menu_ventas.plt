...
<div class="menuitem"> <a href="?seccion=bo_pedidos_ventas" @%func:querystring_activa;bo_pedidos_ventas;activo;;%@ >Encomendas</a></div>
@%end-if:%@
@%if:AllowedLink;bo_proformas_venta;%@
<div class="menuitem"><a href="?seccion=bo_proformas_venta" @%func:querystring_activa;bo_proformas_venta;activo;;%@ >Facturas Pró-forma</a></div>
@%end-if:%@
@%if:AllowedLink;bo_presupuestos_ventas;%@
<div class="menuitem"> <a href="?seccion=bo_presupuestos_ventas&_chgsm=1" @%func:querystring_activa;bo_presupuestos_ventas&_chgsm=1;activo;;%@ >Orçamentos</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_venta;%@
<div class="menuitem"> <a href="?seccion=bo_albaranes_venta" @%func:querystring_activa;bo_albaranes_venta;activo;;%@ >Guias de Remessa</a></div>
@%end-if:%@
...
<!--
@%if:AllowedLink;bo_facturas_venta;%@
<div class="menuitem"> <a href="?seccion=bo_compra_venta" @%func:querystring_activa;nuevo_pedidos_ventas&presupuesto=1;activo;;%@ >Relatórios</a></div>
@%end-if:%@
-->

@%if:AllowedLink;nuevo_pedidos_ventas;%@
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&proforma=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&proforma=1;activo;;%@ >Nova Factura Pró-forma</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&presupuesto=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&presupuesto=1;activo;;%@ >Novo Orçamento</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&pedido=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&pedido=1;activo;;%@  >Emitir Encomenda</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&factura=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&factura=1;activo;;%@  >Emitir Factura</a></div>
