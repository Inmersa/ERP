...
><div name="Cliente_Observaciones" >Observações</div
@%end-if:%@
@%if:AllowedPII;Enlaces;%@
><div name="Enlaces" >Ligações</div
@%end-if:%@
></div>
