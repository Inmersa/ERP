...
@%where:tabla|Articulos;nombre|busc;no_results|1;%@
	...
	<table class="full">
	<tr> 
	<td class="titulotb" align="right">Família:</td>
	...
	<td ><a href="?_search_sort=cantidad_pedida">Requisitada<img src="imag/pixel.png" class="@%func:class_searchsort;cantidad_pedida;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_recibida">Recebida<img src="imag/pixel.png" class="@%func:class_searchsort;cantidad_recibida;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_facturada">Facturada<img src="imag/pixel.png" class="@%func:class_searchsort;cantidad_facturada;%@" /></a></td>
	<td ><a href="?_search_sort=precio_medio">Preço Médio<img src="imag/pixel.png" class="@%func:class_searchsort;precio_medio;%@" /></a></td>
	<td ><a href="?_search_sort=precio_maximo">Preço Máximo<img src="imag/pixel.png" class="@%func:class_searchsort;precio_maximo;%@" /></a></td>
	<td ><a href="?_search_sort=precio_minimo">Preço Mínimo<img src="imag/pixel.png" class="@%func:class_searchsort;precio_minimo;%@" /></a></td>
	</tr>
	</thead>
	<tbody class="informe" >
	@%else:%@
