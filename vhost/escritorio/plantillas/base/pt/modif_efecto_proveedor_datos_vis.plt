...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Conceito: </td>
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Pagamento Integral: </td>
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Método de Pagamento: </td>
...
@%end-where:%@ 
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Meio de Pagamento: </td>
 <td class="texto">@%db:Efectos.medio_pago%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Data de Vencimento: </td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="etiqueta" height="22">Total Pago: </td>
