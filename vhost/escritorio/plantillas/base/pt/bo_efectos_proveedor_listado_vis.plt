...
@%if:nuevo_proveedor%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Denominação Comercial</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="110">Código</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Risco</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="55">Atraso</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="100" align="center">Total de Conta</td>
...
@%else:%@
 ...
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Ref. Factura </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Conceito</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Meio de Pagamento</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Vencimento</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Total</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Total Pago </td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center" width="22">E</td>
 <td width="1"></td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="22"> </td>
 <td bgcolor="#DBE0E3" width="1"></td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="etiqueta" colspan="9" height="20" bgcolor="#DBE0E3">Legenda</td>
 ...
 <td class="etiqueta">Estado<span class="texto"></span></td>
