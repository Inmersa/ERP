...
@%where:tabla|Factura;nombre|busc;no_results|1;%@
	...
	<table class="full">
	<tr> 
	<td class="titulotb">Fornecedor:</td>
	...
	<td ><a href="?_search_sort=Facturas.total_impuestos" class="order" 
		>Total de Impostos<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.total_impuestos;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.retenido" class="order" >Retido<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.retenido;%@" /></a></td>
	...
	<td ><a href="?_search_sort=Facturas.monto_total" class="order" 
		>Montante Total<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.monto_total;%@" /></a></td>
  	@%if:esta_vacio;st[ef_search];%@
	@%else:%@
	<td ><a href="?_search_sort=Efectos.monto" class="order" >Montante Ordens de Pag.<img src="imag/pixel.png" class="@%func:class_searchsort;Efectos.monto;%@" /></a></td>
	...
	<td ><a href="?_search_sort=numero_incidencias" class="order" 
		>Nº Incidências<img src="imag/pixel.png" class="@%func:class_searchsort;numero_incidencias;%@" /></a></td>
	@%end-if:%@
	</tr>
	</thead>
	<tbody class="informe" >
