...
<table class="full"><tr>
<td class="@%css:Empresas_articulos.descripcion;label;%@" >Códigos de área:</td>
...
<tr><td class="etiqueta @%css:Empresas_articulos.precio_costo;label;%@">Preço Local - Tempo Padrão:</td>
...
<td class="etiqueta @%css:Empresas_articulos.precio_standard;label;%@">Preço Local - Tempo Reduzido:</td>
...
<tr><td class="etiqueta @%css:Empresas_articulos.precio_venta;label;%@">Preço chamada externa - Tempo Padrão:</td>
...
<td class="etiqueta @%css:Empresas_articulos.precio_4;label;%@">Preço chamada externa - Tempo Reduzido:</td>
