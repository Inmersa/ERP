...
<li><a href="#" onClick="return onHRefClick('bo_recorridos','accion_ejecutar', 'Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=efectividad" >% Eficácia<img src="imag/pixel.png" class="@%func:class_searchsort;efectividad;%@" /></a></td>
<td ><a href="?_search_sort=Recorridos.fecha" >Data<img src="imag/pixel.png" class="@%func:class_searchsort;Recorridos.fecha;%@" /></a> </td>
<td ><a href="?_search_sort=numero_clientes" >Nº Cliente<img src="imag/pixel.png" class="@%func:class_searchsort;numero_clientes;%@" /></a></td>
<td ><a href="?_search_sort=Agentes.nombre" >Agente<img src="imag/pixel.png" class="@%func:class_searchsort;Agentes.nombre;%@" /></a> </td>
<td ><a href="?_search_sort=numero_pedidos" >Nº Encomenda<img src="imag/pixel.png" class="@%func:class_searchsort;numero_pedidos;%@" /></a> </td>
<td >Total do Valor Tributável</td>
</tr>
</thead>
<tbody>
...
<li><a href="#" onClick="return sendForm('bo_recorridos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Alterar</span></a></li>
</ul></div>
