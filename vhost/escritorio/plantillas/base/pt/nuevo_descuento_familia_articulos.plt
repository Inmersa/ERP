...
<div class="titsuperior">&gt; Novo Desconto por Família (
...
<div class="enviar"><a href="#" onClick="document.forms['nuevo_descuento_familia_articulos'].submit();return false;">Adicionar</a>
</div>
</form>
