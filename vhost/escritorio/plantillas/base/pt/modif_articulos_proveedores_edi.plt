...
<li><a href="?seccion=seleccionar_proveedor" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Seleccionar Fornecedor</span></a></li> 
...
@%end-if:%@
 /></td>
 <td class="etiqueta" colspan="2" style="text-align:left;">Preço por Tempo de Execução</td>
