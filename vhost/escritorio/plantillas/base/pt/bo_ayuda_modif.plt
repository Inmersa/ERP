@%where:tabla|Ayuda;%@
 <div class="barraoscura"><div class="titsuperior">&gt; Modificar Ajuda</div>
 <div class="alinder">
 @%if:AllowedLink;bo_ayuda_nuevo;%@
 <a href="?seccion=bo_ayuda_nuevo">Novo</a>
 @%end-if:%@
 </div></div>
...
>@%db:Sub_Secc.nombre_visual;%@(@%db:Sub_Secc.nombre%@)</option>
 ...
 <tr><td class="etiqueta" >Corpo:</td>
 <td ><textarea name="registro[cuerpo]" class="insertext" cols="80">@%db:Ayuda.cuerpo%@</textarea></td>
 </tr>
 </table>
 <table class="full">
 <tr><td class="check" >&nbsp;</td>
 <td class="caption">Títulos</td>
 <td class="caption" align="right"><a href="?seccion=bo_ayuda_nuevo_epigrafe&id_sub=@%db:Ayuda.id_sub%@" class="accesos">Novo</a></td>
 <td class="caption"><a href="#" onClick="return onHRefClick('modif_ayuda','estado','2','bo_ayuda_modif','¿É você certo que você quer suprimir registros selecionados?');"
 	>Eliminar Itens Seleccionados</a></td></tr>
...
<a href="#" onClick="return resetForm('modif_ayuda');" > Desfazer Alterações</a> </div>
