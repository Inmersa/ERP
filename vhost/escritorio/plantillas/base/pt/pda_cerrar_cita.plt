...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
 <td align="left" class="insertext" width="92">Método Utilizado</td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td align="left" class="titocho" width="123">Observações de Visita</td>
 </tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
 <td align="left" class="insertext" width="123">Data da Próxima Visita</td>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr>
 <td align="left" class="titocho" width="123">Comentário para Próxima Visita</td>
 </tr>
<tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <tr>
 <td align="left" class="insertext" width="123">Meio da Próxima Visita</td>
...
<tr> <td class="accesos" align="right"><!-- a href="javascript:document.forms['cita'].submit();" class="accesos">Fechar</a --><input type="submit" 
value="Fechar"></td>
 </tr>
