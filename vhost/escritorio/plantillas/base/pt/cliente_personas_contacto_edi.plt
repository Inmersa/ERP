...
<legend>Pessoas de Contacto</legend>

<div class="AccionesFicha">
<ul>
@%if:AllowedAction;Cliente_contactos;new;%@
<li><a href="?seccion=nueva_persona_contacto" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Novo</span></a></li>
@%end-if:%@
@%if:AllowedAction;Cliente_contactos;del;%@
<li><a href="#" onClick="return onHRefClick('modif_clientes','accion_ejecutar','BorrarContactos');" class="borrar"><img src="imag/pixel.png" class="icono" /><span>Eliminar Endereços</span></a></li>
@%end-if:%@
</ul>
</div>
