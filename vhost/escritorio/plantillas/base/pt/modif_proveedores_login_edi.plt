...
<tr><td class="etiqueta">Iniciar Sessão:</td><td><input type=text name="prov_user[login]" value="" size="20" /></td>
<td class="etiqueta">Grupo:</td><td><select name="prov_user[grupo]">
...
<tr><td class="etiqueta">Iniciar Sessão:</td>
...
<td colspan="3"><input type="password" name="prov_user[passwd2]" size="20" /></td>
 ...
 <a href="?seccion=crm_seleccionar_usuario&id=@%get:usuario_actual;%@" class="accesos">Atribuir</a>
 @%end-if:%@
