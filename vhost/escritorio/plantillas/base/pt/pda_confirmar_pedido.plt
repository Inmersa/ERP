...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr> <td class="titul1" align="left" width="95">&gt; Endereços de Entrega</td>
</tr>
 <tr>
 <td height="10"></td>
 </tr>
...
<tr>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr> <td align="left" class="titul1" width="114">Método de Pagamento</td>
...
<tr> <td align="left" class="titul1" width="114">@%db:nombre%@</td>
 ...
 <tr> <td align="left" class="titocho" width="114">Valor Tributável:</td>
 <td class="texto" width="86">@%db:base_imponible%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="114">Retenções:</td>
 <td class="texto" width="86">@%db:retenido%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">Desconto Total:</td>
 <td class="texto" width="103">@%db:descuentos%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr>
 <td height="10"></td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">Montante:</td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
<td class="titocho">Observações :</td>
</tr>
 <tr>
