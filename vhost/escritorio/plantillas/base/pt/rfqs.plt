...
<ul>
<li><a href="#" onClick="return sendForm('rfqs');" class="enlazarrfq"><img src="imag/pixel.png" class="icono" /><span>Aceitar</span></a></li>
</ul>
</div>
...
<td >&nbsp;</td>
  @%end-if:%@
@%end-if:%@
 <td ><a href="?_search_sort=RFQs.id_rfq" >Número<img src="imag/pixel.png" class="@%func:class_searchsort;RFQs.id_rfq;%@" /></a></td>
 <td ><a href="?_search_sort=RFQs.fecha" >Data de Entrada<img src="imag/pixel.png" class="@%func:class_searchsort;RFQs.fecha;%@" /></a></td>
 ...
 <td ><a href="?_search_sort=Usuarios.nombre" >Envolvido<img src="imag/pixel.png" class="@%func:class_searchsort;Usuarios.nombre;%@" /></a></td>
@%if:AllowedAction;RFQ_id_usuario_gestor;new;%@
 <td ><a href="?_search_sort=Empleados.nombre" >Responsável Actual<img src="imag/pixel.png" class="@%func:class_searchsort;Empleados.nombre;%@" /></a></td>
@%end-if:%@
 <td ><a href="?_search_sort=RFQs.fecha_estimada" >Data Aproximada de Conclusão<img src="imag/pixel.png" class="@%func:class_searchsort;RFQs.fecha_estimada;%@" /></a></td>
@%if:esta_vacio;nomostrarcierre;%@
 <td ><a href="?_search_sort=RFQs.fecha_cierre" >Data Final<img src="imag/pixel.png" class="@%func:class_searchsort;RFQs.fecha_cierre;%@" /></a></td>
@%end-if:%@
</tr>
</thead>
<tbody>
