...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr> 
<td height="22" align="left" bgcolor="#CCD2D7" class="etiqueta"> Itens Seleccionados</td>
...
<td colspan="3"> 
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" colspan="2">Produto </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="250">Marca</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3">Quantidade</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3">Preço</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <td align="right" class="texto" bgcolor="#EBECED" width="30%">Total Bruto:</td>
 ...
 <td align="right" class="texto" bgcolor="#EBECED">Montante Total:</td>
 <td height="15" class="texto"><img src="imag/p.gif" width="1" height="15"></td>
...
class="accesos">Concluir</a> 
<!--onclick="return SendFormToWindow('ticket_print&printit=1&reloadit=1',400);" class="accesos">Concluir</a --> <a href="?@%env:QUERY_STRING%@&vaciar_pedido=1" class="accesos">Eliminar Itens da Encomenda</a> <input type="hidden" name="Finalizar" value="Finalizar"></td>
 </tr>
</form>
 </table>
 </td>
