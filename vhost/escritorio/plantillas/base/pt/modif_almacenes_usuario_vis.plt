 ...
 <tr> <td width="111" align="right" bgcolor="#EBECED" height="22" class="etiqueta">Iniciar Sessão:</td>
 ...
 <tr> <td width="111" align="right" bgcolor="#EBECED" height="22" class="etiqueta">Palavra-Passe:</td>
