...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 <tr> 
 <td height="22" align="left" bgcolor="#CCD2D7" class="titocho">>Liquidações Parciais</td>
<td width="1" bgcolor="#CCD2D7"></td>
 ...
 <tr> 
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="100">Data de Liquidação</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="100">Meio de Pagamento</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="80">Total</td> <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="80">Banco</td> <td bgcolor="#DBE0E3" width="1"></td>
