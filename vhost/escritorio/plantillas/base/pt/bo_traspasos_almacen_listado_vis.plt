...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Armazém de Origem</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Armazém de Destino </td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Transportador</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="120">Observações</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="75" height="22" class="etiqueta" align="center">Data de Transferência</td>
 <td width="1"></td>
 ...
 <td bgcolor="#DBE0E3"></td>
 <td class="texto">
@%if:AllowedLink;bo_transportistas;%@<a href="?seccion=bo_transportistas&id_transportista=@%db:Traspasos_almacen.id_transportista;%@" class="accesos">
...
@%end-if:%@
 ...
 <td bgcolor="#DBE0E3"></td>
 <td align="center" ><a href="?seccion=modif_traspasos_almacen&id_traspaso=@%db:Traspasos_almacen.id_traspaso;%@" class="accesos">Ver</a></td>
 <td bgcolor="#DBE0E3"></td>
 </tr>
 <tr> <td colspan="13" height="1"></td>
 </tr>
