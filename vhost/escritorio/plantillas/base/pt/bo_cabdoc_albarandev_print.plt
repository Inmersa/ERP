...
<table class="full">
@%if:esta_vacio;id_proveedor_cabecera;%@
	<caption>Direcção Armazém de Colheita (@%db:Direcciones_entrega.nombre;%@)</caption>
@%end-if:%@

	<tr><td class="etiqueta">Nome:</td><td >@%db:Clientes.razon_social;%@ (@%db:Clientes.id_cliente;%@)</td></tr>
	<tr><td class="etiqueta" >CIF:</td>
	...
	<tr><td class="etiqueta" >Código:</td><td >@%db:Direcciones_entrega.id_direccion;%@</td></tr>
	<tr><td class="etiqueta" >Endereço:</td><td >@%db:Direcciones_entrega.direccion;%@</td></tr>
	<tr><td class="etiqueta" >Localidade:</td><td >@%db:Direcciones_entrega.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Distrito:</td>
	...
	<tr> 
	 <td class="etiqueta" >Telefone:</td><td >@%db:Direcciones_entrega.telefono1;%@</td>
...
<table class="full">
	<caption>Direcção Armazém de Colheita (@%db:Almacenes.nombre;%@)</caption>
	<tr><td class="etiqueta" >Endereço:</td><td >@%db:Almacenes.direccion;%@</td></tr>
	<tr><td class="etiqueta" >Localidade:</td><td >@%db:Almacenes.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Distrito:</td>
	<!-- @%db:Almacenes.id_provincia%@ @%set:id_prov=Almacenes.id_provincia;%@ -->
	...
	<tr> 
	 <td class="etiqueta" >Telefone:</td><td >@%db:Almacenes.telefono;%@</td>
...
<table class="full">
 <caption>Endereço de Entrega(@%db:Proveedores.prefijo_cif;%@@%db:Proveedores.cif;%@)</caption>
