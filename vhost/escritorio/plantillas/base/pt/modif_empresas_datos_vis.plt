...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Nome:</td>
...
<input type="hidden" name="registro[nombre]" value="@%db:Empresas.nombre;%@" class="insertext">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Grupo a que Pertence:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="titul1" height="22">Denominação Comercial:</td>
...
<input type="hidden" name="registro[razon_social]" value="@%db:Empresas.razon_social;%@" class="insertext">
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="titul1" height="22">Endereço de Facturação:</td>
...
<input type="hidden" name="registro[direccion_facturacion]" value="@%db:Empresas.direccion_facturacion;%@" class="insertext">
 ...
 <a href="" onclick="return abrir_ventana('?seccion=bo_cat_radio&amp;arreguarda=1&amp;campo_destino=id_empresa&id_imagen=@%db:Catalogo_imagenes.id_imagen%@&tabla=Empresas&id_sub=@%db:Empresas.id_empresa%@');return false" class="accesos">Logótipo</a><br>
 <br>
...
<input type="hidden" name="registro[telefono1]" value="@%db:Empresas.telefono1;%@" class="insertextnumeros" size="14">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Localidade:</td>
...
<input type="hidden" name="registro[fax]" value="@%db:Empresas.fax;%@" class="insertextnumeros" size="14">
 ...
 <tr> <td width="161" height="22" align="right" class="titul1" bgcolor="#EBECED">Distrito:</td>
 <td width="228"> 
