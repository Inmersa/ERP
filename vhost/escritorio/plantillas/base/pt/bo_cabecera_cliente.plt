...
<table width="771" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="19" align="left"></td>
 <td width="43" align="right"><a href="" class="acceso_directo">Terminar Sessão</a></td>
...
class="menus">Cliente</a></td>
 <td align="center"><a href=""
class="menus">Produtos</a></td>
 <td align="center"><a href=""
class="menus">Agentes</a></td>
...
<table width="771" border="0" cellspacing="0" cellpadding="0" bgcolor="@%get:color_inm%@">
 ...
 <td bgcolor="@%get:color_barra%@" align="center" height="16"><a href="" class="menus2">Cliente</a></td>
 <td align="center" height="16"><a href="" class="menus">Produtos</a></td>
 <td align="center" height="16"><a href="" class="menus">Agentes</a></td>
 <td align="center" colspan="5"></td>
...
<table width="771" border="0" cellspacing="0" cellpadding="0" bgcolor="@%get:color_inm%@">
 ...
 <tr> <td width="6"></td>
 <td align="center" height="18"><a href="" class="menus">Cliente</a></td>
 <td bgcolor="@%get:color_barra%@" align="center"><a href="" class="menus2">Produtos</a></td>
 <td align="center"><a href="" class="menus">Agentes</a></td>
 <td align="center" colspan="5"></td>
 <td width="6"></td>
 </tr>
 <tr> <td width="6"></td>
...
<table width="771" border="0" cellspacing="0" cellpadding="0" bgcolor="@%get:color_inm%@">
 ...
 <td align="center" height="18"><a href="" class="menus">Cliente</a></td>
 <td align="center" height="18"><a href="" class="menus">Produtos</a></td>
 <td bgcolor="@%get:color_barra%@" align="center" height="18"><a href="" class="menus2">Agentes</a></td>
 <td align="center" colspan="5"></td>
