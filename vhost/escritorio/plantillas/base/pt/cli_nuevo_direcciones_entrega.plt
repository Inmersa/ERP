<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="46" align="center" ><a href="javascript: hisroty.go(-1);" class="accesos">Voltar</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td class="texto" valign="top">Inserir Endereço de Entrega</td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 </table>
 ...
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Endereço:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185" valign="top">Observações:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <a href="" onclick="document.forms['nuevo_direcciones_entrega'].submit();return false;" class="accesos">Adicionar</a> </td>
 </tr>
 </form>
 </table>
 </td>
