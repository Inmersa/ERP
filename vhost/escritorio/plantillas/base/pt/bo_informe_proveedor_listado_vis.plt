<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#CCD2D7" height="22" ></td>
 <td height="22" ></td>
 <td bgcolor="#CCD2D7" height="22" colspan="7" align="center" class="etiqueta" >Quantidades</td>
 <td height="22" ></td>
 <td bgcolor="#CCD2D7" height="22" ></td>
 <td bgcolor="#CCD2D7" height="22" ></td>
 </tr>
 ...
 <td bgcolor="#CCD2D7" height="22" ></td>
 <td height="22" ></td>
 <td bgcolor="#CCD2D7" height="22" colspan="3" align="center" class="etiqueta" >Fornecedor</td>
 <td height="22" ></td>
 ...
 <td width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="60">Encomendado</td>
 <td width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="60">Recebida</td>
 <td width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="60">Encomendado</td>
 <td width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="60">Recebida</td>
 <td width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="60">Diferença</td>
