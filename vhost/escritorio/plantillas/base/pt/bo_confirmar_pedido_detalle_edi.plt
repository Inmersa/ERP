...
<li><a href="?seccion=hacer_pedido" class="editar" ><img src="imag/pixel.png" class="icono" /><span>Adicionar Produto</span></a></li>
@%else:%@
<li><a href="?seccion=hacer_pedido_compra" class="editar" ><img src="imag/pixel.png" class="icono" /><span>Adicionar Produto</span></a></li>
@%end-if:%@
</ul></div>
