...
@%plt:botonera%@
 ...
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="110">Total de Comissão</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" align="center" class="etiqueta">Total de Conta </td>
 <td width="1" height="22"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" class="etiqueta" align="center">Total </td>
