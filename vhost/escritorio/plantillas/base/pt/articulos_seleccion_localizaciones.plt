...
<table class="full" >
<tbody>
<tr><td class="etiqueta" >Produto</td><td colspan="2" >@%db:Articulos.nombre;%@ (@%db:Articulos.id_articulo;%@)</td></tr>
<tr><td class="etiqueta" >Quantidade a emitir</td><td colspan="2" >@%db:Detalles_albaran.cantidad;%@</td></tr>
...
<tr><td class="etiqueta" >Agrupar localizações de entrega</td><td class="check" 
...
<li><a href="#" onClick="return sendForm('localizaciones_actuales');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Guardar</span></a></li>
</ul></div>
</div>
