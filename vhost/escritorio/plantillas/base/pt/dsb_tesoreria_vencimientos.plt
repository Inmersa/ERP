...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Prazos de Cobro</td>
<td colspan="@%get:_iterate_times;%@" >Prazos de Pagamento</td></td>
...
<!-- 
@%set:grafica[titulo] = Prazos de Cobro;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Prazos de Pagamento;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
