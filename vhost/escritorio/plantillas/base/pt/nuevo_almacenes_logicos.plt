...
<legend>Nova Zona Armazém</legend>
...
<li><a href="#" onClick="return sendForm('nuevo_almacenes_logicos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Guardar</span></a></li>
</ul></div>
