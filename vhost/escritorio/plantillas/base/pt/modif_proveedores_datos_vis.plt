...
<input type="hidden" name="accion_ejecutar" value="Modificar">
 ...
 <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Nome:</td>
...
<input type="hidden" name="registro[nombre]" class="insertext" size="30" value="@%db:Proveedores.nombre;%@"/>
 ...
 <td width="87" class="etiqueta" align="right" bgcolor="#EBECED">NIF Intracomunitário:</td>
...
<input type="hidden" name="registro[cif]" value="@%db:Proveedores.cif;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Endereço:</td>
...
<input type="hidden" name="registro[domicilio]" value="@%db:Proveedores.domicilio;%@" class="insertext" size="30"/>
 ...
 <td bgcolor="#EBECED" width="87" align="right" class="etiqueta">Localidade:</td>
...
<input type="hidden" name="registro[cp]" value="@%db:Proveedores.cp;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Pessoa de Contacto:</td>
...
<input type="hidden" name="registro[telefono1]" value="@%db:Proveedores.telefono1;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Cargo do Contacto:</td>
...
<input type="hidden" name="registro[fax]" value="@%db:Proveedores.fax;%@" class="insertext" size="20"/>
 ...
 <tr> <td width="161" height="22" align="right" bgcolor="#EBECED" class="etiqueta">Data de Registo:</td>
...
<input type=hidden name=registro2[id_usr] value="@%db:Proveedores_empresas.id_usr%@">
 ...
 <td class="etiqueta" height="20" >Dados da Empresa</td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td align="right" height="22" bgcolor="#EBECED" class="etiqueta" width="161">Método de Pagamento:</td>
...
@%end-where:%@
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta">Retenção:</td>
