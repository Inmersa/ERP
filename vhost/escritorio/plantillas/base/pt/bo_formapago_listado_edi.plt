...
<td class="caption">Nº Ordem de Pagamento</td>
<td class="caption">Dias entre Pagamentos</td>
</tr>
...
@%plt:botonera%@
<div class="enviar"><a href="javascript:document.forms['modif_forma_pago'].submit();">Eliminar Itens Seleccionados</a></div>
