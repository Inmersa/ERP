...
<tbody>
 ...
 <option value="0" >Não Existem Itens Seleccionados</option>
 ...
 <tr><td class="etiqueta" >onversão decomposta:</td>
 ...
 <tr><td class="etiqueta" >Números decimans em Unidades de medida:</td>
...
<li><a href="#" onClick="return resetForm('modif_unidades_medida');"  class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Desfazer Alterações</span></a></li> 
