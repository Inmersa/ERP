...
<table class="full">
 ...
 <tr><td class="etiqueta" >Conceito: </td>
...
@%end-if:%@
 ...
 Devolvido (@%db:si_no_flag{Efectos.devuelto}%@) 
 </td>
 </tr>
 </table>
</fieldset>
