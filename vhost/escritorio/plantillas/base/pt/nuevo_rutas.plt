...
<tr>
<td class="etiqueta">Duração da Visita (minutos) (Minutos): </td>
<td><input type="text" name="registro[m_visita]" /></td>
<td class="etiqueta">Duração da Transferência (minutos) (Minutos):</td>
<td><input type="text" name="registro[m_traslado]" /></td>
</tr>

<tr><td class="etiqueta">Frequência/Dias (Dias) :</td>
<td><input type="text" name="registro[d_frecuencia]" /></td>
<td class="etiqueta">Duração da Rota (minutos) (Horas):</td>
