...
<div class="tituloseccion">&gt; Ficha de Produto</div>
...
><div name="Precios" class="activo" >Preço</div
@%end-if:%@
@%if:AllowedPII;Proveedores_Articulo;%@
><div name="Proveedores" >Fornecedores</div
@%end-if:%@
@%if:AllowedPII;Servicios;%@
><div name="Servicios" >Serviços</div
@%end-if:%@
@%if:AllowedPII;Recursos;%@
><div name="Recursos" >Recursos</div
@%end-if:%@
@%if:AllowedPII;Composicion;%@
><div name="Composicion" >Composição</div
@%end-if:%@
...
<li><a href="#" onclick="return onHRefClick('modif_articulos','accion_ejecutar','Modificar');" class="guardar"><img src="imag/pixel.png" class="icono" /><span>Alterar</span></a></li>
</ul></div>
@%end-if:%@
