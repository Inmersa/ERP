...
<form name="bo_inventario_articulos" method="post" action="">
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="190">Produto</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="50">Lote</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Piso</td>
 <td width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Corredor</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Fila</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Coluna</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center">Quantidade</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="22" align="center" class="etiqueta" width="100">Data de Validade </td>
