...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#DBE0E3" width="120" class="etiqueta">Referência</td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Administrador</td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Data de Registo</td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Data Aproximada de Conclusão</td>
