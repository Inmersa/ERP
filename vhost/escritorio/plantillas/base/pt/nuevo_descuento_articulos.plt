...
<div class="tituloseccion">&gt; Adicionar produtos ao cliente (
...
@%plt:botonera%@
 ...
 <li><a href="#" onClick="return sendForm('nuevo_descuento_articulos');"  class="enviar" ><img src="imag/pixel.png" class="icono" /><span>Adicionar</span></a></li>
 </ul></div>
