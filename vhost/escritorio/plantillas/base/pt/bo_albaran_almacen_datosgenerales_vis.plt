...
-->
 <tr> <td bgcolor="#CCD2D7" height="22" align="right" class="etiqueta" width="80">Fornecedor</td>
 <td bgcolor="#CCD2D7" height="22" width="90"></td>
 <td bgcolor="#CCD2D7" height="22" width="60"></td>
 <td bgcolor="#CCD2D7" height="22"></td>
 </tr>
 ...
 <td bgcolor="#EBECED" class="texto" width="96" align="right">Armazém:</td>
 <td width="264" class="texto">@%db:Almacenes.nombre;%@</td>
 </tr>
 <tr> <td colspan="4" height="1" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22" width="80"> Ref. Encomenda:</td>
...
<td bgcolor="#EBECED" class="texto" align="right" >Estados </td>
 ...
 <td width="96" align="right" bgcolor="#EBECED" class="texto">Transportador:</td>
