...
@%end-where:%@
 ...
 <tr><td class="etiqueta" >Prefixo Telefónico:</td>
...
<div class="AccionesEnvio"><ul>
 ...
 <li><a href="#" onClick="return resetForm('modif_provincias');"  class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Desfazer Alterações</span></a></li> 
