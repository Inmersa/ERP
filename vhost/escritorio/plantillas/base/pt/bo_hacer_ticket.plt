 ...
 <td class="titocho" >&gt; Selecçionar Produtos para Talão</td>
 <td align="right" > <a href="#" onclick="return abrir_ventana('?seccion=hacer_ticket_codbarras',400,200);" class="accesos">Código de Barras</a>
 </td>
