...
<li><a href="?seccion=nuevo_familia_articulos" class="accesos" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span> Novo</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_familia_articulos');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
</ul></div>
...
<tr>
<td></td>
<td class="caption">Nome da Família</td>
</tr>
</thead>
<tbody>
