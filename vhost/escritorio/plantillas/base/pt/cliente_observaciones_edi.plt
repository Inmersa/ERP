...
<table class="full">
 ...
 <a href="?seccion=crm_seleccionar_usuario&id=@%get:usuario_actual;%@" >Atribuir</a>
 @%end-if:%@
 ...
 <tr>
 <td class="etiqueta">Recomendado por:</td>
 <td>
 ...
 <a href="?seccion=bo_importar_recomendador" >Atribuir</a>
 @%end-if:%@
