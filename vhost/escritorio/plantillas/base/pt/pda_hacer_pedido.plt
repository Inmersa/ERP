<html>
<head>
<title>Efectuar Encomenda</title>
...
<tr> <td class="accesos" align="right"><!-- a href="javascript: document.forms['cesta'].submit();" class="accesos">Concluir</a --><input type="submit" 
name="Finalizar" value="Concluir">
 <input type="submit" name="Anyadir" value="Adicionar">
 <!-- a href="" onClick="document.forms['hacer_pedido'].submit();return false;"class="accesos">Adicionar</a -->
 </td>
 </tr>
<tr>
<td height="10"></td>
...
<tr> <td class="acceso_directo" align="center" width="95">ID</td>
 <td class="acceso_directo" align="center" width="56">Quantidade</td>
 <td class="acceso_directo" align="center" width="49">Embalagens</td>
 </tr>
 </table>
 <table width="200" border="0" cellspacing="0" cellpadding="0">
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <td class="accesos2" align="left">Produtos Seleccionados<input type="submit" name="Anyadir" value="Adicionar">
</td>
 <tr>
<td height="10"></td>
</tr>
...
<td height="10"></td>
 ...
 <tr> <td class="titul1" align="center" width="114">Total:</td>
 <td class="texto" align="center"width="86"> @%db:importe%@ @%db:leyenda_divisa%@ </td>
 </tr>
 <tr> <td class="titocho" align="center" width="114">Valor Tributável:</td>
...
class="accesos">Home</a>&nbsp;<a href="?seccion=pda_hacer_pedido&vaciar_pedido=1" class="accesos">Eliminar Itens da Encomenda</a> 
<input type="submit" name="Finalizar" value="Concluir">
<!-- a href="javascript: document.forms['cesta'].submit();" class="accesos">Concluir</a -->
</form>
</td>
 </tr>
<tr><td colspan="3"><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr><td height="22" class="texto" align="right" >Referência de:</td>
 <td class="texto" align="left"><input type="text" size="14" maxlength="14" name="repo[fecha]" class="insertext"
value="dd/mm/aaaa"><input type="submit" value="Aceitar">
 </tr>
</table>
</form>
</td></tr>
<tr>
 <td class="accesos2" align="left" colspan="3">Legenda :</td>
</tr>
 <tr> <td height="10" width="114"></td>
 </tr>
<tr> <td class="acceso_directo" align="center" width="27">
<input type="checkbox" name="legend[]" value="" checked>
 ...
 <td class="texto" align="center" width="65">Nome do Produto</td>
 <td class="texto" align="center" width="108">ID</td>
 </tr>
 <tr> <td class="texto" align="center" width="27">Stock</td>
 <td class="texto" align="center" width="65">Valor Tributável</td>
 <td class="texto" align="center" width="108">Quantidade</td>
 </tr>
 <tr>
<td height="10"></td>
</tr>
