...
<table width="702" border="0" cellspacing="0" cellpadding="0" bordercolor="#3F4D83">
 ...
 <br>
 <tr>
 @%where:tabla|Catalogo_imagenes;nombre|busc;no_results|1;%@ 
 @%if:contador%@
 </tr>
 <tr>
 @%end-if:%@
 ...
 <tr> <td class="bordes">
 <a href="?seccion=bo_modif_catalogo&amp;id_imagen=@%db:Catalogo_imagenes.id_imagen%@" class="texto_negrita_sinfondo">Alterar</a></td>
 </tr>
 <tr>
 <td heigth=5></td>
 </table>
...
<a href="?seccion=bo_catalogo&id_imagen=@%db:Catalogo_imagenes.id_imagen%@&nombre_foto=@%db:Catalogo_imagenes.nombre%@&estado=2"
 ...
 Eliminar Itens Seleccionados</a></td>
 </tr>
 </table>
 <br>
 </td>
