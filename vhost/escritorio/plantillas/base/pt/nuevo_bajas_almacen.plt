...
@%if:!esta_vacio;id_albaran;%@
	...
	@%if:esta_vacio;es_venta;%@
		<tr><td class="etiqueta" >Não alterar as existências</td>
		...
		<td class="etiquetacheck" >Restabelecer Stock</td></tr>
	@%else:%@
		<tr><td class="etiqueta" >Abater Stock</td>
		<td class="check" ><input type="radio" name="registro[@%db:i;%@][causar_baja]" value="1" checked="checked" ></td>
		<td class="check" ><input type="radio" name="registro[@%db:i;%@][causar_baja]" value="0"></td>
		<td class="etiquetacheck" >Restabelecer Stock</td></tr>
	@%end-if:%@
...
<tr><td class="etiqueta"> Quantidade Incial : </td><td colspan="3" >@%db:cantidad;%@</td></tr>
...
@%if:!esta_vacio;id_albaran;%@
	<table class="full" >
	<caption class="titulotb" >Notas de Crédito</caption>
