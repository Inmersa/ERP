...
Marca / Família: <input type="text" name="nombre_marca" size="30" value="@%get:st_nombre_marca%@" />
...
<a href="#" onclick="return sendForm('buscadorgeneral');" accesskey="p" class="submit" >Pesquisar</a></td>
 <select name="hp">
