...
<div class="barraoscura"><a href="" onClick="return onHRefClick('descuentos_familia','accion_ejecutar','Borrar');" class="accesos">Eliminar Itens Seleccionados</a>
</div>
<table class="full">
...
<div class="enviar"><a href="" onClick="return onHRefClick('descuentos_familia','accion_ejecutar','Modificar');" class="accesos">Alterar</a>
</div>
</form>
