...
<thead>
<tr>
<td ><a href="?_search_sort=Pedidos.referencia" >Referência<img src="imag/pixel.png" class="@%func:class_searchsort;Pedidos.referencia;%@" /></a></td>
...
<td class="estado"><a href="?_search_sort=Pedidos.preparado" >Enc<img src="imag/pixel.png" class="@%func:class_searchsort;Pedidos.preparado;%@" /></a></td>
