...
<input type="hidden" name="accion_ejecutar" value="0">
 ...
 <tr> <td colspan="15" bgcolor="#CCD2D7" height="22" class="etiqueta" align="right"> <a href="" onClick="return onHRefClick('agentes_clientes','accion_ejecutar','Borrar');" class="accesos">Eliminar Itens Seleccionados</a></td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="70">Código</td>
 <td align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="22"></td>
 <td align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="150">Nome</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Endereço de Entrega</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="100">Data de Entrada </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" align="center" class="etiqueta">Comissão</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" align="center" class="etiqueta">Comissão Partilhada</td>
 ...
 <tr> <td bgcolor="#CCD2D7" height="22" colspan="15" align="center"> <a href="" onClick="return onHRefClick('agentes_clientes','accion_ejecutar','Modificar');" class="accesos">Alterar</a> </td>
 </tr>
</table>
</td>
 </tr>
