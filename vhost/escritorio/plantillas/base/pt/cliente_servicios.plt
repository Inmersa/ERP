...
<div class="tituloseccion">Serviços de Cliente 
...
@%end-if:%@
 ...
 <td ><a href="?_search_sort=Clientes_recursos.fecha_inicio" >Data de Ínicio<img src="imag/pixel.png" 
 	class="@%func:class_searchsort;Clientes_recursos.fecha_inicio;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes_recursos.fecha_fin" >Data de Finalização<img src="imag/pixel.png" 
 	class="@%func:class_searchsort;Clientes_recursos.fecha_fin;%@" /></a></td>
 <td ><a href="?_search_sort=Estados_servicio.nombre" >Estado de Serviço<img src="imag/pixel.png" class="@%func:class_searchsort;Estados_servicio.nombre;%@" /></a></td>
</tr>
</thead>
<tbody>
