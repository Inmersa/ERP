...
<tbody>
 ...
 <tr><td class="etiqueta" >Transportador:</td>
...
<li><a href="#" onclick="return sendForm('modif_direcciones_entrega');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Alterar</span></a></li>
</div>
