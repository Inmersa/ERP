...
<div class="titsuperior">&gt; Encomenda :@%db:nombre;%@</div><div class="alinder"
...
<a href="#" onclick=window.open('?@%env:QUERY_STRING%@&imprimir=1'); return false; class="accesos">Imprimir</a>
