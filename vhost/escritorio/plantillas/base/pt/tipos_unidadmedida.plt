...
<div class="tituloseccion" >Tipo de Unidade de medida</div>
...
<li><a href="#" onClick="return sendForm('listado','accion_ejecutar','ModificarLista');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Alterar</span></a></li>
@%end-if:%@
