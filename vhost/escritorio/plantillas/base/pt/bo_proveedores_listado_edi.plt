...
<li><a href="?seccion=bo_importar_proveedores" class="importarusuario" ><img src="imag/pixel.png" class="icono" /><span>Recuperar Fornecedor</span></a></li>
@%end-if:%@
<li><a href="#" onclick="return sendForm('bo_proveedores');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
</ul></div>
