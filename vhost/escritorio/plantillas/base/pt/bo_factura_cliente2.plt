...
@%end-if:%@
<div id="contadorpaginas">Página @%get:pagina_actual;%@ de @%get:paginas_totales;%@</div></div>
...
<tr class="bordes">
 ...
 <td class="@%css:PVP_rec;label;%@" >PVP Recomendado</td>
 <td >Produto</td>
...
@%end-if:%@
 ...
 <td >Quantidade</td>
 <td >Preço</td>
 <td class="@%db:css:descuento;label;%@" >Desconto</td>
 <td >IVA % </td>
 <td >Montante</td>
</tr>
</thead>
