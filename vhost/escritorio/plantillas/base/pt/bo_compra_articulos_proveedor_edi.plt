...
<li><a href="?seccion=bo_importar_articulos_proveedor" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Recuperar Artigos</span></a></li>
@%end-if:%@
...
<td ><a href="?_search_sort=Empresas_articulos.referencia" class="order" 
	>Referência Própria<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.referencia;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.referencia" class="order" 
	>Referência do Fornecedor<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.referencia;%@" /></a></td>
<td class="estado" ><img src="imag/pixel.png" class="marcartodos" onclick="return formCheckAll('proovedores_articulo_borrar');"  /></td>
<td ><a href="?_search_sort=Compra_articulos.id_articulo" class="order" 
	>IDs<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.id_articulo;%@" /></a></td>
<td ><a href="?_search_sort=Articulos.nombre" class="order" >Nome do Produto<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.PVP_oficial" class="order" 
	>PVP<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.PVP_oficial;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.PV_oficial" class="order" 
	>Preço Resale<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.PV_oficial;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.precio" class="order" 
	>Preço<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.precio;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.descuento" class="order" 
	>Desconto %<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.descuento;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.dto_vol" class="order" 
	>Desconto por Volume<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.dto_vol;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.fabricante" class="order" 
	>Fab.<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.fabricante;%@" /></a></td>
</tr>
</thead>
<tbody>
...
<li><a href="#" onclick="return onHRefClick('compra_articulos_proveedor','accion_ejecutar','Modificar');" 
	class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Alterar</span></a></li>
</ul></div>
