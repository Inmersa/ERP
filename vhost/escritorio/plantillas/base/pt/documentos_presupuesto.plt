...
<legend>Documentos dos Orçamentos</legend>
<div class="AccionesFicha" >
<ul>
@%if:esta_vacio;id_grupo_docs;%@
@%else:%@
@%if:AllowedAction;Presupuestos_Documentos_CRM;new;%@
<li><a href="#" onClick="return onHRefClick('documentos','accion_ejecutar','NuevoDocumento');" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Novo</span></a></li>
@%end-if:%@
@%end-if:%@
...
<li><a href="?seccion=crm_seleccionar_documento&varios=1&id_presupuesto=@%get:id_presupuesto;%@" 
	class="asociar" ><img src="imag/pixel.png" class="icono" /><span>Selecçionar Documento</span></a></li>
...
<li><a href="#" onClick="return sendForm('documentos','accion_ejecutar','BorrarDocumentos',null,'¿É você certo que você quer suprimir registros selecionados?');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
@%end-if:%@
...
@%end-if:%@
   ...
   @%else:%@
@%if:AllowedAction;Presupuestos_Documentos_CRM;new;%@
   <div class="documentos">Novo Documento<input type="text" name="documento[nombre]" ><input type="file" name="document_file" /><br />
