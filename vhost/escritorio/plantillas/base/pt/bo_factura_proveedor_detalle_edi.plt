...
@%if:emitida%@
	...
	<li><a href="#" onClick="return sendForm('factura','accion_ejecutar','AbonarFactura','hacer_pedido_compra&factura=1&abono=1&nuevo=1');" class="abonofactura" 
		><img src="imag/pixel.png" class="icono" /><span>Creditar Factura</span></a></li> 
	@%set:listar_abonos = 1;%@
	@%end-if:%@
@%else:%@
	<li><a href="?seccion=hacer_pedido_compra" class="editar" ><img src="imag/pixel.png" class="icono" /><span>Alterar Detalhe da Encomenda</span></a></li> 
	<li><a href="#" onclick="return onHRefClick('factura','accion_ejecutar','Borrar');" class="borrar" 
		><img src="imag/pixel.png" class="icono" /><span>Eliminar Artigo(s)</span></a></li>
@%end-if:%@
</ul></div>

<table class="full"><thead><tr>
<td class="estado" ><img src="imag/pixel.png" class="marcartodos" onclick="eturn formCheckAll('borrar_articulos');"  /></td>
<td >Código</td>
<td >Quantidade</td>
<td >Preço</td>
<td >IVA</td>
