...
<input type=hidden name=estado value=4>
 ...
 <td class="titocho" >&gt; Ficha da Empresa</td>
 <td align="right" ><a href="../?seccion=bo_empresas" class="accesos">Lista de Empresas</a></td>
...
<a href="javascript:document.forms['modif_empresas'].submit();" class="accesos">Alterar</a>
<a href="javascript:document.forms['modif_empresas'].reset();" class="accesos">Desfazer Alterações</a> 
