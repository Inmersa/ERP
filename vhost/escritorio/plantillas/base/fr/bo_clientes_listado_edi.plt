...
<ul>
 @%if:!oModoSeleccion->isActive;%@
	...
	<li><a href="?seccion=nuevo_clientes" class="nuevo"><img src="imag/pixel.png" class="icono" /><span>Nouveau client</span></a></li>
	@%end-if:%@
	@%if:AllowedLink;bo_importar_clientes;%@
	<li><a href="?seccion=bo_importar_clientes" class="altausuario"><img src="imag/pixel.png" class="icono" /><span>Importer client</span></a></li>
	@%end-if:%@
	@%if:AllowedAction;Clientes_empresas;del;%@
	<li><a href="#" onclick="return sendForm('bo_clientes');" class="bajausuario" ><img src="imag/pixel.png" class="icono" /><span>Fin de période</span></a></li>
	@%set:permitir_selecciones=1;%@
	@%end-if:%@
  @%else:%@
 	<li ><a href="#" onClick="return sendForm('bo_clientes');" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Sélectionner</span></a></li>
  @%end-if:%@
</ul>
</div>
...
<tr>
 ...
 <td ><a href="?_search_sort=Clientes_empresas.persona_contacto">Contact<img src="imag/pixel.png" class="@%func:class_searchsort;Clientes_empresas.persona_contacto;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes.cif">NSF<img src="imag/pixel.png" class="@%func:class_searchsort;Clientes.cif;%@" /></a></td>
 <td ><a href="?_search_sort=Tipo_cliente.nombre">Type client<img src="imag/pixel.png" class="@%func:class_searchsort;Tipo_cliente.nombre;%@" /></a></td>
 </tr>
</thead>
<tbody>
@%end-if:%@
