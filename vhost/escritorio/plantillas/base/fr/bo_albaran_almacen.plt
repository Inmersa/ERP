...
<div class="tituloseccion">&gt; Livraisons:</div>
...
<li><a href="#" onclick="return SendFormToWindow('bo_albaran_almacen','bo_albaran_devolucion_print&id_albaran=@%db:Albaranes.id_albaran%@','__printdevolucion__');" class="devolucionprint"><img src="imag/pixel.png" class="icono" /><span>Imprimer un Remboursement</span></a></li>
@%end-if:%@
<li><a href="#" onclick="return !window.open('?seccion=bo_albaran_envio_print&id_albaran=@%db:Albaranes.id_albaran%@');" class="envioprint" ><img src="imag/pixel.png" class="icono" /><span>Imprimer</span></a></li>
<li><a href="#" onclick="window.open('?@%get:_krn_ss_querystring;%@&imprimir=1');" return false;" class="inicioprint"><img src="imag/pixel.png" class="icono" /><span>Imprimer Début</span></a></li>
@%end-if:%@
</ul></div>
...
<li><a href="#" onclick="return onHRefClick('bo_albaran_almacen','accion_ejecutar','Modificar');" class="guardar"><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
</ul></div>
@%end-if:%@
