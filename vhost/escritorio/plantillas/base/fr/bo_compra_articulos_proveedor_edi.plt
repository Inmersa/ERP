...
<li><a href="?seccion=bo_importar_articulos_proveedor" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Récupérer</span></a></li>
@%end-if:%@
...
<td ><a href="?_search_sort=Empresas_articulos.referencia" class="order" 
	>Référence<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.referencia;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.referencia" class="order" 
	>Réf. Fournisseur<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.referencia;%@" /></a></td>
...
<td ><a href="?_search_sort=Articulos.nombre" class="order" >Nom article<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.PVP_oficial" class="order" 
	>Prix de vente<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.PVP_oficial;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.PV_oficial" class="order" 
	>Prix Éclate<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.PV_oficial;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.precio" class="order" 
	>Prix<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.precio;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.descuento" class="order" 
	>Rem. %<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.descuento;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.dto_vol" class="order" 
	>Remises par volume<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.dto_vol;%@" /></a></td>
...
<li><a href="#" onclick="return onHRefClick('compra_articulos_proveedor','accion_ejecutar','Modificar');" 
	class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
</ul></div>
