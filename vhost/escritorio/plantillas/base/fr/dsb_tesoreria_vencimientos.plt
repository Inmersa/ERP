...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Échéances d'Encaissement</td>
<td colspan="@%get:_iterate_times;%@" >Échéances de Paiement</td></td>
...
<!-- 
@%set:grafica[titulo] = Échéances d'Encaissement;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Échéances de Paiement;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
