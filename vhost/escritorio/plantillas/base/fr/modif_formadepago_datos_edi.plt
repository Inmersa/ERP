...
<tr> <td colspan="3" height="22" bgcolor="#CCD2D7"></td>
 ...
 <tr align="center"> <td height="22" bgcolor="#CCD2D7" colspan="3"><a href="javascript:document.forms['modif_forma_pago'].submit();" class="accesos">Garder</a> 
 <a href="javascript:document.forms['modif_forma_pago'].reset();" class="accesos">Défaire changement</a>
 <a href="?seccion=bo_forma_pago&estado=2&registro[id_forma_pago]=@%db:Forma_pago.id_forma_pago%@" onClick="return confirm('Esta ud. seguro de que de desea borrar el registro?');return false;" class="accesos">Effacer</a> </td>
 </tr>
</form>
 </table>
 </td>
