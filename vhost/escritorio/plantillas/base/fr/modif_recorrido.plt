...
<div class="tituloseccion">&gt; Modifier Parcours</div>
...
@%if:AllowedPII;Citas;%@
><div name="Citas" class="activo" >Listage Parcours</div
@%end-if:%@
@%if:AllowedPII;Gastos;%@
><div name="Gastos" >Dépenses</div
@%end-if:%@
@%if:AllowedPII;Totales;%@
><div name="Efectos" >Effets payés</div
@%end-if:%@
></div>
...
@%if:esta_vacio;estado_cerrado;%@
	...
	<li><a href="#" onClick="return sendForm('modif_recorridos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
	@%if:!esta_vacio;estado_noiniciado;%@
	<li><a href="#" onClick="return sendForm('modif_recorridos','accion_ejecutar','Iniciar');" class="iniciar" 
		><img src="imag/pixel.png" class="icono" /><span>Commencer Route</span></a></li>
	@%else:%@
