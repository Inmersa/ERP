<table class="full">
 ...
 <tr> <td width="6" ></td>
 <td class="titocho" >&gt; Nouvelle enterprise</td>
 <td ></td>
...
@%where:tabla|Grupo_empresas;nolink|1;%@
 ...
 <td width="87" class="etiqueta" >Téléphone 1:</td>
 ...
 <td width="87" class="etiqueta" >Téléphone 2:</td>
 ...
 <td width="87" class="etiqueta" >Télécopieur:</td>
...
@%where:tabla|Provincias;order|nombre;nolink|1;%@
 ...
 <tr > 
 <td width="124" class="etiqueta" >Prefixe de facture:</td>
 <td width="57"> <input type="text" name="registro[prefijo_fact]" class="insertextnumeros" size="6">
 </td>
 <td class="etiqueta" width="124" >Suffixe de facture:</td>
 ...
 <tr bgcolor="#CCD2D7"> <td colspan="2" class="etiqueta">Autres renseignements</td>
 </tr>
 ...
 <tr> <td class="etiqueta">Répéter mot de passe:</td>
 <td width="483"> 
...
<a href="javascript:document.forms['nuevo_empresas'].submit();" >Garder</a>
</table>
</td> 
</tr>
 <tr> <td > </td>
