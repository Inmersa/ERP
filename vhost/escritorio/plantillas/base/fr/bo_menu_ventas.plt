...
<div class="menuitem"> <a href="?seccion=bo_facturas_venta" @%func:querystring_activa;bo_facturas_venta;activo;;%@ >Factures</a></div>
@%end-if:%@
@%if:AllowedLink;bo_pedidos_ventas;%@
<div class="menuitem"> <a href="?seccion=bo_pedidos_ventas" @%func:querystring_activa;bo_pedidos_ventas;activo;;%@ >Commandes</a></div>
@%end-if:%@
@%if:AllowedLink;bo_proformas_venta;%@
<div class="menuitem"><a href="?seccion=bo_proformas_venta" @%func:querystring_activa;bo_proformas_venta;activo;;%@ >Factures Proforma</a></div>
@%end-if:%@
...
<div class="menuitem"> <a href="?seccion=bo_albaranes_venta" @%func:querystring_activa;bo_albaranes_venta;activo;;%@ >Livraisons</a></div>
@%end-if:%@
...
<!--
@%if:AllowedLink;bo_facturas_venta;%@
<div class="menuitem"> <a href="?seccion=bo_compra_venta" @%func:querystring_activa;nuevo_pedidos_ventas&presupuesto=1;activo;;%@ >Renseignements</a></div>
@%end-if:%@
-->

@%if:AllowedLink;nuevo_pedidos_ventas;%@
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&proforma=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&proforma=1;activo;;%@ >Nouvelle Facture Proforma</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&presupuesto=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&presupuesto=1;activo;;%@ >Nouveau Budget</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&pedido=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&pedido=1;activo;;%@  >Passer une commande</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&factura=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&factura=1;activo;;%@  >Passer une commande</a></div>
