...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center" width="80">Code</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Continent</td>
 <td width="1" class="etiqueta"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center" width="80">Prefixe Tf.</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center" width="80">Prefixe NSF</td>
