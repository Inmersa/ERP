<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td colspan="9" bgcolor="#CCD2D7" height="22" class="etiqueta">Magasin </td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Nom article </td>
 <td width="1" align="center"></td>
 <td class="etiqueta" width="120" align="center" bgcolor="#DBE0E3">Référence</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="60">Stock</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="100" height="22" align="center" class="etiqueta">Date limite mineur</td>
