...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="70">Référence</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Réf. Fournisseur </td>
 <td width="1"></td>
 <td width="20" bgcolor="#DBE0E3"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Nom article </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center"></td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Prix</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="65" align="center">Rem. %</td>
 <td class="etiqueta" align="center" width="1"></td>
