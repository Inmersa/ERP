...
<input type="hidden" name="accion_ejecutar" value="0">
 ...
 <tr> <td colspan="15" bgcolor="#CCD2D7" height="22" class="etiqueta" align="right"> <a href="" onClick="return onHRefClick('agentes_clientes','accion_ejecutar','Borrar');" class="accesos">Elimier</a></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Direction remise</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="100">Date de création </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" align="center" class="etiqueta">Commission</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" align="center" class="etiqueta">Commission à partager</td>
 ...
 <tr> <td bgcolor="#CCD2D7" height="22" colspan="15" align="center"> <a href="" onClick="return onHRefClick('agentes_clientes','accion_ejecutar','Modificar');" class="accesos">Modifier</a> </td>
 </tr>
</table>
</td>
 </tr>
