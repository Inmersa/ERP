...
<li><a href="?seccion=nuevo_descuento_familia" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
@%end-if:%@
<li><a href="return sendForm('modif_descuento_familia');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=Familia_articulos.nombre" class="order" 
	>Nom Famille<img src="imag/pixel.png" class="@%func:class_searchsort;Familia_articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Descuento_familia.descuento" class="order" 
	>Remises<img src="imag/pixel.png" class="@%func:class_searchsort;Descuento_familia.descuento;%@" /></a></td>
</tr>
</thead>
<tbody>
