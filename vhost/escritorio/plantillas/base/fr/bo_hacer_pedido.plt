...
<table class="full">
<thead ><tr>
<td ><a href="?_search_sort=Articulos.nombre" class="order" >Nom<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Marcas.nombre" class="order" >Marque<img src="imag/pixel.png" class="@%func:class_searchsort;Marcas.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.stock_ficticio" class="order" 
	>Stock E.<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.stock_ficticio;%@" /></a></td>
<td >Bosses</td>
<td >Quantite</td>
<td ><a href="?_search_sort=Empresas_articulos.unidades_bulto" class="order" 
	>Unités caixa<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.unidades_bulto;%@" /></a></td>
...
<td>@%func:descripcion_descuento%@</td>
 ...
 <input type="hidden" name="Anyadir" value="Añadir" />
</form>

<div class="AccionesEnvio"><ul>
<li><a href="#" onClick="return sendForm('hacer_pedido');" class="sumaracesta"><img src="imag/pixel.png" class="icono" /><span>Ajouter</span></a></li>
</ul></div>
