...
<div class="tituloseccion" >Types de Ressource</div>
...
<li><a href="?seccion=nuevo_tipo_recurso" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
@%end-if:%@
