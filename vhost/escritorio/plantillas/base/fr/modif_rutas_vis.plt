...
<tr bgcolor="#EBECED"> </table>
 ...
 <tr> <td bgcolor="#EBECED" align="right" width="150" height="22" class="etiqueta">Nom route:</td>
 <td width="215" class="texto"> <input type="text" name="registro[nombre]" class="insertext" size="25" value="@%db:Rutas.nombre%@">
 </td>
 <td bgcolor="#EBECED" align="right" width="125" class="etiqueta">Groupe de routes:</td>
...
>@%db:Agentes.nombre%@</option>
 ...
 <tr> <td height="22" bgcolor="#EBECED" class="etiqueta" align="right" width="150">Durée visite (minutes) (Minutes): </td>
 <td height="1" width="215"> <input type="text" name="registro[m_visita]" value="@%db:Rutas.m_visita%@" class="texto">
 </td>
 <td height="1" bgcolor="#EBECED" align="right" class="etiqueta" width="125">Durée déplacement (minutes) (Minutes):</td>
 <td height="1" width="154"> <input type="text" name="registro[m_traslado]" value="@%db:Rutas.m_traslado%@" class="insertext">
 </td>
 </tr>
 <tr> <td height="1" colspan="4" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td height="22" bgcolor="#EBECED" class="etiqueta" align="right" width="150">Fréquence / jours (Jours) :</td>
 <td height="1" width="215"> <input type="text" name="registro[d_frecuencia]" value="@%db:Rutas.d_frecuencia;%@" class="texto">
 </td>
 <td height="1" bgcolor="#EBECED" class="etiqueta" align="right" width="125">Durée route (heures) (Jours):</td>
 ...
 <a href="javascript:document.forms['modif_rutas'].submit();" class="accesos">Ajouter</a></td>
 </tr>
 </table>
 </form>
 </td>
 ...
 <tr> <td bgcolor="#91CC00" height="20" class="titocho">>Liste de clients route</td>
 </tr>
</table>
...
<tr> <td bgcolor="#DBE0E3" width="1" class="etiqueta" align="center"></td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="170">Direction</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Moyen de contact</td>
