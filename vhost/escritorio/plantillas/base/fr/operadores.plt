...
<div class="tituloseccion">&gt; Opérateurs</div>
...
<li><a href="#" onclick="return confirmForm('operadores','Êtes-vous sûr que vous voulez supprimer des enregistrements choisis?');" class="borrar" 
