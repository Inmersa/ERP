...
<ul>
 @%if:!oModoSeleccion->isActive;%@
	 ...
	 <li><a href="?seccion=bo_importar_articulos" class="recuperar"><img src="imag/pixel.png" class="icono" /><span>Importer article</span></a></li>
	 @%end-if:&@
	 ...
	 <li><a href="#" onclick="return onHRefClick('bo_articulos','accion_ejecutar','Borrar');" class="borrar"
		><img src="imag/pixel.png" class="icono" /><span>Fin de période</span></a></li>
	 @%end-if:%@
 @%else:%@
