...
<li><a href="?seccion=nuevo_divisa" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_divisa');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
