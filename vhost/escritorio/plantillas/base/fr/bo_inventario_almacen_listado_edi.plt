...
<td ><a href="?_search_sort=Articulos.codigo_barras" >Code-barres<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.codigo_barras;%@" /></a> </td>
...
<td ><a href="?_search_sort=Articulos.nombre" >Nom article<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a> </td>
...
<td ><a href="?_search_sort=caducidad" >Date limite mineur<img src="imag/pixel.png" class="@%func:class_searchsort;caducidad;%@" /></a></td>
<td ><a href="?_search_sort=caducidad_mayor" >Date Caducité Plus grande<img src="imag/pixel.png" class="@%func:class_searchsort;caducidad_mayor;%@" /></a></td>
<td ><a href="?_search_sort=valor" >Valeur<img src="imag/pixel.png" class="@%func:class_searchsort;valor;%@" /></a></td>
</tr></thead>
...
@%if:esta_vacio;st[id_alml];%@
	...
	@%if:cambia_var_x;%@
	<thead class="secundario" ><tr><td colspan="5">Zone de Magasin: @%db:Almacenes_logicos.nombre;%@</td>
