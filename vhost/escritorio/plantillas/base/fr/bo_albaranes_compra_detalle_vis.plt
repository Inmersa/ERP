...
-->
 ...
 <td bgcolor="#DBE0E3" height="22" class="etiqueta">Magasin</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">Transporteurs</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center" width="125">Ref. Commande </td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center" width="125">Référence </td>
 ...
 <tr> <td bgcolor="#DBE0E3" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" colspan="3">Fournisseur</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">Date </td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">État</td>
 <td bgcolor="#DBE0E3" height="22" width="1"></td>
 </tr>
 <tr> <td bgcolor="#FFFFFF" height="1" width="1"></td>
 <td bgcolor="#FFFFFF" height="1"></td>
