...
<div class="tituloseccion">Services de Client 
...
@%if:AllowedAction;Clientes_recursos;del;%@
 <td >&nbsp;</td>
@%end-if:%@
 <td ><a href="?_search_sort=Recursos.nombre" >Ressource<img src="imag/pixel.png" class="@%func:class_searchsort;Recursos.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Articulos.nombre" >Article<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes_recursos.fecha_inicio" >Debut de periode<img src="imag/pixel.png" 
 	class="@%func:class_searchsort;Clientes_recursos.fecha_inicio;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes_recursos.fecha_fin" >Derniére date<img src="imag/pixel.png" 
 	class="@%func:class_searchsort;Clientes_recursos.fecha_fin;%@" /></a></td>
 <td ><a href="?_search_sort=Estados_servicio.nombre" >État de Service<img src="imag/pixel.png" class="@%func:class_searchsort;Estados_servicio.nombre;%@" /></a></td>
</tr>
</thead>
<tbody>
