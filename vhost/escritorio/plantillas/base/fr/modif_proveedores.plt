...
<div class="barraoscura"><div class="titsuperior">&gt; Fiche Fournisseur (ID: @%db:Proveedores.id_proveedor;%@)</div></div> 
...
<li><a href="#" onClick="return sendForm('modif_proveedores');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li>
</ul></div>
