...
<li><a href="#" onclick="return onHRefClick('bo_inventario_articulos','accion_ejecutar','Agrupar');" class="agruparlocalizaciones" 
	><img src="imag/pixel.png" class="icono" /><span>Grouper</span></a></li>
@%if:AllowedAction;Localizacion_articulos;new;%@
<li><a href="?seccion=bo_importar_articulos_seleccion" class="nuevalocalizacion" ><img src="imag/pixel.png" class="icono" /><span>Activer localisation</span></a></li>
@%end-if:%@
</ul></div>
...
<td ><a href="?_search_sort=Articulos.codigo_barras">Code-barres<img src="imag/pixel.png" 
...
<td ><a href="?_search_sort=Localizacion_articulos.fecha_caducidad">Date limite<img src="imag/pixel.png" 
	class="@%func:class_searchsort;Localizacion_articulos.fecha_caducidad;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.lote">Lot<img src="imag/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.lote;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.cantidad">Quantite<img src="imag/pixel.png" 
	class="@%func:class_searchsort;Localizacion_articulos.cantidad;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.planta">Plante<img src="imag/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.planta;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.pasillo">Couloi<img src="imag/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.pasillo;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.columna">Colonne<img src="imag/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.columna;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.fila">Rang<img src="imag/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.fila;%@" /></a></td>
</tr></thead>
...
@%if:cambia_var_x;%@
<thead class="secundario" ><tr><td colspan="12">Zone de Magasin: @%db:Almacenes_logicos.nombre;%@</td></tr></thead>
@%end-if:%@
@%end-if:%@
...
<li><a href="#" onclick="return onHRefClick('bo_inventario_articulos','accion_ejecutar','Modificar');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
<li><a href="#" onclick="return SendFormToWindow('bo_inventario_articulos','nuevo_bajas_almacen','BajaLocalizacion',400);" class="causarbaja" ><img src="imag/pixel.png" class="icono" /><span>Baisses de magasin</span></a></li>
<li><a href="#" onclick="return onHRefClick('bo_inventario_articulos','accion_ejecutar','Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
