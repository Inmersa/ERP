...
@%if:AllowedLink;nuevo_proveedores;%@
 <li><a href="?seccion=nuevo_proveedores" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
@%end-if:%@
@%if:AllowedLink;bo_importar_proveedores;%@
<li><a href="?seccion=bo_importar_proveedores" class="importarusuario" ><img src="imag/pixel.png" class="icono" /><span>Importer fournisseur</span></a></li>
@%end-if:%@
<li><a href="#" onclick="return sendForm('bo_proveedores');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=Proveedores.persona_contacto" class="order" 
	>Contact<img src="imag/pixel.png" class="@%func:class_searchsort;Proveedores.persona_contacto;%@" /></a></td>
<td ><a href="?_search_sort=Proveedores.cif" class="order" >NSF<img src="imag/pixel.png" class="@%func:class_searchsort;Proveedores.cif;%@" /></a></td>
</tr></thead>
