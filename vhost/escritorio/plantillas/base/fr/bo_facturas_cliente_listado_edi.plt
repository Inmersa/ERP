 ...
 <td ><a href="?_search_sort=Facturas.referencia" class="order" >Référence<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.referencia;%@" /></a></td>
 ...
 <td ><a href="?_search_sort=Tarifas.nombre" class="order" >Tarif<img src="imag/pixel.png" class="@%func:class_searchsort;Tarifas.nombre;%@" /></a></td>
