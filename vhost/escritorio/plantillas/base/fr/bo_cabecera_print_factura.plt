...
<tr><td class="etiqueta" >Registre du commerce:</td><td >@%db:inscripcion_registro;%@</td></tr>
@%end-if:%@

<tr><td class="etiqueta" >Domicile:</td><td >@%db:direccion_facturacion;%@</td></tr>
<tr><td class="etiqueta" >Ville:</td><td >@%db:poblacion;%@</td></tr>
<tr><td class="etiqueta" >Province / État:</td><td >@%db:provincia;%@</td></tr>
...
@%end-if:%@
@%db:cif;%@</td></tr>
<tr><td class="etiqueta" >Téléphone:</td><td >@%db:telefono1;%@</td></tr>
<tr><td class="etiqueta" >Télécopieur:</td><td >@%db:fax;%@</td></tr>
</table>
...
<table class="full">
<tr><td class="diafano">@%db:nombre;%@ (@%db:persona_contacto%@ Tél.:@%db:telefono1;%@)</td></tr>
