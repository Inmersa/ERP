...
@%plt:botonera%@
 ...
 <td width="1"></td>
 <td height="22" bgcolor="#DBE0E3" align="center" class="etiqueta" width="100">Facturation</td>
 <td width="1"></td>
 <td height="22" bgcolor="#DBE0E3" align="center" class="etiqueta" width="100">Commisions</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="100" class="etiqueta" align="center">Reçois le paiement</td>
...
<tr> <td width="1" bgcolor="#DBE0E3" height="22"></td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Facturation</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Commisions </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Reçois le paiement</td>
