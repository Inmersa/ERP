...
<div class="tituloseccion">&gt; Fiche Client &nbsp;&nbsp; (ID: @%db:Clientes.id_cliente;%@) @%db:Clientes.razon_social;%@</div>
...
<li><a href="?seccion=bo_importar_clientes" class="importarusuario"><img src="imag/pixel.png" class="icono" /><span>Importer client</span></a></li>
@%end-if:%@
</ul></div>
...
><div name="Acceso_Sistema" >Accès</div
@%end-if:%@
...
><div name="EfectosPendientes" >Effets en suspens</div
@%end-if:%@
