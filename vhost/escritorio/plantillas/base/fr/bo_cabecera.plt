...
<div id="logoinmersa" class="internacional"><a href="?seccion=@%func:get_from_user;desktop_subsec%@"><img src="imag/pixel.png" class="null"/></a><span class="fecha" >@%func:colocar_fecha;now;%@</span></div>
</div>
...
<a href="?seccion=nuevo_pedido_compra&pedido=1">Acheter</a>
@%end-if:%@
@%if:AllowedLink;nuevo_pedidos_ventas;%@
<a href="?seccion=nuevo_pedidos_ventas&pedido=1">Vendre</a>
@%end-if:%@
@%if:AllowedLink;bo_facturas_compra;%@
<a href="?seccion=bo_facturas_compra">Factures d`acheter</a>
@%end-if:%@
@%if:AllowedLink;bo_facturas_venta;%@
<a href="?seccion=bo_facturas_venta">Factures de vente</a>
@%end-if:%@
...
@%else:%@
 ...
 @%else:%@
 <a href="?seccion=@%get:link_pedido_en_curso;%@">Commande</a>
 @%end-if:%@
@%end-if:%@
</div>
 ...
 <div id="usuario">Usager: @%func:get_from_user;user_name;%@</div>
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=modif_miempresa">Entreprises</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_proveedores">Fournisseurs</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_almacenes">Magasins</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_pedidos_compras">Achats</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_pedidos_ventas">Ventes</a></li>
	@%end-if:%@
@%end-if:%@
