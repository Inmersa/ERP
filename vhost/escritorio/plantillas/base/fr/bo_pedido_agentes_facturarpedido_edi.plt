...
<tr> <td height="22" bgcolor="#CCD2D7" class="etiqueta" colspan="4">Génerér</td>
 <td height="22" bgcolor="#CCD2D7" class="etiqueta" colspan="2" align="right"><a href="" onclick="document.forms['generar_albaran'].submit();return false;" class="accesos">Génerér</a></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="texto" width="91" align="center">Transporteurs:</td>
...
@%where:tabla|Forma_pago;nolink|1;%@ <option value="@%db:Forma_pago.id_forma_pago;%@">@%db:Forma_pago.nombre;%@</option> 
 ...
 <tr> <td bgcolor="#EBECED" class="texto" width="120" align="right">Compteurs:</td>
 <td class="insertext" colspan="3">
