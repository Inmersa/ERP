...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#DBE0E3" width="120" class="etiqueta">Référence</td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Usager</td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Début de période</td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Date approximative terminer</td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="50" align="center">État</td>
 </tr>
 <tr>
 </tr>
