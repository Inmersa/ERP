 ...
 <tr bgcolor="#CCD2D7" align="right"> <td colspan="15" height="22"><a href="" onclick="window.open('?seccion=bo_albaran_envio_print&id_albaran=@%db:Albaranes.id_albaran%@'); return false;" class="accesos">Imprimer</a></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="75">Date limite</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Lot</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" >Quantite Demande</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1">Quantite déplacer</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="titul1" align="center" >Quantite ReÇu </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center" width="60" >Prix</td>
