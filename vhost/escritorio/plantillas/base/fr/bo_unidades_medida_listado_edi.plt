...
<li><a href="#" onClick="return sendForm('modif_unidades_medida');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
...
<td class="caption">Utilisateur</td>
</tr>
