...
<div class="tituloseccion" >États Service</div>
...
<li><a href="?seccion=nuevo_estado_servicio" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
@%end-if:%@
