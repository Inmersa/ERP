...
<div class="tituloseccion" >Type d'Unité de mesure</div>
...
<li><a href="#" onClick="return sendForm('listado','accion_ejecutar','ModificarLista');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
@%end-if:%@
