 ...
 <tr> <td height="22" align="left" bgcolor="#CCD2D7" class="etiqueta"> Sélections Actuel</td>
 </tr>
 <tr> <td height="3"> </td>
 </tr>
 <tr> <td> 
 ...
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3">Bosses</td>
 <td width="1"></td>
...
@%where:nodb|nodb_confirmar_pedido;%@
 ...
 <tr align="center"> <td height="22" colspan="10" bgcolor="#CCD2D7"><a href="" onclick="document.forms['cesta'].submit();return false;" class="accesos">Terminer</a> <input type="hidden" name="Finalizar" value="Finalizar"></td>
 </tr>
</form>
 </table>
 </td>
