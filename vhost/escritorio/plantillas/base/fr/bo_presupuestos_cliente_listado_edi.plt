...
><img src="imag/pixel.png" class="icono" /><span>Réviser des Sélections</span></a></li>
@%end-if:%@
...
><img src="imag/pixel.png" class="icono" /><span>Transformer en Proforma</span></a></li>
@%end-if:%@
@%end-if:%@
...
><img src="imag/pixel.png" class="icono" /><span>Approuver choisis</span></a></li>

<li><a href="#Rechazar Seleccionados" onclick="return onHRefClick('listado','accion_ejecutar','Rechazar');" class="rechazar"
><img src="imag/pixel.png" class="icono" /><span>Rejeter choisis</span></a></li>
@%end-if:%@
...
<td ><a href="?_search_sort=Presupuestos.impuestos" >Impôt<img src="imag/pixel.png" class="@%func:class_searchsort;Presupuestos.impuestos;%@" /></a></td>
