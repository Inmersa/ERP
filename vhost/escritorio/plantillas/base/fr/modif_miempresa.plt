...
<div class="tituloseccion">&gt; Fiche d´entreprises</div>
...
<li><a href="#" onClick="return sendForm('modif_empresas');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
</ul></div>
@%end-if:%@
