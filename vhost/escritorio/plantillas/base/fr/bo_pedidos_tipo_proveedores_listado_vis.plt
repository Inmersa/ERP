...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" width="100" class="etiqueta" align="center">Référence </td>
 <td width="1"></td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="80" align="center">Réf. Ext</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="right" width="70">Montant</td>
 <td width="1"></td>
 </tr>
