...
<div class="tituloseccion">&gt; Sélection Fournisseurs</div>
...
<td class="caption"><a href="?_search_sort=Proveedores.cif" class="order" 
	>NSF<img src="imag/pixel.png" class="@%func:class_searchsort;Proveedores.cif;%@" /></a></td>
</tr></thead>
...
<li><a href="#" onclick="return sendForm('compra_articulos');" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Sélectionner</span></a></li>
</ul></div>
