...
@%if:!esta_vacio;id_albaran;%@
	...
	@%if:esta_vacio;es_venta;%@
		<tr><td class="etiqueta" >Ne pas modifier le stock</td>
		...
		<td class="etiquetacheck" >Rétablir stoc</td></tr>
	@%else:%@
...
<tr><td class="etiqueta"> Initial quantite : </td><td colspan="3" >@%db:cantidad;%@</td></tr>
...
@%if:!esta_vacio;id_albaran;%@
	<table class="full" >
	<caption class="titulotb" >Factures d'Engrais</caption>
	<tr><td class="etiqueta" >Nouvelle</td>
...
<li><a href="#" onClick="return sendForm('nuevo_bajas_almacen');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li>
</ul></div>
</div>
