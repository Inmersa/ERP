...
@%if:!emitida;%@
	@%where:nodb|nodb_reciever_data;nombre|receptor;%@
		...
		<li><a href="#" onClick="return sendForm('factura','accion_ejecutar','CargarCuenta');"  class="cargarpendiente" 
			><img src="imag/pixel.png" class="icono" /><span>Charger depuis le Compte</span></a></li>
		</ul></div>
	@%end-where:%@
...
<td class="etiqueta" >Montant</td><td colspan="3" >@%db:monto_cuenta;%@</td>
@%end-where:%@
...
<td class="etiqueta @%css:agente;label;%@">Réalisé par:</td>
...
<td class="etiqueta" >Forme d'Engrais</td>
...
<td class="etiquetacheck" >Soustraire des Effets et Ajouter à Compte</td>
...
<td class="etiquetacheck" >Soustraire des Effets et Ajouter un Remboursement</td>
...
<td class="etiquetacheck" >Engrais en Remboursement</td>
...
<td class="etiquetacheck" >Engrais en Compte</td>
...
@%where:tabla|Pedidos_facturas;where|Pedidos_facturas.id_factura = $idfra;group|Pedidos.id_pedido;%@
   @%if:primera_vez;%@
	<table class="full" >
	<caption class="titulotb" >Commandes:<caption><tbody>
   @%else:%@
	</tr><tr>
   @%end-if:%@ 
...
@%if:esta_vacio;factura_abono;%@
	@%where:nombre|Fras;where|Facturas_abonos.id_factura = $idfra;nolink|1;contador|cnt;%@
		...
		@%if:equals;cnt;1;%@
		<table class="full" >
		<caption class="titulotb" >Factures d'Engrais En rapport</caption><tbody>
		@%end-if:%@
...
@%if:!esta_vacio;factura_abono;%@
	<table class="full" >
	<caption class="titulotb" >Factures qu'il crédite</caption><tbody>
...
@%if:equals;cnt;1;%@
<table class="full" ><caption class="titulotb" >Effets</caption>
<thead ><tr><td>Date de expiration</td><td>Totals</td><td>Total payé</td></tr>
<tbody>
...
@%if:equals;cnt;1;%@
<table class="full" >
<caption class="titulotb" >Effets qu'il crédite</caption><tbody>
@%set:cabecera_puesta=1;%@
@%end-if:%@
