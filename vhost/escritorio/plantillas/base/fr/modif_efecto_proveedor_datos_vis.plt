...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Réf.Factures: </td>
 <td class="texto">@%db:Facturas.referencia%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Paiement encaissement: </td>
 <td class="texto">@%db:Efectos.pago_cobro%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Compte bancaire IBAN: </td>
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Modalité de paiment: </td>
...
@%end-where:%@ 
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Moyen de payant: </td>
 <td class="texto">@%db:Efectos.medio_pago%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Date de expiration: </td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="etiqueta" height="22">Total payé: </td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="etiqueta" height="22">État:</td>
