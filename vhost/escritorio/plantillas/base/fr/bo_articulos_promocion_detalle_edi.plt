...
<td class="caption">Code-barres</td>
...
<li><a href="#" onclick="return !sendForm('bo_articulos_promocion');" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
</ul></div>
