...
<li><a href="#" onClick="return sendForm('modif_provincias');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>

<table class="full">
<thead><tr>
<td class="estado" ><img src="imag/pixel.png" class="marcartodos" onclick="return formCheckAll('registro_borrar');"  /></td>
<td ><a href="?_search_sort=Provincias.nombre" class="order" >Nom<img src="imag/pixel.png" class="@%func:class_searchsort;Provincias.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Paises.nombre" class="order" >Pays<img src="imag/pixel.png" class="@%func:class_searchsort;Paises.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Provincias.codigo" class="order" >Code<img src="imag/pixel.png" class="@%func:class_searchsort;Provincias.codigo;%@" /></a></td>
<td ><a href="?_search_sort=Provincias.prefijo_tlf" class="order" 
	>Prefixe Tf.<img src="imag/pixel.png" class="@%func:class_searchsort;Provincias.prefijo_tlf;%@" /></a></td>
</tr></thead>
