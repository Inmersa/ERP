...
><div name="TopProveedores" >Top Fournisseurs</div
@%end-if:%@
...
><div name="ArticulosPorVenta" ><a href="?seccion=dashboard_articulos_venta" class="cambio_ss" >Valeurs par Vente</a></div
@%end-if:%@
@%if:!equals;_krn_ss_name;dashboard_articulos_servidoventa;%@
><div name="ArticulosServidoVenta" ><a href="?seccion=dashboard_articulos_servidoventa" class="cambio_ss" >Servi dans des Ventes</a></div
@%end-if:%@
@%if:!equals;_krn_ss_name;dashboard_articulos_topventa;%@
><div name="ArticulosTopVenta" ><a href="?seccion=dashboard_articulos_topventa" class="cambio_ss" >Top Vente</a></div
@%end-if:%@
@%if:!equals;_krn_ss_name;dashboard_articulos_compra;%@
><div name="ArticulosPorCompra" ><a href="?seccion=dashboard_articulos_compra" class="cambio_ss" >Valeurs par Achat</a></div
@%end-if:%@
></div>
