...
checked="checked"
@%end-if:%@
 /></td><td class="etiqueta" style="text-align:left;">Prix pour un période de</td>
...
<td >Nom</td>
<td >Chèque de création</td>
<td >Duré</td>
<td >Délai de facture</td>
<td >Facturant le service à l'avance</td>
</tr>
</thead>
<tbody>
