 ...
 <tr> <td width="111" align="right" bgcolor="#EBECED" height="22" class="etiqueta">Mot de passe:</td>
 <td width="533"> <input type=password name="registro[passwd]" class="insertext" size="20">
 </td>
 </tr>
 <tr bgcolor="#CCD2D7"> <td colspan="2" height="1" align="right"></td>
 </tr>
 <tr> <td width="111" align="right" bgcolor="#EBECED" height="22" class="etiqueta">Accepter:</td>
