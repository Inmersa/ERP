...
<tr> <td colspan="7" bgcolor="#CCD2D7" height="1"></td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="71" height="22">Réf. Externe:</td>
...
@%if:pedido_incompleto%@
 <a href="?seccion=bo_pedido_cliente&id_pedido=@%db:id_pedido_incompleto;%@" class="accesos" align="center"> Voir </a>
@%else:%@
@%end-if:%@
 </td>
 </tr>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="71" height="22">Référence:</td>
 <td colspan="2" class="texto"> @%db:referencia;%@
 </td>
 <td bgcolor="#EBECED" class="texto" align="right" width="274">Réalisé par:</td>
 ...
 <td bgcolor="#EBECED" align="right" class="texto" width="69">Modes de paiement:</td>
 <td colspan="2">
...
<option value="@%db:Forma_pago.id_forma_pago;%@" @%db:selected_value{Forma_pago.id_forma_pago}%@
 ...
 <td bgcolor="#EBECED" class="texto" align="right" width="61">Devise:</td>
