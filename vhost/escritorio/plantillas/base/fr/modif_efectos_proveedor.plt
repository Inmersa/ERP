...
class="tituloseccion"
@%end-if:%@
>&gt; Modifier Effets (ID: @%db:Proveedores.id_proveedor;%@) @%db:Proveedores.razon_social;%@</div>
...
<li><a href="#" onClick="return sendForm('efecto')"  class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li> 
<li><a href="#" onClick="return resetForm('efecto');"  class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Défaire changement</span></a></li>
</ul></div>
@%end-if:%@
