...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta">TVA</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="60">Reteneu équivalent</td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Montant brut</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center">%</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="70">Montant</td>
 ...
 <tr>
 <td align="right" class="texto" width="100" bgcolor="#EBECED">Montant brut:</td>
 ...
 <tr>
 <td align="right" class="texto" width="100" bgcolor="#EBECED">Total Remise:</td>
 ...
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">Total revenu imposable:</td>
 <td height="23" class="texto">
 @%db:base_imponible;%@ </td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">Totals Impôt:</td>
 <td height="23" class="texto">
 @%db:total_impuestos%@ </td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">Rétention:</td>
 <td height="23" class="texto">
 @%db:retenido%@ </td>
 </tr>
...
@%if:emitida;%@
 <a href="?seccion=bo_facturas_pedido_venta&id_pedido=@%db:id_pedido;%@" class="accesos">Voir</a>
@%else:%@
 <a href="" onclick="document.forms['pedido'].submit();return false;" class="accesos">Garder</a>
@%end-if:%@
 
@%if:hay_albaran%@
 <a href="?seccion=bo_albaranes_pedido&id_pedido=@%db:id_pedido;%@" class="accesos">Voir livraisons</a>
@%else:%@
@%end-if:%@
</td> 
</tr> 
