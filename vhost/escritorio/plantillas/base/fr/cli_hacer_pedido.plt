<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="323" >&gt; Articles Sélections</td>
...
@%plt:botonera%@
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="0">Prix </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="0">TVA / Reteneu</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Bosses</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Quantite</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" colspan="3" bgcolor="#DBE0E3">Offre / Promotion</td>
 ...
 <a href="" onclick="document.forms['hacer_pedido'].submit();return false;"class="accesos">Ajouter</a></td>
 </tr>
 </form>
 </table>
