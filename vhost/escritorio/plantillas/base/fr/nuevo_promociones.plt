...
<div class="tituloseccion">&gt; Nouvelle Promotion (
...
<table class="full">
<tr>
<td class="caption">Nome Promotion</td>
<td class="caption">Debut de periode</td>
<td class="caption">Derniére date</td>
...
<li><a href="#" onClick="return sendForm('nuevo_promociones');" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
</ul></div>
