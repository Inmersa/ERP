...
<li><a href="#" onClick="return onHRefClick('bo_recorridos','accion_ejecutar', 'Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
...
<tr>
<td></td>
<td ><a href="?_search_sort=Rutas.nombre" >Route<img src="imag/pixel.png" class="@%func:class_searchsort;Rutas.nombre;%@" /></a></td>
<td ><a href="?_search_sort=efectividad" >% Effet<img src="imag/pixel.png" class="@%func:class_searchsort;efectividad;%@" /></a></td>
<td ><a href="?_search_sort=Recorridos.fecha" >Date<img src="imag/pixel.png" class="@%func:class_searchsort;Recorridos.fecha;%@" /></a> </td>
<td ><a href="?_search_sort=numero_clientes" >Nº Clients<img src="imag/pixel.png" class="@%func:class_searchsort;numero_clientes;%@" /></a></td>
<td ><a href="?_search_sort=Agentes.nombre" >Agent<img src="imag/pixel.png" class="@%func:class_searchsort;Agentes.nombre;%@" /></a> </td>
<td ><a href="?_search_sort=numero_pedidos" >Nº Commandes<img src="imag/pixel.png" class="@%func:class_searchsort;numero_pedidos;%@" /></a> </td>
...
<li><a href="#" onClick="return sendForm('bo_recorridos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
</ul></div>
