...
<div class="tituloseccion">Liste incidence</div>
...
<input type="hidden" name="accion_ejecutar" value="Aprobar" />
	...
	@%else:%@
	<li><a href="?seccion=nueva_incidencia_crm" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouvelle incidence</span></a></li>
	@%end-if:%@
	...
	<li><a href="#" onClick="return sendForm('incidencias','accion_ejecutar','Aprobar');" class="aprobar" 
		><img src="imag/pixel.png" class="icono" /><span>Approuvé</span></a></li>
	@%end-if:%@
	</ul></div>
</form>
@%else:%@
...
<li><a href="#" onClick="return sendForm('incidencias','accion_ejecutar','seleccionar_incidencias');" class="enviar" 
	><img src="imag/pixel.png" class="icono" /><span>Associer</span></a></li>
</ul></div>
@%set:permitir_selecciones=1;%@
@%end-if:%@
...
<td></td>
@%end-if:%@
<td ><a href="?_search_sort=Incidencias.id_incidencia" >Référence<img src="imag/pixel.png" class="@%func:class_searchsort;Incidencias.id_incidencia;%@" /></a></td>
<td ><a href="?_search_sort=Usuarios.nombre" >Usager impliqué<img src="imag/pixel.png" class="@%func:class_searchsort;Usuarios.nombre;%@" /></a></td>
@%if:AllowedAction;Incidencias_id_usuario_gestor;new;%@
<td ><a href="?_search_sort=Empleados.nombre" >Usager<img src="imag/pixel.png" class="@%func:class_searchsort;Empleados.nombre;%@" /></a></td>
@%end-if:%@
<td ><a href="?_search_sort=Incidencias.fecha" >Début de période<img src="imag/pixel.png" class="@%func:class_searchsort;Incidencias.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Incidencias.fecha_estimada" >Date estimée<img src="imag/pixel.png" class="@%func:class_searchsort;Incidencias.fecha_estimada;%@" /></a></td>
</tr>
</thead>
<tbody>
