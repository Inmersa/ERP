...
<input type=hidden name=registro[id_almacen_logico] value="@%db:Almacenes_logicos.id_almacen_logico;%@">
 ...
 <tr> <td width="80" bgcolor="#EBECED" align="right" class="etiqueta" height="22">Nom:</td>
...
<input type="hidden" name="registro[nombre]" value="@%db:Almacenes_logicos.nombre;%@" class="insertext" size="80">
 ...
 <tr align="center"> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Plantes:</td>
 ...
 <td align="right" bgcolor="#EBECED" width="80">Couloirs:</td>
 <td>
 ...
 <td align="right" bgcolor="#EBECED" width="80">Rangs:</td>
 <td>
 ...
 <td bgcolor="#EBECED" align="right" width="80">Colonnes:</td>
 <td>
 ...
 <td height="21" bgcolor="#CCD2D7" width="128" class="etiqueta">Magasins</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" colspan="2">Nom:</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" colspan="2">Direction:</td>
 <td height="22" width="4" bgcolor="#EBECED" align="right" class="etiqueta"></td>
...
@%db:Almacenes.cp;%@ (@%db:Almacenes.poblacion;%@)</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" colspan="2">Personne de contact:</td>
 <td height="22" width="4" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 <td height="22" width="234" class="texto">@%db:Almacenes.persona_contacto;%@ 
(@%db:Almacenes.cargo_persona_contacto;%@)</td>
 <td height="22" width="86" bgcolor="#EBECED" align="right" class="etiqueta">Téléphone:</td>
 ...
 <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="86">Télécopieur:</td>
 <td height="22" width="6" bgcolor="#EBECED"></td>
