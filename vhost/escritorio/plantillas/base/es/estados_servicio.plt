...
<div class="tituloseccion" >Estados Servicio</div>
...
<li><a href="?seccion=nuevo_estado_servicio" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nuevo</span></a></li>
@%end-if:%@
