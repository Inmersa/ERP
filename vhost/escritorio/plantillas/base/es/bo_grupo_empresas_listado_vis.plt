...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="619">Nombre</td>
...
@%where:tabla|Grupo_empresas;nombre|busc;%@ <tr> <td bgcolor="#DBE0E3" height="1" width="24"></td>
 ...
 <td height="22" width="619">@%if:AllowedLink;modif_grupo_empresas;%@<a href="?seccion=modif_grupo_empresas&id_grupo_empresa=@%db:Grupo_empresas.id_grupo_empresa;%@" class="accesos">@%db:Grupo_empresas.nombre;%@
</a></td>
@%end-if:%@
