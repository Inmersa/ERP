...
<div class="tituloseccion">&gt; FICHA DE EMPRESA</div>
...
<li><a href="#" onClick="return sendForm('modif_empresas');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modificar</span></a></li>
</ul></div>
@%end-if:%@
