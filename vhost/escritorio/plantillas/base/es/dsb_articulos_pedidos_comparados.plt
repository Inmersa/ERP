...
<table class="full" >
@%set:dsb_resultados=pedidos_comparados;%@
@%set:dsb_rs_limit=7;%@
@%set:dsb_an_limit=3;%@
...
<!-- @%set:_iterate_reset=1;%@ @%set:_dsb_resultados_anual_valor=pedidos;%@ -->
@%where:nodb|nodb_iterate;%@
...
@%func:dsb_grfx_comparadas;pedidos_comparados;pedidos;%@
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Ventas Comparadas;%@
