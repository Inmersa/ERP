...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="323" >&gt; FICHA DE CLIENTE</td>
...
<tr> <td colspan="4" height="22" bgcolor="#CCD2D7"> <table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <!--@%Clientes.id_cliente;%@-->
 <td class="etiqueta" height="20" > Clientes Empresa</td>
 </tr>
 </table>
 </td>
 </tr>
 <tr align="center"> <td colspan="4" height="22" > <table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Nombre:</td>
 <td width="228"> <input type="text" name="registro[nombre]" value="@%db:Clientes.nombre;%@" class="insertext" size="30">
 </td>
 <td bgcolor="#EBECED" width="87" align="right" class="etiqueta">Apellidos:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Razón social:</td>
 ...
 <tr> <td width="161" class="etiqueta" align="right" height="22" bgcolor="#EBECED">Dirección de facturación:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Población:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Provincia:</td>
 ...
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Persona de contacto:</td>
 <td width="228"> <input type="text" name="registro[persona_contacto]" value="@%db:Clientes.persona_contacto;%@" class="insertext" size="30">
 </td>
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Teléfono 1:</td>
 <td width="168"> <input type="text" name="registro[telefono1]" value="@%db:Clientes.telefono1;%@" class="insertextnumeros" size="14">
 </td>
 </tr>
 <tr> <td colspan="4" height="1" bgcolor="#CCD2D7" ></td>
 </tr>
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Cargo de persona de contacto:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Teléfono 2:</td>
 ...
 <tr> <td width="161" align="right" bgcolor="#EBECED" height="22" class="etiqueta">Repetir contraseña:</td>
 <td width="483">
 ...
 <td class="etiqueta" height="20" width="466" align="right" ><a href="?seccion=cli_nuevo_direcciones_entrega&amp;id_cliente=@%db:Clientes.id_cliente%@" class="accesos">Añadir dirección</a> <a href="" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Borrar');" class="accesos">Borrar direcciones</a>
 </td>
 </tr>
 </table>
 </td>
