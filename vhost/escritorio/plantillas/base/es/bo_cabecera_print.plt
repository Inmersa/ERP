...
<tr> <td class="titul" height="15" bgcolor="#EBECED"></td>
 <td class="titul" height="18"bgcolor="#EBECED">Población:</td>
...
<tr> <td height="15" class="titul" bgcolor="#EBECED"></td>
 <td height="18" class="titul" bgcolor="#EBECED">Telefono:</td>
...
<tr> <td class="titul" height="15" bgcolor="#EBECED"></td>
 <td class="titul" height="15" bgcolor="#EBECED">Población:</td>
 <td class="texto" colspan="4" height="15"> @%db:poblacion;%@</td>
</tr>
<tr> <td height="15" class="titul" bgcolor="#EBECED"></td>
...
<tr> <td height="15" class="titul" bgcolor="#EBECED"></td>
 <td height="15" class="titul" bgcolor="#EBECED">Teléfono:</td>
 <td class="texto" height="15">@%db:telefono1;%@</td>
 <td align="right" class="titul" height="15" bgcolor="#EBECED">Fax:</td>
 <td class="texto" height="15">@%db:fax;%@</td>
 <td class="texto" height="15"></td>
...
<tr>
 ...
 <td height="20" class="titocho" bgcolor="#CCD2D7">Dirección de facturación </td>
</tr>
<tr>
