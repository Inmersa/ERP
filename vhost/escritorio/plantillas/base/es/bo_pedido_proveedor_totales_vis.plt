<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="70">Importe</td>
...
@%else:%@
 <a href="" onclick="document.forms['pedido'].submit();return false;" class="accesos">Guardar Cambios</a>
@%end-if:%@
