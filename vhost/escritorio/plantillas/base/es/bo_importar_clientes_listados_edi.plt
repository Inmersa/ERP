...
<input type="hidden" name="accion_ejecutar" value="Importar">
 ...
 <td >C�digo</td>
 <td ></td>
 <td >Cliente | Raz�n social| Cliente | Raz�n social</td>
 <td >Contacto</td>
 <td >CIF</td>
 </tr>
 </thead>
 ...
 <ul>
 <li><a href="#" onclick="return sendForm('importar_clientes');" class="enviar"><img src="images/pixel.png" class="icono" /><span>Importar</span></a></li>
 </ul>
 </div>
