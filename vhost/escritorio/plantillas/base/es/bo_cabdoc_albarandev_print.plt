...
<table class="full">
@%if:esta_vacio;id_proveedor_cabecera;%@
	<caption>Dirección Almacén de Recogida (@%db:Direcciones_entrega.nombre;%@)</caption>
@%end-if:%@

	<tr><td class="etiqueta">Nombre:</td><td >@%db:Clientes.razon_social;%@ (@%db:Clientes.id_cliente;%@)</td></tr>
	<tr><td class="etiqueta" >CIF:</td>
	...
	<tr><td class="etiqueta" >Domicilio:</td><td >@%db:Direcciones_entrega.direccion;%@</td></tr>
	<tr><td class="etiqueta" >Población:</td><td >@%db:Direcciones_entrega.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Provincia:</td>
	...
	<tr> 
	 <td class="etiqueta" >Telefono:</td><td >@%db:Direcciones_entrega.telefono1;%@</td>
...
<table class="full">
 <caption>Dirección de entrega</caption>
 <tr><td class="diafano">@%db:Almacenes.nombre;%@(Tlf - @%db:Almacenes.telefono;%@)</td></tr>
...
<table class="full">
	<caption>Dirección Almacén de Recogida (@%db:Almacenes.nombre;%@)</caption>
	<tr><td class="etiqueta" >Domicilio:</td><td >@%db:Almacenes.direccion;%@</td></tr>
	<tr><td class="etiqueta" >Población:</td><td >@%db:Almacenes.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Provincia:</td>
	<!-- @%db:Almacenes.id_provincia%@ @%set:id_prov=Almacenes.id_provincia;%@ -->
	...
	<tr> 
	 <td class="etiqueta" >Telefono:</td><td >@%db:Almacenes.telefono;%@</td>
...
<table class="full">
 <caption>Dirección de entrega(@%db:Proveedores.prefijo_cif;%@@%db:Proveedores.cif;%@)</caption>
 <tr><td class="diafano">@%db:Proveedores.razon_social;%@(Tlf - @%db:Proveedores.telefono1;%@)</td></tr>
