 ...
 <table width="647" border="0" cellspacing="0" cellpadding="0">Razón social
...
<tr bgcolor="#EBECED"> </table>
 ...
 <tr> <td bgcolor="#EBECED" align="right" width="150" height="22" class="etiqueta">Nombre Ruta:</td>
 <td width="215" class="texto"> <input type="text" name="registro[nombre]" class="insertext" size="25" value="@%db:Rutas.nombre%@">
 </td>
 <td bgcolor="#EBECED" align="right" width="125" class="etiqueta">Grupo de Ruta:</td>
...
>@%db:Agentes.nombre%@</option>
 ...
 <tr> <td bgcolor="#EBECED" align="right" height="22" class="etiqueta" width="150">Descripcción:</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" class="etiqueta" align="right" width="150">Duración Visita (Minutos): </td>
 <td height="1" width="215"> <input type="text" name="registro[m_visita]" value="@%db:Rutas.m_visita%@" class="texto">
 </td>
 <td height="1" bgcolor="#EBECED" align="right" class="etiqueta" width="125">Duración Traslado (Minutos):</td>
 <td height="1" width="154"> <input type="text" name="registro[m_traslado]" value="@%db:Rutas.m_traslado%@" class="insertext">
 </td>
 </tr>
 <tr> <td height="1" colspan="4" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td height="22" bgcolor="#EBECED" class="etiqueta" align="right" width="150">Frecuencia (Días) :</td>
 <td height="1" width="215"> <input type="text" name="registro[d_frecuencia]" value="@%db:Rutas.d_frecuencia;%@" class="texto">
 </td>
 <td height="1" bgcolor="#EBECED" class="etiqueta" align="right" width="125">Duración ruta (Horas):</td>
 ...
 <a href="javascript:document.forms['modif_rutas'].submit();" class="accesos">Añadir</a></td>
 </tr>
 </table>
 </form>
 </td>
 ...
 <tr> <td bgcolor="#91CC00" height="20" class="titocho">>Listado de clientes en la ruta</td>
 </tr>
</table>
...
<tr> <td bgcolor="#DBE0E3" width="1" class="etiqueta" align="center"></td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="170">Dirección</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Medio de Contacto</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Orden</td>
