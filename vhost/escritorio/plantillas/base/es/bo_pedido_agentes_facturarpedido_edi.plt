...
<tr> <td height="22" bgcolor="#CCD2D7" class="etiqueta" colspan="4">Datos para Generar</td>
 <td height="22" bgcolor="#CCD2D7" class="etiqueta" colspan="2" align="right"><a href="" onclick="document.forms['generar_albaran'].submit();return false;" class="accesos">Generar albaranes</a></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="texto" width="91" align="center">Transportista:</td>
...
@%end-where:%@
 ...
 <td bgcolor="#EBECED" class="texto" width="97" align="right">Confirmación:</td>
