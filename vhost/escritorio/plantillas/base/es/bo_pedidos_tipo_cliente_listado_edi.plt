...
<li><a href="#" onclick="return sendForm('pedidos_tipo_cliente');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Borrar seleccionados</span></a></li>
@%set:permitir_selecciones = 1;%@
@%end-if:%@
</ul></div>
...
<thead>
 ...
 <td ></td>
 @%end-if:%@
 <td ><a href="?_search_sort=Pedidos_tipo_cliente.nombre" >Nombre<img src="images/pixel.png" class="@%func:class_searchsort;Pedidos_tipo_cliente.nombre;%@" /></a></td>
 ...
 <td ><a href="?_search_sort=Direcciones_entrega.nombre" 
 	>Direcci�n de entrega<img src="images/pixel.png" class="@%func:class_searchsort;Direcciones_entrega.nombre;%@" /></a> </td>
