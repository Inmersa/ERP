...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td align="right" colspam="4"><a href="#" onclick=window.open('?@%func:querystring%@&imprimir=1'); return false; class="accesos">Imprimir</a></td>
 <td width="46" align="center" ><a href="javascript:history.go(-1);" class="accesos">Volver</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<tr> <td bgcolor="#EBECED" align="right" class="texto" width="80" height="22">Ref externa:</td>
...
<tr> <td bgcolor="#EBECED" align="right" class="texto" width="80" height="22">Referencia:</td>
 ...
 <td bgcolor="#EBECED" class="texto" align="right">Divisa</td>
 <td colspan="3"> @%db:Divisa.nombre;%@
<!--@%wdb:Pedidos.id_agente%@--> </td>
 </tr>
 <tr> <td colspan="7" height="1" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22" colspan="2">Fecha:</td>
 ...
 <td bgcolor="#EBECED" align="right" class="texto">Forma de pago:</td>
 <td colspan="2">
...
<a href="" onclick="document.forms['anyadir_al_pedido'].submit();return false;" class="accesos">Añadir artículo </a>
...
<td bgcolor="#DBE0E3"></td>
 ...
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta">IVA/IGIC</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="60">R. equiv.</td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="110">Descuento</td>
 <td width="1"></td>
