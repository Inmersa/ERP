...
<table class="full">
<thead ><tr>
<td ><a href="?_search_sort=Articulos.nombre" class="order" >Nombre<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
...
<td ><a href="?_search_sort=Empresas_articulos.unidades_bulto" class="order" 
	>Uds/Caja<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.unidades_bulto;%@" /></a></td>
<td >Ofer./Promos</td>
</tr></thead>
<tbody>
...
<li><a href="#" onClick="return sendForm('hacer_pedido');" class="sumaracesta"><img src="images/pixel.png" class="icono" /><span>A�adir</span></a></li>
</ul></div>
