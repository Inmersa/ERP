...
<input type="hidden" name="registro[nombre]" value="@%db:Provincias.nombre;%@" class="insertext" size="55">
 ...
 <tr> <td bgcolor="#EBECED" width="219" class="etiqueta" align="right" height="22">Países:</td>
...
@%end-where:%@
 ...
 <tr> <td bgcolor="#EBECED" width="219" class="etiqueta" align="right" height="22">Código:</td>
...
<input type="hidden" name="registro[codigo]" size="5" class="insertext" value="@%db:Provincias.codigo;%@">
 ...
 <tr> <td bgcolor="#EBECED" width="219" class="etiqueta" align="right" height="22">Prefijo telefónico:</td>
