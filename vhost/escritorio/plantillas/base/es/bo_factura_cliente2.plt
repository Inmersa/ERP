...
@%end-if:%@
<div id="contadorpaginas">Pag @%get:pagina_actual;%@ de @%get:paginas_totales;%@</div></div>
...
<tr class="bordes">
 ...
 <td class="@%css:PVP_rec;label;%@" >PVP Rec.</td>
 <td >Producto</td>
@%if:!esta_vacio;_aAppConf[print_observaciones_enlinea];%@
 <td > </td>
@%end-if:%@
 <td class="@%css:nombre_marca;label;%@" >Marca</td>
 <td class="@%css:certificado;label;%@" >Cert.</td>
 <td >Cant.</td>
 <td >Precio</td>
 <td class="@%css:descuento;label;%@" >Dto</td>
 <td >IVA %</td>
 <td >Importe</td>
<tr>
</thead>
...
@%end-if:%@
 ...
 <td >Cant.</td>
 <td >Precio</td>
 <td class="@%db:css:descuento;label;%@" >Dto</td>
 <td >IVA % </td>
 <td >Importe</td>
</tr>
</thead>
