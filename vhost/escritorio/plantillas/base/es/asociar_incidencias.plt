...
<div class="tituloseccion">Listado de Incidencias</div>
...
<input type="hidden" name="accion_ejecutar" value="Aprobar" />
	...
	@%else:%@
	<li><a href="?seccion=nueva_incidencia_crm" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nueva Incidencia</span></a></li>
	@%end-if:%@
	...
	<li><a href="#" onClick="return sendForm('incidencias','accion_ejecutar','Aprobar');" class="aprobar" 
		><img src="images/pixel.png" class="icono" /><span>Aprobar</span></a></li>
	@%end-if:%@
	</ul></div>
</form>
@%else:%@
...
<li><a href="#" onClick="return sendForm('incidencias','accion_ejecutar','seleccionar_incidencias');" class="enviar" 
	><img src="images/pixel.png" class="icono" /><span>Asociar</span></a></li>
</ul></div>
@%set:permitir_selecciones=1;%@
@%end-if:%@
...
<td></td>
@%end-if:%@
<td ><a href="?_search_sort=Incidencias.id_incidencia" >Referencia<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.id_incidencia;%@" /></a></td>
<td ><a href="?_search_sort=Usuarios.nombre" >Usuario Implicado<img src="images/pixel.png" class="@%func:class_searchsort;Usuarios.nombre;%@" /></a></td>
@%if:AllowedAction;Incidencias_id_usuario_gestor;new;%@
<td ><a href="?_search_sort=Empleados.nombre" >Usuario Gestor<img src="images/pixel.png" class="@%func:class_searchsort;Empleados.nombre;%@" /></a></td>
@%end-if:%@
<td ><a href="?_search_sort=Incidencias.fecha" >Fecha de alta<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Incidencias.fecha_estimada" >Fecha Estimada<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.fecha_estimada;%@" /></a></td>
</tr>
</thead>
<tbody>
