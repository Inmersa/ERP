...
<li><a href="?seccion=nuevo_descuento_articulos" class="seleccionar" ><img src="images/pixel.png" class="icono" /><span>A�adir art�culo</span></a></li>
@%end-if:%@
...
<td class="caption">Pr. Tarifa</td>
<td class="caption">Descuento</td>
<td class="caption">Cant. descuento</td>
</tr>
@%end-if:%@
