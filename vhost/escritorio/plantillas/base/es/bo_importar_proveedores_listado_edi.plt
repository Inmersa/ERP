...
<li><a href="#" onclick="return onHRefClick('bo_proveedores_importar','accion_ejecutar','Importar');" class="enviar" 
	><img src="images/pixel.png" class="icono" /><span>Importar</span></a></li>
<li><a href="#" onclick="return onHRefClick('bo_proveedores_importar','accion_ejecutar','Borrar');" class="borrar" 
	><img src="images/pixel.png" class="icono" /><span>Borrar</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=Proveedores.id_proveedor" class="order" 
	>C�digo<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.id_proveedor;%@" /></a></td>
<td class="estado" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('proveedor_importar');"  /></td>
<td ><a href="?_search_sort=Proveedores.razon_social" class="order" 
	>Raz�n Social<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.razon_social;%@" /></a></td>
<td ><a href="?_search_sort=Proveedores.persona_contacto" class="order" 
	>Contacto<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.persona_contacto;%@" /></a></td>
<td ><a href="?_search_sort=Proveedores.cif" class="order" >CIF<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.cif;%@" /></a></td>
</tr></thead>
<tbody>
