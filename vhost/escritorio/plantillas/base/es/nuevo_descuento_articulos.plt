...
<div class="tituloseccion">&gt; Añadir artículos a Cliente (
...
@%plt:botonera%@
 ...
 <li><a href="#" onClick="return sendForm('nuevo_descuento_articulos');"  class="enviar" ><img src="imag/pixel.png" class="icono" /><span>Añadir</span></a></li>
 </ul></div>
