...
<li><a href="#" onclick="return onHRefClick('bo_inventario_articulos','accion_ejecutar','Agrupar');" class="agruparlocalizaciones" 
	><img src="images/pixel.png" class="icono" /><span>Agrupar</span></a></li>
@%if:AllowedAction;Localizacion_articulos;new;%@
<li><a href="?seccion=bo_importar_articulos_seleccion" class="nuevalocalizacion" ><img src="images/pixel.png" class="icono" /><span>Alta de localizaci�n</span></a></li>
@%end-if:%@
</ul></div>
...
<td ><a href="?_search_sort=Articulos.codigo_barras">Cod. barras<img src="images/pixel.png" 
	class="@%func:class_searchsort;Articulos.codigo_barras;%@" /></a></td>
<td ><a href="?_search_sort=Articulos.nombre">Art�culo<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Marcas.nombre">Marca<img src="images/pixel.png" class="@%func:class_searchsort;Marcas.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.fecha_caducidad">Fecha cad.<img src="images/pixel.png" 
	class="@%func:class_searchsort;Localizacion_articulos.fecha_caducidad;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.lote">Lote<img src="images/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.lote;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.cantidad">Cantidad<img src="images/pixel.png" 
	class="@%func:class_searchsort;Localizacion_articulos.cantidad;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.planta">Planta<img src="images/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.planta;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.pasillo">Pasillo<img src="images/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.pasillo;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.columna">Colum.<img src="images/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.columna;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.fila">Fila<img src="images/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.fila;%@" /></a></td>
</tr></thead>
...
@%if:cambia_var_x;%@
<thead class="secundario" ><tr><td colspan="12">Zona: @%db:Almacenes_logicos.nombre;%@</td></tr></thead>
@%end-if:%@
@%end-if:%@
...
<li><a href="#" onclick="return onHRefClick('bo_inventario_articulos','accion_ejecutar','Modificar');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Modificar</span></a></li>
<li><a href="#" onclick="return SendFormToWindow('bo_inventario_articulos','nuevo_bajas_almacen','BajaLocalizacion',400);" class="causarbaja" ><img src="images/pixel.png" class="icono" /><span>Causar Bajas</span></a></li>
<li><a href="#" onclick="return onHRefClick('bo_inventario_articulos','accion_ejecutar','Borrar');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Borrar seleccionados</span></a></li>
</ul></div>
