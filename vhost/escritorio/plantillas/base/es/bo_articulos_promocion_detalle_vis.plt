...
<tr> <td>
 ...
 <td bgcolor="#DBE0E3" width="150" class="etiqueta">Nombre</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Descripción</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Cod. barras</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="60" class="etiqueta">Cantidad</td>
