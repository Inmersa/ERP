...
<div class="barraoscura"><div class="titsuperior">&gt; AÑADIR DIRECCION DE ENTREGA</div></div>
...
<div class="enviar">
<a href="" onClick="document.forms['nuevo_direcciones_entrega'].submit();return false;" >Añadir</a>
</div>
</form>
