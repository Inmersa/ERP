...
<input type="hidden" name="accion_ejecutar" value="Importar">
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="190">Artículo</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="50">Lote</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Planta</td>
 <td width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Pasillo</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Fila</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Colum.</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center">Cantidad</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="22" align="center" class="etiqueta" width="100">Fecha cad. </td>
