...
<li><a href="#" onClick="return sendForm('modif_almacenes_logicos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modificar</span></a></li>
</ul></div>

<table class="full">
<tr>
<td class="caption">Almacenes</td>
</tr>
<tr>
<td class="etiqueta">Nombre:</td>
