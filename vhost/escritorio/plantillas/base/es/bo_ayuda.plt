...
<div class="titsuperior">&gt; AYUDA</div><div class="alinder">
...
<td class="caption">Sub Sección</td>
</tr>
...
@%plt:botonera%@
<div class="enviar"><a href="#" onClick="return sendForm('modif_ayuda');">Borrar seleccionados</a></div>
