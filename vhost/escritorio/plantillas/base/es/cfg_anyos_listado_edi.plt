...
><img src="imag/pixel.png" class="icono" /><span>Reconstruir Enlaces</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=nombre" class="order" >Nombre<img src="imag/pixel.png" class="@%func:class_searchsort;nombre;%@" /></a></td>
<td ><a href="?_search_sort=Anyos.f_ini" class="order" >Fecha de inicio<img src="imag/pixel.png" class="@%func:class_searchsort;Anyos.f_ini;%@" /></a></td>
<td ><a href="?_search_sort=Anyos.f_fin" class="order" >Fecha Fin<img src="imag/pixel.png" class="@%func:class_searchsort;Anyos.f_fin;%@" /></a></td>
...
<option value="0" selected="selected">-- Ninguna seleccion --</option>
@%end-if:%@
<option value="1"
