...
@%if:es_presupuesto%@
 ...
 <td width="46" align="center" ><a href="?seccion=hacer_ticket" class="accesos">Volver</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#CCD2D7" class="etiqueta">Convertir en pedido tipo <input type="checkbox" name="pedido_tipo" value="1">
 </td>
 </tr>
 <tr>
 <td height="10"></td>
 ...
 @%where:nodb|nodb_reciever_data;%@ <tr> <td height="22" align="right" bgcolor="#EBECED" class="etiqueta">Nombre:</td>
...
@%end-where:%@
 ...
 <tr> <td width="6"></td>
 <td width="419"></td>
 <td align="center" width="100"><a href="?seccion=hacer_pedido" class="accesos">Añadir artículo </a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" height="20" class="etiqueta">Nombre</td>
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="60">Cant.</td>
 <td width="1" height="20"></td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center" width="60"> Dtos </td>
 <td width="1" height="20"></td>
...
@%end-if:%@
 ...
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center">Base imponible</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta">IVA %</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="120">R. equiv. %</td>
 <td width="1" height="20" bgcolor="#DBE0E3"></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Base imponible</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center">Descuento</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="80">Importe</td>
 <td width="1" bgcolor="#DBE0E3" height="20"></td>
 </tr>
