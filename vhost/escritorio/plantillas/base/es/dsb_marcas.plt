...
><div name="MarcasVenta" ><a href="?seccion=dashboard_marcas" class="cambio_ss" >Valores en Venta</a></div
@%end-if:%@
@%if:!equals;_krn_ss_name;dashboard_marcas_pedidoventa;%@
><div name="MarcasPedidosVenta" ><a href="?seccion=dashboard_marcas_pedidoventa" class="cambio_ss" >Pedidos en Venta</a></div
@%end-if:%@
@%if:!equals;_krn_ss_name;dashboard_marcas_devolucionventa;%@
><div name="MarcasDevolucionesVenta" ><a href="?seccion=dashboard_marcas_devolucionventa" class="cambio_ss" >Devoluciones en Venta</a></div
@%end-if:%@
...
><div name="MarcasCompra" ><a href="?seccion=dashboard_marcas_compra" class="cambio_ss" >Valores en Compra</a></div
@%end-if:%@
@%if:!equals;_krn_ss_name;dashboard_marcas_pedidocompra;%@
><div name="MarcasPedidosCompra" ><a href="?seccion=dashboard_marcas_pedidocompra" class="cambio_ss" >Pedidos en Compra</a></div
@%end-if:%@
@%if:!equals;_krn_ss_name;dashboard_marcas_devolucioncompra;%@
><div name="MarcasDevolucionesCompra" ><a href="?seccion=dashboard_marcas_devolucioncompra" class="cambio_ss" >Devoluciones en Compra</a></div
@%end-if:%@
