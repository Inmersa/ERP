 ...
 <tr bgcolor="#CCD2D7" align="right"> <td colspan="15" height="22"><a href="" onclick="window.open('?seccion=bo_albaran_envio_print&id_albaran=@%db:Albaranes.id_albaran%@'); return false;" class="accesos">Imprimir envio</a></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="75">Fecha cad.</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Lote</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" >Cant.Pedida</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1">Cant. Movida</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="titul1" align="center" >Cant. Recibida </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center" width="60" >Precio</td>
