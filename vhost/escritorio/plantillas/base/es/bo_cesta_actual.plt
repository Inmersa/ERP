...
<div class="barraoscurai">Selecciones actuales : &nbsp;&nbsp;
...
<thead>
<tr>
<td class="estado" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('articulos_confirmados');"  /></td>
<td >ID</td>
<td >Art�culo</td>
<td >Marca</td>
<td >Precio</td>
...
<ul>
<li><a href="#" onclick="return sendForm('cesta');" class="finalizar" ><img src="images/pixel.png" class="icono" /><span>Finalizar</span></a></li>
<li><a href="?@%env:QUERY_STRING%@&vaciar_pedido=1" class="vaciar" ><img src="images/pixel.png" class="icono" /><span>Vaciar Pedido</span></a></li>
</ul>
</div>
...
<ul>
<li class="noicon" >Referencias Habituales del Cliente Desde:</li>
<li class="noicon" ><input type="text" size="14" maxlength="14" name="repo[fecha]" value="dd/mm/aaaa" /></li>
<li><a href="#" onClick="return sendForm('habituales');" class="enviar"><img src="images/pixel.png" class="icono" />Enviar</a></li>
</ul>
</div>
</form>
@%end-if:%@
