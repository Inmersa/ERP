...
<thead>
 ...
 <td ><a href="?_search_sort=Direcciones_entrega.direccion" >Dir. entrega<img src="images/pixel.png" class="@%func:class_searchsort;Direcciones_entrega.direccion;%@" /></a></td>
 <td ><a href="?_search_sort=monto_pedido" >Base Imp.<img src="images/pixel.png" class="@%func:class_searchsort;monto_pedido;%@" /></a></td>
