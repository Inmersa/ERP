...
<div class="menuitem"> <a href="?seccion=bo_inventario_almacen&_chgsm=1" @%func:querystring_activa;bo_inventario_almacen&_chgsm;activo;;%@ >Inventario</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_compra;%@
<div class="menuitem"><a href="?seccion=bo_albaranes_compra" @%func:querystring_activa;bo_albaranes_compra;activo;;%@ >Albaranes Compras</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_venta;%@
<div class="menuitem"><a href="?seccion=bo_albaranes_venta" @%func:querystring_activa;bo_albaranes_venta;activo;;%@ >Albaranes Ventas</a></div>
@%end-if:%@
