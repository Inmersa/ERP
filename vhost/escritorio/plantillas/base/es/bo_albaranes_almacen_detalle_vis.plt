...
@%plt:botonera%@
 ...
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="190">Dirección Destino</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="90">Tipo albarán </td>
 <td width="1"></td>
...
<!--br>
<a href="?seccion=nuevo_albaranes">Añadir Registro</a>
<br-->
