...
@%plt:botonera%@
 ...
 <tr> <td class="etiqueta" height="22" bgcolor="#DBE0E3" width="100" align="right">Nombre:<font color="#DBE0E3">..</font></td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Zona </td>
 <td bgcolor="#FFFFFF" class="etiqueta" align="center" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Cantidad</td>
 <td bgcolor="#FFFFFF" class="etiqueta" align="center" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Fecha cad.</td>
 <td bgcolor="#FFFFFF" class="etiqueta" align="center" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Fecha alta</td>
 <td bgcolor="#FFFFFF" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Planta</td>
 <td bgcolor="#FFFFFF" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Fila</td>
 <td bgcolor="#FFFFFF" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Colum.</td>
 <td bgcolor="#FFFFFF" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Pasillo</td>
