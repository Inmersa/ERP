...
<li><a href="?seccion=nueva_persona_contacto" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nuevo</span></a></li>
@%end-if:%@
@%if:AllowedAction;Cliente_contactos;del;%@
<li><a href="#" onClick="return onHRefClick('modif_clientes','accion_ejecutar','BorrarContactos');" class="borrar"><img src="imag/pixel.png" class="icono" /><span>Borrar direcciones</span></a></li>
@%end-if:%@
</ul>
</div>
