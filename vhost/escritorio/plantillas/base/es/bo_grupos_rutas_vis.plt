...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="205">Nombre</td>
 <td class="etiqueta" height="1" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="413">Descripción</td>
 ...
 @%where:tabla|Grupo_rutas;nombre|busc;%@ <tr> <td bgcolor="#DBE0E3" height="1" width="24"></td>
 <td colspan="4" height="1"></td>
 </tr>
 <tr> <td class="etiqueta" height="22" bgcolor="#DBE0E3" width="24" align="center"> </td>
 <td height="22" width="205">@%if:AllowedLink;modif_grupo_rutas;%@<a href="?seccion=modif_grupo_rutas&id_grupo_rutas=@%db:Grupo_rutas.id_grupo_ruta;%@" class="accesos">@%db:Grupo_rutas.nombre;%@</a></td>
 @%end-if:%@
 <td height="1" bgcolor="#CCD2D7" width="1"></td>
 <td height="22" width="413" class="texto">@%db:Grupo_rutas.descripcion;%@</td>
