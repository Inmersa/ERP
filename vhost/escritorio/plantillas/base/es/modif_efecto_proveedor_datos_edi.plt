...
<table class="full">
 ...
 <tr><td class="etiqueta" >Concepto: </td>
...
@%end-where:%@ 
 ...
 <tr><td class="etiqueta" >Nombre Banco: </td>
 <td >
...
@%end-if:%@
 ...
 Devuelto (@%db:si_no_flag{Efectos.devuelto}%@) 
 </td>
 </tr>
 </table>
</fieldset>
