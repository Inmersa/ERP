...
<li><a href="?seccion=bo_importar_clientes_agente" class="importarusuario"><img src="images/pixel.png" class="icono" /><span>Importar clientes</span></a></li>
@%end-if:%@
...
<td></td>
<td ><a href="?_search_sort=Clientes.razon_social" >Nombre<img src="images/pixel.png" class="@%func:class_searchsort;Clientes.razon_social;%@" /></a></td>
<td ><a href="?_search_sort=Agentes_clientes.fecha_captacion" >Fecha captaci�n<img src="images/pixel.png" 
	class="@%func:class_searchsort;Agentes_clientes.fecha_captacion;%@" /></a> </td>
<td ><a href="?_search_sort=Agentes_clientes.comision" >Comisi�n<img src="images/pixel.png" class="@%func:class_searchsort;Agentes_clientes.comision;%@" /></a></td>
<td ><a href="?_search_sort=Agentes_clientes.comision_repartida" >Comisi�n repartida<img src="images/pixel.png" 
