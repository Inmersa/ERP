...
<legend>Ventas Comparadas</legend>
...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Vencimientos de Cobro</td>
<td colspan="@%get:_iterate_times;%@" >Vencimientos de Pago</td></td>
...
<!-- 
@%set:grafica[titulo] = Vencimientos de Cobro;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Vencimientos de Pago;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
