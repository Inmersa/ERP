...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center" width="60"><span class="texto">%</span>Dto </td>
 <td width="1" height="20"></td>
...
@%end-if:%@ <tr> <td colspan="13" height="1" bgcolor="#DBE0E3"></td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">T. Bruto</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center">%</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="70">T. Bruto</td>
 <td width="1" bgcolor="#DBE0E3" height="20"></td>
 </tr>
...
<!--@%set:total_bruto=Descuentos.monto_base;%@-->
 ...
 <tr>
 <td align="right" class="texto" width="100" bgcolor="#EBECED">T. Bruto:</td>
 ...
 <tr>
 <td align="right" class="texto" width="100" bgcolor="#EBECED">Total descuento:</td>
 ...
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">T.B. Imponible:</td>
 ...
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">T. Impuestos:</td>
 <td height="23" class="texto"> <!-- sumatorio de cantidades de impuestos -->
 @%db:Facturas.total_impuestos;%@</td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">Retención:</td>
