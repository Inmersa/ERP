...
<li><a href="?seccion=hacer_pedido" class="editar" ><img src="images/pixel.png" class="icono" /><span>A�adir art�culo</span></a></li>
@%else:%@
<li><a href="?seccion=hacer_pedido_compra" class="editar" ><img src="images/pixel.png" class="icono" /><span>A�adir art�culo</span></a></li>
@%end-if:%@
</ul></div>
