...
<li><a href="#" onClick="return sendForm('cita');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modificar</span></a></li>
@%if:!esta_vacio;estado_iniciado;%@
@%if:esta_vacio;Citas.id_pedido;%@
<li><a href="#" onClick="return sendForm('nuevopedido');" class="nuevopedido" ><img src="imag/pixel.png" class="icono" /><span>Hacer pedido</span></a></li>
@%end-if:%@
...
><div name="Incidencias" class="activo" >Incidencias</div
@%end-if:%@
@%if:!esta_vacio;estado_iniciado;%@
@%if:AllowedPII;EfectosPendientes;%@
><div name="Efectos" >Efectos Pendientes</div
@%end-if:%@
@%end-if:%@
></div>
