...
<ul>
 @%if:!oModoSeleccion->isActive;%@
	 ...
	 <li><a href="?seccion=bo_importar_articulos" class="recuperar"><img src="images/pixel.png" class="icono" /><span>Importar art�culo</span></a></li>
	 @%end-if:&@
	 @%if:AllowedAction;Articulos;new;%@
	 <li><a href="?seccion=nuevo_articulos" class="nuevo"><img src="images/pixel.png" class="icono" /><span>Nuevo art�culo</span></a></li>
	 @%end-if:&@
	 ...
	 <li><a href="#" onclick="return onHRefClick('bo_articulos','accion_ejecutar','Borrar');" class="borrar"
		><img src="images/pixel.png" class="icono" /><span>Dar de Baja Seleccionados</span></a></li>
	 @%end-if:%@
 @%else:%@
