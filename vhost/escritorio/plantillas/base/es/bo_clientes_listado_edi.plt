...
<ul>
 @%if:!oModoSeleccion->isActive;%@
	...
	<li><a href="?seccion=nuevo_clientes" class="nuevo"><img src="images/pixel.png" class="icono" /><span>Nuevo Cliente</span></a></li>
	@%end-if:%@
	@%if:AllowedLink;bo_importar_clientes;%@
	<li><a href="?seccion=bo_importar_clientes" class="altausuario"><img src="images/pixel.png" class="icono" /><span>Importar cliente</span></a></li>
	@%end-if:%@
	@%if:AllowedAction;Clientes_empresas;del;%@
	<li><a href="#" onclick="return sendForm('bo_clientes');" class="bajausuario" ><img src="images/pixel.png" class="icono" /><span>Dar de Baja Seleccionados</span></a></li>
	@%set:permitir_selecciones=1;%@
	@%end-if:%@
  @%else:%@
 	<li ><a href="#" onClick="return sendForm('bo_clientes');" class="seleccionar" ><img src="images/pixel.png" class="icono" /><span>Seleccionar</span></a></li>
  @%end-if:%@
</ul>
</div>
...
<thead>
<tr>
 <td ><a href="?_search_sort=Clientes.id_cliente">C�digo<img src="images/pixel.png" class="@%func:class_searchsort;Clientes.id_cliente;%@" /></a></td>
 <td class="check" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('selecciones');"  /></td>
 <td ><a href="?_search_sort=Clientes.razon_social">Cliente<img src="images/pixel.png" class="@%func:class_searchsort;Clientes.razon_social;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes_empresas.persona_contacto">Contacto<img src="images/pixel.png" class="@%func:class_searchsort;Clientes_empresas.persona_contacto;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes.cif">CIF<img src="images/pixel.png" class="@%func:class_searchsort;Clientes.cif;%@" /></a></td>
 <td ><a href="?_search_sort=Tipo_cliente.nombre">Tipo cliente<img src="images/pixel.png" class="@%func:class_searchsort;Tipo_cliente.nombre;%@" /></a></td>
 </tr>
</thead>
<tbody>
@%end-if:%@
