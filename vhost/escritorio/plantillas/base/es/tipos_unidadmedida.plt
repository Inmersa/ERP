...
<div class="tituloseccion" >Tipo de Unidad de medida</div>
...
<li><a href="#" onClick="return sendForm('listado','accion_ejecutar','ModificarLista');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modificar</span></a></li>
@%end-if:%@
