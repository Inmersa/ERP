...
<li><a href="?seccion=nuevo_series_facturacion" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nuevo</span></a></li></td>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_series_facturacion');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Borrar seleccionados</span></a></li>
</ul></div> 
...
<td ><a href="?_search_sort=Series_facturacion.nombre" class="order" >Nombre<img src="imag/pixel.png" 
	class="@%func:class_searchsort;Series_facturacion.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Series_facturacion.descripcion" class="order" >Descripción<img src="imag/pixel.png" 
