...
<div class="tituloseccion">&gt; MODIFICAR RECORRIDO</div>
...
@%if:AllowedPII;Citas;%@
><div name="Citas" class="activo" >Citas</div
@%end-if:%@
@%if:AllowedPII;Gastos;%@
><div name="Gastos" >Gastos</div
@%end-if:%@
@%if:AllowedPII;Totales;%@
><div name="Efectos" >Efectos Pagados</div
@%end-if:%@
></div>
...
@%if:esta_vacio;estado_cerrado;%@
	...
	<li><a href="#" onClick="return sendForm('modif_recorridos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modificar</span></a></li>
	@%if:!esta_vacio;estado_noiniciado;%@
	<li><a href="#" onClick="return sendForm('modif_recorridos','accion_ejecutar','Iniciar');" class="iniciar" 
		><img src="imag/pixel.png" class="icono" /><span>Iniciar ruta</span></a></li>
	@%else:%@
	<li><a href="#" onClick="return sendForm('modif_recorridos','accion_ejecutar','Finalizar');" class="finalizar" 
		><img src="imag/pixel.png" class="icono" /><span>Finalizar</span></a></li>
	@%end-if:%@
	</ul></div>
@%end-if:%@
@%end-if:%@
