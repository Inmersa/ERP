...
<li><a href="?seccion=seleccionar_proveedor" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Seleccionar Proveedor</span></a></li> 
<li><a href="#" onClick="return onHRefClick('modif_articulos','accion_ejecutar','Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Descartar Seleccionados</span></a></li>
</ul></div>
</fieldset>
...
<td class="etiqueta" >Dto por Volumen</td>
...
@%end-if:%@
 /></td>
 <td class="etiqueta" colspan="2" style="text-align:left;">Precios para un periodo de</td>
