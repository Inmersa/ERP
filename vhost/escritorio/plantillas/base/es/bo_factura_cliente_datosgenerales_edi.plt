...
@%if:!emitida;%@
	@%where:nodb|nodb_reciever_data;nombre|receptor;%@
		...
		<li><a href="#" onClick="return sendForm('factura','accion_ejecutar','CargarCuenta');"  class="cargarpendiente" 
			><img src="images/pixel.png" class="icono" /><span>Cargar desde la Cuenta</span></a></li>
		</ul></div>
	@%end-where:%@
...
<td class="etiqueta" >Monto Cuenta</td><td colspan="3" >@%db:monto_cuenta;%@</td>
@%end-where:%@
...
<td class="etiqueta @%css:agente;label;%@">Realizado por:</td>
...
<td class="etiqueta" >Forma de Abono</td>
...
<td class="etiquetacheck" >Restar Efectos y Sumar a Cuenta</td>
...
<td class="etiquetacheck" >Restar Efectos y A�adir Devoluci�n</td>
...
<td class="etiquetacheck" >Abono en Devoluci�n</td>
...
<td class="etiquetacheck" >Abono en Cuenta</td>
...
@%where:tabla|Pedidos_facturas;where|Pedidos_facturas.id_factura = $idfra;group|Pedidos.id_pedido;%@
   @%if:primera_vez;%@
	<table class="full" >
	<caption class="titulotb" >Pedidos:<caption><tbody>
   @%else:%@
	</tr><tr>
   @%end-if:%@ 
...
@%if:esta_vacio;factura_abono;%@
	@%where:nombre|Fras;where|Facturas_abonos.id_factura = $idfra;nolink|1;contador|cnt;%@
		...
		@%if:equals;cnt;1;%@
		<table class="full" >
		<caption class="titulotb" >Facturas de Abono Relacionadas</caption><tbody>
		@%end-if:%@
...
@%if:!esta_vacio;factura_abono;%@
	<table class="full" >
	<caption class="titulotb" >Facturas que Abona</caption><tbody>
...
@%if:equals;cnt;1;%@
<table class="full" ><caption class="titulotb" >Efectos</caption>
<thead ><tr><td>Fecha Vencimiento</td><td>Total</td><td>T. Pagado</td></tr>
<tbody>
...
@%if:equals;cnt;1;%@
<table class="full" >
<caption class="titulotb" >Efectos que Abona</caption><tbody>
@%set:cabecera_puesta=1;%@
@%end-if:%@
