...
<ul>
<li><a href="?seccion=nuevo_operador" class="nuevo"><img src="imag/pixel.png" class="icono" /><span>Nuevo Operador</span></a></li>
</ul>
</div>
@%end-if:%@
...
<li><a href="#" onClick="return resetForm('ficha');" class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Deshacer Cambios</span></a></li>
</ul>
</div>
