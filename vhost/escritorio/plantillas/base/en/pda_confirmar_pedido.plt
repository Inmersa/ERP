<html>
<head>
<title>{{acc_confirmarpedido}}</title>
...
class="accesos">{{acc_confirmar}}</a--><input type="submit" value="{{acc_confirmar}}"><a href="?seccion=pda_hacer_pedido" class="accesos"
>{{acc_volver}}</a></td>
 </tr>
<tr>
<td height="10"></td>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr> <td class="titul1" align="left" width="95">&gt; {{fld_direccionesdeentrega}}</td>
</tr>
 <tr>
 <td height="10"></td>
 </tr>
...
<tr>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr> <td align="left" class="titul1" width="114">{{label_formapago}}</td>
...
<tr> <td align="left" class="titul1" width="114">{{fld_divisa}}</td>
 <td class="texto" width="86">
...
<tr> <td align="left" class="titul1" width="114">@%db:porcentaje%@% {{label_slash}} @%db:porcentaje_recargo_equivalente%@%</td>
 <td class="texto" width="86">@%db:recargo_iva%@@%db:leyenda_divisa%@ {{label_slash}} @%db:recargo_equivalente%@@%db:leyenda_divisa%@</td>
 </tr>
 @%end-where:%@
...
<tr> <td align="left" class="titul1" width="114">@%db:nombre%@</td>
 ...
 <tr> <td align="left" class="titocho" width="114">{{label_totalbruto}}:</td>
 <td class="texto" width="86">@%db:bruto%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="114">{{label_baseimponible}}:</td>
 <td class="texto" width="86">@%db:base_imponible%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="114">{{fld_retenciones}}:</td>
 <td class="texto" width="86">@%db:retenido%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">{{label_totaldtos}}:</td>
 <td class="texto" width="103">@%db:descuentos%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr>
 <td height="10"></td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">{{label_IMPORTE}}:</td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
<td class="titocho">{{fld_observaciones}} :</td>
</tr>
 <tr>
