...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="70">Own Reference</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Supplier Ref. </td>
 <td width="1"></td>
 <td width="20" bgcolor="#DBE0E3"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Article name </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center"></td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Price</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="65" align="center">Discount %</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="50">Manuf.</td>
 <td width="1"></td>
 </tr>
