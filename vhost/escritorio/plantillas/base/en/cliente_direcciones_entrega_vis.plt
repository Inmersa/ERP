...
@%if:AllowedLink;nuevo_direcciones_entrega;%@
	...
	<a href="?seccion=nuevo_direcciones_entrega&amp;id_cliente=@%get:id_cliente_promocion%@">Add address</a> 
	@%end-if:%@
@%end-if:%@
@%if:AllowedAction;Direcciones_entrega;del;%@
<a href="#" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Borrar');">Delete</a>
@%end-if:%@
</div></div>
