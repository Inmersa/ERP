...
@%where:tabla|Articulos;nombre|busc;no_results|1;%@
	...
	<table class="full">
	<tr> 
	<td class="titulotb" align="right">Brand:</td>
	...
	<table class="full">
	<tr> 
	<td class="titulotb" align="right">Family:</td>
	...
	<td ><a href="?_search_sort=cantidad_pedida">Ordered<img src="images/pixel.png" class="@%func:class_searchsort;cantidad_pedida;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_recibida">Received<img src="images/pixel.png" class="@%func:class_searchsort;cantidad_recibida;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_facturada">Invoiced<img src="images/pixel.png" class="@%func:class_searchsort;cantidad_facturada;%@" /></a></td>
	<td ><a href="?_search_sort=precio_medio">Average Price<img src="images/pixel.png" class="@%func:class_searchsort;precio_medio;%@" /></a></td>
	<td ><a href="?_search_sort=precio_maximo">Maximum Price<img src="images/pixel.png" class="@%func:class_searchsort;precio_maximo;%@" /></a></td>
	<td ><a href="?_search_sort=precio_minimo">Minimum Price<img src="images/pixel.png" class="@%func:class_searchsort;precio_minimo;%@" /></a></td>
	</tr>
	</thead>
	<tbody class="informe" >
	@%else:%@
