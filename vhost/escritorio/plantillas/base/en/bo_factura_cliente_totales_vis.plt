...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Total gross amount</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center">%</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="70">Amount</td>
 ...
 <tr>
 <td align="right" class="texto" width="100" bgcolor="#EBECED">Total gross amount:</td>
 ...
 <tr>
 <td align="right" class="texto" width="100" bgcolor="#EBECED">Total Discount:</td>
 ...
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">Total Taxable Income:</td>
 <td height="23" class="texto">
 @%db:base_imponible;%@ </td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">Total Taxes:</td>
 <td height="23" class="texto">
 @%db:total_impuestos%@ </td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="100">Deduction:</td>
 <td height="23" class="texto">
 @%db:retenido%@ </td>
 </tr>
...
@%if:emitida;%@
 <a href="?seccion=bo_facturas_pedido_venta&id_pedido=@%db:id_pedido;%@" class="accesos">To see</a>
@%else:%@
 <a href="" onclick="document.forms['pedido'].submit();return false;" class="accesos">Save Changes</a>
@%end-if:%@
 
@%if:hay_albaran%@
 <a href="?seccion=bo_albaranes_pedido&id_pedido=@%db:id_pedido;%@" class="accesos">To see delivery notes</a>
@%else:%@
@%end-if:%@
</td> 
</tr> 
