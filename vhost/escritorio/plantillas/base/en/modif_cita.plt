<div class="tituloseccion">&gt; Modify Appoinment</div>
...
<li><a href="#" onClick="return sendForm('cita');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Modify</span></a></li>
@%if:!esta_vacio;estado_iniciado;%@
@%if:esta_vacio;Citas.id_pedido;%@
<li><a href="#" onClick="return sendForm('nuevopedido');" class="nuevopedido" ><img src="images/pixel.png" class="icono" /><span>Make order</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('cita','accion_ejecutar','Finalizar');" class="finalizar" 
	><img src="images/pixel.png" class="icono" /><span>Finish</span></a></li>
@%end-if:%@
@%if:!esta_vacio;estado_noiniciado;%@
<li><a href="#" onClick="return sendForm('cita','accion_ejecutar','Iniciar');" class="iniciar" ><img src="images/pixel.png" class="icono" /><span>Start Up</span></a></li>
@%end-if:%@
</ul></div>
...
><div name="Incidencias" class="activo" >Events</div
@%end-if:%@
@%if:!esta_vacio;estado_iniciado;%@
@%if:AllowedPII;EfectosPendientes;%@
><div name="Efectos" >Pending Effects</div
@%end-if:%@
@%end-if:%@
></div>
