...
<li><a href="?seccion=nuevo_grupo_familias" class="accesos" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>New</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_grupo_familias');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Delete selected</span></a></li>
</ul></div>
