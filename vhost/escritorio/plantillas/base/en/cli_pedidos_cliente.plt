...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="485" >&gt; All time orders record</td>
 <td class="titocho" width="110" align="center" ><a href="?seccion=cli_hacer_pedido&pedido=1" class="accesos">New order</a></td>
...
@%plt:botonera%@
 ...
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="240">Delivery Add.</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="83">Amount</td>
 <td width="1"></td>
