 ...
 <td class="etiqueta" bgcolor="#CCD2D7" >Countable accounts:</td>
 </tr>
 </table>
 <table width="644" border="0" cellspacing="0" cellpadding="0">
...
<input type="hidden" name="registro2[cc_compras]" value="@%db:Proveedores_empresas.cc_compras;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Discounts:</td>
...
<input type="hidden" name="registro2[cc_gastos]" value="@%db:Proveedores_empresas.cc_gastos;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta" width="161">Deductions:</td>
...
<input type="hidden" name="registro2[cc_retenciones]" value="@%db:Proveedores_empresas.cc_retenciones;%@" class="insertext" size="10" maxlength="10">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Bank drafts:</td>
...
<input type="hidden" name="registro2[cc_efectos]" value="@%db:Proveedores_empresas.cc_efectos;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <td height="22" width="49" align="center">Country / DC</td>
 <td height="22" width="68" align="center">Bank</td>
 <td height="22" width="65" align="center">Branch</td>
 <td height="22">DC / Account Number</td>
 </tr>
 <tr> 
 ...
 <tr> <td align="right" class="etiqueta" height="22" bgcolor="#EBECED">Register date:</td>
 ...
 <td align="right" class="etiqueta" height="22" bgcolor="#EBECED">Active:</td>
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta" valign="top">Remarks:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">% Discount:</td>
...
<input type="hidden" name="registro2[descuento]" value="@%db:Proveedores_empresas.descuento;%@" class="insertext" size="4">
 ...
 <tr> <td width="162" bgcolor="#EBECED" align="right" class="etiqueta">Apply Surcharge :</td>
 <td> <!--@%db:Proveedores.aplicar_recargo;%@-->
 </td>
 <td bgcolor="#EBECED" align="right" width="200" class="etiqueta">Apply VAT (extracom.):</td>
 <td>
...
<table width="644" border="0" height="22" cellspacing="0" cellpadding="0">
 <tr> 
 <td class="etiqueta" align0"right" width="200" bgcolor="#EBECED">Financial Discount:</td>
...
<tr><td height="22">
 ...
 <tr> 
 <td class="etiqueta" height="20" width="172" >Payment days</td>
 </tr>
 </table>
 <table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr>
