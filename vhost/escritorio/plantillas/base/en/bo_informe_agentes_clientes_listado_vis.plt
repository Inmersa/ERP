...
@%plt:botonera%@
 ...
 <td height="22" bgcolor="#DBE0E3" class="etiqueta">Client name</td>
 <td width="1"></td>
 <td height="22" bgcolor="#DBE0E3" align="center" class="etiqueta" width="70">Invoices</td>
 <td width="1"></td>
 <td height="22" bgcolor="#DBE0E3" align="center" class="etiqueta" width="100">Billed</td>
 <td width="1"></td>
 <td height="22" bgcolor="#DBE0E3" align="center" class="etiqueta" width="100">Commission</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="100" class="etiqueta" align="center">Received</td>
...
<tr> <td width="1" bgcolor="#DBE0E3" height="22"></td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Billed</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Commission </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Received</td>
