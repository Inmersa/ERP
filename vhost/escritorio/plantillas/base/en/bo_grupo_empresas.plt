<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="393" >&gt; Companies Group</td>
 <td class="titocho" width="91" align="center" ></td>
 <td width="80" align="center" >@%if:AllowedLink;nuevo_grupo_empresas;%@<a href="../?seccion=nuevo_grupo_empresas" class="accesos">New</a></td>
 @%end-if:%@
 <td width="46" align="center" ><a href="javascript: history.go(-1);return false;" class="accesos">Return</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td class="texto">Results: @%func:numero_resultados;%@</td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 <tr> <td height="5"></td>
