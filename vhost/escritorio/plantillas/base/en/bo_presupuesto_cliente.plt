...
><img src="images/pixel.png" class="icono" /><span>Review</span></a></li>
@%end-if:%@
@%end-if:%@
...
><img src="images/pixel.png" class="icono" /><span>Reject</span></a></li>
@%end-if:%@
@%end-if:%@
...
@%if:equals_any;estado;2;%@
	...
	><img src="images/pixel.png" class="icono" /><span>Billing</span></a></li>
	@%end-if:%@
@%else:%@
...
@%if:esta_vacio;id_rfq;%@
	<li><a href="?seccion=rfqs&modo_seleccion=1" class="enlazarrfq" ><img src="images/pixel.png" class="icono" /><span>Select RFQ</span></a></li>
@%end-if:%@

<li><a href="#" onclick="window.open('?@%env:QUERY_STRING%@&imprimir=1'); return false;" class="imprimir"><img 
src="images/pixel.png" class="icono" /><span>Print</span></a></li>
