...
<div class="menuitem"> <a href="?seccion=bo_pedidos_compras" @%func:querystring_activa;bo_pedidos_compras;activo;;%@ >Orders</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_compra;%@
<div class="menuitem"> <a href="?seccion=bo_albaranes_compra" @%func:querystring_activa;bo_albaranes_compra;activo;;%@ >Delivery notes</a></div>
@%end-if:%@
@%if:AllowedLink;bo_facturas_compra;%@
<div class="menuitem"> <a href="?seccion=bo_facturas_compra" @%func:querystring_activa;bo_facturas_compra;activo;;%@ >Invoices</a></div>
@%end-if:%@
