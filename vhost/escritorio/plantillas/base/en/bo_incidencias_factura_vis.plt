...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#DBE0E3" width="120" class="etiqueta">Reference</td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Managing User</td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Register date</td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Aproximate date to end</td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="50" align="center">Condition</td>
 </tr>
 <tr>
 </tr>
