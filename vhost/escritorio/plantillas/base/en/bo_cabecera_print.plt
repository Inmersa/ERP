...
<tr> <td height="15" class="titul" bgcolor="#EBECED"></td>
 <td height="18" class="titul" bgcolor="#EBECED">Provinces-States:</td>
 <td class="texto" height="15" width="110">@%db:provincia;%@</td> <td class="titul" align="right" height="15" width="60" bgcolor="#EBECED">Postal Code:</td>
...
<tr> <td height="15" class="titul" bgcolor="#EBECED"></td>
 <td height="15" class="titul" bgcolor="#EBECED">Provinces-States:</td>
<td class="texto" height="15">@%db:provincia;%@</td> <td class="titul" align="right" height="15" bgcolor="#EBECED">Postal Code:</td>
...
<tr>
 ...
 <td height="20" class="titocho" bgcolor="#CCD2D7">Invoicing address </td>
</tr>
<tr>
