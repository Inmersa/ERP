...
Name Promotion</td>
 ...
 <td width="1"></td>
 <td width="80" bgcolor="#DBE0E3" align="center" class="etiqueta">Starting date</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" class="etiqueta" width="80">Last date</td>
 </tr>
...
<input type="text" name="registro[fecha_inicio]" value="@%db:colocar_fecha{Promociones.fecha_inicio};%@" size="10" class="insertextnumeros">
 Last date<input type="text" name="registro[fecha_fin]" value="@%db:colocar_fecha{Promociones.fecha_fin};%@" size="10" class="insertextnumeros">


<a href="" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Modificar');" class="accesos">Active</a>
