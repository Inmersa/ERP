...
<li><a href="#" onClick="return sendForm('importar_articulos_proveedor');" class="enviar" ><img src="images/pixel.png" class="icono" /><span>Import</span></a></li>
</ul></div>
...
<table class="full">
<thead><tr>
<td colspan="3"><a href="?_search_sort=Articulos.nombre" class="order" >Name<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Articulos.codigo_barras" class="order" 
	>Bar code<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.codigo_barras;%@" /></a></td>
...
<td colspan="2"><a href="?_search_sort=Empresas_articulos.fecha_baja" class="order" 
	>Stock down date<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.fecha_baja;%@" /></a></td>
</tr></thead>
