...
<tr> <td height="22" bgcolor="#CCD2D7" class="etiqueta" colspan="4">Data to Create Delivery Note</td>
 <td height="22" bgcolor="#CCD2D7" class="etiqueta" colspan="2" align="right"><a href="" onclick="document.forms['generar_albaran'].submit();return false;" class="accesos">Create Delivery Notes</a></td>
 </tr>
