...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" width="150">Supplier</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="80">Date</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="80">Taxable Income</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="65">Taxes</td>
 <td width="1"></td>
