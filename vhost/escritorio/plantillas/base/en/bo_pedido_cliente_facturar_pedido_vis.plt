<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td height="22" bgcolor="#CCD2D7" class="etiqueta" align="right"><a href="" onclick="document.forms['generar_albaran'].submit();return false;" class="accesos">Create Delivery Notes</a></td>
 <td></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="texto" width="92" align="center">Carrier:</td>
 ...
 <tr> <td height="20" bgcolor="#EBECED" align="right" class="texto" width="92">Ready:</td>
 <td height="20" colspan="3" class="texto">
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr> <td width="120"> <input type="checkbox" name="preparado" value="1">
 </td>
 <td bgcolor="#EBECED" height="20" align="right" class="texto">Sended:</td>
...
<form name="generar_factura" action="?seccion=bo_facturas_venta" method="post">
 ...
 <tr> <td height="22" bgcolor="#CCD2D7" class="etiqueta" colspan="3">Data to Create Delivery Note</td>
 <td height="22" bgcolor="#CCD2D7" class="etiqueta" align="right"><a href="" onclick="document.forms['generar_factura'].submit();return false;" class="accesos">Billing</a></td>
 </tr>
...
<select name="id_forma_pago" class="insertext">
 ...
 <tr> <td bgcolor="#EBECED" class="texto" width="120" align="right">Reference:</td>
 <td class="insertext" colspan="3">
 <input type="text" name="contador" class="insertext" size="16">
 Create residual order <input type="checkbox" name="residuo" value="1" checked>
 </td>
 </tr>
