...
<div class="titsuperior">&gt; Help</div><div class="alinder">
...
@%plt:botonera%@
<div class="enviar"><a href="#" onClick="return sendForm('modif_ayuda');">Delete selected</a></div>
