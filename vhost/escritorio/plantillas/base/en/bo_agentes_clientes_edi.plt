...
<li><a href="?seccion=bo_importar_clientes_agente" class="importarusuario"><img src="images/pixel.png" class="icono" /><span>Clients import</span></a></li>
@%end-if:%@
...
<td></td>
<td ><a href="?_search_sort=Clientes.razon_social" >Name<img src="images/pixel.png" class="@%func:class_searchsort;Clientes.razon_social;%@" /></a></td>
<td ><a href="?_search_sort=Agentes_clientes.fecha_captacion" >Recruitment date<img src="images/pixel.png" 
	class="@%func:class_searchsort;Agentes_clientes.fecha_captacion;%@" /></a> </td>
<td ><a href="?_search_sort=Agentes_clientes.comision" >Commission<img src="images/pixel.png" class="@%func:class_searchsort;Agentes_clientes.comision;%@" /></a></td>
<td ><a href="?_search_sort=Agentes_clientes.comision_repartida" >Shared Commission<img src="images/pixel.png" 
