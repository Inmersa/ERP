...
><img src="images/pixel.png" class="icono" /><span>Review Selected</span></a></li>
@%end-if:%@

@%if:equals;_krn_ss_name;bo_presupuestos_cliente;%@
...
><img src="images/pixel.png" class="icono" /><span>Transform in Proforma</span></a></li>
@%end-if:%@
@%end-if:%@
...
><img src="images/pixel.png" class="icono" /><span>Approve Selected</span></a></li>

<li><a href="#Rechazar Seleccionados" onclick="return onHRefClick('listado','accion_ejecutar','Rechazar');" class="rechazar"
><img src="images/pixel.png" class="icono" /><span>Reject Selected</span></a></li>
@%end-if:%@
...
class="imprimirmultiple"><img src="images/pixel.png" class="icono" /><span>Multiple Print</span></a></li>
...
<thead>
<tr>
<td ><a href="?_search_sort=Presupuestos.referencia" >Ref.<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.referencia;%@" /></a></td>
...
<td ><a href="?_search_sort=Presupuestos.fecha" >Date<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Presupuestos.base_imponible" >Taxable Income<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.base_imponible;%@" /></a></td>
<td ><a href="?_search_sort=Presupuestos.impuestos" >Taxes<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.impuestos;%@" /></a></td>
<td ><a href="?_search_sort=Presupuestos.importe" >Total<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.importe;%@" /></a></td>
<td >Condition</td>
</tr>
</thead>
