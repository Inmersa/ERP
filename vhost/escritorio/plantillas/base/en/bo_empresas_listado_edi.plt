...
<input type="hidden" name="estado" value="3">
 ...
 <td align="right" width="148"><a href="javascript:document.forms['bo_empresas'].submit();" class="accesos">Delete selected</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" colspan="2">Name<span class="texto"></span></td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="100">Group</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="100">EIN</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3" width="200">Company Name </td>
 <td width="1"></td>
 </tr>
...
<!-- @%db:Empresas.id_grupo_empresa;%@ -->
 ...
 <tr> <td bgcolor="#DBE0E3" valign="top" height="22"> <input type="checkbox" name="registro_borrar[@%db:Empresas.id_empresa;%@]" value="1">
 </td>
 <td class="accesos" width="6"></td>
 <td class="accesos"><a href="?seccion=modif_empresas&id_empresa=@%db:Empresas.id_empresa;%@" class="accesos">@%db:Empresas.nombre;%@</a></td>
