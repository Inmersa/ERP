<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" >&gt; Warehouses Transfer</td>
 <td align="right" >@%if:AllowedLink;nuevo_traspasos_almacen;%@<a href="../?seccion=nuevo_traspasos_almacen" class="accesos">New</a><a href="../?seccion=modif_almacenes_logicos" class="accesos">Return</a></td>
@%end-if:%@
 </tr>
 </table>
 </td>
 ...
 <tr> 
 <td class="texto">Results: @%func:numero_resultados;%@</td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 <tr> 
 <td class="texto">Searching Statement: </td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 </table>
