...
<div class="barraoscura"><div class="titsuperior">&gt; Supplier Card (ID: @%db:Proveedores.id_proveedor;%@)</div></div> 
...
><div name="Condiciones" class="activo" >Conditions</div
@%end-if:%@
@%if:AllowedPII;Descuentos;%@
><div name="Descuentos" >Commercial</div
@%end-if:%@
@%if:AllowedPII;Reposicion;%@
><div name="Reposicion" >Replacement</div
@%end-if:%@
@%if:AllowedPII;Cuentas_Contables;%@
><div name="CuentasContables" >Financier</div
@%end-if:%@
@%if:AllowedPII;Login;%@
><div name="Acceso" >Access</div
@%end-if:%@
@%if:AllowedPII;Observaciones;%@
><div name="Observaciones" >Observations</div
@%end-if:%@
></div>
...
<li><a href="#" onClick="return sendForm('modif_proveedores');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Save</span></a></li>
</ul></div>
