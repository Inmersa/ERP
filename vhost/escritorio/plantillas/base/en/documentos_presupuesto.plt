...
<legend>Budget Documents</legend>
<div class="AccionesFicha" >
<ul>
@%if:esta_vacio;id_grupo_docs;%@
@%else:%@
@%if:AllowedAction;Presupuestos_Documentos_CRM;new;%@
<li><a href="#" onClick="return onHRefClick('documentos','accion_ejecutar','NuevoDocumento');" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>New</span></a></li>
@%end-if:%@
@%end-if:%@
...
<li><a href="?seccion=crm_seleccionar_documento&varios=1&id_presupuesto=@%get:id_presupuesto;%@" 
	class="asociar" ><img src="images/pixel.png" class="icono" /><span>Choose Document</span></a></li>
<li><a href="#" onClick="return sendForm('documentos');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Save</span></a></li>
@%end-if:%@

@%if:AllowedAction;Presupuestos_Documentos_CRM;del;%@
<li><a href="#" onClick="return sendForm('documentos','accion_ejecutar','BorrarDocumentos',null,'Are you sure that do you want to delete the selected registries?');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Delete selected</span></a></li>
@%end-if:%@
...
@%end-if:%@
   ...
   @%else:%@
@%if:AllowedAction;Presupuestos_Documentos_CRM;new;%@
   <div class="documentos">New Document<input type="text" name="documento[nombre]" ><input type="file" name="document_file" /><br />
