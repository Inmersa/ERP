...
@%plt:botonera%@
 ...
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="190">Posting Address</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="90">Delivery note Type </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="70" height="22" align="center" class="etiqueta">Condition</td>
...
<!--br>
<a href="?seccion=nuevo_albaranes">Add</a>
<br-->
