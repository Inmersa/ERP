...
<table class="full">
@%if:esta_vacio;id_proveedor_cabecera;%@
	<caption>Direction Warehouse of Collection (@%db:Direcciones_entrega.nombre;%@)</caption>
@%end-if:%@

	<tr><td class="etiqueta">Name:</td><td >@%db:Clientes.razon_social;%@ (@%db:Clientes.id_cliente;%@)</td></tr>
	<tr><td class="etiqueta" >EIN:</td>
	...
	<tr><td class="etiqueta" >Address:</td><td >@%db:Direcciones_entrega.direccion;%@</td></tr>
	<tr><td class="etiqueta" >City:</td><td >@%db:Direcciones_entrega.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Provinces-States:</td>
	...
	<tr> 
	 <td class="etiqueta" >Telephone:</td><td >@%db:Direcciones_entrega.telefono1;%@</td>
...
<table class="full">
	<caption>Direction Warehouse of Collection (@%db:Almacenes.nombre;%@)</caption>
	<tr><td class="etiqueta" >Address:</td><td >@%db:Almacenes.direccion;%@</td></tr>
	<tr><td class="etiqueta" >City:</td><td >@%db:Almacenes.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Provinces-States:</td>
	<!-- @%db:Almacenes.id_provincia%@ @%set:id_prov=Almacenes.id_provincia;%@ -->
	...
	@%end-where:%@
	 ...
	 <td class="etiqueta" >Postal Code:</td><td >@%db:Almacenes.cp;%@</td>
	</tr>
	<tr> 
	 <td class="etiqueta" >Telephone:</td><td >@%db:Almacenes.telefono;%@</td>
...
<table class="full">
 <caption>Delivery Add.(@%db:Proveedores.prefijo_cif;%@@%db:Proveedores.cif;%@)</caption>
