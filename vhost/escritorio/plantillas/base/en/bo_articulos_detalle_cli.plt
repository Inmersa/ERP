...
<thead>
<tr>
<td colspan="2" ><a href="?_search_sort=Articulos.nombre" >Name<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td >Price</td>
<td >Recomm. Price</td>
<td >Estimated Stock</td>
...
<td ><a href="?_search_sort=Familia_articulos.nombre" >Family<img src="images/pixel.png" class="@%func:class_searchsort;Familia_articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Marcas.nombre" >Brand<img src="images/pixel.png" class="@%func:class_searchsort;Marcas.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.unidades_bulto" >Units by package<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.unidades_bulto;%@" /></a></td>
