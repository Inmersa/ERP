...
<table class="full">
<tr><td class="etiqueta" >Name:</td><td >@%db:razon_social;%@</td></tr>
@%if:!esta_vacio;capital_social;%@
<tr><td class="etiqueta" >Share capital:</td><td >@%db:capital_social;%@ 
...
<tr><td class="etiqueta" >Companies Register:</td><td >@%db:inscripcion_registro;%@</td></tr>
@%end-if:%@

<tr><td class="etiqueta" >Address:</td><td >@%db:direccion_facturacion;%@</td></tr>
<tr><td class="etiqueta" >City:</td><td >@%db:poblacion;%@</td></tr>
<tr><td class="etiqueta" >Provinces-States:</td><td >@%db:provincia;%@</td></tr>
<tr><td class="etiqueta" >Postal Code:</td><td >@%db:cp;%@</td></tr>
<tr><td class="etiqueta" >EIN:</td><td >@%db:prefijo_cif;%@
@%if:!esta_vacio;prefijo_cif;%@
-
@%end-if:%@
@%db:cif;%@</td></tr>
<tr><td class="etiqueta" >Telephone:</td><td >@%db:telefono1;%@</td></tr>
...
<tr><td class="etiqueta">Provinces-States:</td><td>@%db:provincia;%@</td></tr>
<tr><td class="etiqueta">Postal Code:</td><td>@%db:cp;%@</td></tr>
<tr><td class="etiqueta">EIN:</td><td>@%db:prefijo_cif;%@-@%db:cif;%@</td></tr>
<tr><td class="etiqueta">Telephone:</td><td>@%db:telefono1;%@</td></tr>
<tr><td class="etiqueta">Fax:</td><td>@%db:fax;%@</td></tr>
...
<table class="full">
<tr><td class="diafano">@%db:razon_social;%@ (@%db:persona_contacto%@)</td></tr>
