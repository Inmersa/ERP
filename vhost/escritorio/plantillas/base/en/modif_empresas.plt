...
<input type=hidden name=estado value=4>
 ...
 <td class="titocho" >&gt; Company card</td>
 <td align="right" ><a href="../?seccion=bo_empresas" class="accesos">Companies List</a></td>
...
<a href="javascript:document.forms['modif_empresas'].submit();" class="accesos">Modify</a>
<a href="javascript:document.forms['modif_empresas'].reset();" class="accesos">Undo changes</a> 
