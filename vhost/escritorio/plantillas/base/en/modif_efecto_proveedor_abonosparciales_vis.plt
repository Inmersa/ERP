...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 <tr> 
 <td height="22" align="left" bgcolor="#CCD2D7" class="titocho">>Partial Settlement</td>
<td width="1" bgcolor="#CCD2D7"></td>
 ...
 <tr> 
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="100">Settlement date</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="100">Payment way</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="80">Total amount</td> <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="80">Bank</td> <td bgcolor="#DBE0E3" width="1"></td>
