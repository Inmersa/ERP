...
<td ><a href="?_search_sort=Articulos.codigo_barras" >Bar code<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.codigo_barras;%@" /></a> </td>
<td ><a href="?_search_sort=Empresas_articulos.referencia" 
	>Reference<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.referencia;%@" /></a></td>
<td ><a href="?_search_sort=Articulos.nombre" >Article name<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a> </td>
...
<td ><a href="?_search_sort=caducidad" >Minor use-by date<img src="images/pixel.png" class="@%func:class_searchsort;caducidad;%@" /></a></td>
<td ><a href="?_search_sort=caducidad_mayor" >Greater Use-by date<img src="images/pixel.png" class="@%func:class_searchsort;caducidad_mayor;%@" /></a></td>
<td ><a href="?_search_sort=valor" >Value<img src="images/pixel.png" class="@%func:class_searchsort;valor;%@" /></a></td>
</tr></thead>
...
@%if:esta_vacio;st[id_alml];%@
	...
	@%if:cambia_var_x;%@
	<thead class="secundario" ><tr><td colspan="5">Warehouse Zone: @%db:Almacenes_logicos.nombre;%@</td>
