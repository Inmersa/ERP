...
@%if:AllowedLink;seleccionar_servicio;%@
	...
	<li><a href="?seccion=seleccionar_servicio" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Add</span></a></li> 
	@%end-if:%@
@%end-if:%@
@%if:AllowedAction;Empresas_servicios;del;%@
<li><a href="#" onClick="return onHRefClick('modif_articulos','accion_ejecutar','Borrar_servicios');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Delete</span></a></li>
...
checked="checked"
@%end-if:%@
 /></td><td class="etiqueta" style="text-align:left;">Prices for a period of</td>
