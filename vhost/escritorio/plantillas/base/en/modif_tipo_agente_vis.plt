...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" width="208" class="etiqueta" align="right" height="22">Name:</td>
...
<input type="hidden" name="registro[nombre]" value="@%db:Tipo_agente.nombre;%@" class="insertext" size="40">
 ...
 <tr> <td bgcolor="#EBECED" width="208" class="etiqueta" align="right" height="22">Description:</td>
