...
<div class="tituloseccion">&gt; Modify Day Work</div>
...
@%if:AllowedPII;Citas;%@
><div name="Citas" class="activo" >Day Work List</div
@%end-if:%@
@%if:AllowedPII;Gastos;%@
><div name="Gastos" >Expenses</div
@%end-if:%@
@%if:AllowedPII;Totales;%@
><div name="Efectos" >Paid Bank Drafts</div
@%end-if:%@
></div>
...
@%if:esta_vacio;estado_cerrado;%@
	...
	<li><a href="#" onClick="return sendForm('modif_recorridos');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Modify</span></a></li>
	@%if:!esta_vacio;estado_noiniciado;%@
	<li><a href="#" onClick="return sendForm('modif_recorridos','accion_ejecutar','Iniciar');" class="iniciar" 
		><img src="images/pixel.png" class="icono" /><span>Start route</span></a></li>
	@%else:%@
