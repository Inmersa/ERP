...
<input type="hidden" name="accion_ejecutar" value="Modificar" />
 <div class="barraoscura"><div class="titsuperior">&gt; Modify Stock Down</div></div>
...
@%end-if:%@
<tr><td class="etiqueta"> Location : 
</td><td >
Floor: @%db:Bajas_localizacion.planta;%@
Corridor: @%db:Bajas_localizacion.pasillo;%@
Row: @%db:Bajas_localizacion.fila;%@
Column: @%db:Bajas_localizacion.columna;%@
</td></tr>

<tr><td class="etiqueta"> Product (Lot / Use by date) : </td>
<td >@%db:Bajas_localizacion.lote;%@ @%db:colocar_fecha{Bajas_localizacion.fecha_caducidad};%@</td></tr>

<tr><td class="etiqueta"> Amount : </td>
<td >@%db:Bajas_localizacion.cantidad;%@</td></tr>

<tr><td class="etiqueta">Type of stock down:</td>
<td>
...
<tr><td class="etiqueta" > Stock Down Reasons : </td>
...
<li><a href="#" onClick="return sendForm('bajas_localizacion');"  class="guardar" ><img src="images/pixel.png" class="icono" /><span>Save</span></a></li>
<li><a href="#" onClick="return sendForm('bajas_localizacion');"  class="deshacer" ><img src="images/pixel.png" class="icono" /><span>Undo changes</span></a></li>
