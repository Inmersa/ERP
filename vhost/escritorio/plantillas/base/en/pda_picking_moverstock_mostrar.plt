...
@%where:tabla|Localizacion_articulos;where|1 AND $where_localizacion;contador|i;order|Marcas.nombre desc;%@
<tr ><td>
	...
	<div name="CodigoBarras" class="oculto" ><input type="hidden" name="codigoBarras[@%db:i;%@]" value="@%db:Articulos.codigo_barras;%@" 
	class="codigobarras" /><input type="text" name="comprobacionBarras[@%db:i;%@]" value="" class="codigobarras"
	/>@%db:Articulos.codigo_barras;%@</div>
	...
	* @%db:Localizacion_articulos.lote;%@ 
	...
	<div name="Cantidades" id="DivLocation_cnt_@%db:i;%@" 
		...
		/>{{label_cantidad}}: @%db:Localizacion_articulos.cantidad;%@</div>
