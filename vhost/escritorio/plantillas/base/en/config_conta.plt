...
<legend>Link with i-Accounting</legend>
<table class="full"><tbody>
<tr><td class="etiqueta">Accounting Period</td>
...
@%if:!esta_vacio;_aAppConf[iconta_ejercicio];%@
	<td class="etiqueta">Company Name in Accounting</td>
	<td>
	...
	<tr><td class="etiqueta">Journal</td>
	<td>
