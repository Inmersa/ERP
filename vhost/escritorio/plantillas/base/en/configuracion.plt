...
<div class="tituloseccion">General Configuration</div>

<form name="configuracion" method="post" action="#">
<input type="hidden" name="accion_ejecutar" value="Modificar" />

<div class="PIIContainer" id="CfgTab_General" 
><div name="Impresion" class="activo" >Print</div
><div name="Facturas" >Invoices</div
><div name="Email" >Mail</div
><div name="General" >General Configuration</div
></div>
...
<li><a href="#" onClick="return sendForm('configuracion');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Save</span></a></li>
</ul></div>
