...
<div class="tituloseccion" >Annotation Types</div>
...
<li><a href="?seccion=nuevo_tipo_anotacion" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>New</span></a></li>
@%end-if:%@
