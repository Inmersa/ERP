...
<tr> <td colspan="7" bgcolor="#CCD2D7" height="22" class="etiqueta" align="right">
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="80" align="center">Length</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="110">Invoice period</td>
...
<!--@%db:Servicios.id_servicio%@-->
 ...
 <td class="texto" align="center">@%db:Servicios.duracion;%@ Days</td>
 <td class="texto" bgcolor="#DBE0E3"></td>
 <td class="texto" align="center">@%db:Servicios.plazo_factura;%@ Days</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 </tr>
