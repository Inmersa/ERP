...
@%if:!emitida;%@
	@%where:nodb|nodb_reciever_data;nombre|receptor;%@
		...
		<li><a href="#" onClick="return sendForm('factura','accion_ejecutar','CargarCuenta');"  class="cargarpendiente" 
			><img src="images/pixel.png" class="icono" /><span>Charge from Account</span></a></li>
		</ul></div>
	@%end-where:%@
...
<td class="etiqueta" >Amount</td><td colspan="3" >@%db:monto_cuenta;%@</td>
@%end-where:%@
...
<td class="etiqueta" >Installment Method</td>
...
<td class="etiquetacheck" >Detract From Effects and add against the account</td>
...
<td class="etiquetacheck" >Detract From Effects and add to Refunds</td>
...
<td class="etiquetacheck" >Installment in Refunds</td>
...
<td class="etiquetacheck" >Installment in Account</td>
...
@%where:tabla|Pedidos_facturas;where|Pedidos_facturas.id_factura = $idfra;group|Pedidos.id_pedido;%@
   @%if:primera_vez;%@
	<table class="full" >
	<caption class="titulotb" >Orders:<caption><tbody>
   @%else:%@
	</tr><tr>
   @%end-if:%@ 
...
@%if:esta_vacio;factura_abono;%@
	@%where:nombre|Fras;where|Facturas_abonos.id_factura = $idfra;nolink|1;contador|cnt;%@
		...
		@%if:equals;cnt;1;%@
		<table class="full" >
		<caption class="titulotb" >Related Installment Invoices</caption><tbody>
		@%end-if:%@
...
@%if:!esta_vacio;factura_abono;%@
	<table class="full" >
	<caption class="titulotb" >Invoices that Pay</caption><tbody>
...
@%if:equals;cnt;1;%@
<table class="full" ><caption class="titulotb" >Effects</caption>
<thead ><tr><td>Due date</td><td>Total</td><td>Total Payment</td></tr>
<tbody>
...
@%if:equals;cnt;1;%@
<table class="full" >
<caption class="titulotb" >Effects that Pay</caption><tbody>
@%set:cabecera_puesta=1;%@
@%end-if:%@
