 ...
 <tr bgcolor="#EBECED"> 
 <td width="124" height="22" class="titul1" align="right">Invoice prefix:</td>
 ...
 <td class="titul1" width="124" align="right">Invoice suffix:</td>
 ...
 <tr bgcolor="#EBECED"> 
 <td width="124" height="22" class="titul1" align="right">Order prefix:</td>
 ...
 <td class="titul1" width="124" align="right">Order suffix:</td>
 ...
 <td width="148" class="titul1" bgcolor="#EBECED" align="right">Order meter:</td>
 ...
 <tr bgcolor="#EBECED"> 
 <td width="124" height="22" class="titul1" align="right">Prefix Delivery note:</td>
 ...
 <td class="titul1" width="124" align="right">Delivery note suffix:</td>
 ...
 <td width="148" class="titul1" bgcolor="#EBECED" align="right">Delivery notes meter:</td>
 ...
 <tr bgcolor="#EBECED"> 
 <td width="124" height="22" class="titul1" align="right">Budget prefix:</td>
 ...
 <td class="titul1" width="124" align="right">Budget suffix:</td>
 ...
 <td width="148" class="titul1" bgcolor="#EBECED" align="right">Budget meter:</td>
 ...
 <tr bgcolor="#CCD2D7"> <td height="22" colspan="2" class="titul1">Additional data</td>
 </tr>
 ...
 <tr bgcolor="#EBECED"> <td height="22" class="titul1">Negative Stock:</td>
