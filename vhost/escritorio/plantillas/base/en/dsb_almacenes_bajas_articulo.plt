...
<legend>Stock Down by Article</legend>
...
@%set:dsb_resultados=top_articulos;%@ @%set:dsb_rs_limit=7;%@ @%set:dsb_grfx_field=bajas_stock;%@
...
@%func:dsb_grfx_horizontal;top_articulos;bajas_stock;%@
