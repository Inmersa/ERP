...
@%if:es_presupuesto%@
 ...
 <td width="46" align="center" ><a href="?seccion=hacer_ticket" class="accesos">Return</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#CCD2D7" class="etiqueta">Standard order <input type="checkbox" name="pedido_tipo" value="1">
 </td>
 </tr>
 <tr>
 <td height="10"></td>
 ...
 @%where:nodb|nodb_reciever_data;%@ <tr> <td height="22" align="right" bgcolor="#EBECED" class="etiqueta">Name:</td>
...
@%end-where:%@
 ...
 <tr> <td width="6"></td>
 <td width="419"></td>
 <td align="center" width="100"><a href="?seccion=hacer_pedido" class="accesos">Add article </a></td>
 </tr>
 </table>
 </td>
 </tr>
...
@%end-if:%@
 ...
 <a href="" onclick="document.forms['hacer_ticket'].submit();return false;" class="accesos">Confirm</a></td>
 </tr>
