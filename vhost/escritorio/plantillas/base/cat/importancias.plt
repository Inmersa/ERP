...
<div class="tituloseccion" >Import�ncia</div>
...
<li><a href="?seccion=nueva_importancia" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nou</span></a></li>
@%end-if:%@
...
<tr>
<td></td>
<td ><a href="?_search_sort=Importancias.nombre">Nom<img src="images/pixel.png" class="@%func:class_searchsort;Importancias.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Importancias.descripcion">Descripci�<img src="images/pixel.png" class="@%func:class_searchsort;Importancias.descripcion;%@" /></a></td>
<td ><a href="?_search_sort=Importancias.nivel">Nivell<img src="images/pixel.png" class="@%func:class_searchsort;Importancias.nivel;%@" /></a></td>
</tr>
</thead>
