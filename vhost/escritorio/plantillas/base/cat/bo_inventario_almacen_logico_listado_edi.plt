...
<li><a href="?seccion=bo_importar_articulos_seleccion" class="nuevalocalizacion" ><img src="images/pixel.png" class="icono" /><span>Alta de localitzaci�</span></a></li>
@%end-if:%@
</ul></div>
...
<td ><a href="?_search_sort=Articulos.codigo_barras">Codi de barres<img src="images/pixel.png" 
...
<td ><a href="?_search_sort=Localizacion_articulos.fecha_caducidad">Data de caducitat<img src="images/pixel.png" 
...
<td ><a href="?_search_sort=Localizacion_articulos.cantidad">Quantitat<img src="images/pixel.png" 
...
<td ><a href="?_search_sort=Localizacion_articulos.pasillo">Corredor<img src="images/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.pasillo;%@" /></a></td>
<td ><a href="?_search_sort=Localizacion_articulos.columna">Columna<img src="images/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.columna;%@" /></a></td>
...
@%if:cambia_var_x;%@
<thead class="secundario" ><tr><td colspan="12">Zona Magatzem: @%db:Almacenes_logicos.nombre;%@</td></tr></thead>
@%end-if:%@
@%end-if:%@
...
<li><a href="#" onclick="return SendFormToWindow('bo_inventario_articulos','nuevo_bajas_almacen','BajaLocalizacion',400);" class="causarbaja" ><img src="images/pixel.png" class="icono" /><span>Baixes de magatzen</span></a></li>
<li><a href="#" onclick="return onHRefClick('bo_inventario_articulos','accion_ejecutar','Borrar');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar seleccionats</span></a></li>
</ul></div>
