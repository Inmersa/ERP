...
<li><a href="#" onClick="return onHRefClick('efecto','accion_ejecutar','Borrar_parciales');"  class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar seleccionats</span></a></li>
...
<thead>
<tr>
<td class="estado" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('borrar_parciales');"  /></td>
<td >Data abonament</td>
<td >Mig de pagament</td>
<td >Suma</td>
<td >Banc</td>
<td >Cita</td>
<td >Factura d'Abonament</td>
</tr>
</thead>
<tbody>
