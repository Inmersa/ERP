...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="70">Referència</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Ref. Proveïdor </td>
 <td width="1"></td>
 <td width="20" bgcolor="#DBE0E3"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Nom d´article </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center"></td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Preu</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="65" align="center">Desc. %</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="50">Fabricat</td>
 <td width="1"></td>
 </tr>
