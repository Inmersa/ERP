...
<div class="tituloseccion" >Estats de Servei</div>
...
<li><a href="?seccion=nuevo_estado_servicio" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nou</span></a></li>
@%end-if:%@
