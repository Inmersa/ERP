...
<div class="tituloseccion">Serveis de Client 
...
<li><a href="?seccion=bo_articulos&modo_seleccion=1&many=1&target=nuevo_servicio_cliente&recursos=NOTNULL" class="nuevo"
	><img src="images/pixel.png" class="icono" /><span>Nou</span></a></li>
@%end-if:%@
...
@%if:AllowedAction;Clientes_recursos;del;%@
 <td >&nbsp;</td>
@%end-if:%@
 <td ><a href="?_search_sort=Recursos.nombre" >Recurs<img src="images/pixel.png" class="@%func:class_searchsort;Recursos.nombre;%@" /></a></td>
 ...
 <td ><a href="?_search_sort=Clientes_recursos.fecha_inicio" >Data d�inici<img src="images/pixel.png" 
 	class="@%func:class_searchsort;Clientes_recursos.fecha_inicio;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes_recursos.fecha_fin" >Data Finalitzaci�<img src="images/pixel.png" 
 	class="@%func:class_searchsort;Clientes_recursos.fecha_fin;%@" /></a></td>
 <td ><a href="?_search_sort=Estados_servicio.nombre" >Estat de Servei<img src="images/pixel.png" class="@%func:class_searchsort;Estados_servicio.nombre;%@" /></a></td>
</tr>
</thead>
<tbody>
