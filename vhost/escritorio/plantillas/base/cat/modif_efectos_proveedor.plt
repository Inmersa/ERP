...
class="tituloseccion"
@%end-if:%@
>&gt; Modificar Efectes (ID: @%db:Proveedores.id_proveedor;%@) @%db:Proveedores.razon_social;%@</div>
...
<li><a href="#" onClick="return sendForm('efecto')"  class="guardar" ><img src="images/pixel.png" class="icono" /><span>Guardar</span></a></li> 
<li><a href="#" onClick="return resetForm('efecto');"  class="deshacer" ><img src="images/pixel.png" class="icono" /><span>Desfer canvis</span></a></li>
</ul></div>
@%end-if:%@
