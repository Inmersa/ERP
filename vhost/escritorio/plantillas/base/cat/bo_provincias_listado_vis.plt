...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="191">Nom</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="213" >Països</td>
 <td class="etiqueta" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" >Codi</td>
