...
<li><a href="#" onclick="return onHRefClick('proveedores','accion_ejecutar','asociar_proveedores');" class="enviar" 
	><img src="images/pixel.png" class="icono" /><span> Assignar</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=Proveedores.nombre" >Nom<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.nombre;%@" /></a></td>
<td >Preu</td>
<td >Pr.Rt Oficial</td>
