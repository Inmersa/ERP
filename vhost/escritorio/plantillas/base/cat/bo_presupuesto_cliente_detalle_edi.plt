...
<div class="AccionesFicha">
	...
	@%if:AllowedLink;hacer_pedido;%@
		...
		<li><a href="?seccion=hacer_pedido" class="editar" ><img src="images/pixel.png" class="icono" /><span>Modificar detall de comanda</span></a> 
		@%end-if:%@
	@%end-if:%@
	@%if:AllowedAction;Lineas_detalle_presupuesto;del;%@
	<li><a href="#" onclick="return onHRefClick('pedido','accion_ejecutar','Borrar');" class="borrar" ><img src="images/pixel.png" 
		class="icono" /><span>Esborrar(s)</span></a>
...
@%else:%@
<!-- este checkbox solo va si el pedido no esta consolidado (lo mismo pal enlace de a�adir>-->
