...
<legend>Article VOIP</legend>

<table class="full"><tr>
<td class="@%css:Empresas_articulos.fabricacion_propia;label;%@">Sempre Local</td>
...
<table class="full"><tr>
<td class="@%css:Empresas_articulos.descripcion;label;%@" >Prefixos Telefònics:</td>
...
<td class="etiqueta @%css:Empresas_articulos.precio_standard;label;%@">Tarifa Local Reduïda:</td>
...
<td class="etiqueta @%css:Empresas_articulos.precio_4;label;%@">Tarifa Externa Reduïda:</td>
...
<tr><td class="etiqueta @%css:Empresas_articulos.precio_6;label;%@">Establiment de cridada:</td>
...
<!-- td class="etiqueta @%css:Empresas_articulos.precio_5;label;%@">Preu 5:</td>
