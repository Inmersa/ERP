...
<div class="menuitem"> <a href="?seccion=bo_pedidos_compras" @%func:querystring_activa;bo_pedidos_compras;activo;;%@ >Comandes</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_compra;%@
<div class="menuitem"> <a href="?seccion=bo_albaranes_compra" @%func:querystring_activa;bo_albaranes_compra;activo;;%@ >Albaràns</a></div>
@%end-if:%@
