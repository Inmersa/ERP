...
<div class="menuitem"> <a href="?seccion=bo_inventario_almacen&_chgsm=1" @%func:querystring_activa;bo_inventario_almacen&_chgsm;activo;;%@ >Inventari</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_compra;%@
<div class="menuitem"><a href="?seccion=bo_albaranes_compra" @%func:querystring_activa;bo_albaranes_compra;activo;;%@ >Albaràns Compres</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_venta;%@
<div class="menuitem"><a href="?seccion=bo_albaranes_venta" @%func:querystring_activa;bo_albaranes_venta;activo;;%@ >Albaràns Vendes</a></div>
@%end-if:%@
@%if:AllowedLink;bo_inventario_almacen_logico;%@
<div class="menuitem"> <a href="?seccion=bo_inventario_almacen_logico" @%func:querystring_activa;bo_inventario_almacen_logico;activo;;%@ >Localització</a></div>
@%end-if:%@
