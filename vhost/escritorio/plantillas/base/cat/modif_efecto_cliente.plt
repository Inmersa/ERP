...
class="tituloseccion"
@%end-if:%@
>&gt; Modificar Efectes (ID: @%db:Clientes.id_cliente;%@) @%db:Clientes.razon_social;%@</div>
...
<li><a href="#" onClick="return sendForm('efecto');" class="deshacer" ><img src="images/pixel.png" class="icono" /><span>Desfer canvis</span></a></li>
