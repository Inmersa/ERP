...
<div class="tituloseccion">&gt; Baixes de magatzen
...
<td ><a href="?_search_sort=Almacenes_logicos.nombre" class="order" 
	>Magatzem Origen<img src="images/pixel.png" class="@%func:class_searchsort;Almacenes_logicos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Bajas_almacen.nombre" class="order" 
	>Ra� Baixes de magatzen<img src="images/pixel.png" class="@%func:class_searchsort;Bajas_almacen.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Albaranes.referencia" class="order" 
	>Albar�ns<img src="images/pixel.png" class="@%func:class_searchsort;Albaranes.referencia;%@" /></a></td>
<td ><a href="?_search_sort=Bajas_localizacion.fecha_baja" class="order" 
	>Data de baixa<img src="images/pixel.png" class="@%func:class_searchsort;Bajas_localizacion.fecha_baja;%@" /></a></td>
</tr></thead>
