...
<td class="caption">Telèfon</td>
<td class="caption">Tipus d´agent</td>
</tr>
...
@%plt:botonera%@
<div class="enviar"><a href="javascript:document.forms['bo_importar_agentes'].submit();">Importar</a></div>
