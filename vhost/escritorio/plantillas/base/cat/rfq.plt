...
<div class="tituloseccion" >Fitxa de RFQ </div>
...
<ul>
<li><a href="#" onClick="return sendForm('rfq','accion_ejecutar','Modificar');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Guardar</span></a></li>
</ul>
</div>
</form>
...
<div class="AccionesFicha" >
	...
	@%if:AllowedAction;RFQ;edit;%@
		...
		src="images/pixel.png" class="icono" /><span>Guardar</span></a></li>
	@%end-if:%@
	@%if:AllowedLink;hacer_pedido;%@
		@%if:AllowedAction;RFQ;edit;%@
		<li><a href="?seccion=hacer_pedido&returnlink=rfq" class="seleccionar" ><img src="images/pixel.png" class="icono" 
			/><span>Seleccionar Articles</span></a></li>
		@%end-if:%@
	@%end-if:%@
	@%if:AllowedAction;RFQ;edit;%@
	@%if:esta_vacio;fecha_inicio;%@
		<li><a href="#" onclick="return onHRefClick('@%get:documento_formvarname;%@','accion_ejecutar','BorrarDetalle');" class="borrar" ><img src="images/pixel.png" 
			class="icono" /><span>Esborrar(s)</span></a></li>
