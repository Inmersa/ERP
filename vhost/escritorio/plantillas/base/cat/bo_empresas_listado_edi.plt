...
<input type="hidden" name="estado" value="3">
 ...
 <td align="right" width="148"><a href="javascript:document.forms['bo_empresas'].submit();" class="accesos">Esborrar seleccionats</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3" width="200">Raó social </td>
 <td width="1"></td>
 </tr>
