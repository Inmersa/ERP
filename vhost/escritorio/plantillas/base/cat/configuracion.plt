...
<li><a href="#" onClick="return sendForm('configuracion');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Guardar</span></a></li>
</ul></div>
