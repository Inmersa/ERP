...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 <tr> 
 <td height="22" align="left" bgcolor="#CCD2D7" class="titocho">>Liquidació Parcial</td>
<td width="1" bgcolor="#CCD2D7"></td>
 ...
 <tr> 
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="100">Data liquidació</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="100">Mig de pagament</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="80">Suma</td> <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="80">Banc</td> <td bgcolor="#DBE0E3" width="1"></td>
