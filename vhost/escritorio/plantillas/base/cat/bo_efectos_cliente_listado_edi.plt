...
<li class="noicon" >Data venciment</li>
<li class="noicon" ><select name="registro[id_banco]" size="1">
<option value="0">Sense Bancs</option>
...
<li><a href="#" onClick="return onHRefClick('listado_efectos','accion_ejecutar','Devolver');"
	class="devolverabono" ><img src="images/pixel.png" class="icono" /><span>Tornar</span></a></li>
...
<!-- a href="#" onClick="return onHRefClick('listado_efectos','accion_ejecutar','Emitir');">Emetre</a -->
</div> 
...
<thead>
<tr>
<td ><a href="?_search_sort=Clientes.id_cliente" class="order" >Codi<img src="images/pixel.png" class="@%func:class_searchsort;Clientes.id_cliente;%@" /></a></td>
...
<td ><a href="?_search_sort=Clientes.razon_social" class="order" 
	>Ra� social<img src="images/pixel.png" class="@%func:class_searchsort;Clientes.razon_social;%@" /></a></td>
...
<td ><a href="?_search_sort=Facturas.base_imponible" class="order" >Base imposable<img src="images/pixel.png" class="@%func:class_searchsort;Facturas.base_imponible;%@" 
	/></a></td>
...
<td ><a href="?_search_sort=Facturas.referencia" class="order" >Ref. Factures<img src="images/pixel.png" class="@%func:class_searchsort;Facturas.referencia;%@" /></a></td>
<td class="estado" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('registro[efectos]');"  /></td>
<td ><a href="?_search_sort=Efectos.concepto" class="order" >Concepte<img src="images/pixel.png" class="@%func:class_searchsort;Efectos.concepto;%@" /></a></td>
<td ><a href="?_search_sort=Efectos.medio_pago" class="order" >Mig de pagament<img src="images/pixel.png" class="@%func:class_searchsort;Efectos.medio_pago;%@" /></a></td>
<td ><a href="?_search_sort=Efectos.fecha_vencimiento" class="order" 
	>Venciment<img src="images/pixel.png" class="@%func:class_searchsort;Efectos.fecha_vencimiento;%@" /></a></td>
<td ><a href="?_search_sort=Efectos.monto" class="order" >Totals<img src="images/pixel.png" class="@%func:class_searchsort;Efectos.monto;%@" /></a></td>
<td ><a href="?_search_sort=Efectos.monto_pagado" class="order" 
	>Total pagat<img src="images/pixel.png" class="@%func:class_searchsort;Efectos.monto_pagado;%@" /></a> </td>
<td >R</td>
</tr></thead>
<tbody>
 @%else:%@
...
<table class="full">
<caption class="titulotb" >Llegenda</caption>
<tr>
