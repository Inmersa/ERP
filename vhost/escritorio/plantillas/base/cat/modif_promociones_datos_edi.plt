...
<li><a href="?seccion=nuevo_promociones" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Afegir</span></a></li>
</ul></div> 
@%end-if:%@
...
<li><a href="?seccion=bo_articulos_promocion&id_promocion=@%db:Promociones.id_promocion%@" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Afegir article</span></a></li>
<li><a href="#" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Borrar_articulos');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar seleccionats</span></a></li>
</ul></div>
...
<li><a href="#" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Modificar');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Modificar</span></a></li>
<li><a href="#" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Borrar');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar</span></a></li>
</ul></div>
