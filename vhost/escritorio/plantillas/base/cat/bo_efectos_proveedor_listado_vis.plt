...
@%if:nuevo_proveedor%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Raó social</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="110">Codi</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Risc</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="55">Demora</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="100" align="center">Quantia</td>
...
@%else:%@
 ...
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Ref. Factures </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Concepte</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Mig de pagament</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Venciment</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Totals</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Total pagat </td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center" width="22">R</td>
 <td width="1"></td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="22"> </td>
 <td bgcolor="#DBE0E3" width="1"></td>
