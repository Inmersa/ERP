...
<div class="barraoscura"><a href="" onClick="return onHRefClick('descuentos_familia','accion_ejecutar','Borrar');" class="accesos">Esborrar seleccionats</a>
</div>
<table class="full">
...
<div class="enviar"><a href="" onClick="return onHRefClick('descuentos_familia','accion_ejecutar','Modificar');" class="accesos">Modificar</a>
</div>
</form>
