...
><img src="images/pixel.png" class="icono" /><span>Revisar Seleccions</span></a></li>
@%end-if:%@
...
><img src="images/pixel.png" class="icono" /><span>Aprovar Seleccions</span></a></li>

<li><a href="#Rechazar Seleccionados" onclick="return onHRefClick('listado','accion_ejecutar','Rechazar');" class="rechazar"
><img src="images/pixel.png" class="icono" /><span>Rebutjar Seleccions</span></a></li>
@%end-if:%@
...
class="imprimirmultiple"><img src="images/pixel.png" class="icono" /><span>Impresi� M�ltiple</span></a></li>
...
<td ><a href="?_search_sort=Presupuestos.fecha" >Data<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Presupuestos.base_imponible" >Base imposable<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.base_imponible;%@" /></a></td>
<td ><a href="?_search_sort=Presupuestos.impuestos" >Imposts<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.impuestos;%@" /></a></td>
<td ><a href="?_search_sort=Presupuestos.importe" >Totals<img src="images/pixel.png" class="@%func:class_searchsort;Presupuestos.importe;%@" /></a></td>
<td >Estat</td>
</tr>
</thead>
