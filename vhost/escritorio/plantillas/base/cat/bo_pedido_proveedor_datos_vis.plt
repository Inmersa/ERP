...
<tr> <td colspan="7" bgcolor="#CCD2D7" height="1"></td>
 ...
 <td bgcolor="#EBECED" class="texto" align="right" width="274">Incomplet:</td>
 <td colspan="3" align="center">
@%if:pedido_incompleto%@
 <a href="?seccion=bo_pedido_cliente&id_pedido=@%db:id_pedido_incompleto;%@" class="accesos" align="center"> Veure </a>
@%else:%@
@%end-if:%@
 </td>
 </tr>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="71" height="22">Referència:</td>
 <td colspan="2" class="texto"> @%db:referencia;%@
 </td>
 <td bgcolor="#EBECED" class="texto" align="right" width="274">Realitzar per:</td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22" width="71">Data:</td>
 <td width="75"> <input type="text" name="pedido[fecha]" class="insertextnumeros" size="13" value="@%db:colocar_fecha{fecha};%@" maxlength="10">
 </td>
 <td bgcolor="#EBECED" align="right" class="texto" width="69">Forma de paga:</td>
 <td colspan="2">
