...
<input type="hidden" name="registro[nombre]" value="@%db:Familia_articulos.nombre;%@" class="insertext" size="55">
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Matèria prima:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Grup famílies:</td>
