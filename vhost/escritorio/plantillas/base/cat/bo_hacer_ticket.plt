 ...
 <td class="titocho" >&gt; Selecció Articles Ticket</td>
 <td align="right" > <a href="#" onclick="return abrir_ventana('?seccion=hacer_ticket_codbarras',400,200);" class="accesos">Codi de barres</a>
 </td>
