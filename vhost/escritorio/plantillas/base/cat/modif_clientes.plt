...
<div class="tituloseccion">&gt; Fitxa Client &nbsp;&nbsp; (ID: @%db:Clientes.id_cliente;%@) @%db:Clientes.razon_social;%@</div>
...
<li><a href="?seccion=bo_importar_clientes" class="importarusuario"><img src="images/pixel.png" class="icono" /><span>Importar client</span></a></li>
@%end-if:%@
</ul></div>
...
><div name="Personas_Contacto" >Contacte</div
@%end-if:%@
@%if:AllowedPII;Acceso_Sistema;%@
><div name="Acceso_Sistema" >Accessos</div
@%end-if:%@
@%if:AllowedPII;Direccion_Entrega;%@
><div name="Direccion_Entrega" >Adreces</div
@%end-if:%@
@%if:AllowedPII;Cliente_Agente;%@
><div name="Cliente_Agente" >Agents</div
@%end-if:%@
@%if:AllowedPII;Cliente_Empresa;%@
><div name="Cliente_Empresa" class="activo" >Condicions</div
@%end-if:%@
></div>
