...
Excloure Baixes <input type="checkbox" name="excluir_bajas" value="1" @%func:check_flag;st[excluir_bajas];%@ />
Marca / Familia<input type="text" name="marca" size="20" value="@%get:st[marca];%@" />
