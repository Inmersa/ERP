...
@%where:tabla|Factura;nombre|busc;no_results|1;%@
	...
	<table class="full">
	<tr> 
	<td class="titulotb">Prove�dor:</td>
	...
	<td ><a href="?_search_sort=Facturas.total_impuestos" class="order" 
		>Totals Imposts<img src="images/pixel.png" class="@%func:class_searchsort;Facturas.total_impuestos;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.retenido" class="order" >Retingut<img src="images/pixel.png" class="@%func:class_searchsort;Facturas.retenido;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.total_bruto" class="order" 
		>Totals<img src="images/pixel.png" class="@%func:class_searchsort;Facturas.total_bruto;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.monto_total" class="order" 
		>Import Total<img src="images/pixel.png" class="@%func:class_searchsort;Facturas.monto_total;%@" /></a></td>
  	@%if:esta_vacio;st[ef_search];%@
	@%else:%@
	<td ><a href="?_search_sort=Efectos.monto" class="order" >Import d'efectes<img src="images/pixel.png" class="@%func:class_searchsort;Efectos.monto;%@" /></a></td>
	...
	<td ><a href="?_search_sort=numero_incidencias" class="order" 
		>N� Incid�ncies<img src="images/pixel.png" class="@%func:class_searchsort;numero_incidencias;%@" /></a></td>
	@%end-if:%@
	</tr>
	</thead>
	<tbody class="informe" >
