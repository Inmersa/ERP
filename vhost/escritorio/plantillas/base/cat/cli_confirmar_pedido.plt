<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td align="center" ></td>
 <td align="center" ></td>
 <td width="46" align="center" ><a href="?seccion=cli_hacer_pedido" class="accesos">Tornar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
-->
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="112" height="22">Nom Comanda:</td>

 <td class="texto" width="190"> <input type="text" name="registro[nombre]" class="insertext" size="25">
 </td>
 <td bgcolor="#EBECED" class="texto" width="95" align="right">Direcció entrega::</td>
 <td width="220">
...
<!--<a href="?seccion=hacer_pedido" class="accesos">Afegir article </a>-->
 </td>
 </tr>
 </table>
 </td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="120">Recàrrec equiv. / %</td>
 <td width="1" height="20" bgcolor="#DBE0E3"></td>
 </tr>
