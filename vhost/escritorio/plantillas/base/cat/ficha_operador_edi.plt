...
<div class="tituloseccion">&gt; Fitxa d'Operador (@%db:Operadores.nombre;%@ @%db:Operadores.apellidos;%@)</div>
...
<ul>
 <li><a href="#" onClick="return sendForm('ficha');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Guardar</span></a></li>
<li><a href="#" onClick="return resetForm('ficha');" class="deshacer" ><img src="images/pixel.png" class="icono" /><span>Desfer canvis</span></a></li>
</ul>
</div>
