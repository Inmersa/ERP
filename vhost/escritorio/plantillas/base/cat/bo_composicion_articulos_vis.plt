...
<input type="hidden" name="accion_ejecutar" value="0">
 ...
 <tr> <td width="6"></td>
 <td class="etiqueta" width="200">Composició</td>
 <td align="center"> <!--a href="?seccion=bo_composicion_articulos" class="accesos">Afegir article</a-->
 </td>
 <td align="center">
...
<td class="etiqueta" align="center" width="1"></td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" colspan="7">Quantitat</td>
