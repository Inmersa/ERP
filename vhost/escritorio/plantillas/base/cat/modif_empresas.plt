...
<input type=hidden name=estado value=4>
 ...
 <td class="titocho" >&gt; Fitxa d´empresa</td>
 <td align="right" ><a href="../?seccion=bo_empresas" class="accesos">Llistat d´empreses</a></td>
...
<a href="javascript:document.forms['modif_empresas'].reset();" class="accesos">Desfer canvis</a> 
