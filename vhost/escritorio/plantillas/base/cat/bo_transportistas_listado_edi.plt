...
<li><a href="?seccion=nuevo_transportistas"  class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nou</span></a></li>
@%end-if:%@
<li><a href="return sendForm('modif_transportistas');"  class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar seleccionats</span></a></li>
</ul></div>
...
<td class="caption"><a href="?_search_sort=Transportistas.nombre" class="order" 
	>Nom<img src="images/pixel.png" class="@%func:class_searchsort;Transportistas.nombre;%@" /></a></td>
<td class="caption"><a href="?_search_sort=Transportistas.razon_social" class="order" 
	>Ra� social<img src="images/pixel.png" class="@%func:class_searchsort;Transportistas.razon_social;%@" /></a></td>
<td class="caption"><a href="?_search_sort=Transportistas.telefono" class="order" 
	>Tel�fon<img src="images/pixel.png" class="@%func:class_searchsort;Transportistas.telefono;%@" /></a></td>
<td class="caption"><a href="?_search_sort=Transportistas.email" class="order" 
	>e-mail<img src="images/pixel.png" class="@%func:class_searchsort;Transportistas.email;%@" /></a></td>
</tr></thead>
