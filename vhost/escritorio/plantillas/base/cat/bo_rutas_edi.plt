...
<li class="noicon" >Des de: <input type="text" name="generar_desde" value="dd/mm/aaaa" size="12" maxlength="10" /> </li>
<li class="noicon" >Fins: <input type="text" name="generar_hasta" value="dd/mm/aaaa" size="12" maxlength="10" /></li>
<li><a href="#" onClick="return onHRefClick('bo_rutas','accion_ejecutar', 'Generar');" class="generar" 
	><img src="images/pixel.png" class="icono" /><span>Generar</span></a></li>
<li><a href="?seccion=nuevo_rutas" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Afegir</span></a></li>
...
<td ><a href="?_search_sort=Rutas.nombre" class="order" >Ruta<img src="images/pixel.png" class="@%func:class_searchsort;Rutas.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Grupo_rutas.nombre" class="order" >Grup<img src="images/pixel.png" class="@%func:class_searchsort;Grupo_rutas.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Rutas.descripcion" class="order" >Desc.<img src="images/pixel.png" class="@%func:class_searchsort;Rutas.descripcion;%@" /></a></td>
<td ><a href="?_search_sort=Rutas.d_frecuencia" class="order" >Freq��ncia / dies<img src="images/pixel.png" class="@%func:class_searchsort;Rutas.d_frecuencia;%@" /></a></td>
