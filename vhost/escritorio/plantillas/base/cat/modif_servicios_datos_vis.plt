...
<tr> <td colspan="3" height="22" bgcolor="#CCD2D7"></td>
 ...
 <tr> <td bgcolor="#EBECED" width="185" class="etiqueta" align="right" height="22">Duració:</td>
 ...
 Dies <input type="radio" name="registro1" value="d" checked>
 Mesos <input type="radio" name="registro1" value="m" >
 any <input type="radio" name="registro1" value="a" >
 </td>
 </tr>
 <tr> <td bgcolor="#CCD2D7" height="1" width="185"></td>
 <td bgcolor="#CCD2D7" height="1" width="458"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" width="185" align="right" class="etiqueta" height="22">Plaç de factura:</td>
 ...
 Dies <input type="radio" name="registro2" value="d" checked>
 Mesos <input type="radio" name="registro2" value="m" >
 any <input type="radio" name="registro2" value="a" >
 </td>
 </tr>
