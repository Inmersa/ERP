...
<input type="hidden" name="accion_ejecutar" value="Importar">
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Columna</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center">Quantitat</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="22" align="center" class="etiqueta" width="100">Data de caducitat </td>
