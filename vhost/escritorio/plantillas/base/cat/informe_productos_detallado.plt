...
@%where:tabla|Articulos;nombre|busc;no_results|1;%@
	...
	<table class="full">
	<tr> 
	<td class="titulotb" align="right">Fam�lia:</td>
	...
	<td ><a href="?_search_sort=cantidad_pedida">Demanada<img src="images/pixel.png" class="@%func:class_searchsort;cantidad_pedida;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_recibida">Rebuda<img src="images/pixel.png" class="@%func:class_searchsort;cantidad_recibida;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_facturada">Facturada<img src="images/pixel.png" class="@%func:class_searchsort;cantidad_facturada;%@" /></a></td>
	<td ><a href="?_search_sort=precio_medio">Preu mig<img src="images/pixel.png" class="@%func:class_searchsort;precio_medio;%@" /></a></td>
	<td ><a href="?_search_sort=precio_maximo">Preu M�xim<img src="images/pixel.png" class="@%func:class_searchsort;precio_maximo;%@" /></a></td>
	<td ><a href="?_search_sort=precio_minimo">Preu M�nim<img src="images/pixel.png" class="@%func:class_searchsort;precio_minimo;%@" /></a></td>
	</tr>
	</thead>
	<tbody class="informe" >
	@%else:%@
