...
@%plt:botonera%@
 ...
 <tr> <td align="left">
<a href="" class="accesos">Afegir</a>
</td>
<td width="20" align="center"></td>
 <td align="center">
<a href="#" onClick="return onHrefClick('bo_rutas','accion_ejecutar', 'Generar');" class="accesos">Generar Recorreguts</a>
</td>
<td ></td>
 <td width="146" align="right">
<a href="#" onClick="return onHrefClick('bo_rutas','accion_ejecutar', 'Borrar');" class="accesos">Esborrar seleccionats</a>
</td>
 <td width="4"></td>
 </tr>
 </table>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Freqüència / dies</td>
 <td width="1"></td>

 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Última Data </td>
 <td width="1"></td>

 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Nº Clients</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="257" align="center">Agent </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="176">Pròxima data</td>
 <td width="1"></td>
 </tr>
