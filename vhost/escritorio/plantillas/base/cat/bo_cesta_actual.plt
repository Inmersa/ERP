...
<div class="barraoscurai">Selecci� Actuel : &nbsp;&nbsp;
...
<ul>
<li><a href="#" onclick="return sendForm('cesta');" class="finalizar" ><img src="images/pixel.png" class="icono" /><span>Finalitzar</span></a></li>
<li><a href="?@%env:QUERY_STRING%@&vaciar_pedido=1" class="vaciar" ><img src="images/pixel.png" class="icono" /><span>Buidar Comanda</span></a></li>
</ul>
</div>
...
<ul>
<li class="noicon" >Ref. Clients Des de:</li>
<li class="noicon" ><input type="text" size="14" maxlength="14" name="repo[fecha]" value="dd/mm/aaaa" /></li>
<li><a href="#" onClick="return sendForm('habituales');" class="enviar"><img src="images/pixel.png" class="icono" />Confirmar</a></li>
</ul>
</div>
</form>
@%end-if:%@
