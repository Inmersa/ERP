...
><img src="images/pixel.png" class="icono" /><span>Reconstruir Enlla�os</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=Anyos.numero" class="order" >N�mero<img src="images/pixel.png" class="@%func:class_searchsort;Anyos.numero;%@" /></a></td>
<td ><a href="?_search_sort=nombre" class="order" >Nom<img src="images/pixel.png" class="@%func:class_searchsort;nombre;%@" /></a></td>
<td ><a href="?_search_sort=Anyos.f_ini" class="order" >Data d�inici<img src="images/pixel.png" class="@%func:class_searchsort;Anyos.f_ini;%@" /></a></td>
<td ><a href="?_search_sort=Anyos.f_fin" class="order" >Data final<img src="images/pixel.png" class="@%func:class_searchsort;Anyos.f_fin;%@" /></a></td>
<td ><a href="?_search_sort=Anyos.n_trimestres" class="order" >Nombre de Trimestres<img src="images/pixel.png" class="@%func:class_searchsort;Anyos.n_trimestres;%@" /></a></td>
</tr></thead>
...
<option value="0" selected="selected">Cap selecci�</option>
@%end-if:%@
<option value="1"
