...
<input type="hidden" name="registro[nombre]" value="@%db:Empresas.nombre;%@" class="insertext">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Grup al que pertanya:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="titul1" height="22">Raó social:</td>
...
<input type="hidden" name="registro[razon_social]" value="@%db:Empresas.razon_social;%@" class="insertext">
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="titul1" height="22">Adreça de facturació:</td>
...
<input type="hidden" name="registro[telefono1]" value="@%db:Empresas.telefono1;%@" class="insertextnumeros" size="14">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Població:</td>
...
<input type="hidden" name="registro[fax]" value="@%db:Empresas.fax;%@" class="insertextnumeros" size="14">
 ...
 <tr> <td width="161" height="22" align="right" class="titul1" bgcolor="#EBECED">Província:</td>
 <td width="228"> 
