...
<td class="caption">Nº Efectes</td>
<td class="caption">Dies entre Efectes</td>
</tr>
...
@%plt:botonera%@
<div class="enviar"><a href="javascript:document.forms['modif_forma_pago'].submit();">Esborrar seleccionats</a></div>
