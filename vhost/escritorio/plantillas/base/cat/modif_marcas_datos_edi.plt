...
@%end-where:%@ 
 ...
 <td class="etiqueta" >Excl�s de Venda</td>
 ...
 <li><a href="#" onClick="return sendForm('modif_marcas');"  class="guardar" ><img src="images/pixel.png" class="icono" /><span>Guardar</span></a></li> 
 <li><a href="#" onClick="return resetForm('modif_marcas');"  class="deshacer" ><img src="images/pixel.png" class="icono" /><span>Desfer canvis</span></a></li>
