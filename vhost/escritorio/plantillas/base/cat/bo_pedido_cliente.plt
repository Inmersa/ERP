...
<div class="tituloseccion">&gt; Comanda :@%db:nombre;%@</div>
...
<li><a href="#" onclick="return imprimir_directo('?@%get:_krn_ss_querystring%@&imprimir=1&ticket=1');" class="imprimirticket" 
 	><img src="images/pixel.png" class="icono" /><span>Imprimir Ticket</span></a></li>
</ul></div> 
</form>
...
<li><a href="?seccion=bo_facturas_pedido_venta&id_pedido=@%db:id_pedido;%@" class="verfras" ><img src="images/pixel.png" class="icono" /><span>Veure</span></a></li>
@%else:%@
