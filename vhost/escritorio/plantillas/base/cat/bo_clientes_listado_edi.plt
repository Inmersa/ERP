...
<ul>
 @%if:!oModoSeleccion->isActive;%@
	...
	<li><a href="?seccion=nuevo_clientes" class="nuevo"><img src="images/pixel.png" class="icono" /><span>Nou client</span></a></li>
	@%end-if:%@
	@%if:AllowedLink;bo_importar_clientes;%@
	<li><a href="?seccion=bo_importar_clientes" class="altausuario"><img src="images/pixel.png" class="icono" /><span>Importar client</span></a></li>
	@%end-if:%@
	@%if:AllowedAction;Clientes_empresas;del;%@
	<li><a href="#" onclick="return sendForm('bo_clientes');" class="bajausuario" ><img src="images/pixel.png" class="icono" /><span>Donar de baixa</span></a></li>
...
<tr>
 ...
 <td ><a href="?_search_sort=Clientes_empresas.persona_contacto">Contacte<img src="images/pixel.png" class="@%func:class_searchsort;Clientes_empresas.persona_contacto;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes.cif">CIF<img src="images/pixel.png" class="@%func:class_searchsort;Clientes.cif;%@" /></a></td>
 <td ><a href="?_search_sort=Tipo_cliente.nombre">Tipus client<img src="images/pixel.png" class="@%func:class_searchsort;Tipo_cliente.nombre;%@" /></a></td>
 </tr>
</thead>
<tbody>
@%end-if:%@
