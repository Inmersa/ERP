<table class="full">
 ...
 <tr> <td width="6" ></td>
 <td class="titocho" >&gt; Nova Localització Article</td>
 ...
 <tr> <td colspan="13" class="etiqueta" bgcolor="#CCD2D7">Ordre Fabricació pròpia: <select name="registro[lote]" >
@%where:tabla|Ordenes_fabricacion;nolink|1;%@
 ...
 <td ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Columna</td>
 <td ></td>
 <td class="etiqueta" bgcolor="#DBE0E3" >Quantitat</td>
