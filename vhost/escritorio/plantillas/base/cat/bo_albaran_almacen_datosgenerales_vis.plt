...
-->
 <tr> <td bgcolor="#CCD2D7" height="22" align="right" class="etiqueta" width="80">Proveïdor</td>
 <td bgcolor="#CCD2D7" height="22" width="90"></td>
 <td bgcolor="#CCD2D7" height="22" width="60"></td>
 <td bgcolor="#CCD2D7" height="22"></td>
 </tr>
 ...
 <td bgcolor="#EBECED" class="texto" width="96" align="right">Magatzem:</td>
 <td width="264" class="texto">@%db:Almacenes.nombre;%@</td>
 </tr>
 <tr> <td colspan="4" height="1" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22" width="80"> Ref. Comanda:</td>
 ...
 @%end-if:%@
<td bgcolor="#EBECED" class="texto" align="right" >Estats </td>
 <td class="texto" > P <input type="checkbox" name="registro[preparado]" value="1" @%db:check_flag{Albaranes.preparado}%@> R <input type="checkbox" name="registro[enviado]" value="1" @%db:check_flag{Albaranes.enviado}%@> C <input type="checkbox" name="registro[confirmacion]" value="1" @%db:check_flag{Albaranes.confirmacion}%@> T <input type="checkbox" name="registro[devolucion]" value="1" @%db:check_fllag{Albaranes.devolucion}%@>
 </td>
 </tr>
 <tr> <td colspan="4" height="1" bgcolor="#CCD2D7"></td>
 </tr>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22" width="80">Data:</td>
 <td width="204">
 ...
 <td width="96" align="right" bgcolor="#EBECED" class="texto">Transportistes:</td>
