-- MySQL dump 10.11
--
-- Host: dbserver.devel    Database: biomundo_gestion
-- ------------------------------------------------------
...
/*!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO,MYSQL323,NO_TABLE_OPTIONS' */;
...
CREATE TABLE `Almacenes` (
  ...
  `cargo_persona_contacto` varchar(100) default NULL,
  `persona_contacto` varchar(255) default NULL,
  `nota_pie_albaran` mediumtext,
...
CREATE TABLE `Almacenes_logicos` (
  `id_almacen_logico` int(6) NOT NULL,
  `id_almacen` int(6) NOT NULL default '0',
  `nombre` varchar(75) NOT NULL default '',
...
CREATE TABLE `Articulos` (
  ...
  `wwwsinopsis` mediumtext,
  `wwwdescripcion` mediumtext,
...
CREATE TABLE `Bajas_almacen` (
  `id_baja_almacen` int(6) NOT NULL,
  `nombre` varchar(75) NOT NULL default '',
  `descripcion` varchar(255) default NULL,
...
CREATE TABLE `Bajas_localizacion` (
  `id_baja_localizacion` int(6) NOT NULL,
...
CREATE TABLE `Bancos` (
  ...
  `poblacion` varchar(125) default NULL,
  `cp` varchar(10) default NULL,
...
CREATE TABLE `Catalogo_imagenes` (
  ...
  `copyright` varchar(75) default NULL,
  `fecha_toma` date default NULL,
  `lugar_toma` varchar(50) default NULL,
...
CREATE TABLE `Cliente_notas` (
  `id_nota_cliente` int(7) NOT NULL,
  `id_cliente` int(6) NOT NULL default '0',
  `id_empresa` int(2) NOT NULL default '0',
...
CREATE TABLE `Clientes` (
  ...
  `id_provincia` int(6) NOT NULL default '0',
  `poblacion` varchar(200) default NULL,
  `cif` varchar(12) NOT NULL default '',
  `prefijo_cif` char(3) default NULL,
  `direccion_facturacion` varchar(255) NOT NULL default '',
  `cp` varchar(10) default NULL,
...
CREATE TABLE `Clientes_recursos` (
  `id_cliente_recurso` int(7) NOT NULL,
  `id_cliente` int(6) NOT NULL default '0',
  `id_empresa` int(2) NOT NULL default '0',
  `id_articulo` int(6) NOT NULL default '0',
  `id_recurso` int(4) NOT NULL default '0',
...
CREATE TABLE `Detalles_albaran` (
  ...
  `id_albaran` int(6) NOT NULL default '0',
  `lote` varchar(75) NOT NULL default '',
...
CREATE TABLE `Efectos` (
  `id_efecto` int(6) NOT NULL,
  `id_factura` int(6) NOT NULL default '0',
  `id_banco` int(3) NOT NULL default '0',
  `concepto` varchar(125) NOT NULL default '',
  ...
  `medio_pago` enum('efectivo','cheque','transferencia','pagare','recibo') NOT NULL default 'efectivo',
...
CREATE TABLE `Efectos_asientos` (
  ...
  `fecha` date NOT NULL default '0000-00-00',
  `operacion` enum('reconocimiento','cargo','eliminacion') NOT NULL default 'reconocimiento',
...
CREATE TABLE `Efectos_parciales` (
  `id_efecto_parcial` int(7) NOT NULL,
  `id_efecto` int(6) NOT NULL default '0',
  `id_banco` int(3) NOT NULL default '0',
...
CREATE TABLE `Empresas` (
  ...
  `prefijo_cif` char(1) NOT NULL default '',
  `nombre` varchar(75) NOT NULL default '',
  `apellidos` varchar(150) default NULL,
  `razon_social` varchar(255) NOT NULL default '',
  `capital_social` bigint(9) NOT NULL default '0',
  `inscripcion_registro` varchar(255) NOT NULL default '',
  `direccion_facturacion` varchar(255) NOT NULL default '',
  `cp` varchar(10) default NULL,
  `email` varchar(100) default NULL,
  `web` varchar(255) default NULL,
  ...
  `prefijo_fact_compras` varchar(11) default 'FC-',
  `sufijo_fact_compras` varchar(11) default NULL,
  `digitos_fact_compras` int(3) NOT NULL default '5',
  `prefijo_fact_ventas` varchar(11) default 'F',
  `sufijo_fact_ventas` varchar(11) default NULL,
  `digitos_fact_ventas` int(3) NOT NULL default '5',
  `prefijo_ped_ventas` varchar(11) default 'P',
  `sufijo_ped_ventas` varchar(11) default NULL,
  `contador_ped_ventas` bigint(10) NOT NULL default '0',
  `digitos_ped_ventas` int(3) NOT NULL default '5',
  `prefijo_alb_ventas` varchar(11) default 'A',
  `sufijo_alb_ventas` varchar(11) default NULL,
  `contador_alb_ventas` bigint(10) NOT NULL default '0',
  `digitos_alb_ventas` int(3) NOT NULL default '5',
  `prefijo_pre_ventas` varchar(11) default 'Ps',
  `sufijo_pre_ventas` varchar(11) default NULL,
  `contador_pre_ventas` bigint(10) NOT NULL default '0',
  `digitos_pre_ventas` int(3) NOT NULL default '5',
  `prefijo_pre_compras` varchar(11) NOT NULL default 'PrC',
  `sufijo_pre_compras` varchar(11) default NULL,
  `contador_pre_compras` bigint(10) NOT NULL default '0',
  `digitos_pre_compras` int(2) NOT NULL default '4',
  `prefijo_alb_compras` varchar(11) NOT NULL default 'AC',
  `sufijo_alb_compras` varchar(11) default NULL,
  `contador_alb_compras` bigint(10) NOT NULL default '0',
  `digitos_alb_compras` int(2) NOT NULL default '4',
  `prefijo_ped_compras` varchar(11) NOT NULL default 'PC',
  `sufijo_ped_compras` varchar(11) default NULL,
  `contador_ped_compras` bigint(10) NOT NULL default '0',
  `digitos_ped_compras` int(2) NOT NULL default '4',
  `prefijo_pro_ventas` varchar(11) default 'FPV',
  `sufijo_pro_ventas` varchar(11) default NULL,
  `digitos_pro_ventas` int(2) NOT NULL default '5',
  `contador_pro_ventas` bigint(10) NOT NULL default '0',
  `prefijo_pro_compras` varchar(11) default 'FPC',
  `sufijo_pro_compras` varchar(11) default NULL,
...
CREATE TABLE `Estados_servicio` (
  `id_estado_servicio` int(2) NOT NULL,
  `nombre` varchar(125) NOT NULL default '',
...
CREATE TABLE `Facturas` (
  ...
  `referencia` varchar(50) NOT NULL default '',
  `referencia_externa` varchar(50) NOT NULL default '',
...
CREATE TABLE `Facturas_detalle` (
  ...
  `notas` mediumtext,
  `iextra1` varchar(200) default NULL,
  `iextra2` varchar(200) default NULL,
  `iextra3` varchar(200) default NULL,
  `iextra4` varchar(200) default NULL,
...
CREATE TABLE `Forma_pago_TPV` (
  `id_forma_pago_tpv` int(11) NOT NULL,
...
CREATE TABLE `Grupo_empresas` (
  `id_grupo_empresa` int(3) NOT NULL,
  `nombre` varchar(75) NOT NULL default '',
  `id_usr` int(4) NOT NULL default '0',
...
CREATE TABLE `Grupo_familias` (
  `id_grupo_familia` int(4) NOT NULL,
  `nombre` varchar(100) default NULL,
  `descripcion` varchar(255) default NULL,
...
CREATE TABLE `Inventario_stock` (
  `id_almacen_logico` int(6) NOT NULL default '0',
  `id_articulo` int(6) NOT NULL default '0',
  `lote` varchar(8) NOT NULL default '',
  `planta` int(4) NOT NULL default '0',
  `pasillo` int(4) NOT NULL default '0',
  `fila` int(4) NOT NULL default '0',
  `columna` int(4) NOT NULL default '0',
...
CREATE TABLE `Lineas_detalle` (
  ...
  `oextra1` varchar(200) default NULL,
  `oextra2` varchar(200) default NULL,
  `oextra3` varchar(200) default NULL,
  `oextra4` varchar(200) default NULL,
...
--
-- Table structure for table `Maestro_bajas_almacen`
--

DROP TABLE IF EXISTS `Maestro_bajas_almacen`;
CREATE TABLE `Maestro_bajas_almacen` (
  `id_baja_almacen` int(6) NOT NULL,
  `nombre` varchar(75) NOT NULL default '',
  `descripcion` varchar(255) default NULL,
  PRIMARY KEY  (`id_baja_almacen`)
...
CREATE TABLE `Notificaciones` (
  ...
  `de` varchar(125) NOT NULL default '',
  `para` varchar(125) NOT NULL default '',
  `tema` varchar(255) default NULL,
  `fecha` datetime NOT NULL default '0000-00-00 00:00:00',
  `tipo_mime` varchar(125) NOT NULL default '',
  `body` longblob,
...
CREATE TABLE `Proveedores` (
  ...
  `apellidos` varchar(150) default NULL,
  `razon_social` varchar(255) NOT NULL default '',
  `prefijo_cif` char(2) NOT NULL default '',
  `cif` varchar(12) NOT NULL default '',
...
CREATE TABLE `Recursos` (
  ...
  `nombre` varchar(175) NOT NULL default '',
  `descripcion` mediumtext,
  `extra` mediumtext,
...
CREATE TABLE `Tarifas` (
  ...
  `campo_accion` varchar(50) NOT NULL default '',
  `campo_recomendacion` varchar(20) NOT NULL default '',
...
CREATE TABLE `Tarifas_transporte` (
  `id_tarifa_transporte` int(4) NOT NULL,
  `id_transportista` int(4) default NULL,
  `nombre` varchar(100) default NULL,
...
CREATE TABLE `Tipos_Cuarentena` (
  `id_tipo_cuarentena` int(6) NOT NULL,
  `nombre` varchar(75) NOT NULL default '',
  `descripcion` varchar(255) default NULL,
...
CREATE TABLE `Tipos_UnidadMedida` (
  `id_tipo_unidadmedida` int(2) NOT NULL,
  `nombre` varchar(125) NOT NULL default '',
...
CREATE TABLE `Tipos_anotacion` (
  `id_tipo_anotacion` int(2) NOT NULL,
  `nombre` varchar(175) NOT NULL default '',
...
CREATE TABLE `Tipos_recurso` (
  `id_tipo_recurso` int(2) NOT NULL,
  `nombre` varchar(125) NOT NULL default '',
...
CREATE TABLE `Tpv` (
  `id_tpv` int(3) NOT NULL,
  `id_empresa` int(3) NOT NULL default '0',
  `nombre` varchar(25) default NULL,
  `prefijo_ticket` varchar(4) default NULL,
  `contador_ticket` bigint(10) default NULL,
  `sufijo_ticket` varchar(4) default NULL,
...
CREATE TABLE `Transportistas` (
  `id_transportista` int(6) NOT NULL,
  `id_provincia` int(6) NOT NULL default '1',
  `nombre` varchar(75) NOT NULL default '',
...
CREATE TABLE `UnidadesMedida_Escalas` (
  `id_escala_medida` int(5) NOT NULL,
  `id_unidad_medida` int(4) NOT NULL default '0',
  `nombre` varchar(125) NOT NULL default '',
  `leyenda` varchar(6) NOT NULL default '',
  `alias_list` varchar(70) default NULL,
...
CREATE TABLE `Unidades_medida` (
  `id_unidad_medida` int(4) NOT NULL,
  `id_tipo_unidadmedida` int(2) NOT NULL default '0',
  `nombre` varchar(100) NOT NULL default '',
  `leyenda` varchar(10) default NULL,
  `user_defined` tinyint(1) NOT NULL default '1',
...
-- Dump completed on 2007-10-30 17:20:15
-- MySQL dump 10.11
--
-- Host: dbserver.devel    Database: biomundo_gestion
-- ------------------------------------------------------
