...
<div class="tituloseccion" >Ressources</div>
...
@%if:esta_vacio;modo_seleccion;%@
	...
	<li><a href="?seccion=nuevo_recurso" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
	@%end-if:%@
	...
	@%end-if:%@
@%else:%@
	<li><a href="#" onClick="return sendForm('listado');" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Asigner</span></a></li>
@%end-if:%@
</ul>
</div>
