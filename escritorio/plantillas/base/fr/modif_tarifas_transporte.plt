...
<div class="titsuperior">&gt; Modifier Tarif de Transport</div><div class="alinder">
 @%if:AllowedLink;nuevo_tarifas_transporte;%@
 <a href="?seccion=nuevo_tarifas_transporte">Nouveau</a>
 @%end-if:%@
 </div></div>
...
<td class="etiqueta" >Pèse initial:</td>
...
<div class="enviar"><a href="#" onClick="sendForm('nuevo_tarifas');" >Garder</a>
</form>
