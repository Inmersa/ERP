...
@%where:tabla|Factura;nombre|busc;no_results|1;%@
	...
	<table class="full">
	<tr> 
	<td class="titulotb">Fournisseur:</td>
	...
	<td ><a href="?_search_sort=Facturas.total_impuestos" class="order" 
		>Totals Impôt<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.total_impuestos;%@" /></a></td>
	...
	@%else:%@
	<td ><a href="?_search_sort=Efectos.monto" class="order" >Quantité Totale d´Effets<img src="imag/pixel.png" class="@%func:class_searchsort;Efectos.monto;%@" /></a></td>
	...
	<td ><a href="?_search_sort=numero_incidencias" class="order" 
		>Nº Incidences<img src="imag/pixel.png" class="@%func:class_searchsort;numero_incidencias;%@" /></a></td>
	@%end-if:%@
	</tr>
	</thead>
	<tbody class="informe" >
