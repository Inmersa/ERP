...
@%if:hay_albaran%@
 ...
 @%if:AllowedLink;bo_albaranes_pedido;%@<a href="?seccion=bo_albaranes_pedido&id_pedido=@%db:Pedidos.id_pedido;%@" class="accesos">Voir livraisons</a>
...
@%if:hay_factura%@
 ...
 <a href="?seccion=bo_factura_cliente&id_factura=@%db:Pedidos.id_factura;%@" class="accesos">Voir</a>
