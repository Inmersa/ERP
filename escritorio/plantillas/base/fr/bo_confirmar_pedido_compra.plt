...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="250" >&gt; Confirmer 
@%if:esta_vacio;es_pedido;%@
@%if:esta_vacio;es_factura;%@
 Devis @%set:send_form_to=bo_presupuestos_compras;%@
 @%else:%@ 
 Factures @%set:send_form_to=bo_facturas_compra;%@
 @%end-if:%@ 
@%else:%@ 
Commande @%set:send_form_to=bo_pedidos_compras;%@
@%end-if:%@ 
</td>
 <td width="46" align="center" ><a href="?seccion=hacer_pedido_compra" class="accesos">Tourner</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#CCD2D7" class="titul1">Consolider Commande type <input type="checkbox" name="pedido_tipo" value="1">
 </td>
 </tr>
 <tr>
 <td height="10"></td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#CCD2D7" height="22" class="titul1">Fournisseur</td>
 </tr>
 ...
 <tr> <td bgcolor="#CCD2D7" height="22" align="right" class="titul1" width="80">Entreprise</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Domicile:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Ville:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">Province / État:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">NSF:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">Téléphone:</td>
 <td class="texto">@%db:telefono1;%@</td>
 <td bgcolor="#EBECED" align="right" class="titul1">Télécopieur:</td>
...
@%set:observaciones_en_totales=observaciones;%@
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22" width="112">Modes de paiement:</td>
 <td width="217">
...
@%end-where:%@
 ...
 <td bgcolor="#EBECED" align="right" class="texto" width="95">Devise:</td>
...
@%if:esta_vacio;es_pedido%@
@%else:%@
 <tr> <td bgcolor="#EBECED" width="112" class="texto">Direction remise:</td>
...
@%end-where:%@
 ...
 <tr> <td width="6"></td>
 <td width="419"></td>
 <td align="center" width="100"><a href="?seccion=hacer_pedido_compra" class="accesos">Ajouter article </a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Quantite</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Prix</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="titul1" align="center" width="60">TVA</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center" width="60"> Rem. </td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="110">Montant</td>
...
@%end-if:%@
 ...
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center">Revenu imposable</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1">TVA %</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="120">Reteneu équivalent %</td>
 <td width="1" height="20" bgcolor="#DBE0E3"></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="titul1" align="center">Revenu imposable</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center">Remises</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="80">Montant</td>
 <td width="1" bgcolor="#DBE0E3" height="20"></td>
 </tr>
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="titul1" height="22">Montant </td>
 </tr>
...
<br><br>
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="titul1" height="22">Montant @%db:divisa_cliente_nombre%@</td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="1"></td>
...
@%end-if:%@
 ...
 <a href="" onclick="document.forms['hacer_pedido'].submit();return false;" class="accesos">Accepter</a></td>
 </tr>
