...
<li><a href="?seccion=bo_importar_clientes_agente" class="importarusuario"><img src="imag/pixel.png" class="icono" /><span>Importer clients</span></a></li>
@%end-if:%@
...
<td></td>
<td ><a href="?_search_sort=Clientes.razon_social" >Nom<img src="imag/pixel.png" class="@%func:class_searchsort;Clientes.razon_social;%@" /></a></td>
<td ><a href="?_search_sort=Agentes_clientes.fecha_captacion" >Date de création<img src="imag/pixel.png" 
	class="@%func:class_searchsort;Agentes_clientes.fecha_captacion;%@" /></a> </td>
<td ><a href="?_search_sort=Agentes_clientes.comision" >Commission<img src="imag/pixel.png" class="@%func:class_searchsort;Agentes_clientes.comision;%@" /></a></td>
<td ><a href="?_search_sort=Agentes_clientes.comision_repartida" >Commission à partager<img src="imag/pixel.png" 
