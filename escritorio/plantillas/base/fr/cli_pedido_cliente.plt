...
<tr> <td bgcolor="#EBECED" align="right" class="texto" width="80" height="22">Réf. Externe:</td>
...
<tr> <td bgcolor="#EBECED" align="right" class="texto" width="80" height="22">Référence:</td>
 ...
 <td bgcolor="#EBECED" class="texto" align="right">Devise</td>
...
<!--@%wdb:Pedidos.id_agente%@--> </td>
 ...
 <td bgcolor="#EBECED" align="right" class="texto">Modes de paiement:</td>
 <td colspan="2">
...
<a href="" onclick="document.forms['anyadir_al_pedido'].submit();return false;" class="accesos">Ajouter article </a>
...
<td bgcolor="#DBE0E3"></td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="110">Remises</td>
 <td width="1"></td>
