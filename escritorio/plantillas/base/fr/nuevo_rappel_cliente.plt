...
<div class="titsuperior">&gt; Rappel annuel (
...
<div class="alinder"><a href="javascript: history.go(-1);">Tourner</a>
</div>
</div>
<form name="rappel_cliente" method="post" action="?seccion=bo_rappel_cliente">
<div class="barraoscurai">Terminaison 12 moises</div>
<table class="full">
<tr>
<td colspan="2">
</td>
<td class="etiqueta">Debut de periode
</td>
</tr>@%set:_iterate_times=15%@
@%where:nodb|nodb_iterate;%@
<tr>
<td class="etiqueta">de
<input type="text" name="rappel[@%db:iterate_num%@][monto_inicial]" size="15" maxlength="9" />L
...
<div class="enviar"><a href="" onClick="document.forms['rappel_cliente'].submit();return false;">Ajouter</a>
</div>
</form>
