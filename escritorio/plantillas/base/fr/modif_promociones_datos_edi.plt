...
<li><a href="?seccion=nuevo_promociones" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Ajouter</span></a></li>
</ul></div> 
@%end-if:%@
...
<li><a href="?seccion=bo_articulos_promocion&id_promocion=@%db:Promociones.id_promocion%@" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Ajouter article</span></a></li>
<li><a href="#" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Borrar_articulos');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>

<table class="full">
<caption class="titulotb">Listage d´articles Promotion</caption>
<tr>
<td></td>
...
<li><a href="#" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Modificar');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
<li><a href="#" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Effacer</span></a></li>
</ul></div>
