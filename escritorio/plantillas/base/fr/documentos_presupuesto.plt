...
<legend>Documents pour Budgets</legend>
<div class="AccionesFicha" >
<ul>
@%if:esta_vacio;id_grupo_docs;%@
@%else:%@
@%if:AllowedAction;Presupuestos_Documentos_CRM;new;%@
<li><a href="#" onClick="return onHRefClick('documentos','accion_ejecutar','NuevoDocumento');" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
@%end-if:%@
@%end-if:%@
...
<li><a href="?seccion=crm_seleccionar_documento&varios=1&id_presupuesto=@%get:id_presupuesto;%@" 
	class="asociar" ><img src="imag/pixel.png" class="icono" /><span>Sélectionner Document</span></a></li>
<li><a href="#" onClick="return sendForm('documentos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li>
@%end-if:%@

@%if:AllowedAction;Presupuestos_Documentos_CRM;del;%@
<li><a href="#" onClick="return sendForm('documentos','accion_ejecutar','BorrarDocumentos',null,'Êtes-vous sûr que vous voulez supprimer des enregistrements choisis?');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
@%end-if:%@
...
@%end-if:%@
   ...
   @%else:%@
@%if:AllowedAction;Presupuestos_Documentos_CRM;new;%@
   <div class="documentos">Nouveau Document<input type="text" name="documento[nombre]" ><input type="file" name="document_file" /><br />
