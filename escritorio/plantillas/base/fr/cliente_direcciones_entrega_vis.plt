...
<legend>Direction à remise</legend>
<div class="barraoscura"><div class="alinder">
@%if:AllowedLink;nuevo_direcciones_entrega;%@
	@%if:AllowedAction;Direcciones_entrega;new;%@
	<a href="?seccion=nuevo_direcciones_entrega&amp;id_cliente=@%get:id_cliente_promocion%@">Ajouter direction</a> 
	@%end-if:%@
@%end-if:%@
@%if:AllowedAction;Direcciones_entrega;del;%@
<a href="#" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Borrar');">Effacer</a>
@%end-if:%@
</div></div>
