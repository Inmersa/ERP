...
<div class="tituloseccion">&gt; Ajouter des articles à Client (
...
@%plt:botonera%@
 ...
 <li><a href="#" onClick="return sendForm('nuevo_descuento_articulos');"  class="enviar" ><img src="imag/pixel.png" class="icono" /><span>Ajouter</span></a></li>
 </ul></div>
