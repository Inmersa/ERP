...
class="accesos">Accepter</a--><input type="submit" value="Accepter"><a href="?seccion=pda_hacer_pedido" class="accesos"
>Tourner</a></td>
 </tr>
<tr>
<td height="10"></td>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr> <td class="titul1" align="left" width="95">&gt; Direction à remise</td>
</tr>
 <tr>
 <td height="10"></td>
 </tr>
...
<tr>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr> <td align="left" class="titul1" width="114">Modalité de paiment</td>
...
<tr> <td align="left" class="titul1" width="114">Devise</td>
 <td class="texto" width="86">
...
<tr> <td align="left" class="titul1" width="114">@%db:nombre%@</td>
 ...
 <tr> <td align="left" class="titocho" width="114">Totals:</td>
 <td class="texto" width="86">@%db:bruto%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="114">Revenu imposable:</td>
 <td class="texto" width="86">@%db:base_imponible%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="114">Rétentions:</td>
 <td class="texto" width="86">@%db:retenido%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">Total Remises:</td>
 <td class="texto" width="103">@%db:descuentos%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr>
 <td height="10"></td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">Montant:</td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
<td class="titocho">Observationes :</td>
</tr>
 <tr>
