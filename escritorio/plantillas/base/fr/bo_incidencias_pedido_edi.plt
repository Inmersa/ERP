...
<li><a href="?seccion=nueva_incidencia_crm&id_pedido=@%get:id_documento%@" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouvelle incidence</span></a></li>
@%end-if:%@
...
<li><a href="#" onClick="return sendForm('borrar_incidencias');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
@%end-if:%@
