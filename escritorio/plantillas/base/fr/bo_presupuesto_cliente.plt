...
><img src="imag/pixel.png" class="icono" /><span>Réviser</span></a></li>
@%end-if:%@
@%end-if:%@
...
><img src="imag/pixel.png" class="icono" /><span>Rejeter</span></a></li>
@%end-if:%@
@%end-if:%@
...
@%if:equals_any;estado;2;%@
	...
	><img src="imag/pixel.png" class="icono" /><span>Consolider</span></a></li>
	@%end-if:%@
@%else:%@
...
@%if:esta_vacio;id_rfq;%@
	<li><a href="?seccion=rfqs&modo_seleccion=1" class="enlazarrfq" ><img src="imag/pixel.png" class="icono" /><span>Sélectionner RFQ</span></a></li>
@%end-if:%@

<li><a href="#" onclick="window.open('?@%env:QUERY_STRING%@&imprimir=1'); return false;" class="imprimir"><img 
src="imag/pixel.png" class="icono" /><span>Imprimer</span></a></li>
