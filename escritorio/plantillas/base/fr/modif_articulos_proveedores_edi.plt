...
<li><a href="?seccion=seleccionar_proveedor" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Sélectionner Fournisseur</span></a></li> 
...
<td class="etiqueta">Pour unité</td>
...
@%end-if:%@
 /></td>
 <td class="etiqueta" colspan="2" style="text-align:left;">Prix pour un période de</td>
...
<tr>
<td class="etiqueta">Facturant le service à l'avance</td>
