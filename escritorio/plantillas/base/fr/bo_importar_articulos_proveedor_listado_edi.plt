...
<li><a href="#" onClick="return sendForm('importar_articulos_proveedor');" class="enviar" ><img src="imag/pixel.png" class="icono" /><span>Importer</span></a></li>
</ul></div>
...
<table class="full">
<thead><tr>
<td colspan="3"><a href="?_search_sort=Articulos.nombre" class="order" >Nom<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Articulos.codigo_barras" class="order" 
	>Code-barres<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.codigo_barras;%@" /></a></td>
<td colspan="2"><a href="?_search_sort=Empresas_articulos.fecha_alta" class="order" 
	>Début de période<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.fecha_alta;%@" /></a></td>
<td colspan="2"><a href="?_search_sort=Empresas_articulos.fecha_baja" class="order" 
	>Date de retrait<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.fecha_baja;%@" /></a></td>
</tr></thead>
...
<td class="estado" ><img src="imag/pixel.png" class="marcartodos" onclick="return formCheckAll('articulos_proveedor_importar');"  /></td>
<td >Ref.</td>
<td >Prix</td>
<td >Rem.</td>
<td >Prix de vente</td>
