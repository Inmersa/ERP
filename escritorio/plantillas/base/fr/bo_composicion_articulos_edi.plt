...
<td ><a href="?_search_sort=Familia_articulos.nombre" >Famille à articles<img src="imag/pixel.png" class="@%func:class_searchsort;Familia_articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.fecha_alta" 
	>Date de creation<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.fecha_alta;%@" /></a></td>
