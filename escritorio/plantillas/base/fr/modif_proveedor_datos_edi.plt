 ...
 <td width="87" class="titul1" align="right" bgcolor="#EBECED">NSF Intracommunitaire:</td>
 <td width="168">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Province / État:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Personne de contact:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="titul1" align="right">Téléphone 1:</td>
 <td width="168"> <input type="text" name="registro[telefono1]" value="@%db:Proveedores.telefono1;%@" class="insertext" size="20"/>
 </td>
 </tr>
 <tr> <td colspan="4" bgcolor="#CCD2D7" height="1"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Charge de contact:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="titul1" align="right">Téléphone 2:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="titul1" align="right">Télécopieur:</td>
 <td width="168"> <input type="text" name="registro[fax]" value="@%db:Proveedores.fax;%@" class="insertext" size="20"/>
 </td>
 </tr>
 <tr> <td colspan="4" bgcolor="#CCD2D7" height="1"></td>
 </tr>
 <tr> <td width="161" height="22" align="right" bgcolor="#EBECED" class="titul1">Début de période:</td>
...
<input type=hidden name=registro2[id_usr] value="@%db:Proveedores_empresas.id_usr%@">
 ...
 <td class="titul1" height="20" >Donnée général</td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td align="right" height="22" bgcolor="#EBECED" class="titul1" width="161">Modalité de paiment:</td>
...
@%end-where:%@
 ...
 <tr> <td class="titul1" height="22" bgcolor="#EBECED" align="right" width="161">Devise:</td>
...
@%end-where:%@
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="titul1">Rétention:</td>
