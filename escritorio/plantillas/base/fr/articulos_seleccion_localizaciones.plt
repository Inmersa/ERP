...
<tr><td class="etiqueta" >Quantité à servir</td><td colspan="2" >@%db:Detalles_albaran.cantidad;%@</td></tr>
<tr><td class="etiqueta" >Grouper</td><td class="check" ><input type="checkbox" name="detalles_localizacion[@%get:idx_albaran;%@][agrupar]" value="1" /></td>
<tr><td class="etiqueta" >Grouper des localisations de livraison</td><td class="check" 
...
<li><a href="#" onClick="return sendForm('localizaciones_actuales');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li>
</ul></div>
</div>
