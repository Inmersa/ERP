...
<li><a href="?seccion=nuevo_series_facturacion" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li></td>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_series_facturacion');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div> 
