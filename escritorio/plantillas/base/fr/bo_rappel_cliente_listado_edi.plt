...
<li><a href="?seccion=nuevo_rappel_cliente" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Ajouter Rappel</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return onHRefClick('rappel_cliente','accion_ejecutar','Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
...
<thead>
<tr>
<td colspan="3">Terminaison 12 moises</td>
