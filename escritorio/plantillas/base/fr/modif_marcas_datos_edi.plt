...
@%end-where:%@ 
 ...
 <td class="etiqueta" >Exclu de Vente</td>
 ...
 <li><a href="#" onClick="return sendForm('modif_marcas');"  class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li> 
 <li><a href="#" onClick="return resetForm('modif_marcas');"  class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Défaire changement</span></a></li>
