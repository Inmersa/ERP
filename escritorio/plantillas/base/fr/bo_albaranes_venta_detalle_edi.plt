...
<td colspan="2"><a href="?_search_sort=Almacenes.nombre" >Magasin<img src="imag/pixel.png" class="@%func:class_searchsort;Almacenes.nombre;%@" /></a></td>
</tr></thead>
...
<td colspan="3"><a href="?_search_sort=Clientes.razon_social" 
	>Client<img src="imag/pixel.png" class="@%func:class_searchsort;Clientes.razon_social;%@" /></a></td>
