<div class="tituloseccion">Nouvelle incidence</div>
...
<td colspan="4" class="barraoscurai"> Nota d´overture</td></tr>
<tr><td colspan="4"><textarea name="incidencia[nota_apertura]" rows="5" cols="80" wrap="VIRTUAL"></textarea></td></tr>
</tbody>
</table>

<div class="AccionesEnvio"><ul>
<li><a href="#" onClick="return sendForm('nueva_incidencia');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li>
</ul></div>
</form>
