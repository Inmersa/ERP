...
@%if:emitida%@
	...
	<li><a href="#" onClick="return sendForm('factura','accion_ejecutar','AbonarFactura','hacer_pedido&factura=1&abono=1&nuevo=1');" class="abonofactura" 
		><img src="imag/pixel.png" class="icono" /><span>Créditer Facture</span></a></li> 
	@%set:listar_abonos = 1;%@
	@%end-if:%@
@%else:%@
	@%if:esta_vacio;factura_abono;%@
	...
	<li><a href="?seccion=hacer_pedido" class="editar" 
		><img src="imag/pixel.png" class="icono" /><span>Modifier Détail de Facture</span></a></li> 
	@%end-if:%@
	@%end-if:%@
	@%if:AllowedAction;Facturas_detalle;del;%@
	<li><a href="#" onclick="return onHRefClick('factura','accion_ejecutar','Borrar');" class="borrar" 
		><img src="imag/pixel.png" class="icono" /><span>Effacer(s)</span></a></li>
	@%end-if:%@
...
<thead>
<tr>
<td class="estado" ><img src="imag/pixel.png" class="marcartodos" onclick="return formCheckAll('borrar_articulos');"  /></td>
<td >Code</td>
<td >Quantite</td>
<td >Prix</td>
<td >TVA</td>
...
<td class="etiqueta" >Effacer touts</td>
