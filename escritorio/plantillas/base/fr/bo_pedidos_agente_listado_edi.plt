...
<thead>
<tr>
<td ><a href="?_search_sort=Pedidos.referencia" >Référence<img src="imag/pixel.png" class="@%func:class_searchsort;Pedidos.referencia;%@" /></a></td>
...
<td ><a href="?_search_sort=Direcciones_entrega.direccion" 
	>Direction à remise<img src="imag/pixel.png" class="@%func:class_searchsort;Direcciones_entrega.direccion;%@" /></a></td>
<td ><a href="?_search_sort=monto_pedido" >Quantite<img src="imag/pixel.png" class="@%func:class_searchsort;monto_pedido;%@" /></a></td>
<td class="estado"><a href="?_search_sort=Pedidos.preparado" >Comm<img src="imag/pixel.png" class="@%func:class_searchsort;Pedidos.preparado;%@" /></a></td>
