 ...
 Numéro <input type="text" name="nombre" size="6" class="insertext" value="@%get:st[nombre];%@" />

 @%if:AllowedAction;RFQ_id_usuario_gestor;new;%@
 Gestionnaire: <input type="text" name="gestor" size="20" class="insertext" value="@%get:st[gestor];%@" />
 @%end-if:%@
...
>@%db:Tipo_incidencia.nombre;%@</option>
 ...
 @%end-if:%@
 />
 Jusqu´a: <input type="text" name="fecha_fin" size="12" maxlength="10" 
