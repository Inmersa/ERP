...
<div class="barraoscurai">Sélections Actuel : &nbsp;&nbsp;
...
<ul>
<li><a href="#" onclick="return sendForm('cesta');" class="finalizar" ><img src="imag/pixel.png" class="icono" /><span>Terminer</span></a></li>
<li><a href="?@%env:QUERY_STRING%@&vaciar_pedido=1" class="vaciar" ><img src="imag/pixel.png" class="icono" /><span>Èvider Commande</span></a></li>
</ul>
</div>
...
<ul>
<li class="noicon" >Ref. Clients Depuis:</li>
<li class="noicon" ><input type="text" size="14" maxlength="14" name="repo[fecha]" value="dd/mm/aaaa" /></li>
<li><a href="#" onClick="return sendForm('habituales');" class="enviar"><img src="imag/pixel.png" class="icono" />Accepter</a></li>
</ul>
</div>
</form>
@%end-if:%@
