...
<ul>
<li><a href="#" onClick="return sendForm('rfqs');" class="enlazarrfq"><img src="imag/pixel.png" class="icono" /><span>Accepter</span></a></li>
</ul>
</div>
...
@%end-if:%@
 ...
 <td ><a href="?_search_sort=RFQs.fecha" >Date d'entrée<img src="imag/pixel.png" class="@%func:class_searchsort;RFQs.fecha;%@" /></a></td>
 <td ><a href="?_search_sort=Tipo_incidencia.nombre" >Type<img src="imag/pixel.png" class="@%func:class_searchsort;Tipo_incidencia.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Usuarios.nombre" >Impliquer<img src="imag/pixel.png" class="@%func:class_searchsort;Usuarios.nombre;%@" /></a></td>
@%if:AllowedAction;RFQ_id_usuario_gestor;new;%@
 <td ><a href="?_search_sort=Empleados.nombre" >Gestionnaire actual<img src="imag/pixel.png" class="@%func:class_searchsort;Empleados.nombre;%@" /></a></td>
@%end-if:%@
 <td ><a href="?_search_sort=RFQs.fecha_estimada" >Date approximative terminer<img src="imag/pixel.png" class="@%func:class_searchsort;RFQs.fecha_estimada;%@" /></a></td>
@%if:esta_vacio;nomostrarcierre;%@
 <td ><a href="?_search_sort=RFQs.fecha_cierre" >Date final<img src="imag/pixel.png" class="@%func:class_searchsort;RFQs.fecha_cierre;%@" /></a></td>
@%end-if:%@
</tr>
</thead>
<tbody>
