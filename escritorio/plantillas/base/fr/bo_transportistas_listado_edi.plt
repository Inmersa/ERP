...
<li><a href="?seccion=nuevo_transportistas"  class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
@%end-if:%@
<li><a href="return sendForm('modif_transportistas');"  class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
...
<td class="caption"><a href="?_search_sort=Transportistas.nombre" class="order" 
	>Nom<img src="imag/pixel.png" class="@%func:class_searchsort;Transportistas.nombre;%@" /></a></td>
<td class="caption"><a href="?_search_sort=Transportistas.razon_social" class="order" 
	>Raison sociale<img src="imag/pixel.png" class="@%func:class_searchsort;Transportistas.razon_social;%@" /></a></td>
<td class="caption"><a href="?_search_sort=Transportistas.telefono" class="order" 
	>Téléphone<img src="imag/pixel.png" class="@%func:class_searchsort;Transportistas.telefono;%@" /></a></td>
