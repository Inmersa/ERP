...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="323" >&gt; Fiche Client</td>
...
<tr> <td colspan="4" height="22" bgcolor="#CCD2D7"> <table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <!--@%Clientes.id_cliente;%@-->
 <td class="etiqueta" height="20" > Clients entreprise</td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td bgcolor="#EBECED" width="87" align="right" class="etiqueta">Surnom:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Raison sociale:</td>
 <td width="228"> <input type="text" name="registro[razon_social]" value="@%db:Clientes.razon_social;%@" class="insertext" size="30">
 </td>
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">NSF:</td>
 ...
 <tr> <td width="161" class="etiqueta" align="right" height="22" bgcolor="#EBECED">Direction de facturacion:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Ville:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Province / État:</td>
 ...
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Personne de contact:</td>
 <td width="228"> <input type="text" name="registro[persona_contacto]" value="@%db:Clientes.persona_contacto;%@" class="insertext" size="30">
 </td>
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Téléphone 1:</td>
 <td width="168"> <input type="text" name="registro[telefono1]" value="@%db:Clientes.telefono1;%@" class="insertextnumeros" size="14">
 </td>
 </tr>
 <tr> <td colspan="4" height="1" bgcolor="#CCD2D7" ></td>
 </tr>
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Charge de contact:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Téléphone 2:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Télécopieur:</td>
 ...
 <tr> <td width="6" align="center" height="20" ></td>
 <td class="etiqueta" height="20" width="172" >Direction à remise:</td>
 <td class="etiqueta" height="20" width="466" align="right" ><a href="?seccion=cli_nuevo_direcciones_entrega&amp;id_cliente=@%db:Clientes.id_cliente%@" class="accesos">Ajouter direction</a> <a href="" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Borrar');" class="accesos">Effacer</a>
 </td>
 </tr>
 </table>
 </td>
...
<a href="" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Modificar');" class="accesos">Modifier</a>
 </td>
 </tr>
 </>
 </table>
