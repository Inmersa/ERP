...
<div class="tituloseccion">Configuration Générale</div>

<form name="configuracion" method="post" action="#">
<input type="hidden" name="accion_ejecutar" value="Modificar" />

<div class="PIIContainer" id="CfgTab_General" 
><div name="Impresion" class="activo" >Impression</div
><div name="Facturas" >Factures</div
><div name="Email" >Mail</div
><div name="General" >Configuration Générale</div
></div>
...
><div name="iConta" >Accounting</div
@%end-if:%@
></div>
...
<li><a href="#" onClick="return sendForm('configuracion');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li>
</ul></div>
