...
@%if:es_presupuesto%@
 ...
 <td width="46" align="center" ><a href="?seccion=hacer_ticket" class="accesos">Tourner</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#CCD2D7" class="etiqueta">Consolider Commande type <input type="checkbox" name="pedido_tipo" value="1">
 </td>
 </tr>
 <tr>
 <td height="10"></td>
...
@%end-where:%@
 ...
 <tr> <td width="6"></td>
 <td width="419"></td>
 <td align="center" width="100"><a href="?seccion=hacer_pedido" class="accesos">Ajouter article </a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center" width="60"> Rem. </td>
 <td width="1" height="20"></td>
...
@%end-if:%@
 ...
 <a href="" onclick="document.forms['hacer_ticket'].submit();return false;" class="accesos">Accepter</a></td>
 </tr>
