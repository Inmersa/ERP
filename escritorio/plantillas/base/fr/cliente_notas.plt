...
<li><a href="#" onClick="return sendForm('notas','accion_ejecutar','Borrar');" class="borrar"><img src="imag/pixel.png" class="icono" /><span>Elimier</span></a></li>
</ul></div>
@%end-if:%@
...
@%if:AllowedAction;Cliente_notas;del;%@
 <td >&nbsp;</td>
@%end-if:%@
 <td ><a href="?_search_sort=Cliente_notas.nombre" class="order" >Nom<img src="imag/pixel.png" class="@%func:class_searchsort;Cliente_notas.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Tipos_anotacion.nombre" class="order" >Type<img src="imag/pixel.png" class="@%func:class_searchsort;Tipos_anotacion.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Cliente_notas.fecha" class="order" >Date<img src="imag/pixel.png" class="@%func:class_searchsort;Cliente_notas.fecha;%@" /></a></td>
 <td >Usager</td>
</tr>
</thead>
<tbody>
...
<li><a href="#" onClick="return sendForm('nuevo');" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
</ul></div>
@%end-if:%@
