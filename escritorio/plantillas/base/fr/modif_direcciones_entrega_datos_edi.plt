...
<tbody>
 ...
 <tr><td class="etiqueta" >Transporteurs:</td>
...
<li><a href="#" onclick="return sendForm('modif_direcciones_entrega');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
</div>
