...
<table class="firmas">
 ...
 <tr >
   <td class="etiqueta">Étapes</td>
   <td class="etiqueta">Préparation par</td>
   <td class="etiqueta">Empaquetage par</td>
   <td class="etiqueta">Vérifié par</td>
   <td class="etiqueta">Facturé par</td>
   <td class="etiqueta">Envoyé</td>
 </tr>
 <tr>
   <td class="etiqueta" >Daté dans</td>
   <td > &nbsp;</td>
   <td > &nbsp;</td>
   <td > &nbsp;</td>
   <td > &nbsp;</td>
