...
<li><a href="?seccion=nuevo_descuento_articulos" class="seleccionar" ><img src="imag/pixel.png" class="icono" /><span>Ajouter article</span></a></li>
@%end-if:%@
...
<td class="caption">Tarif</td>
<td class="caption">Remises</td>
<td class="caption">Quantite à remise</td>
</tr>
@%end-if:%@
