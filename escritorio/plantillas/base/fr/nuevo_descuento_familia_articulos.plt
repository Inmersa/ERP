...
<div class="titsuperior">&gt; Nouveau remise Famille (
...
<div class="enviar"><a href="#" onClick="document.forms['nuevo_descuento_familia_articulos'].submit();return false;">Ajouter</a>
</div>
</form>
