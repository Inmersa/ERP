...
<table class="full">
 ...
 <div class="enviar">
 <a href="#" onClick="return sendForm('modif_maestro_bajas_almacen');">Garder</a> 
 <a href="#" onClick="return resetForm('modif_maestro_bajas_almacen');">Défaire changement</a>
 <a href="?seccion=bo_maestro_bajas_almacen&estado=2&registro[id_baja_almacen]=@%db:Bajas_almacen.id_baja_almacen%@" 
 	onClick="return confirm('Êtes-vous sûr que vous voulez supprimer des enregistrements choisis?');return false;" class="accesos">Effacer</a></div>
 </form>
