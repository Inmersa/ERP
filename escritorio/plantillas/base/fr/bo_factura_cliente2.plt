...
<tr class="bordes">
 ...
 <td class="@%css:PVP_rec;label;%@" >Prix de vente Rec.</td>
 <td >Article</td>
@%if:!esta_vacio;_aAppConf[print_observaciones_enlinea];%@
 <td > </td>
@%end-if:%@
 <td class="@%css:nombre_marca;label;%@" >Marque</td>
 <td class="@%css:certificado;label;%@" >Garant</td>
 <td >Quantite</td>
 <td >Prix</td>
 <td class="@%css:descuento;label;%@" >Rem.</td>
 <td >TVA %</td>
 <td >Montant</td>
<tr>
</thead>
...
@%end-if:%@
 ...
 <td >Quantite</td>
 <td >Prix</td>
 <td class="@%db:css:descuento;label;%@" >Rem.</td>
 <td >TVA % </td>
 <td >Montant</td>
</tr>
</thead>
