...
class="tituloseccion"
@%end-if:%@
>&gt; Modifier Effets (ID: @%db:Clientes.id_cliente;%@) @%db:Clientes.razon_social;%@</div>
...
<li><a href="#" onClick="return sendForm('efecto');" class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Défaire changement</span></a></li>
