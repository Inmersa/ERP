...
<tr> <td class="accesos" align="right"><input type="submit" value="Fermer route">
<!-- a href="javascript:document.forms['cierre_ruta'].submit();" class="accesos">Fermer route</a --> </td>
 </tr>
<tr>
<td height="10"></td>
</tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr>
 <td class="accesos2" align="left">Dépenses route</td>
</tr>
...
<tr> <td class="acceso_directo" align="left">Observationes:</td>
 </tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td class="accesos2" align="left">Date prochaine route</td>
 </tr>
 <tr>
