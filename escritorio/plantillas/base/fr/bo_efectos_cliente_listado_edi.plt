...
<li><a href="#" onClick="return onHRefClick('listado_efectos','accion_ejecutar','Abonar');" 
	class="abonar" ><img src="imag/pixel.png" class="icono" /><span>Régler</span></a></li>
<li><a href="#" onClick="return onHRefClick('listado_efectos','accion_ejecutar','Devolver');"
	class="devolverabono" ><img src="imag/pixel.png" class="icono" /><span>Rendre</span></a></li>
...
<li><a href="#" onClick="return SendFormToWindow('listado_efectos','modif_efectos_cliente&imprimir=1','Imprimir');"
	class="imprimir" ><img src="imag/pixel.png" class="icono" /><span>Imprimer</span></a></li>

</ul>
<!-- a href="#" onClick="return onHRefClick('listado_efectos','accion_ejecutar','Emitir');">Émettre</a -->
</div> 
...
<thead>
<tr>
<td ><a href="?_search_sort=Clientes.id_cliente" class="order" >Code<img src="imag/pixel.png" class="@%func:class_searchsort;Clientes.id_cliente;%@" /></a></td>
...
<td ><a href="?_search_sort=Clientes.razon_social" class="order" 
	>Raison sociale<img src="imag/pixel.png" class="@%func:class_searchsort;Clientes.razon_social;%@" /></a></td>
...
<td ><a href="?_search_sort=Facturas.referencia" class="order" >Réf.Factures<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.referencia;%@" /></a></td>
...
<td ><a href="?_search_sort=Efectos.fecha_vencimiento" class="order" 
	>Échéance<img src="imag/pixel.png" class="@%func:class_searchsort;Efectos.fecha_vencimiento;%@" /></a></td>
...
<td ><a href="?_search_sort=Efectos.monto_pagado" class="order" 
	>Total payé<img src="imag/pixel.png" class="@%func:class_searchsort;Efectos.monto_pagado;%@" /></a> </td>
<td >E</td>
</tr></thead>
<tbody>
 @%else:%@
...
<td class="etiquetacheck" >Abonné</td>
