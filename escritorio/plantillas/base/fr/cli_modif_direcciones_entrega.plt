...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" >&gt; Modifier direction</td>
 <td width="46" align="center" ><a href="?seccion=cli_modif_clientes" class="accesos">Tourner</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td class="texto" valign="top">Remplir formulaire</td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 </table>
 ...
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Direction:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Ville:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Province / État</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
...
@%where:tabla|Provincias;order|nombre;nolink|1;%@
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Téléphone:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Télécopieur:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Personne de contact:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Charge de contact:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185" valign="top">Observationes:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <td colspan="4" height="22" bgcolor="#CCD2D7"> <a href="" onclick="document.forms['modif_direcciones_entrega'].submit();return false;" class="accesos">Modifier</a> </td>
 </tr>
 </form>
 </table>
 </td>
