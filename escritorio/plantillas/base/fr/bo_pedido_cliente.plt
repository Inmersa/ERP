...
<div class="tituloseccion">&gt; Commande :@%db:nombre;%@</div>
...
<li><a href="?seccion=bo_facturas_pedido_venta&id_pedido=@%db:id_pedido;%@" class="verfras" ><img src="imag/pixel.png" class="icono" /><span>Voir</span></a></li>
@%else:%@
