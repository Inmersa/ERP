...
<tr>
<td >ID</td>
<td ><a href="?_search_sort=Articulos.nombre" >Nom<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.precio" >Prix<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.precio;%@" /></a></td>
...
<td ><a href="?_search_sort=Empresas_articulos.stock_ficticio" 
	>Stk E<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.stock_ficticio;%@" /></a></td>
<td >Stoc réel</td>
<td >Quantite</a></td>
<td >u/B</td>
<td >b/C</td>
...
<li><a href="#" onclick="return sendForm('hacer_pedido_compra');" class="sumaracesta" ><img src="imag/pixel.png" class="icono" /><span>Ajouter</span></a></li>
</ul></div>
</form>
