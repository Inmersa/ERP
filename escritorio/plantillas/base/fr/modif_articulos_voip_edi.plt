...
<table class="full"><tr>
<td class="@%css:Empresas_articulos.descripcion;label;%@" >Indicatifs règionaux:</td>
...
<td class="etiqueta @%css:Empresas_articulos.precio_standard;label;%@">Prix Local - Temps Rèduit:</td>
...
<td class="etiqueta @%css:Empresas_articulos.precio_4;label;%@">Prix External - Temps Rèduit:</td>
