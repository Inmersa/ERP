...
<div class="tituloseccion" >Types d'Annotation</div>
...
<li><a href="?seccion=nuevo_tipo_anotacion" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nouveau</span></a></li>
@%end-if:%@
