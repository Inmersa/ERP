...
<td class="estado" ><img src="imag/pixel.png" class="marcartodos" onclick="return formCheckAll('registro');"  /></td>
<td ><a href="?_search_sort=Articulos.nombre" class="order" >Article<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
...
<li><a href="#" onClick="return sendForm('bo_importar_articulos_seleccion');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modifier</span></a></li>
</ul></div>
