...
@%if:nuevo_proveedor%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Raison sociale</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="110">Code</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Risque</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="55">Retard</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="100" align="center">Montant</td>
...
@%else:%@
 ...
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Réf.Factures </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Concept</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Moyen de payant</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Échéance</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Totals</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Total payé </td>
 <td bgcolor="#DBE0E3" width="1"></td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="etiqueta">État<span class="texto"></span></td>
