...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Magasin Origine</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Magasin Destin </td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Transporteurs</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="120">Observationes</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="75" height="22" class="etiqueta" align="center">Date Transpert</td>
 <td width="1"></td>
...
@%end-if:%@
 ...
 <td bgcolor="#DBE0E3"></td>
 <td align="center" ><a href="?seccion=modif_traspasos_almacen&id_traspaso=@%db:Traspasos_almacen.id_traspaso;%@" class="accesos">Voir</a></td>
 <td bgcolor="#DBE0E3"></td>
 </tr>
 <tr> <td colspan="13" height="1"></td>
 </tr>
