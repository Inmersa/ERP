...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta">Demise premier</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Demise second</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Quantite</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Champ d´action</td>
