...
<legend>Nouvelle Zone de Magasin</legend>
...
<li><a href="#" onClick="return sendForm('nuevo_almacenes_logicos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Garder</span></a></li>
</ul></div>
