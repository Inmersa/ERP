...
><img src="imag/pixel.png" class="icono" /><span>Reconstruire des liaisons</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=Anyos.numero" class="order" >Numero<img src="imag/pixel.png" class="@%func:class_searchsort;Anyos.numero;%@" /></a></td>
<td ><a href="?_search_sort=nombre" class="order" >Nom<img src="imag/pixel.png" class="@%func:class_searchsort;nombre;%@" /></a></td>
<td ><a href="?_search_sort=Anyos.f_ini" class="order" >Debut de periode<img src="imag/pixel.png" class="@%func:class_searchsort;Anyos.f_ini;%@" /></a></td>
<td ><a href="?_search_sort=Anyos.f_fin" class="order" >Date final<img src="imag/pixel.png" class="@%func:class_searchsort;Anyos.f_fin;%@" /></a></td>
<td ><a href="?_search_sort=Anyos.n_trimestres" class="order" >Nombre Trimestriel<img src="imag/pixel.png" class="@%func:class_searchsort;Anyos.n_trimestres;%@" /></a></td>
</tr></thead>
...
<option value="0" selected="selected">Aucune sélection</option>
@%end-if:%@
<option value="1"
