...
<input type=hidden name=estado value=1>
 ...
 <tr align="center"> <td height="22" bgcolor="#CCD2D7" colspan="3"><a href="javascript:document.forms['modif_grupo_empresas'].submit();" class="accesos">Garder</a> 
 <a href="javascript:document.forms['modif_grupo_empresas'].reset();" class="accesos">Défaire changement</a>
 <a href="?seccion=bo_grupo_empresas&estado=2&registro[id_grupo_empresa]=@%db:Grupo_empresas.id_grupo_empresa%@" onClick="return confirm('Esta ud. seguro de que de desea borrar el registro?');return false;" class="accesos">Effacer</a> </td>
 </tr>
 </form>
 </table>
 </td>
