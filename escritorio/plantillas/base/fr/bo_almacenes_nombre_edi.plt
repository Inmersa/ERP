...
<!-- li><a href="?seccion=bo_importar_almacenes" class="importaralmacen"><img src="imag/pixel.png" class="icono" /><span>Importer</span></a></li -->
@%end-if:%@
@%if:AllowedLink;nuevo_almacenes;%@
<li><a href="?seccion=nuevo_almacenes" class="nuevo"><img src="imag/pixel.png" class="icono" /><span>Nouveau Magasin</span></a></li>
@%end-if:%@
...
<td class="caption">Personne de contact</td>
</tr>
