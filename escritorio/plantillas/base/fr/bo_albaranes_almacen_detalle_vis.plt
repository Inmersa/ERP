...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="180">Référence</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="75">Date</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="190">Direction destin</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="90">Types Livraisons </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="70" height="22" align="center" class="etiqueta">État</td>
...
<!--br>
<a href="?seccion=nuevo_albaranes">Ajouter registre</a>
<br-->
