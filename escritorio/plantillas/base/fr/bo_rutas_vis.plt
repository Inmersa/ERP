...
@%plt:botonera%@
 ...
 <tr> <td align="left">
<a href="" class="accesos">Ajouter</a>
</td>
<td width="20" align="center"></td>
 <td align="center">
<a href="#" onClick="return onHrefClick('bo_rutas','accion_ejecutar', 'Generar');" class="accesos">Génerér</a>
</td>
<td ></td>
 <td width="146" align="right">
<a href="#" onClick="return onHrefClick('bo_rutas','accion_ejecutar', 'Borrar');" class="accesos">Elimier</a>
</td>
 <td width="4"></td>
 </tr>
 </table>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Fréquence / jours</td>
 <td width="1"></td>

 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Derniére date </td>
 <td width="1"></td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="176">Prochainement</td>
 <td width="1"></td>
 </tr>
