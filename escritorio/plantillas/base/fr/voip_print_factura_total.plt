...
<div class="titulo">Résumé de Facture</div>
<div class="resumen" >
...
@%where:nodb|nodb_order_totals;nombre|detalleTotales;%@
 ...
 <tr><td class="etiqueta">Rétention:</td><td >@%db:retenido%@</td></tr>
 @%end-if:%@
@%end-where:%@
...
<table class="total">
 ...
 <td class="etiqueta">Économie concerne Telefónica</td>
 <td class="etiqueta">Totals Impôt</td>
 <td class="etiqueta">Total à Payer</td>
 </tr>
