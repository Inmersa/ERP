...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Remboursements d'Encaissement</td>
<td colspan="@%get:_iterate_times;%@" >Remboursements de Paiement</td></td>
...
<!-- 
@%set:grafica[titulo] = Remboursements d'Encaissement;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Remboursements de Paiement;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
