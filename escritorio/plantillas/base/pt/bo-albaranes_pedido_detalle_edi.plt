 ...
 <tr bgcolor="#CCD2D7" align="right"> <td colspan="15" height="22"><a href="" onclick="window.open('?seccion=bo_albaran_envio_print&id_albaran=@%db:Albaranes.id_albaran%@'); return false;" class="accesos">Imprimir</a></td>
 </tr>
 <tr> <td colspan="15" height="1"></td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="1" height="22"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1">Código</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="75">Data de Validade</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Lote</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" >Quantidade Encomendada</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1">Quantidade Movida</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="titul1" align="center" >Quantidade Recebida </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center" width="60" >Preço</td>
