...
@%if:esta_vacio;id_proveedor_cabecera;%@
	<caption>Direcção Armazém de Colheita</caption>
@%end-if:%@
	<tr><td class="etiqueta" >Armazém:</td><td >@%db:Almacenes.nombre;%@</td></tr>

	<tr><td class="etiqueta">Endereço:</td><td >@%db:Almacenes.direccion;%@</td></tr>
	<tr><td class="etiqueta">Localidade:</td><td >@%db:Almacenes.poblacion;%@</td></tr>
	...
	<tr><td class="etiqueta">Conservatória:</td><td >@%db:Empresas.inscripcion_registro;%@</td></tr>
	@%end-if:%@

	<tr><td class="etiqueta">Telefone:</td><td >@%db:Almacenes.telefono;%@</td></tr>
...
<table class="full">
	...
	<tr><td class="etiqueta">Nome:</td><td >@%db:Clientes.razon_social;%@</td></tr>
	<tr><td class="etiqueta" >Código:</td><td >@%db:Clientes.id_cliente;%@</td></tr>
	<tr><td class="etiqueta" >Endereço:</td><td >@%db:Clientes.direccion_facturacion;%@</td></tr>
	<tr><td class="etiqueta" >Localidade:</td><td >@%db:Clientes.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Distrito:</td>
	...
	<tr> 
	 <td class="etiqueta" >Telefone:</td><td >@%db:Clientes.telefono1;%@</td>
...
<table class="full">
 <caption>Endereço de Entrega(@%db:Direcciones_entrega.id_direccion;%@)</caption>
...
<table class="full">
	...
	<tr><td class="etiqueta">Nome:</td><td >@%db:Proveedores.razon_social;%@</td></tr>
	<tr><td class="etiqueta" >Código:</td><td >@%db:Proveedores.id_proveedor;%@</td></tr>
	<tr><td class="etiqueta" >Endereço:</td><td >@%db:Proveedores.domicilio;%@</td></tr>
	<tr><td class="etiqueta" >Localidade:</td><td >@%db:Proveedores.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Distrito:</td>
	...
	<tr> 
	 <td class="etiqueta" >Telefone:</td><td >@%db:Proveedores.telefono1;%@</td>
...
@%where:tabla|Almacenes;where|Almacenes.id_almacen = $id_almacen_cabecera;nolink|1;%@
<table class="full">
 <caption>Endereço de Entrega(@%db:Almacenes.nombre;%@)</caption>
