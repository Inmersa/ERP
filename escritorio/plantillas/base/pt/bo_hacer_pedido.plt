...
<table class="full">
<thead ><tr>
<td ><a href="?_search_sort=Articulos.nombre" class="order" >Nome<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Marcas.nombre" class="order" >Marca<img src="imag/pixel.png" class="@%func:class_searchsort;Marcas.nombre;%@" /></a></td>
...
<td ><a href="?_search_sort=Empresas_articulos.unidades_bulto" class="order" 
	>Unidades por Embalagem<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.unidades_bulto;%@" /></a></td>
<td >Ofertas / Promoções</td>
</tr></thead>
<tbody>
...
@%else:%@
(Referência: @%db:Empresas_articulos.referencia;%@)
@%end-if:%@
...
<li><a href="#" onClick="return sendForm('hacer_pedido');" class="sumaracesta"><img src="imag/pixel.png" class="icono" /><span>Adicionar</span></a></li>
</ul></div>
