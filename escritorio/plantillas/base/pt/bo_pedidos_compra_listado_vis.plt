...
<form name="bo_pedidos_compras" method="post" action="">
 ...
 <td bgcolor="#DBE0E3" align="center" width="20" class="etiqueta">G</td>
 <td bgcolor="#DBE0E3" align="center" width="20" class="etiqueta">F</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Cliente</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="90" class="etiqueta">Data</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="60" class="etiqueta">Quantidade</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="55" class="etiqueta">Guia de Remessa</td>
 <td width="1"></td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="etiqueta">G - <span class="texto">Guia de Remessa</span></td>
 ...
 <td><img src="imag/amarillo.gif" width="14" height="14"></td>
 <td class="texto">Por Emitir</td>
 <td><img src="imag/rojo.gif" width="14" height="14"></td>
 <td class="texto">Sem Factura</td>
 <td ></td>
 <td class="texto"></td>
 <td class="texto" bgcolor="#DBE0E3"></td>
 </tr>
