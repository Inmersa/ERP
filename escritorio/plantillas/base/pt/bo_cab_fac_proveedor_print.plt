...
<td width="698"> 
 ...
 <tr bgcolor="#CCD2D7" align="center"> <td height="15" class="titul">Factura</td>
 <td class="titul">Ref. Externa</td>
 <td class="titul">Data</td>
 <td class="titul">Peso Total</td>
 <td class="titul">Método de Pagamento</td>
