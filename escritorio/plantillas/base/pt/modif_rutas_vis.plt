 ...
 <table width="647" border="0" cellspacing="0" cellpadding="0">Denominação Comercial
...
<tr bgcolor="#EBECED"> </table>
 ...
 <tr> <td bgcolor="#EBECED" align="right" width="150" height="22" class="etiqueta">Nome da Rota:</td>
 <td width="215" class="texto"> <input type="text" name="registro[nombre]" class="insertext" size="25" value="@%db:Rutas.nombre%@">
 </td>
 <td bgcolor="#EBECED" align="right" width="125" class="etiqueta">Grupo de Rotas:</td>
...
>@%db:Grupo_rutas.nombre%@</option>
 ...
 <tr> <td bgcolor="#EBECED" align="right" height="22" class="etiqueta" width="150">Agente:</td>
...
>@%db:Agentes.nombre%@</option>
 ...
 <tr> <td bgcolor="#EBECED" align="right" height="22" class="etiqueta" width="150">Descrição:</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" class="etiqueta" align="right" width="150">Duração da Visita (minutos) (Minutos): </td>
 <td height="1" width="215"> <input type="text" name="registro[m_visita]" value="@%db:Rutas.m_visita%@" class="texto">
 </td>
 <td height="1" bgcolor="#EBECED" align="right" class="etiqueta" width="125">Duração da Transferência (minutos) (Minutos):</td>
 <td height="1" width="154"> <input type="text" name="registro[m_traslado]" value="@%db:Rutas.m_traslado%@" class="insertext">
 </td>
 </tr>
 <tr> <td height="1" colspan="4" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td height="22" bgcolor="#EBECED" class="etiqueta" align="right" width="150">Frequência/Dias (Dias) :</td>
 <td height="1" width="215"> <input type="text" name="registro[d_frecuencia]" value="@%db:Rutas.d_frecuencia;%@" class="texto">
 </td>
 <td height="1" bgcolor="#EBECED" class="etiqueta" align="right" width="125">Duração da Rota (minutos) (Horas):</td>
 ...
 <a href="javascript:document.forms['modif_rutas'].submit();" class="accesos">Adicionar</a></td>
 </tr>
 </table>
 </form>
 </td>
 ...
 <tr> <td bgcolor="#91CC00" height="20" class="titocho">>Lista de Clientes por Rota</td>
 </tr>
</table>
...
<tr> <td bgcolor="#DBE0E3" width="1" class="etiqueta" align="center"></td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="170">Cliente<span class="texto"> | Raz&oacute;n social</span></td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="170">Endereço</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Meio de Contacto</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Ordem</td>
