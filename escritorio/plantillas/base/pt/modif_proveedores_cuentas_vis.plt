 ...
 <td class="etiqueta" bgcolor="#CCD2D7" >Contas Contabilísticas:</td>
 </tr>
 </table>
 <table width="644" border="0" cellspacing="0" cellpadding="0">
...
<input type="hidden" name="registro2[cc_compras]" value="@%db:Proveedores_empresas.cc_compras;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Descontos:</td>
...
<input type="hidden" name="registro2[cc_gastos]" value="@%db:Proveedores_empresas.cc_gastos;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta" width="161">Retenções:</td>
...
<input type="hidden" name="registro2[cc_retenciones]" value="@%db:Proveedores_empresas.cc_retenciones;%@" class="insertext" size="10" maxlength="10">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Ordens de Pagamento:</td>
...
<input type="hidden" name="registro2[cc_efectos]" value="@%db:Proveedores_empresas.cc_efectos;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <td height="22" width="49" align="center">País / DC</td>
 <td height="22" width="68" align="center">Entidade</td>
 <td height="22" width="65" align="center">Escritório</td>
 <td height="22">DC/N.º Conta</td>
 </tr>
 <tr> 
 <td width="161" align="right" bgcolor="#EBECED" height="22">IBAN:</td>
 ...
 <tr> <td align="right" class="etiqueta" height="22" bgcolor="#EBECED">Data de Registo:</td>
 ...
 <td align="right" class="etiqueta" height="22" bgcolor="#EBECED">Activo:</td>
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta" valign="top">Observações:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">% Desconto:</td>
...
<input type="hidden" name="registro2[descuento]" value="@%db:Proveedores_empresas.descuento;%@" class="insertext" size="4">
 ...
 <tr> <td width="162" bgcolor="#EBECED" align="right" class="etiqueta">Aplicar Custo Extra :</td>
 <td> <!--@%db:Proveedores.aplicar_recargo;%@-->
 </td>
 <td bgcolor="#EBECED" align="right" width="200" class="etiqueta">Aplicar IVA (Extracomunitário):</td>
 <td>
...
<table width="644" border="0" height="22" cellspacing="0" cellpadding="0">
 <tr> 
 <td class="etiqueta" align0"right" width="200" bgcolor="#EBECED">Desconto Financeiro:</td>
...
<tr><td height="22">
 ...
 <tr> 
 <td class="etiqueta" height="20" width="172" >Dias do pagamento</td>
 </tr>
 </table>
 <table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr>
