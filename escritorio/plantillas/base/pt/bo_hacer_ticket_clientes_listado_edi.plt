...
<form name="compra_articulos" method="post" action="?seccion=hacer_ticket">
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Contacto</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">CIF</td>
...
@%where:tabla|Clientes;nombre|busc;no_results|1;%@
 ...
 <tr>
 <td bgcolor="#CCD2D7" align="center" height="22"><a href="" onclick="document.forms['compra_articulos'].submit();return false;" class="accesos">Seleccionar</a>
