 ...
 <td ><a href="?_search_sort=Facturas.referencia" class="order" >Referência<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.referencia;%@" /></a></td>
 ...
 <td ><a href="?_search_sort=Forma_pago.nombre" class="order" >Modo de Pagamento<img src="imag/pixel.png" class="@%func:class_searchsort;Forma_pago.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Tarifas.nombre" class="order" >Tarifa<img src="imag/pixel.png" class="@%func:class_searchsort;Tarifas.nombre;%@" /></a></td>
