...
<li><a href="?seccion=nuevo_grupo_familias" class="accesos" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Novo</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_grupo_familias');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
</ul></div>
