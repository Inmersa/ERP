...
<form method="post" ENCTYPE="multipart/form-data"
 ...
 <span class="bordesbot"><a href="" onclick="window.close()">Fechar</a></span> </td>
 </tr>
 </table>
 <br>
 </td>
 ...
 <tr> <td class="texto_negrita_sinfondo" width="314" height="22"> Imagem: <input height="20" size="30"
 type="file"
 style="border: 2 #989898 solid; height: 23;"
 name="foto">
 </td>
 ...
 <tr> <td class="bordes"><a href="javascript:document.form_ficha.reset()" class="texto_negrita_sinfondo">Desfazer Alterações</a></td>
 </tr>
 </table>
 </td>
 </tr>
