...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="485" >&gt; Histórico de Encomendas</td>
 <td class="titocho" width="110" align="center" ><a href="?seccion=cli_hacer_pedido&pedido=1" class="accesos">Nova Encomenda</a></td>
 ...
 <tr> <td class="texto">Resultados Obtidos: @%func:numero_resultados;%@</td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 <tr> <td height="5"></td>
...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="100">Código</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="83">Data</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="240">Endereço de Entrega</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="83">Quantidade</td>
 <td width="1"></td>
