...
<thead>
 ...
 <td ><a href="?_search_sort=Direcciones_entrega.direccion" >Endereço de Entrega<img src="imag/pixel.png" class="@%func:class_searchsort;Direcciones_entrega.direccion;%@" /></a></td>
 <td ><a href="?_search_sort=monto_pedido" >Valor Tributável<img src="imag/pixel.png" class="@%func:class_searchsort;monto_pedido;%@" /></a></td>
 <td class="estado" >E</td>
