...
<div class="tituloseccion" >Tipos de Anotação</div>
...
<li><a href="?seccion=nuevo_tipo_anotacion" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Novo</span></a></li>
@%end-if:%@
