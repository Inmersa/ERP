 ...
 <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Nome:</td>
 <td width="228"> <input type="text" name="registro[nombre]" class="insertext" size="30" value="@%db:Proveedores.nombre;%@"/>
 </td>
 <td width="87" class="titul1" align="right" bgcolor="#EBECED">NIF Intracomunitário:</td>
 <td width="168">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Distrito:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Pessoa de Contacto:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="titul1" align="right">Telefone 1:</td>
 <td width="168"> <input type="text" name="registro[telefono1]" value="@%db:Proveedores.telefono1;%@" class="insertext" size="20"/>
 </td>
 </tr>
 <tr> <td colspan="4" bgcolor="#CCD2D7" height="1"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Cargo do Contato:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="titul1" align="right">Telefone 2:</td>
 ...
 <tr> <td width="161" height="22" align="right" bgcolor="#EBECED" class="titul1">Data de Registo:</td>
...
<input type=hidden name=registro2[id_usr] value="@%db:Proveedores_empresas.id_usr%@">
 ...
 <td class="titul1" height="20" >Dados da Empresa</td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td align="right" height="22" bgcolor="#EBECED" class="titul1" width="161">Método de Pagamento:</td>
...
@%end-where:%@
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="titul1">Retenção:</td>
