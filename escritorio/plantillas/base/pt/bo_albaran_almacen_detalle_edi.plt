...
<li><a href="#" onclick="return SendFormToWindow('bo_albaran_almacen','nuevo_bajas_almacen','BajaLocalizacion','accion_ejecutar','',600);" class="rechazar" ><img src="imag/pixel.png" class="icono" /><span>Devolver</span></a></li>
@%end-if:%@

@%if:esta_vacio;preparado;%@
<li><a href="#" onclick="return SendFormToWindow('bo_albaran_almacen','albaran_localizaciones','Localizaciones',null,null,640);" class="verlocalizaciones" ><img src="imag/pixel.png" class="icono" /><span>Ver Localizações</span></a></li>
