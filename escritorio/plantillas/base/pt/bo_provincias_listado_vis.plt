...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="191">Nome</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="213" >Países</td>
 <td class="etiqueta" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" >Código</td>
 <td class="etiqueta" width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" >Prefixo Telefónico</td>
