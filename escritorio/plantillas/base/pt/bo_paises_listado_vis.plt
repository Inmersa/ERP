...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center" width="80">Código</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Continente</td>
 <td width="1" class="etiqueta"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center" width="80">Prefixo Telefónico</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center" width="80">Prefixo CIF</td>
