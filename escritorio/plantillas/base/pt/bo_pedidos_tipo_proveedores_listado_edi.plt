...
<li><a href="#" onclick="return sendForm('pedidos_tipo_proveedor');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
@%set:permitir_selecciones = 1;%@
@%end-if:%@
</ul></div>
...
<thead>
<tr>
<td ><a href="?_search_sort=Pedidos.referencia" >Nossa Ref.<img src="imag/pixel.png" class="@%func:class_searchsort;Pedidos.referencia;%@" /></a></td>
 @%if:!esta_vacio;permitir_selecciones;%@
 <td ></td>
 @%end-if:%@
<td ><a href="?_search_sort=Pedidos_tipo_proveedor.nombre" >Nome<img src="imag/pixel.png" class="@%func:class_searchsort;Pedidos_tipo_proveedor.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Pedidos.fecha" >Data<img src="imag/pixel.png" class="@%func:class_searchsort;Pedidos.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Pedidos.referencia_externa" >Ref. Externa<img src="imag/pixel.png" class="@%func:class_searchsort;Pedidos.referencia_externa;%@" /></a></td>
