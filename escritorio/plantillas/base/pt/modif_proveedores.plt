...
<div class="barraoscura"><div class="titsuperior">&gt; Ficha de Fornecedor (ID: @%db:Proveedores.id_proveedor;%@)</div></div> 

<div id="AccionesEncabezado"><ul>
<li><a href="?seccion=nuevo_proveedores" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Novo Fornecedor</span></a></li>
</ul></div>
...
><div name="Condiciones" class="activo" >Condições</div
@%end-if:%@
@%if:AllowedPII;Descuentos;%@
><div name="Descuentos" >Comercial</div
@%end-if:%@
@%if:AllowedPII;Reposicion;%@
><div name="Reposicion" >Substituição</div
@%end-if:%@
@%if:AllowedPII;Cuentas_Contables;%@
><div name="CuentasContables" >Financeiro</div
@%end-if:%@
@%if:AllowedPII;Login;%@
><div name="Acceso" >Acesso</div
@%end-if:%@
@%if:AllowedPII;Observaciones;%@
><div name="Observaciones" >Observações</div
@%end-if:%@
></div>
