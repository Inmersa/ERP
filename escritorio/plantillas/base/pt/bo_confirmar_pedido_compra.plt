...
@%if:esta_vacio;es_factura;%@
 Orçamento @%set:send_form_to=bo_presupuestos_compras;%@
 @%else:%@ 
 Factura @%set:send_form_to=bo_facturas_compra;%@
 @%end-if:%@ 
@%else:%@ 
Encomenda @%set:send_form_to=bo_pedidos_compras;%@
@%end-if:%@ 
</td>
 <td width="46" align="center" ><a href="?seccion=hacer_pedido_compra" class="accesos">Voltar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#CCD2D7" class="titul1">Converter em Encomenda Padrão <input type="checkbox" name="pedido_tipo" value="1">
 </td>
 </tr>
 <tr>
 <td height="10"></td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#CCD2D7" height="22" class="titul1">Fornecedor</td>
 </tr>
 ...
 <tr> <td height="22" align="right" bgcolor="#EBECED" class="titul1">Nome:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Endereço:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Localidade:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">Distrito:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">Telefone:</td>
...
@%set:observaciones_en_totales=observaciones;%@
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="112" height="22">Nome do Documento :</td>
...
@%end-where:%@
 ...
 <tr> <td width="6"></td>
 <td width="419"></td>
 <td align="center" width="100"><a href="?seccion=hacer_pedido_compra" class="accesos">Adicionar Produto </a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" height="20" class="titul1">Nome</td>
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Quantidade</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Preço</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="titul1" align="center" width="60">IVA</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center" width="60"> Descontos </td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="110">Montante</td>
...
@%end-if:%@
 ...
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center">Valor Tributável</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1">IVA %</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="120">Sobretaxa Equivalente %</td>
 <td width="1" height="20" bgcolor="#DBE0E3"></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="titul1" align="center">Valor Tributável</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center">Desconto</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="80">Montante</td>
 <td width="1" bgcolor="#DBE0E3" height="20"></td>
 </tr>
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="titul1" height="22">Montante Total </td>
 </tr>
...
<br><br>
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="titul1" height="22">Montante de @%db:divisa_cliente_nombre%@</td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="1"></td>
