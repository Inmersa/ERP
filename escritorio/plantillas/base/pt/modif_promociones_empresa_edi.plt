...
Nome da Promoção</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" align="center" class="etiqueta">Produto</td>
 <td width="1"></td>
 <td width="80" bgcolor="#DBE0E3" align="center" class="etiqueta">Data de Ínicio</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" class="etiqueta" width="80">Data Final</td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr> 
 <td colspan="7" bgcolor="#DBE0E3" height="22" align="center" class="etiqueta"> Fecha Inicio
<input type="text" name="registro[fecha_inicio]" value="@%db:colocar_fecha{Promociones.fecha_inicio};%@" size="10" class="insertextnumeros">
 Data de Finalização<input type="text" name="registro[fecha_fin]" value="@%db:colocar_fecha{Promociones.fecha_fin};%@" size="10" class="insertextnumeros">


<a href="" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Modificar');" class="accesos">Activar</a>
