...
<li><a href="#" onClick="return onHRefClick('listado_efectos','accion_ejecutar','Abonar');" 
	class="abonar" ><img src="imag/pixel.png" class="icono" /><span>Pagar</span></a></li>
<li><a href="#" onClick="return onHRefClick('listado_efectos','accion_ejecutar','Devolver');"
	class="devolverabono" ><img src="imag/pixel.png" class="icono" /><span>Devolver</span></a></li>
...
<li><a href="#" onClick="return SendFormToWindow('listado_efectos','modif_efectos_cliente&imprimir=1','Imprimir');"
	class="imprimir" ><img src="imag/pixel.png" class="icono" /><span>Imprimir</span></a></li>
...
<thead>
<tr>
<td ><a href="?_search_sort=Clientes.id_cliente" class="order" >Código<img src="imag/pixel.png" class="@%func:class_searchsort;Clientes.id_cliente;%@" /></a></td>
...
<td ><a href="?_search_sort=Clientes.razon_social" class="order" 
	>Denominação Comercial<img src="imag/pixel.png" class="@%func:class_searchsort;Clientes.razon_social;%@" /></a></td>
...
<td ><a href="?_search_sort=Facturas.base_imponible" class="order" >Valor Tributável<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.base_imponible;%@" 
	/></a></td>
