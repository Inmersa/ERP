...
<td ><a href="?_search_sort=Localizacion_articulos.id_articulo" 
	>ID<img src="imag/pixel.png" class="@%func:class_searchsort;Localizacion_articulos.id_articulo;%@" /></a> </td>
<td ><a href="?_search_sort=Articulos.codigo_barras" >Código de Barras<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.codigo_barras;%@" /></a> </td>
<td ><a href="?_search_sort=Empresas_articulos.referencia" 
	>Referência<img src="imag/pixel.png" class="@%func:class_searchsort;Empresas_articulos.referencia;%@" /></a></td>
<td ><a href="?_search_sort=Articulos.nombre" >Nome do Produto<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a> </td>
<td ><a href="?_search_sort=Marcas.nombre" >Marca<img src="imag/pixel.png" class="@%func:class_searchsort;Marcas.nombre;%@" /></a> </td>
<td ><a href="?_search_sort=cantidad" >Stock<img src="imag/pixel.png" class="@%func:class_searchsort;cantidad;%@" /></a></td>
<td ><a href="?_search_sort=caducidad" >Data de Validade Inferior<img src="imag/pixel.png" class="@%func:class_searchsort;caducidad;%@" /></a></td>
<td ><a href="?_search_sort=caducidad_mayor" >Data Caducidade mais grande<img src="imag/pixel.png" class="@%func:class_searchsort;caducidad_mayor;%@" /></a></td>
<td ><a href="?_search_sort=valor" >Valor<img src="imag/pixel.png" class="@%func:class_searchsort;valor;%@" /></a></td>
</tr></thead>
...
@%if:esta_vacio;st[id_alml];%@
	...
	@%if:cambia_var_x;%@
	<thead class="secundario" ><tr><td colspan="5">Zona Armazém: @%db:Almacenes_logicos.nombre;%@</td>
