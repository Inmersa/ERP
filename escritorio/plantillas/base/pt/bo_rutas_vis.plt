...
@%plt:botonera%@
 ...
 <tr> <td align="left">
<a href="" class="accesos">Adicionar</a>
</td>
<td width="20" align="center"></td>
 <td align="center">
<a href="#" onClick="return onHrefClick('bo_rutas','accion_ejecutar', 'Generar');" class="accesos">Gerar Percursos</a>
</td>
<td ></td>
 <td width="146" align="right">
<a href="#" onClick="return onHrefClick('bo_rutas','accion_ejecutar', 'Borrar');" class="accesos">Eliminar Itens Seleccionados</a>
</td>
 <td width="4"></td>
 </tr>
 </table>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="288">Rota</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Frequência de Dias</td>
 <td width="1"></td>

 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Última Data </td>
 <td width="1"></td>

 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Nº Cliente</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="257" align="center">Agente </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="176">Data Seguinte</td>
 <td width="1"></td>
 </tr>
