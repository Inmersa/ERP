...
<a href="?seccion=bo_facturas_venta">Facturas de Venda</a>
@%end-if:%@
...
@%else:%@
 ...
 @%else:%@
 <a href="?seccion=@%get:link_pedido_en_curso;%@">Encomenda</a>
 @%end-if:%@
@%end-if:%@
</div>
 ...
 <div id="usuario">Utilizador: @%func:get_from_user;user_name;%@</div>
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_proveedores">Fornecedores</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_articulos">Produtos</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_almacenes">Armazéns</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_pedidos_ventas">Vendas</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_maestros">Configuração</a></li>
	@%end-if:%@
@%end-if:%@
</ul>
</div>
