...
<thead><tr>
<td class="nombregrupo" >Produto</td>
<td>Quantidade</td>
<td>Preço</td>
<td>Desconto</td>
<td>Total</td>
...
@%if:!esta_vacio;romper_linea;%@
	...
	<div class="titulo">Resumido por Número</div>
	<div class="resumen" >
	<table class="subtotal">
	<thead><tr>
	<td class="nombregrupo" >Produto</td>
...
<table class="subtotal">
<thead><tr>
<td class="nombregrupo" >Telefone</td>
<td>Duração</td>
<td>Consumo</td>
<td>Desconto</td>
<td>Total</td>
...
<div class="titulo">Resumido por Conceito</div>
<div class="resumen" >
...
<table class="subtotal">
<thead><tr>
<td class="nombregrupo" >Conceito</td>
<td>Duração</td>
<td>Consumo</td>
<td>Desconto</td>
<td>Total</td>
