...
<legend >&gt; Alterar Família de Produtos</legend>
<table class="full">
 <tr> 
 ...
 <tr> 
 <td class="etiqueta" >Matéria Prima:
 ...
 <tr><td class="etiqueta" >Grupo de Famílias:</td>
 <td >
...
<li><a href="#" onClick="return resetForm('modif_familia_articulos');"  class="deshacer" 
 	><img src="imag/pixel.png" class="icono" /><span>Desfazer Alterações</span></a></li> 
