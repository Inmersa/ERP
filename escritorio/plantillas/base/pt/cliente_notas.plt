...
<li><a href="#" onClick="return sendForm('notas','accion_ejecutar','Borrar');" class="borrar"><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
</ul></div>
@%end-if:%@
...
@%if:AllowedAction;Cliente_notas;del;%@
 <td >&nbsp;</td>
@%end-if:%@
 <td ><a href="?_search_sort=Cliente_notas.nombre" class="order" >Nome<img src="imag/pixel.png" class="@%func:class_searchsort;Cliente_notas.nombre;%@" /></a></td>
 ...
 <td ><a href="?_search_sort=Cliente_notas.fecha" class="order" >Data<img src="imag/pixel.png" class="@%func:class_searchsort;Cliente_notas.fecha;%@" /></a></td>
 <td >Utilizador</td>
</tr>
</thead>
<tbody>
...
<li><a href="#" onClick="return sendForm('nuevo');" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Novo</span></a></li>
</ul></div>
@%end-if:%@
