...
<legend>Pagamentos Parciais</legend>

<div class="AccionesFicha"><ul>
<li><a href="#" onClick="return onHRefClick('efecto','accion_ejecutar','Borrar_parciales');"  class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
