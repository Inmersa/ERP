...
<!-- div class="tituloseccion">&gt; Nova Família de Produtos</div -->
...
<legend>&gt; Nova Família de Produtos</legend>
<table class="full">
<tr>
...
<tr><td class="etiqueta">Matéria Prima:</td>
<td class="check"><input type="checkbox" name="registro[materia_prima]" value="1" /></td>
</tr>
<tr>
<td class="etiqueta">Grupo de Famílias:</td>
