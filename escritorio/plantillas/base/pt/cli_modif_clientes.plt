...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr align="center"> <td ><a href="javascript: history.go(-1);" class="accesos">Voltar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<tr> <td colspan="4" height="22" bgcolor="#CCD2D7"> <table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <!--@%Clientes.id_cliente;%@-->
 <td class="etiqueta" height="20" > Clientes da Empresa</td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td width="161" class="etiqueta" align="right" height="22" bgcolor="#EBECED">Endereço de Facturação:</td>
 ...
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Pessoa de Contacto:</td>
 ...
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Cargo do Contacto:</td>
 ...
 <tr> <td width="161" align="right" bgcolor="#EBECED" height="22" class="etiqueta">Iniciar Sessão:</td>
 <td width="483">
 ...
 <tr> <td width="161" align="right" bgcolor="#EBECED" height="22" class="etiqueta">Repetir a Palavra-Passe:</td>
 <td width="483">
 ...
 <tr> <td width="6" align="center" height="20" ></td>
 <td class="etiqueta" height="20" width="172" >Endereços de Entrega:</td>
 <td class="etiqueta" height="20" width="466" align="right" ><a href="?seccion=cli_nuevo_direcciones_entrega&amp;id_cliente=@%db:Clientes.id_cliente%@" class="accesos">Adicionar Endereço</a> <a href="" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Borrar');" class="accesos">Eliminar Endereços</a>
 </td>
 </tr>
 </table>
 </td>
...
<a href="" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Modificar');" class="accesos">Alterar</a>
 </td>
 </tr>
 </>
 </table>
