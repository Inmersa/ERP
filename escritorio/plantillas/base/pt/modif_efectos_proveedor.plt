...
class="tituloseccion"
@%end-if:%@
>&gt; Alterar Ordem de Pagamento (ID: @%db:Proveedores.id_proveedor;%@) @%db:Proveedores.razon_social;%@</div>
...
<li><a href="#" onClick="return resetForm('efecto');"  class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Desfazer Alterações</span></a></li>
</ul></div>
@%end-if:%@
