...
<td ><a href="?_search_sort=Compra_articulos.precio" >Preço<img src="imag/pixel.png" class="@%func:class_searchsort;Compra_articulos.precio;%@" /></a></td>
...
<li><a href="#" onclick="return sendForm('hacer_pedido_compra');" class="sumaracesta" ><img src="imag/pixel.png" class="icono" /><span>Adicionar</span></a></li>
</ul></div>
</form>
