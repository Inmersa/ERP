...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Reembolsos de Cobro</td>
<td colspan="@%get:_iterate_times;%@" >Reembolsos de Pagamento</td></td>
...
<!-- 
@%set:grafica[titulo] = Reembolsos de Cobro;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Reembolsos de Pagamento;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
