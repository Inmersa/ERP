...
<div class="barraoscura"><div class="titsuperior">&gt; Adicionar Endereço de Entrega</div></div>
...
<div class="enviar">
<a href="" onClick="document.forms['nuevo_direcciones_entrega'].submit();return false;" >Adicionar</a>
</div>
</form>
