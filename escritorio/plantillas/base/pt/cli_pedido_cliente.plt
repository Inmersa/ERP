...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="46" align="center" ><a href="javascript:history.go(-1);" class="accesos">Voltar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
-->
 <tr> <td height="22" align="right" bgcolor="#EBECED" class="etiqueta">Nome:</td>
...
<tr> <td bgcolor="#EBECED" align="right" class="texto" width="80" height="22">Referência Externa:</td>
...
<tr> <td bgcolor="#EBECED" align="right" class="texto" width="80" height="22">Referência:</td>
...
<!--@%wdb:Pedidos.id_agente%@--> </td>
 ...
 <td bgcolor="#EBECED" align="right" class="texto">Modo de Pagamento:</td>
 <td colspan="2">
...
@%end-if:%@
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center" width="60"><span class="texto">%</span>Envolvido </td>
 <td width="1" height="20"></td>
