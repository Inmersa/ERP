...
><img src="imag/pixel.png" class="icono" /><span>Verificar</span></a></li>
@%end-if:%@
@%end-if:%@
...
@%if:equals_any;estado;2;%@
	...
	><img src="imag/pixel.png" class="icono" /><span>Consolidar</span></a></li>
	@%end-if:%@
@%else:%@
...
@%if:esta_vacio;id_rfq;%@
	<li><a href="?seccion=rfqs&modo_seleccion=1" class="enlazarrfq" ><img src="imag/pixel.png" class="icono" /><span>Seleccionar RFQ</span></a></li>
@%end-if:%@

<li><a href="#" onclick="window.open('?@%env:QUERY_STRING%@&imprimir=1'); return false;" class="imprimir"><img 
src="imag/pixel.png" class="icono" /><span>Imprimir</span></a></li>
...
<li><a href="#" onclick="return sendForm('pedido');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Guardar Alterações</span></a></li>
</ul></div>
@%end-if:%@ 
