...
<legend>Incidências</legend>

<div class="AccionesFicha">
<ul>
@%if:AllowedAction;Citas_Incidencias_CRM;new;%@
<li><a href="?seccion=nueva_incidencia_crm&id_cita=@%get:id_documento%@" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nova Incidência</span></a></li> 
@%end-if:%@
