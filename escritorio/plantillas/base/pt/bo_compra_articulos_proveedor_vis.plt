...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="70">Referência Própria</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Referência do Fornecedor </td>
 <td width="1"></td>
 <td width="20" bgcolor="#DBE0E3"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Nome do Produto </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center"></td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Preço</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="65" align="center">Desconto %</td>
 <td class="etiqueta" align="center" width="1"></td>
