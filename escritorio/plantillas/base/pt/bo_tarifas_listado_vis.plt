...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta">Primeiro Desconto</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Segundo Desconto</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Quantidade</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Campo de Acção</td>
