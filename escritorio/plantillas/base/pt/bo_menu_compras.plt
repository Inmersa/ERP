...
<div class="menuitem"> <a href="?seccion=bo_pedidos_compras" @%func:querystring_activa;bo_pedidos_compras;activo;;%@ >Encomendas</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_compra;%@
<div class="menuitem"> <a href="?seccion=bo_albaranes_compra" @%func:querystring_activa;bo_albaranes_compra;activo;;%@ >Guias de Remessa</a></div>
@%end-if:%@
@%if:AllowedLink;bo_facturas_compra;%@
<div class="menuitem"> <a href="?seccion=bo_facturas_compra" @%func:querystring_activa;bo_facturas_compra;activo;;%@ >Facturas</a></div>
@%end-if:%@
