<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td align="center" ></td>
 <td align="center" ></td>
 <td width="46" align="center" ><a href="?seccion=cli_hacer_pedido" class="accesos">Voltar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
-->
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="112" height="22">Nome da Encomenda:</td>

 <td class="texto" width="190"> <input type="text" name="registro[nombre]" class="insertext" size="25">
 </td>
 <td bgcolor="#EBECED" class="texto" width="95" align="right">Endereço de Entrega::</td>
 <td width="220">
...
<!--<a href="?seccion=hacer_pedido" class="accesos">Adicionar Produto </a>-->
 </td>
 </tr>
 </table>
 </td>
