...
<input type="hidden" name="estado" value="3">
 ...
 <td align="right" width="148"><a href="javascript:document.forms['bo_empresas'].submit();" class="accesos">Eliminar Itens Seleccionados</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="100">Grupo</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="100">CIF</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3" width="200">Denominação Comercial </td>
 <td width="1"></td>
 </tr>
