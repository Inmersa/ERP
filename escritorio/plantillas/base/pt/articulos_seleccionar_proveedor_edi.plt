...
<li><a href="#" onclick="return onHRefClick('proveedores','accion_ejecutar','asociar_proveedores');" class="enviar" 
	><img src="imag/pixel.png" class="icono" /><span> Associar Itens Seleccionados</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=Proveedores.nombre" >Nome<img src="imag/pixel.png" class="@%func:class_searchsort;Proveedores.nombre;%@" /></a></td>
<td >Preço</td>
<td >Pr.Rt Oficial</td>
