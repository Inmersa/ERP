...
@%if:anterior%@
<a href="#" onClick="return arrastre_paginado('FormPaginacion','@%func:pg_ant%@');" >Anterior</a>
@%end-if:%@ 
...
@%if:siguiente%@
 <a href="#" onClick="return arrastre_paginado('FormPaginacion','@%func:pg_sig%@');">Seguinte</a>
@%end-if:%@
...
</div><div class="alinder">Resultados Obtidos: @%func:numero_resultados;%@</div>
</div>
