...
<tr> <td bgcolor="#FFFFFF" height="30">
 ...
 <a href="javascript:document.forms['modif_certificados'].submit();" class="accesos">Eliminar Itens Seleccionados</a> 
</td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22" width="24"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="150">Nome</td>
 <td class="etiqueta" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="300">Descrição</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="100" align="center" >Responsável</td>
