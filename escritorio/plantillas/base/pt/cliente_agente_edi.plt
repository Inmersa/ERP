...
@%if:AllowedLink;bo_cliente_agentes;%@
	...
	<li><a href="?seccion=bo_cliente_agentes&amp;id_cliente=@%db:Clientes.id_cliente%@"  class="seleccionar" 
		><img src="imag/pixel.png" class="icono" /><span>Adicionar Agente</span></a></li>
	@%end-if:%@
@%end-if:%@
...
<li><a href="#" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Borrar');"  class="borrar" 
	><img src="imag/pixel.png" class="icono" /><span>Eliminar Agente</span></a></li>
@%end-if:%@
</ul></div>
@%end-if:%@
...
<td class="caption">Data de Entrada</td>
<td class="caption">Comissão</td>
<td class="caption">Comissão Partilhada</td>
</tr>
