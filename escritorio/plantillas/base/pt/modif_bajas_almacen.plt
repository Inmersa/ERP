...
<input type="hidden" name="accion_ejecutar" value="Modificar" />
 <div class="barraoscura"><div class="titsuperior">&gt; Alterar Quebra de Armazém</div></div>
...
<tr><td class="etiqueta">Data da Quebra de Armazém :</td>
<td>@%db:colocar_fecha{Bajas_localizacion.fecha_baja};%@</td></tr>

<tr><td class="etiqueta"> Zona Armazém : </td>
...
@%end-if:%@
<tr><td class="etiqueta"> Localização : 
</td><td >
...
<tr><td class="etiqueta">Tipo de Devolução:</td>
<td>
...
<tr><td class="etiqueta" > Motivo de Devolução : </td>
...
<li><a href="#" onClick="return sendForm('bajas_localizacion');"  class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Desfazer Alterações</span></a></li>
