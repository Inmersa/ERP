...
<table class="full">
 ...
 <tr><td class="etiqueta">Campo de Acção:</td>
 <td colspan="2"> 
 ...
 <tr><td class="etiqueta">Campo de Preço Recomendado:</td>
 ...
 <tr><td class="etiqueta">Cálculo de Preço Recomendado:</td>
...
@%db:check_flag{Tarifas.coniva_recomendacion};%@ />Acrescentar IVA ao Preço Recomendado </td>
 </tr>
 </table>
 </form>
 ...
 <li><a href="#" onClick="return resetForm('modif_tarifas');"  class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Desfazer Alterações</span></a></li>
