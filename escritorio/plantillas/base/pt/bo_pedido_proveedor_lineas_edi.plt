...
<li><a href="" onclick="return onHRefClick('pedido','accion_ejecutar','Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Artigo(s)</span></a></li>
</ul>
</div>
@%end-if:%@
