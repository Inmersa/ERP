...
<div class="titsuperior">&gt; Ajuda</div><div class="alinder">
...
<td class="caption">Título</td>
<td class="caption">Subsecção</td>
</tr>
...
@%plt:botonera%@
<div class="enviar"><a href="#" onClick="return sendForm('modif_ayuda');">Eliminar Itens Seleccionados</a></div>
