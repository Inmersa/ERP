...
<form name="compra_articulos" method="post" action=""> 
<input type="hidden" name="nuevo" value="1">
 ...
 <td bgcolor="#DBE0E3" class="etiqueta">Cliente<span class="texto"> | Raz&oacute;n social</span></td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="170">Contacto</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">CIF</td>
 <td width="1"></td>
 </tr>
 ...
 <td></td>
 <td bgcolor="#DBE0E3" valign="top"> <input type="radio" name="id_proveedor_pedido" value="@%db:Proveedores.id_proveedor;%@" >
 </td>
 <td class="texto"> <p><a href="?seccion=modif_proveedores&id_proveedor=@%db:Proveedores.id_proveedor;%@" class="accesos">@%db:Proveedores.nombre;%@</a><br>
 ...
 <tr align="center"> <td > 
<a href="" onclick="document.forms['compra_articulos'].submit();return false;" class="accesos">Seleccionar</a></td>
