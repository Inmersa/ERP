...
<li><a href="?seccion=nuevo_rappel_cliente" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Adicionar Rappel</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return onHRefClick('rappel_cliente','accion_ejecutar','Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Eliminar Itens Seleccionados</span></a></li>
</ul></div>
...
<thead>
<tr>
<td colspan="3">Concluido em 12 Meses</td>
