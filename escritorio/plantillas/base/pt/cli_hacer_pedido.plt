<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="323" >&gt; Selecção de Produtos</td>
...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" colspan="2">Nome<span class="texto"></span></td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="250">Descrição</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="0">Preço </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="0">IVA</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Embalagens</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Quantidade</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" colspan="3" bgcolor="#DBE0E3">Ofertas / Promoções</td>
 ...
 <a href="" onclick="document.forms['hacer_pedido'].submit();return false;"class="accesos">Adicionar</a></td>
 </tr>
 </form>
 </table>
