...
<tr> <td colspan="7" bgcolor="#CCD2D7" height="1"></td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="71" height="22">Referência Externa:</td>
...
@%end-if:%@
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="71" height="22">Referência:</td>
 <td colspan="2" class="texto"> @%db:referencia;%@
 </td>
 <td bgcolor="#EBECED" class="texto" align="right" width="274">Feito por:</td>
 ...
 <td bgcolor="#EBECED" align="right" class="texto" width="69">Modo de Pagamento:</td>
 <td colspan="2">
