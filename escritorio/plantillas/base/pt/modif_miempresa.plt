...
<div class="tituloseccion">&gt; Ficha da Empresa</div>
...
<li><a href="#" onClick="return sendForm('modif_empresas');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Alterar</span></a></li>
</ul></div>
@%end-if:%@
