...
><img src="imag/pixel.png" class="icono" /><span>Verificar Itens Seleccionados</span></a></li>
@%end-if:%@
...
><img src="imag/pixel.png" class="icono" /><span>Transformar em Factura Pró-forma</span></a></li>
@%end-if:%@
@%end-if:%@
...
><img src="imag/pixel.png" class="icono" /><span>Rejeitar</span></a></li>
@%end-if:%@
...
class="imprimirmultiple"><img src="imag/pixel.png" class="icono" /><span>Impressão Múltipla</span></a></li>
...
<td ><a href="?_search_sort=Presupuestos.fecha" >Data<img src="imag/pixel.png" class="@%func:class_searchsort;Presupuestos.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Presupuestos.base_imponible" >Valor Tributável<img src="imag/pixel.png" class="@%func:class_searchsort;Presupuestos.base_imponible;%@" /></a></td>
<td ><a href="?_search_sort=Presupuestos.impuestos" >Impostos<img src="imag/pixel.png" class="@%func:class_searchsort;Presupuestos.impuestos;%@" /></a></td>
