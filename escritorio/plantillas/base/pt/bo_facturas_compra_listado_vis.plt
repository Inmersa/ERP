...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" width="150">Fornecedor</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="80">Data</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="80">Valor Tributável</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="65">Impostos</td>
 <td width="1"></td>
