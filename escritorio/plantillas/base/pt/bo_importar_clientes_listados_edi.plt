...
<input type="hidden" name="accion_ejecutar" value="Importar">
 ...
 <td >Código</td>
 <td ></td>
 <td >Denominação Comercial do Cliente| Denominação Comercial do Cliente</td>
 <td >Contacto</td>
 <td >CIF</td>
 </tr>
 </thead>
 ...
 <ul>
 <li><a href="#" onclick="return sendForm('importar_clientes');" class="enviar"><img src="imag/pixel.png" class="icono" /><span>Recuperar</span></a></li>
 </ul>
 </div>
