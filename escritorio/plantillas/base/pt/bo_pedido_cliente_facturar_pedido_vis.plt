<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td height="22" bgcolor="#CCD2D7" class="etiqueta" align="right"><a href="" onclick="document.forms['generar_albaran'].submit();return false;" class="accesos">Gerar Guia de Remessa</a></td>
 <td></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="texto" width="92" align="center">Transportador:</td>
 ...
 <tr> <td height="20" bgcolor="#EBECED" align="right" class="texto" width="92">Preparada:</td>
 ...
 <td bgcolor="#EBECED" width="91" align="right" class="texto">Confirmação:</td>
...
<select name="id_forma_pago" class="insertext">
 ...
 <tr> <td bgcolor="#EBECED" class="texto" width="120" align="right">Referência:</td>
 <td class="insertext" colspan="3">
 <input type="text" name="contador" class="insertext" size="16">
 Encomenda Residual <input type="checkbox" name="residuo" value="1" checked>
 </td>
 </tr>
