...
<form method="post" ENCTYPE="multipart/form-data"
 ...
 <tr> <td class="titulo_seccion" height="2" width="218" valign="middle"> <div align="center"><font color="#FFFFFF">Image Card</font></div>
 </td>
 ...
 <span class="bordesbot"><a href="" onclick="window.close()">Close</a></span> </td>
 </tr>
 </table>
 <br>
 </td>
 </tr>
 <tr> <td class="texto_negrita_sinfondo" height="33" colspan="2">Author: <input height="20" size="49"
 type="text"
 ...
 <tr> <td colspan="2" class="texto_negrita_sinfondo"> Location: <input height="20" size="44"
 type="text"
 style="border: 2 #989898 solid; height: 23;"
 name="registro[lugar_toma]">
 </td>
 </tr>
 <tr> <td class="texto_negrita_sinfondo" colspan="2" height="22">Key words: <input height="20" size="42"
 type="text"
 style="border: 2 #989898 solid; height: 23;"
 ...
 <tr> <td class="bordes"><a href="javascript:document.form_ficha.submit()" class="texto_negrita_sinfondo">Save</a></td>
 </tr>
 </table>
 </td>
 <td width="181" height="30"> <table width="129" border="0" cellspacing="0" cellpadding="0">
 <tr> <td class="bordes"><a href="javascript:document.form_ficha.reset()" class="texto_negrita_sinfondo">Undo changes</a></td>
 </tr>
 </table>
 </td>
 </tr>
