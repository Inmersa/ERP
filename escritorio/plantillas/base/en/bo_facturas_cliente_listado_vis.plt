 ...
 <td ><a href="?_search_sort=Forma_pago.nombre" >Method of payment<img src="images/pixel.png" class="@%func:class_searchsort;Forma_pago.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Tarifas.nombre" >Tariff<img src="images/pixel.png" class="@%func:class_searchsort;Tarifas.nombre;%@" /></a></td>
