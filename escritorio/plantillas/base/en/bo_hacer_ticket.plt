 ...
 <td class="titocho" >&gt; Select Ticket Products</td>
 <td align="right" > <a href="#" onclick="return abrir_ventana('?seccion=hacer_ticket_codbarras',400,200);" class="accesos">Bar code</a>
 </td>
