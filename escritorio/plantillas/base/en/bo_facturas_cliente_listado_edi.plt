 ...
 <td ><a href="?_search_sort=Facturas.referencia" class="order" >Reference<img src="images/pixel.png" class="@%func:class_searchsort;Facturas.referencia;%@" /></a></td>
 ...
 <td ><a href="?_search_sort=Tarifas.nombre" class="order" >Tariff<img src="images/pixel.png" class="@%func:class_searchsort;Tarifas.nombre;%@" /></a></td>
