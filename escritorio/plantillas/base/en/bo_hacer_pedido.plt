...
<table class="full">
<thead ><tr>
<td ><a href="?_search_sort=Articulos.nombre" class="order" >Name<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Marcas.nombre" class="order" >Brand<img src="images/pixel.png" class="@%func:class_searchsort;Marcas.nombre;%@" /></a></td>
...
<td ><a href="?_search_sort=Empresas_articulos.unidades_bulto" class="order" 
	>Units Box<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.unidades_bulto;%@" /></a></td>
...
<li><a href="#" onClick="return sendForm('hacer_pedido');" class="sumaracesta"><img src="images/pixel.png" class="icono" /><span>Add</span></a></li>
</ul></div>
