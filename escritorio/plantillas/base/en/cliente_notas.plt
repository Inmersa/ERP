...
<div class="tituloseccion">Client Notes 
...
<li><a href="#" onClick="return sendForm('notas','accion_ejecutar','Borrar');" class="borrar"><img src="images/pixel.png" class="icono" /><span>Delete selected</span></a></li>
</ul></div>
@%end-if:%@
...
@%if:AllowedAction;Cliente_notas;del;%@
 <td >&nbsp;</td>
@%end-if:%@
 <td ><a href="?_search_sort=Cliente_notas.nombre" class="order" >Name<img src="images/pixel.png" class="@%func:class_searchsort;Cliente_notas.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Tipos_anotacion.nombre" class="order" >Type<img src="images/pixel.png" class="@%func:class_searchsort;Tipos_anotacion.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Cliente_notas.fecha" class="order" >Date<img src="images/pixel.png" class="@%func:class_searchsort;Cliente_notas.fecha;%@" /></a></td>
 <td >User</td>
</tr>
</thead>
<tbody>
