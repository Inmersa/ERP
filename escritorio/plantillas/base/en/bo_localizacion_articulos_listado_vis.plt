...
@%plt:botonera%@
 ...
 <tr> <td class="etiqueta" height="22" bgcolor="#DBE0E3" width="100" align="right">Name:<font color="#DBE0E3">..</font></td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Warehouse Zone </td>
 <td bgcolor="#FFFFFF" class="etiqueta" align="center" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Amount</td>
 <td bgcolor="#FFFFFF" class="etiqueta" align="center" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Use-by date</td>
 <td bgcolor="#FFFFFF" class="etiqueta" align="center" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Register date</td>
 <td bgcolor="#FFFFFF" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Floor</td>
 <td bgcolor="#FFFFFF" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Row</td>
 <td bgcolor="#FFFFFF" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Column</td>
 <td bgcolor="#FFFFFF" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" height="22">Corridor</td>
