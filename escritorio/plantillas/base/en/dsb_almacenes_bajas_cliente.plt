...
<legend>Stock Down by Client</legend>
...
@%set:dsb_resultados=top_clientes;%@ @%set:dsb_rs_limit=7;%@ @%set:dsb_grfx_field=bajas_stock;%@
...
@%func:dsb_grfx_horizontal;top_clientes;bajas_stock;%@
