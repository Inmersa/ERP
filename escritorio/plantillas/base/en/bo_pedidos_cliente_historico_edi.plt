...
<thead>
 ...
 <td ><a href="?_search_sort=Direcciones_entrega.direccion" >Delivery Add.<img src="images/pixel.png" class="@%func:class_searchsort;Direcciones_entrega.direccion;%@" /></a></td>
 <td ><a href="?_search_sort=monto_pedido" >Taxable Income<img src="images/pixel.png" class="@%func:class_searchsort;monto_pedido;%@" /></a></td>
 <td class="estado" >Ord</td>
 <td class="estado" >D</td>
 <td class="estado" >I</td>
 </tr>
</thead>
