...
<li><a href="?seccion=nuevo_series_facturacion" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>New</span></a></li></td>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_series_facturacion');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Delete selected</span></a></li>
</ul></div> 
...
<td ><a href="?_search_sort=Series_facturacion.nombre" class="order" >Name<img src="images/pixel.png" 
	class="@%func:class_searchsort;Series_facturacion.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Series_facturacion.descripcion" class="order" >Description<img src="images/pixel.png" 
	class="@%func:class_searchsort;Series_facturacion.descripcion;%@" /></a></td>
<td ><a href="?_search_sort=Series_facturacion.contador" class="order" >Meter<img src="images/pixel.png" 
	class="@%func:class_searchsort;Series_facturacion.contador;%@" /></a></td>
<td ><a href="?_search_sort=Series_facturacion.ventas" class="order" >of<img src="images/pixel.png" 
