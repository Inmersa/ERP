...
<legend>New Warehouse Zone</legend>
...
<li><a href="#" onClick="return sendForm('nuevo_almacenes_logicos');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Save</span></a></li>
</ul></div>
