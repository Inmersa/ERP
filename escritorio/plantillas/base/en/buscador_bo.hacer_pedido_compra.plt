...
Brand / Family: <input type="text" name="nombre_marca" size="30" value="@%get:st_nombre_marca%@" />
Article:  <input type="text" name="nombre" size="40" value="@%get:st_nombre%@" />
IDs: <input type="text" name="id" size="10" value="@%get:st_id%@" />

<a href="#" onclick="return sendForm('buscadorgeneral');" accesskey="f" class="submit" >Search</a></td>
 <select name="hp">
