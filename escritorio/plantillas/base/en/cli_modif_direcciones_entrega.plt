...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" >&gt; Modify delivery address</td>
 <td width="46" align="center" ><a href="?seccion=cli_modif_clientes" class="accesos">Return</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td class="texto" valign="top">Fill this form to add a new delivery address</td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 </table>
 ...
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Name:</td>
 ...
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Address:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">City:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Area</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
...
@%where:tabla|Provincias;order|nombre;nolink|1;%@
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Postal Code:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Telephone:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Contact person:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Contact Role:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185" valign="top">Remarks:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <td colspan="4" height="22" bgcolor="#CCD2D7"> <a href="" onclick="document.forms['modif_direcciones_entrega'].submit();return false;" class="accesos">Modify</a> </td>
 </tr>
 </form>
 </table>
 </td>
