...
<div class="barraoscura"><a href="" onClick="return onHRefClick('descuentos_familia','accion_ejecutar','Borrar');" class="accesos">Delete selected</a>
</div>
<table class="full">
...
<div class="enviar"><a href="" onClick="return onHRefClick('descuentos_familia','accion_ejecutar','Modificar');" class="accesos">Modify</a>
</div>
</form>
