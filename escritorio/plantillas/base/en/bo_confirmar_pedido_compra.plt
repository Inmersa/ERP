...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="250" >&gt; Confirm 
@%if:esta_vacio;es_pedido;%@
@%if:esta_vacio;es_factura;%@
 Budget @%set:send_form_to=bo_presupuestos_compras;%@
 @%else:%@ 
 Invoices @%set:send_form_to=bo_facturas_compra;%@
 @%end-if:%@ 
@%else:%@ 
Order @%set:send_form_to=bo_pedidos_compras;%@
@%end-if:%@ 
</td>
 <td width="46" align="center" ><a href="?seccion=hacer_pedido_compra" class="accesos">Return</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#CCD2D7" class="titul1">Standard order <input type="checkbox" name="pedido_tipo" value="1">
 </td>
 </tr>
 <tr>
 <td height="10"></td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#CCD2D7" height="22" class="titul1">Supplier</td>
 </tr>
 ...
 <tr> <td bgcolor="#CCD2D7" height="22" align="right" class="titul1" width="80">Company</td>
 <td bgcolor="#CCD2D7" height="22" width="90"></td>
 <td bgcolor="#CCD2D7" height="22" width="60"></td>
 <td bgcolor="#CCD2D7" height="22"></td>
 </tr>
 @%where:nodb|nodb_reciever_data;%@ 
 <tr> <td height="22" align="right" bgcolor="#EBECED" class="titul1">Name:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Code:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Address:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">City:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">Area:</td>
 <td class="texto">@%db:provincia;%@</td>
 <td bgcolor="#EBECED" class="titul1" align="right">Postal Code:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">EIN:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">Telephone:</td>
...
@%set:observaciones_en_totales=observaciones;%@
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="112" height="22">Document name :</td>
...
@%if:esta_vacio;es_pedido%@
@%else:%@
 <tr> <td bgcolor="#EBECED" width="112" class="texto">Delivery Add.:</td>
...
>@%db:Almacenes.nombre;%@ @%db:Almacenes.direccion;%@</option>
 ...
 <td bgcolor="#EBECED" class="texto" width="95" align="right">Done by:</td>
 <td width="220">
...
@%end-where:%@
 ...
 <tr> <td width="6"></td>
 <td width="419"></td>
 <td align="center" width="100"><a href="?seccion=hacer_pedido_compra" class="accesos">Add article </a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" height="20" class="titul1">Name</td>
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Amount</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Price</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="titul1" align="center" width="60">VAT</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center" width="60"> Discounts </td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="110">Amount</td>
...
@%end-if:%@
 ...
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center">Taxable Income</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1">VAT %</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="120">Surcharge %</td>
 <td width="1" height="20" bgcolor="#DBE0E3"></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="titul1" align="center">Taxable Income</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center">Discounts</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="80">Amount</td>
 <td width="1" bgcolor="#DBE0E3" height="20"></td>
 </tr>
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="titul1" height="22">Total amount </td>
 </tr>
...
<br><br>
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="titul1" height="22">Total amount in @%db:divisa_cliente_nombre%@</td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="1"></td>
