<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="331" >&gt; Promotion Company(
 ...
 <tr align="center"> <td width="47" > @%if:AllowedLink;nuevo_promociones;%@ <a href="" class="accesos">Add </a> </td>
 @%end-if:%@
 <td width="47" ><a href="javascript: history.go(-1);" class="accesos">Return</a></td>
 </tr>
 </table>
 </td>
 </tr>
