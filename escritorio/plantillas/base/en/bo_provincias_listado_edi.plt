...
<li><a href="#" onClick="return sendForm('modif_provincias');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Delete selected</span></a></li>
</ul></div>

<table class="full">
<thead><tr>
<td class="estado" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('registro_borrar');"  /></td>
<td ><a href="?_search_sort=Provincias.nombre" class="order" >Name<img src="images/pixel.png" class="@%func:class_searchsort;Provincias.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Paises.nombre" class="order" >Countries<img src="images/pixel.png" class="@%func:class_searchsort;Paises.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Provincias.codigo" class="order" >Code<img src="images/pixel.png" class="@%func:class_searchsort;Provincias.codigo;%@" /></a></td>
