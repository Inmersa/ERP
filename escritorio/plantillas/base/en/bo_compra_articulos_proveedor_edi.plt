...
<li><a href="?seccion=bo_importar_articulos_proveedor" class="seleccionar" ><img src="images/pixel.png" class="icono" /><span>Recover articles</span></a></li>
@%end-if:%@
...
<td ><a href="?_search_sort=Empresas_articulos.referencia" class="order" 
	>Own Reference<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.referencia;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.referencia" class="order" 
	>Supplier Ref.<img src="images/pixel.png" class="@%func:class_searchsort;Compra_articulos.referencia;%@" /></a></td>
...
<td ><a href="?_search_sort=Articulos.nombre" class="order" >Article name<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.PVP_oficial" class="order" 
	>Price<img src="images/pixel.png" class="@%func:class_searchsort;Compra_articulos.PVP_oficial;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.PV_oficial" class="order" 
	>Resale Pr.<img src="images/pixel.png" class="@%func:class_searchsort;Compra_articulos.PV_oficial;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.precio" class="order" 
	>Price<img src="images/pixel.png" class="@%func:class_searchsort;Compra_articulos.precio;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.descuento" class="order" 
	>Discount %<img src="images/pixel.png" class="@%func:class_searchsort;Compra_articulos.descuento;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.dto_vol" class="order" 
	>Discounts by volume<img src="images/pixel.png" class="@%func:class_searchsort;Compra_articulos.dto_vol;%@" /></a></td>
<td ><a href="?_search_sort=Compra_articulos.fabricante" class="order" 
	>Manuf.<img src="images/pixel.png" class="@%func:class_searchsort;Compra_articulos.fabricante;%@" /></a></td>
</tr>
</thead>
<tbody>
