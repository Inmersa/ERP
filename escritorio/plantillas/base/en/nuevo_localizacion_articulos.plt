<table class="full">
 ...
 <tr> <td width="6" ></td>
 <td class="titocho" >&gt; New Article Location</td>
 ...
 <tr> <td colspan="13" class="etiqueta" bgcolor="#CCD2D7">Manufacture order: <select name="registro[lote]" >
@%where:tabla|Ordenes_fabricacion;nolink|1;%@
 ...
 <td ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Floor</td>
 <td ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Corridor</td>
 <td class="etiqueta" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Row</td>
 <td ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Column</td>
 <td ></td>
 <td class="etiqueta" bgcolor="#DBE0E3" >Amount</td>
 ...
 <tr > <td colspan="13" bgcolor="#CCD2D7"><a href="javascript:document.forms['nuevo_localizacion_articulos'].submit();" >Save</a> </td>
 </tr>
 </form>
 </table>
 </td>
