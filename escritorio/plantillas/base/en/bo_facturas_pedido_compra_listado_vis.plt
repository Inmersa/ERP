<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="90">Date</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="90">Taxable Income</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="90">Taxes</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center" width="90">Total</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="50">Condition</td>
...
<!-- @%db:Pedidos_facturas.id_pedido;%@ -->
 ...
 <td class="etiqueta"><span class="texto">Invoices</span></td>
