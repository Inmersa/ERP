...
<form name="compra_articulos" method="post" action="?seccion=hacer_ticket">
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">EIN</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="30">CT</td>
 <td width="1"></td>
 </tr>
...
@%where:tabla|Clientes;nombre|busc;no_results|1;%@
 ...
 <td class="texto" align="center">Rd@%db:Tipo_cliente.nombre%@<br>
 <br>
 <br>
 </td>
 <td bgcolor="#DBE0E3"></td>
 ...
 <tr>
 <td bgcolor="#CCD2D7" align="center" height="22"><a href="" onclick="document.forms['compra_articulos'].submit();return false;" class="accesos">Select</a>
