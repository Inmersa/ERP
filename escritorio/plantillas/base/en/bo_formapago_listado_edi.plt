...
<td class="caption">Nº Bank drafts</td>
<td class="caption">Days between Bank drafts</td>
</tr>
...
@%plt:botonera%@
<div class="enviar"><a href="javascript:document.forms['modif_forma_pago'].submit();">Delete selected</a></div>
