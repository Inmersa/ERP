...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Due Dates for Collection</td>
<td colspan="@%get:_iterate_times;%@" >Due Dates for Payments</td></td>
...
<!-- 
@%set:grafica[titulo] = Due Dates for Collection;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Due Dates for Payments;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
