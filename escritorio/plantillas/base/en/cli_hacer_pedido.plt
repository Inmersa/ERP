<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="323" >&gt; Products Selection</td>
...
@%plt:botonera%@
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="250">Description</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="0">Price </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="0">VAT / Surcharge</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Packages</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Amount</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" colspan="3" bgcolor="#DBE0E3">Off. / Promotions</td>
 ...
 <a href="" onclick="document.forms['hacer_pedido'].submit();return false;"class="accesos">Add</a></td>
 </tr>
 </form>
 </table>
