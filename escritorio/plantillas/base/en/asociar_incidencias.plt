...
<div class="tituloseccion">Incidences List</div>
...
<input type="hidden" name="accion_ejecutar" value="Aprobar" />
	...
	@%else:%@
	<li><a href="?seccion=nueva_incidencia_crm" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>New event</span></a></li>
	@%end-if:%@
	...
	<li><a href="#" onClick="return sendForm('incidencias','accion_ejecutar','Aprobar');" class="aprobar" 
		><img src="images/pixel.png" class="icono" /><span>Approve</span></a></li>
	@%end-if:%@
	</ul></div>
</form>
@%else:%@
...
<li><a href="#" onClick="return sendForm('incidencias','accion_ejecutar','seleccionar_incidencias');" class="enviar" 
	><img src="images/pixel.png" class="icono" /><span>Associate</span></a></li>
</ul></div>
@%set:permitir_selecciones=1;%@
@%end-if:%@
...
<td></td>
@%end-if:%@
<td ><a href="?_search_sort=Incidencias.id_incidencia" >Reference<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.id_incidencia;%@" /></a></td>
<td ><a href="?_search_sort=Usuarios.nombre" >User involved<img src="images/pixel.png" class="@%func:class_searchsort;Usuarios.nombre;%@" /></a></td>
@%if:AllowedAction;Incidencias_id_usuario_gestor;new;%@
<td ><a href="?_search_sort=Empleados.nombre" >Managing User<img src="images/pixel.png" class="@%func:class_searchsort;Empleados.nombre;%@" /></a></td>
@%end-if:%@
<td ><a href="?_search_sort=Incidencias.fecha" >Register date<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Incidencias.fecha_estimada" >Estimated date<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.fecha_estimada;%@" /></a></td>
</tr>
</thead>
<tbody>
...
>EV-@%db:Incidencias.id_incidencia%@</a></td>
