...
<div class="tituloseccion">&gt; Company card</div>
...
<li><a href="#" onClick="return sendForm('modif_empresas');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Modify</span></a></li>
</ul></div>
@%end-if:%@
