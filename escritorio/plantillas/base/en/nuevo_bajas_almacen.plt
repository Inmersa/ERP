...
@%if:!esta_vacio;id_albaran;%@
	...
	@%if:esta_vacio;es_venta;%@
		<tr><td class="etiqueta" >Non Stock Change</td>
		...
		<td class="etiquetacheck" >Restore stock</td></tr>
	@%else:%@
		<tr><td class="etiqueta" >Stock Down</td>
		<td class="check" ><input type="radio" name="registro[@%db:i;%@][causar_baja]" value="1" checked="checked" ></td>
		<td class="check" ><input type="radio" name="registro[@%db:i;%@][causar_baja]" value="0"></td>
		<td class="etiquetacheck" >Restore stock</td></tr>
	@%end-if:%@
...
<tr><td class="etiqueta"> Initial amount : </td><td colspan="3" >@%db:cantidad;%@</td></tr>
...
@%if:!esta_vacio;id_albaran;%@
	<table class="full" >
	<caption class="titulotb" >Installment Invoices</caption>
	<tr><td class="etiqueta" >New</td>
...
<li><a href="#" onClick="return sendForm('nuevo_bajas_almacen');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Save</span></a></li>
</ul></div>
</div>
