...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr align="center"> <td height="22" bgcolor="#CCD2D7" colspan="3"><a href="javascript:document.forms['modif_gastos'].submit();" class="accesos">Save</a> <a href="javascript:document.forms['modif_gastos'].reset();" class="accesos">Undo changes</a> <a href="?seccion=bo_gastos&estado=2&registro[id_gasto]=@%db:Gastos.id_gasto%@" onClick="return confirm('Esta ud. seguro de que de desea borrar el registro?');return false;" class="accesos">Delete</a> </td>
 </tr>
 </form>
 </table>
 </td>
