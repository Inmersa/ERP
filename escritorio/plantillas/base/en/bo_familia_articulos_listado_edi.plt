...
<li><a href="?seccion=nuevo_familia_articulos" class="accesos" class="nuevo" ><img src="images/pixel.png" class="icono" /><span> New</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_familia_articulos');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Delete selected</span></a></li>
</ul></div>
