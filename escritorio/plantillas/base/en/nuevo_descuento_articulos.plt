...
<div class="tituloseccion">&gt; Add Products to Client (
...
@%plt:botonera%@
 ...
 <li><a href="#" onClick="return sendForm('nuevo_descuento_articulos');"  class="enviar" ><img src="images/pixel.png" class="icono" /><span>Add</span></a></li>
 </ul></div>
