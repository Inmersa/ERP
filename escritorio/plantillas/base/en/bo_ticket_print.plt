...
<td colspan="1" bgcolor="#EBECED" class="titul">Company:</td>
<td width="1"><img src="imag/p.gif" width="1" height="100%"></td>
 </tr>
 <tr> 
<td width="1"><img src="imag/p.gif" width="1" height="100%"></td>
...
<tr> <td class="minititulo">Telephone:</td>
...
<tr> <td width="1" height="15" bgcolor="#000000"></td>
 <td class="titul" width="15%">Amount</td>
 <td width="1" bgcolor="#000000"></td>
 <td class="titul">Product</td>
 <td width="1" bgcolor="#000000"></td>
 <td class="titul" align="center" width="10%">Price</td>
 <td width="1" bgcolor="#000000"></td>
 <td align="center" class="titul" width="10%">Implicated</td>
 <td width="1" bgcolor="#000000"></td>
</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <td align="right" class="texto" bgcolor="#EBECED" width="40%">Gross Total:</td>
...
<tr><td class="texto">Thank you for visiting</td></tr>
</table>
</body>
</html>
