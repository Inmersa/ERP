...
<tr> <td colspan="3" height="22" bgcolor="#CCD2D7"></td>
 ...
 <tr> <td bgcolor="#EBECED" width="185" class="etiqueta" align="right" height="22">Length:</td>
 ...
 Days <input type="radio" name="registro1" value="d" checked>
 Months <input type="radio" name="registro1" value="m" >
 years <input type="radio" name="registro1" value="a" >
 </td>
 </tr>
 <tr> <td bgcolor="#CCD2D7" height="1" width="185"></td>
 <td bgcolor="#CCD2D7" height="1" width="458"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" width="185" align="right" class="etiqueta" height="22">Invoice period:</td>
 ...
 Days <input type="radio" name="registro2" value="d" checked>
 Months <input type="radio" name="registro2" value="m" >
 years <input type="radio" name="registro2" value="a" >
 </td>
 </tr>
