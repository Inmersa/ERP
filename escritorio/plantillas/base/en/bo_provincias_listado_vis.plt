...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="191">Name</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="213" >Countries</td>
 <td class="etiqueta" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" >Code</td>
 <td class="etiqueta" width="1" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" >Prefix Tf.</td>
