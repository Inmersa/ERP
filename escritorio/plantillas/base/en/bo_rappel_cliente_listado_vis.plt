<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" colspan="5" class="etiqueta" height="22">{{bo_rtoppel_cliente_listado_vis.plt0}} <span class="texto">12 months</span></td>
 </tr>
 ...
 <td width="170" class="etiqueta" align="center" bgcolor="#EBECED"> Starting date</td>
 </tr>
 ...
 <td width="232" class="etiqueta" bgcolor="#EBECED" height="22">of @%db:Rappel.monto_inicial;%@<input type="hidden" name="rappel_inicio[@%db:Rappel.id_rappel%@]" value="@%db:Rappel.monto_inicial;%@" size="15" class="insertextnumeros" maxlength="9">
