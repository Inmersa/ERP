...
-->
 ...
 <td bgcolor="#DBE0E3" height="22" class="etiqueta">Warehouse</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">Carrier</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center" width="125">Order Ref. </td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center" width="125">Reference </td>
 ...
 <tr> <td bgcolor="#DBE0E3" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" colspan="3">Supplier</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">Date </td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">Condition</td>
 <td bgcolor="#DBE0E3" height="22" width="1"></td>
 </tr>
 <tr> <td bgcolor="#FFFFFF" height="1" width="1"></td>
 <td bgcolor="#FFFFFF" height="1"></td>
