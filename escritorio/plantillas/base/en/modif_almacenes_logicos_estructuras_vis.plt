...
<input type=hidden name=registro[id_almacen_logico] value="@%db:Almacenes_logicos.id_almacen_logico;%@">
 ...
 <tr> <td width="80" bgcolor="#EBECED" align="right" class="etiqueta" height="22">Name:</td>
...
<input type="hidden" name="registro[nombre]" value="@%db:Almacenes_logicos.nombre;%@" class="insertext" size="80">
 ...
 <tr align="center"> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Floors:</td>
 ...
 <td align="right" bgcolor="#EBECED" width="80">Corridors:</td>
 <td>
 ...
 <td align="right" bgcolor="#EBECED" width="80">Rows:</td>
 <td>
 ...
 <td bgcolor="#EBECED" align="right" width="80">Columns:</td>
 <td>
 ...
 <td height="21" bgcolor="#CCD2D7" width="128" class="etiqueta">Warehouses</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" colspan="2">Name:</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" colspan="2">Address:</td>
 <td height="22" width="4" bgcolor="#EBECED" align="right" class="etiqueta"></td>
...
@%db:Almacenes.cp;%@ (@%db:Almacenes.poblacion;%@)</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" colspan="2">Contact person:</td>
 <td height="22" width="4" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 <td height="22" width="234" class="texto">@%db:Almacenes.persona_contacto;%@ 
(@%db:Almacenes.cargo_persona_contacto;%@)</td>
 <td height="22" width="86" bgcolor="#EBECED" align="right" class="etiqueta">Telephone:</td>
