...
<li><a href="return sendForm('modif_rutas');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Modify</span></a></li>
</ul></div>
...
<fieldset class="fsficha" >
<legend>Clients by Route</legend>
...
<li><a href="#" onclick="return sendForm('clientes_ruta');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Save</span></a></li>
</ul></div>
