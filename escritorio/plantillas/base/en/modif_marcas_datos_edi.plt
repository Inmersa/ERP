...
@%end-where:%@ 
 ...
 <td class="etiqueta" >Excluded from Sale</td>
 ...
 <li><a href="#" onClick="return sendForm('modif_marcas');"  class="guardar" ><img src="images/pixel.png" class="icono" /><span>Save</span></a></li> 
 <li><a href="#" onClick="return resetForm('modif_marcas');"  class="deshacer" ><img src="images/pixel.png" class="icono" /><span>Undo changes</span></a></li>
