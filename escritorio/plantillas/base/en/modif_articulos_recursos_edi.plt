...
<legend>Resources Articles</legend>
<div class="AccionesFicha"><ul>
@%if:AllowedLink;recursos;%@
	@%if:AllowedAction;Articulos_recursos;new;%@
	<li><a href="?seccion=recursos&modo_seleccion=1&many=1" class="asociar"><img src="images/pixel.png" class="icono" /><span>Add Resource</span></a></li>
	@%end-if:%@
@%end-if:%@
