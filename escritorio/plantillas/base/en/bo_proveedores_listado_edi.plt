...
@%if:AllowedLink;nuevo_proveedores;%@
 <li><a href="?seccion=nuevo_proveedores" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>New Supplier</span></a></li>
@%end-if:%@
@%if:AllowedLink;bo_importar_proveedores;%@
<li><a href="?seccion=bo_importar_proveedores" class="importarusuario" ><img src="images/pixel.png" class="icono" /><span>Supplier import</span></a></li>
@%end-if:%@
<li><a href="#" onclick="return sendForm('bo_proveedores');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Delete selected</span></a></li>
</ul></div>
...
<td class="estado" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('proveedor_borrar');"  /></td>
...
<td ><a href="?_search_sort=Proveedores.persona_contacto" class="order" 
	>Contact<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.persona_contacto;%@" /></a></td>
<td ><a href="?_search_sort=Proveedores.cif" class="order" >EIN<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.cif;%@" /></a></td>
</tr></thead>
