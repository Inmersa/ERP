...
<li><a href="?seccion=nuevo_divisa" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>New</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_divisa');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Delete selected</span></a></li>
</ul></div>
