...
<tbody>
 ...
 <tr><td class="etiqueta" >Carrier:</td>
...
<li><a href="#" onclick="return sendForm('modif_direcciones_entrega');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Modify</span></a></li>
</div>
