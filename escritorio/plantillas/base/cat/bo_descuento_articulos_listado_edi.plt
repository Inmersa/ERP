...
<li><a href="?seccion=nuevo_descuento_articulos" class="seleccionar" ><img src="images/pixel.png" class="icono" /><span>Afegir article</span></a></li>
@%end-if:%@
...
<td class="caption">Descomptes</td>
<td class="caption">Quantitat de descompte</td>
</tr>
@%end-if:%@
