...
<legend>Persones de Contacte</legend>

<div class="AccionesFicha">
<ul>
@%if:AllowedAction;Cliente_contactos;new;%@
<li><a href="?seccion=nueva_persona_contacto" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nou</span></a></li>
@%end-if:%@
@%if:AllowedAction;Cliente_contactos;del;%@
<li><a href="#" onClick="return onHRefClick('modif_clientes','accion_ejecutar','BorrarContactos');" class="borrar"><img src="images/pixel.png" class="icono" /><span>Esborrar</span></a></li>
@%end-if:%@
</ul>
</div>
