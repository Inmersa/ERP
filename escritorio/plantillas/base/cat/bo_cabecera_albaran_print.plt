...
@%if:esta_vacio;id_proveedor_cabecera;%@
	<caption>Adreça Magatzem de Recollida</caption>
@%end-if:%@
...
<table class="full">
	...
	<tr><td class="etiqueta" >Codi:</td><td >@%db:Clientes.id_cliente;%@</td></tr>
	<tr><td class="etiqueta" >Domicili:</td><td >@%db:Clientes.direccion_facturacion;%@</td></tr>
	<tr><td class="etiqueta" >Població:</td><td >@%db:Clientes.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Províncies:</td>
	...
	<tr> 
	 <td class="etiqueta" >Telèfon:</td><td >@%db:Clientes.telefono1;%@</td>
...
<table class="full">
 <caption>Adreça entrega(@%db:Direcciones_entrega.id_direccion;%@)</caption>
...
<table class="full">
	...
	<tr><td class="etiqueta" >Codi:</td><td >@%db:Proveedores.id_proveedor;%@</td></tr>
	<tr><td class="etiqueta" >Domicili:</td><td >@%db:Proveedores.domicilio;%@</td></tr>
	<tr><td class="etiqueta" >Població:</td><td >@%db:Proveedores.poblacion;%@</td></tr>
	<tr><td class="etiqueta" >Províncies:</td>
	...
	<tr> 
	 <td class="etiqueta" >Telèfon:</td><td >@%db:Proveedores.telefono1;%@</td>
...
@%where:tabla|Almacenes;where|Almacenes.id_almacen = $id_almacen_cabecera;nolink|1;%@
<table class="full">
 <caption>Adreça entrega(@%db:Almacenes.nombre;%@)</caption>
