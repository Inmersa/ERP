...
<table width="647" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
 ...
 <tr> <td width="6"></td>
 <td class="titocho" width="641" >&gt; Pressupost : @%db:Presupuestos.nombre;%@ </td>
 </tr>
 </table>
 </td>
 </tr>
...
-->
 ...
 <td bgcolor="#EBECED" class="texto" width="99" align="right">Realitzar per:</td>
 ...
 <td width="154" bgcolor="#EBECED" valign="middle" class="texto" height="22">Notes:</td>
 <td width="7" bgcolor="#EBECED" valign="top" rowspan="2"></td>
