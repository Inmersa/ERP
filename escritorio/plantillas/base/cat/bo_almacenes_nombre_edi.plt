...
<!-- li><a href="?seccion=bo_importar_almacenes" class="importaralmacen"><img src="images/pixel.png" class="icono" /><span>Importar registres</span></a></li -->
@%end-if:%@
@%if:AllowedLink;nuevo_almacenes;%@
<li><a href="?seccion=nuevo_almacenes" class="nuevo"><img src="images/pixel.png" class="icono" /><span>Nou Magatzem</span></a></li>
@%end-if:%@
...
<td class="caption">Tel�fon</td>
<td class="caption">e-mail</td>
<td class="caption">Persona de contacte</td>
</tr>
