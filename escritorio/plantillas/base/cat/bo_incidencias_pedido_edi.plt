...
<li><a href="?seccion=nueva_incidencia_crm&id_pedido=@%get:id_documento%@" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nova incid�ncia</span></a></li>
@%end-if:%@
...
<li><a href="#" onClick="return sendForm('borrar_incidencias');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar seleccionats</span></a></li>
@%end-if:%@
