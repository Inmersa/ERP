...
<div class="menuitem"> <a href="?seccion=bo_pedidos_ventas" @%func:querystring_activa;bo_pedidos_ventas;activo;;%@ >Comandes</a></div>
@%end-if:%@
...
<div class="menuitem"> <a href="?seccion=bo_presupuestos_ventas&_chgsm=1" @%func:querystring_activa;bo_presupuestos_ventas&_chgsm=1;activo;;%@ >Pressupostos</a></div>
@%end-if:%@
@%if:AllowedLink;bo_albaranes_venta;%@
<div class="menuitem"> <a href="?seccion=bo_albaranes_venta" @%func:querystring_activa;bo_albaranes_venta;activo;;%@ >Albaràns</a></div>
@%end-if:%@
...
<!--
@%if:AllowedLink;bo_facturas_venta;%@
<div class="menuitem"> <a href="?seccion=bo_compra_venta" @%func:querystring_activa;nuevo_pedidos_ventas&presupuesto=1;activo;;%@ >Informs</a></div>
@%end-if:%@
-->

@%if:AllowedLink;nuevo_pedidos_ventas;%@
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&proforma=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&proforma=1;activo;;%@ >Nova Factura Proforma</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&presupuesto=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&presupuesto=1;activo;;%@ >Nou Pressupost</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&pedido=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&pedido=1;activo;;%@  >Fer comanda</a></div>
   <div class="menuitem"> <a href="?seccion=nuevo_pedidos_ventas&factura=1&nuevo=1&_chgsm=1" 
   @%func:querystring_activa;nuevo_pedidos_ventas&factura=1;activo;;%@  >Fer Factura</a></div>
