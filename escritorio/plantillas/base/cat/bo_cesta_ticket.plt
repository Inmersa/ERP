...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr> 
<td height="22" align="left" bgcolor="#CCD2D7" class="etiqueta"> Selecció Actuel</td>
...
<td colspan="3"> 
 ...
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3">Preu</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <td align="right" class="texto" bgcolor="#EBECED" width="30%">Totals:</td>
 ...
 <td align="right" class="texto" bgcolor="#EBECED">T. Descomptes:</td>
 ...
 <td align="right" class="texto" bgcolor="#EBECED">Import Total:</td>
 <td height="15" class="texto"><img src="imag/p.gif" width="1" height="15"></td>
...
class="accesos">Finalitzar</a> 
<!--onclick="return SendFormToWindow('ticket_print&printit=1&reloadit=1',400);" class="accesos">Finalitzar</a --> <a href="?@%env:QUERY_STRING%@&vaciar_pedido=1" class="accesos">Buidar Comanda</a> <input type="hidden" name="Finalizar" value="Finalizar"></td>
 </tr>
</form>
 </table>
 </td>
