...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Magatzem Origen</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Magatzem Destí </td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Transportistes</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="120">Observacions</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="75" height="22" class="etiqueta" align="center">Data de Traspos</td>
 <td width="1"></td>
...
@%end-if:%@
 ...
 <td bgcolor="#DBE0E3"></td>
 <td align="center" ><a href="?seccion=modif_traspasos_almacen&id_traspaso=@%db:Traspasos_almacen.id_traspaso;%@" class="accesos">Veure</a></td>
 <td bgcolor="#DBE0E3"></td>
 </tr>
 <tr> <td colspan="13" height="1"></td>
 </tr>
