...
<li><a href="?seccion=nuevo_agentes" class="nuevo"><img src="images/pixel.png" class="icono" /><span>Nou</span></a></li>
@%end-if:%@
...
<li><a href="#" onClick="return sendForm('bo_agentes');" class="borrar"><img src="images/pixel.png" class="icono" /><span>Esborrar seleccionats</span></a></li>
...
<td></td>
@%end-if:%@
<td ><a href="?_search_sort=Agentes.nombre" >Nom<img src="images/pixel.png" class="@%func:class_searchsort;Agentes.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Agentes.telefono1" >Tel�fon<img src="images/pixel.png" class="@%func:class_searchsort;Agentes.telefono1;%@" /></a></td>
<td ><a href="?_search_sort=Tipo_agente.nombre" >Tipus d�agent<img src="images/pixel.png" class="@%func:class_searchsort;Tipo_agente.nombre;%@" /></a></td>
</tr>
</thead>
<tbody>
