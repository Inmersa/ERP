<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" colspan="5" class="etiqueta" height="22">{{bo_rappel_cliente_listado_vis.plt0}} <span class="texto">12 mesos</span></td>
 </tr>
 ...
 <td width="170" class="etiqueta" align="center" bgcolor="#EBECED"> Data d´inici</td>
 </tr>
