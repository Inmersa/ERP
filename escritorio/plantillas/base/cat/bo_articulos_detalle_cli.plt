...
<thead>
<tr>
<td colspan="2" ><a href="?_search_sort=Articulos.nombre" >Nom<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td >Preu</td>
<td >Preu Rec.</td>
<td >Stock Estimat</td>
...
<td ><a href="?_search_sort=Familia_articulos.nombre" >Fam�lia<img src="images/pixel.png" class="@%func:class_searchsort;Familia_articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Marcas.nombre" >Marca<img src="images/pixel.png" class="@%func:class_searchsort;Marcas.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.unidades_bulto" >Unitat paquet<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.unidades_bulto;%@" /></a></td>
<td colspan="2" >Promoci�</td>
</tr>
</thead>
