...
@%if:!emitida;%@
	@%where:nodb|nodb_reciever_data;nombre|receptor;%@
		...
		<li><a href="#" onClick="return sendForm('factura','accion_ejecutar','CargarCuenta');"  class="cargarpendiente" 
			><img src="images/pixel.png" class="icono" /><span>Carregar des del Compte</span></a></li>
		</ul></div>
	@%end-where:%@
...
<td class="etiqueta" >Quantia</td><td colspan="3" >@%db:monto_cuenta;%@</td>
@%end-where:%@
...
<td class="etiqueta @%css:agente;label;%@">Realitzar per:</td>
...
<td class="etiqueta" >Forma d'Abonament</td>
...
<td class="etiquetacheck" >Restar Efectes i Sumar a Compte</td>
...
<td class="etiquetacheck" >Restar Efectes i Afegir Devoluci�</td>
...
<td class="etiquetacheck" >Abonament en Devoluci�</td>
...
<td class="etiquetacheck" >Abonament en Compte</td>
...
@%where:tabla|Pedidos_facturas;where|Pedidos_facturas.id_factura = $idfra;group|Pedidos.id_pedido;%@
   @%if:primera_vez;%@
	<table class="full" >
	<caption class="titulotb" >Comandes:<caption><tbody>
   @%else:%@
	</tr><tr>
   @%end-if:%@ 
...
@%if:esta_vacio;factura_abono;%@
	@%where:nombre|Fras;where|Facturas_abonos.id_factura = $idfra;nolink|1;contador|cnt;%@
		...
		@%if:equals;cnt;1;%@
		<table class="full" >
		<caption class="titulotb" >Factures d'Abonament Relacionades</caption><tbody>
		@%end-if:%@
...
@%if:!esta_vacio;factura_abono;%@
	<table class="full" >
	<caption class="titulotb" >Factures que Abona</caption><tbody>
...
@%if:equals;cnt;1;%@
<table class="full" ><caption class="titulotb" >Efectes</caption>
<thead ><tr><td>Data venciment</td><td>Totals</td><td>Total pagat</td></tr>
<tbody>
...
@%if:equals;cnt;1;%@
<table class="full" >
<caption class="titulotb" >Efectes que Abona</caption><tbody>
@%set:cabecera_puesta=1;%@
@%end-if:%@
