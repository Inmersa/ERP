...
<legend>Compres Comparades</legend>
...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Compres</td>
<td colspan="@%get:_iterate_times;%@" >Cobrat</td></td>
...
<!-- 
@%set:grafica[titulo] = Compres Comparades;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Cobrat Comparat;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
