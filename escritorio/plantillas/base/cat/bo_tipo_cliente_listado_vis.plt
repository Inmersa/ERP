<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="100">Tipus</td>
 <td></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="400">Descripció</td>
 <td class="etiqueta" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="80" align="center">IVA</td>
 <td class="etiqueta" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="90" align="center">Recàrrec equivalent </td>
