...
<ul>
 @%if:!oModoSeleccion->isActive;%@
	 ...
	 <li><a href="?seccion=bo_importar_articulos" class="recuperar"><img src="images/pixel.png" class="icono" /><span>Importar article</span></a></li>
	 @%end-if:&@
	 ...
	 <li><a href="#" onclick="return onHRefClick('bo_articulos','accion_ejecutar','Borrar');" class="borrar"
		><img src="images/pixel.png" class="icono" /><span>Donar de baixa</span></a></li>
	 @%end-if:%@
 @%else:%@
...
<td colspan="3"><a href="?_search_sort=Articulos.nombre" >Nom<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.unidades_bulto" >Unitat paquet<img src="images/pixel.png" 
...
<td colspan="2"><a href="?_search_sort=Empresas_articulos.stock_ficticio" >Stock Estimat<img src="images/pixel.png" 
...
<td >Promoci�</td>
<td ><a href="?_search_sort=Empresas_articulos.precio_costo" >Preu 1<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.precio_costo;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.precio_standard" >Preu 2<img src="images/pixel.png" 
	class="@%func:class_searchsort;Empresas_articulos.precio_standard;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.precio_venta" >Preu 3<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.precio_venta;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.precio_4" >Preu 4<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.precio_4;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.precio_5" >Preu 5<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.precio_5;%@" /></a></td>
<td ><a href="?_search_sort=Empresas_articulos.precio_6" >Preu 6<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.precio_6;%@" /></a></td>
</tr>
</thead>
