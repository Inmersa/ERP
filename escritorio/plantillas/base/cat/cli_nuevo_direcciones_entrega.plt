<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="46" align="center" ><a href="javascript: hisroty.go(-1);" class="accesos">Tornar</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <a href="" onclick="document.forms['nuevo_direcciones_entrega'].submit();return false;" class="accesos">Afegir</a> </td>
 </tr>
 </form>
 </table>
 </td>
