...
@%if:AllowedLink;bo_cliente_agentes;%@
	...
	<li><a href="?seccion=bo_cliente_agentes&amp;id_cliente=@%db:Clientes.id_cliente%@"  class="seleccionar" 
		><img src="images/pixel.png" class="icono" /><span>Afegir agent</span></a></li>
	@%end-if:%@
@%end-if:%@
...
<li><a href="#" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Borrar');"  class="borrar" 
	><img src="images/pixel.png" class="icono" /><span>Esborrar agent</span></a></li>
@%end-if:%@
</ul></div>
@%end-if:%@
...
<td class="caption">Data captaci�</td>
<td class="caption">Comissi�</td>
<td class="caption">Comissi� compartida</td>
</tr>
