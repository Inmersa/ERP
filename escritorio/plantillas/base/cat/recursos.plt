...
@%if:esta_vacio;modo_seleccion;%@
	...
	<li><a href="?seccion=nuevo_recurso" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nou</span></a></li>
	@%end-if:%@
	...
	@%end-if:%@
@%else:%@
	<li><a href="#" onClick="return sendForm('listado');" class="seleccionar" ><img src="images/pixel.png" class="icono" /><span>Assignar</span></a></li>
@%end-if:%@
</ul>
</div>
