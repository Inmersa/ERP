...
<table class="full">
 ...
 <a href="?seccion=crm_seleccionar_usuario&id=@%get:usuario_actual;%@" >Assignar</a>
 @%end-if:%@
 ...
 <tr>
 <td class="etiqueta">Recomanar:</td>
 <td>
 ...
 <a href="?seccion=bo_importar_recomendador" >Assignar</a>
 @%end-if:%@
