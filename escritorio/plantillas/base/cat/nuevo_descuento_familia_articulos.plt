...
<div class="titsuperior">&gt; Nou descompte Família (
...
<div class="enviar"><a href="#" onClick="document.forms['nuevo_descuento_familia_articulos'].submit();return false;">Afegir</a>
</div>
</form>
