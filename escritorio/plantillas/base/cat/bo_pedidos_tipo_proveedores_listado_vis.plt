...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" width="100" class="etiqueta" align="center">Referència </td>
 <td width="1"></td>
 <td width="20" bgcolor="#DBE0E3"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Nom<span class="texto"></span></td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Data</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="80" align="center">Ref. Ext</td>
 <td class="etiqueta" align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="right" width="70">Import</td>
 <td width="1"></td>
 </tr>
