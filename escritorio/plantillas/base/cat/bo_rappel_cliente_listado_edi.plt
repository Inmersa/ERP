...
<li><a href="?seccion=nuevo_rappel_cliente" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Afegir Rappel</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return onHRefClick('rappel_cliente','accion_ejecutar','Borrar');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar seleccionats</span></a></li>
</ul></div>
...
<thead>
<tr>
<td colspan="3">Finalitzat 12 mesos</td>
