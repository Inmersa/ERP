...
<tr> <td>
 ...
 <td bgcolor="#DBE0E3" width="150" class="etiqueta">Nom</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Descripció</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Codi de barres</td>
 <td width="1"></td>
