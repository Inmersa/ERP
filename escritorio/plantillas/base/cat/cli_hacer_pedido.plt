<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="323" >&gt; Articles Selecció</td>
...
@%plt:botonera%@
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="0">Preu </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="0">IVA / Recàrrec</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Paquets</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Quantitat</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" colspan="3" bgcolor="#DBE0E3">Oferta / Promoció</td>
 ...
 <a href="" onclick="document.forms['hacer_pedido'].submit();return false;"class="accesos">Afegir</a></td>
 </tr>
 </form>
 </table>
