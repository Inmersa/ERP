...
<div id="barra1"><div id="contadorpaginas">Pàgines @%get:pagina_actual%@ de @%get:paginas_totales;%@</div></div>
...
<tr class="bordes">
 ...
 <td rowspan="2" >Qt. Ida</td>
 <td rowspan="2" >Paqs</td>
 <td rowspan="2" >&nbsp;</td>
 <td colspan="4" >Localització</td>
 <td rowspan="2" >D. Cadu.</td>
</tr>
<tr class="bordes">
 <td>Pl</td>
 <td>Corr</td>
...
<tr class="bordes">
 ...
 <td rowspan="2" >&nbsp;</td>
 <td colspan="4" >Localització</td>
 <td rowspan="2" >Data de caducitat</td>
</tr>
<tr class="bordes">
 <td>Pl</td>
 <td>Corr</td>
...
<table class="firmas">
 ...
 <tr >
   <td class="etiqueta">Etapes</td>
   <td class="etiqueta">Preparat per</td>
   <td class="etiqueta">Empaquetat per</td>
   <td class="etiqueta">Comprovat per</td>
   <td class="etiqueta">Facturat per</td>
   <td class="etiqueta">Enviat</td>
 </tr>
 <tr>
   <td class="etiqueta" >Datat en</td>
   <td > &nbsp;</td>
   <td > &nbsp;</td>
   <td > &nbsp;</td>
   <td > &nbsp;</td>
