...
<input type="hidden" name="registro[razon_social]" class="insertext" size="30" value="@%db:Proveedores.razon_social;%@"/>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">NIF:</td>
...
<input type="hidden" name="registro[cif]" value="@%db:Proveedores.cif;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Domicili:</td>
...
<input type="hidden" name="registro[domicilio]" value="@%db:Proveedores.domicilio;%@" class="insertext" size="30"/>
 ...
 <td bgcolor="#EBECED" width="87" align="right" class="etiqueta">Població:</td>
...
<input type="hidden" name="registro[cp]" value="@%db:Proveedores.cp;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Persona de contacte:</td>
...
<input type="hidden" name="registro[telefono1]" value="@%db:Proveedores.telefono1;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Càrrec de contacte:</td>
...
<input type="hidden" name="registro[fax]" value="@%db:Proveedores.fax;%@" class="insertext" size="20"/>
 ...
 <tr> <td width="161" height="22" align="right" bgcolor="#EBECED" class="etiqueta">Data de alta:</td>
...
<input type=hidden name=registro2[id_usr] value="@%db:Proveedores_empresas.id_usr%@">
 ...
 <td class="etiqueta" height="20" >Dades generals</td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td align="right" height="22" bgcolor="#EBECED" class="etiqueta" width="161">Mig de paga:</td>
...
@%end-where:%@
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta">Retenció:</td>
