...
<tr> <td class="titul1" align="left" width="68">Raó social:</td>
 <td width="132">@%db:Clientes.razon_social%@</td>
 </tr>

<tr> <td class="titul1" align="left" width="68">Adreça de facturació:</td>
 <td width="132">@%db:Clientes.direccion_facturacion%@</td>
 </tr>

<tr> <td class="titul1" align="left" width="68">Població:</td>
 <td width="132">@%db:Clientes.poblacion%@</td>
 </tr>
<tr> <td class="titul1" align="left" width="68">Telèfon<span class="titul1">o</span>No:</td>
...
class="accesos">>Ver Adreces de entrega</a></td>
 </tr>
<tr>
<td height="10"></td>
</tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td class="accesos2" align="left">Efectes Pendents</td>
 </tr>
 <tr>
<td height="10"></td>
</tr>
 ...
 <tr>
 <td align="left" class="titul1" width="123">Paga parcial</td>
 <td> <input type="text" border="cccccc" name="pago[@%db:Efectos.id_efecto%@][importe]" class="insertext" size="10">
 </td>
 </tr>
 <tr>
 <td align="left" class="titul1" width="123">Mig de pagament</td>
 ...
 <tr>
 <td align="left" class="titul1" width="123"> Import Total </td>
...
<tr>
 <td class="accesos2" align="left" width="154">Comandes Pendent</td>
 </tr>
 <tr>
 <td align="left" class="accesos" width="154">Referència </td>
 <td align="left" width="154">Data </td>
 </tr>
 <tr>
 <td align="left" class="titul1" width="154"> Base imposable</td>
...
class="accesos">Home</a></td>
 <td class="accesos" align="right"><a href="?seccion=pda_hacer_pedido&id_cliente=@%db:Clientes.id_cliente%@">Fer comanda</a></td>
 <td class="accesos" align="right"><a href="#" onClick="document.forms['ficha_cliente'].submit(); return false;">Confirmar</a></td>
 <td class="accesos" align="right">
@%if:esta_vacio;id_cita_pda;%@
@%else:%@
@%where:tabla|Citas;where|Citas.id_cita = $id_cita_pda;nolink|1;%@
<a href="?seccion=pda_cerrar_cita&id_cita=@%db:Citas.id_cita%@">Finalitzar</a>
@%end-where:%@
