...
<!--@%Transportistas.id_transportista;%@-->
 ...
 <tr> <td width="161" class="etiqueta" align="right" height="22" bgcolor="#EBECED">Adreça:</td>
...
@%where:tabla|Provincias;nolink|1;%@
 ...
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Compte bancari IBAN:</td>
