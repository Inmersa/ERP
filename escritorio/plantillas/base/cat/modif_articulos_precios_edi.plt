...
<tr><td class="@%css:Empresas_articulos.descripcion;label;%@" >Descripció:</td>
...
<tr><td class="etiqueta @%css:Empresas_articulos.precio_costo;label;%@">Preu 1:</td>
...
<td class="etiqueta @%css:Empresas_articulos.precio_standard;label;%@">Preu 2:</td>
<td class="@%css:Empresas_articulos.precio_standard;%@" ><input type="text" name="registro2[precio_standard]" value="@%db:Empresas_articulos.precio_standard%@" 
	class="importe" /></td>
<td class="etiqueta @%css:Empresas_articulos.precio_venta;label;%@">Preu 3:</td>
...
<tr><td class="etiqueta @%css:Empresas_articulos.precio_4;label;%@">Preu 4:</td>
...
<td class="etiqueta @%css:Empresas_articulos.precio_6;label;%@">Preu 6:</td>
