...
@%end-where:%@
 ...
 Codi de barres<input type="text" name="cod_barras" size="20" value="@%get:st[cod_barras];%@" />
 <br/>
 ...
 @%end-if:%@
 />
 Quantital de <input type="text" name="cantidad_inicio" class="mininum" value="@%get:st[cantidad_inicio];%@" />
