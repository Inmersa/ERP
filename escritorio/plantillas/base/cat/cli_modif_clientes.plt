...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" width="323" >&gt; Fitxa Client</td>
 <td width="318" align="right" > <table width="260" border="0" cellspacing="0" cellpadding="0">
 <tr align="center"> <td ><a href="javascript: history.go(-1);" class="accesos">Tornar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<tr> <td colspan="4" height="22" bgcolor="#CCD2D7"> <table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Raó social:</td>
 ...
 <tr> <td width="161" class="etiqueta" align="right" height="22" bgcolor="#EBECED">Adreça de facturació:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Població:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Província:</td>
 ...
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Persona de contacte:</td>
 <td width="228"> <input type="text" name="registro[persona_contacto]" value="@%db:Clientes.persona_contacto;%@" class="insertext" size="30">
 </td>
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Telèfon 1:</td>
 <td width="168"> <input type="text" name="registro[telefono1]" value="@%db:Clientes.telefono1;%@" class="insertextnumeros" size="14">
 </td>
 </tr>
 <tr> <td colspan="4" height="1" bgcolor="#CCD2D7" ></td>
 </tr>
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Càrrec de contacte:</td>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">Telèfon 2:</td>
 ...
 <tr> <td width="161" align="right" bgcolor="#EBECED" height="22" class="etiqueta">Repetir contrasenya:</td>
 <td width="483">
 ...
 <tr> <td width="6" align="center" height="20" ></td>
 <td class="etiqueta" height="20" width="172" >Adreces de entrega:</td>
 <td class="etiqueta" height="20" width="466" align="right" ><a href="?seccion=cli_nuevo_direcciones_entrega&amp;id_cliente=@%db:Clientes.id_cliente%@" class="accesos">Afegir direcció</a> <a href="" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Borrar');" class="accesos">Esborrar</a>
 </td>
 </tr>
 </table>
 </td>
...
<a href="" onClick="return onHRefClick('modif_clientes','accion_ejecutar','Modificar');" class="accesos">Modificar</a>
 </td>
 </tr>
 </>
 </table>
