...
<legend>Servicis</legend>

<div class="AccionesFicha"><ul>
@%if:AllowedLink;seleccionar_servicio;%@
	@%if:AllowedAction;Empresas_servicios;new;%@
	<li><a href="?seccion=seleccionar_servicio" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Afegir</span></a></li> 
	@%end-if:%@
@%end-if:%@
@%if:AllowedAction;Empresas_servicios;del;%@
<li><a href="#" onClick="return onHRefClick('modif_articulos','accion_ejecutar','Borrar_servicios');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar</span></a></li>
...
checked="checked"
@%end-if:%@
 /></td><td class="etiqueta" style="text-align:left;">Preus per un per�ode de</td>
...
<thead>
<tr> 
<td class="estado" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('registro_servicios');"  /></td>
<td >Nom</td>
<td >Quota d�alta</td>
<td >Duraci�</td>
<td >Pla� de factura</td>
<td >Facturaci� Servei Anticipadament</td>
</tr>
</thead>
<tbody>
