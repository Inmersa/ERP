<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td height="22" bgcolor="#CCD2D7" class="etiqueta" colspan="3">Generar Albarà</td>
 <td height="22" bgcolor="#CCD2D7" class="etiqueta" align="right"><a href="" onclick="document.forms['generar_albaran'].submit();return false;" class="accesos">Generar Albarà</a></td>
 <td></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="texto" width="92" align="center">Transportistes:</td>
 ...
 <td bgcolor="#EBECED" align="right" width="91" class="texto">Ref. Ext:</td>
 ...
 <tr> <td height="20" bgcolor="#EBECED" align="right" class="texto" width="92">Preparat:</td>
 <td height="20" colspan="3" class="texto">
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr> <td width="120"> <input type="checkbox" name="preparado" value="1">
 </td>
 <td bgcolor="#EBECED" height="20" align="right" class="texto">Enviat:</td>
 <td width="100"> <input type="checkbox" name="enviado" value="1">
 </td>
 <td bgcolor="#EBECED" width="91" align="right" class="texto">Confirmació:</td>
...
<form name="generar_factura" action="?seccion=bo_facturas_venta" method="post">
 ...
 <tr> <td bgcolor="#EBECED" class="texto" width="120" align="right">Ser. Facturat:</td>
...
- @%db:Series_facturacion.contador;%@</option>
 ...
 <td bgcolor="#EBECED" align="right" class="texto">Ref. Ext:</td>
 <td> <input type="text" name="ref_externa" class="insertext" size="16">
 </td>
 </tr>
 <tr> <td bgcolor="#CCD2D7" height="1" colspan="4"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="texto" width="120" align="right">Forma de paga:</td>
...
<select name="id_forma_pago" class="insertext">
 ...
 <tr> <td bgcolor="#EBECED" class="texto" width="120" align="right">Referència:</td>
 <td class="insertext" colspan="3">
 <input type="text" name="contador" class="insertext" size="16">
 Crear Comande Residual <input type="checkbox" name="residuo" value="1" checked>
 </td>
 </tr>
