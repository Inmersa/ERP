...
<tr> <td colspan="3" height="22" bgcolor="#CCD2D7"></td>
 ...
 <tr> <td bgcolor="#EBECED" width="215" class="etiqueta" align="right" height="22">Nº Efectes:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="215" align="right" class="etiqueta" height="22">Dies entre Efectes:</td>
 ...
 <a href="javascript:document.forms['modif_forma_pago'].reset();" class="accesos">Desfer canvis</a>
 <a href="?seccion=bo_forma_pago&estado=2&registro[id_forma_pago]=@%db:Forma_pago.id_forma_pago%@" onClick="return confirm('Esta ud. seguro de que de desea borrar el registro?');return false;" class="accesos">Esborrar</a> </td>
 </tr>
</form>
 </table>
 </td>
