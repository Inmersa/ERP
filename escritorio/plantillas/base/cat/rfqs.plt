...
<ul>
<li><a href="#" onClick="return sendForm('rfqs');" class="enlazarrfq"><img src="images/pixel.png" class="icono" /><span>Confirmar</span></a></li>
</ul>
</div>
...
<td >&nbsp;</td>
  @%end-if:%@
@%end-if:%@
 <td ><a href="?_search_sort=RFQs.id_rfq" >N�mero<img src="images/pixel.png" class="@%func:class_searchsort;RFQs.id_rfq;%@" /></a></td>
 <td ><a href="?_search_sort=RFQs.fecha" >Data entrada<img src="images/pixel.png" class="@%func:class_searchsort;RFQs.fecha;%@" /></a></td>
 <td ><a href="?_search_sort=Tipo_incidencia.nombre" >Tipus<img src="images/pixel.png" class="@%func:class_searchsort;Tipo_incidencia.nombre;%@" /></a></td>
 <td ><a href="?_search_sort=Usuarios.nombre" >Implicat<img src="images/pixel.png" class="@%func:class_searchsort;Usuarios.nombre;%@" /></a></td>
@%if:AllowedAction;RFQ_id_usuario_gestor;new;%@
 <td ><a href="?_search_sort=Empleados.nombre" >Gestor actual<img src="images/pixel.png" class="@%func:class_searchsort;Empleados.nombre;%@" /></a></td>
@%end-if:%@
 <td ><a href="?_search_sort=RFQs.fecha_estimada" >Data aproximada final�tzaci�<img src="images/pixel.png" class="@%func:class_searchsort;RFQs.fecha_estimada;%@" /></a></td>
@%if:esta_vacio;nomostrarcierre;%@
 <td ><a href="?_search_sort=RFQs.fecha_cierre" >Data final<img src="images/pixel.png" class="@%func:class_searchsort;RFQs.fecha_cierre;%@" /></a></td>
@%end-if:%@
</tr>
</thead>
<tbody>
