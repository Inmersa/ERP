...
<div class="tituloseccion">&gt; Albar�ns:</div>
...
<li><a href="#" onclick="return SendFormToWindow('bo_albaran_almacen','bo_albaran_devolucion_print&id_albaran=@%db:Albaranes.id_albaran%@','__printdevolucion__');" class="devolucionprint"><img src="images/pixel.png" class="icono" /><span>Imprimir Devoluci�</span></a></li>
@%end-if:%@
<li><a href="#" onclick="return !window.open('?seccion=bo_albaran_envio_print&id_albaran=@%db:Albaranes.id_albaran%@');" class="envioprint" ><img src="images/pixel.png" class="icono" /><span>Imprimir enviament</span></a></li>
<li><a href="#" onclick="window.open('?@%get:_krn_ss_querystring;%@&imprimir=1');" return false;" class="inicioprint"><img src="images/pixel.png" class="icono" /><span>Imprimir Inici</span></a></li>
@%end-if:%@
</ul></div>
