...
<div class="tituloseccion">Llistat Incid�ncies</div>
...
<input type="hidden" name="accion_ejecutar" value="Aprobar" />
	...
	@%else:%@
	<li><a href="?seccion=nueva_incidencia_crm" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nova incid�ncia</span></a></li>
	@%end-if:%@
...
<li><a href="#" onClick="return sendForm('incidencias','accion_ejecutar','seleccionar_incidencias');" class="enviar" 
	><img src="images/pixel.png" class="icono" /><span>Associar</span></a></li>
</ul></div>
@%set:permitir_selecciones=1;%@
@%end-if:%@
...
<td></td>
@%end-if:%@
<td ><a href="?_search_sort=Incidencias.id_incidencia" >Refer�ncia<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.id_incidencia;%@" /></a></td>
<td ><a href="?_search_sort=Usuarios.nombre" >Usuari implicat<img src="images/pixel.png" class="@%func:class_searchsort;Usuarios.nombre;%@" /></a></td>
@%if:AllowedAction;Incidencias_id_usuario_gestor;new;%@
<td ><a href="?_search_sort=Empleados.nombre" >Usuari<img src="images/pixel.png" class="@%func:class_searchsort;Empleados.nombre;%@" /></a></td>
@%end-if:%@
<td ><a href="?_search_sort=Incidencias.fecha" >Data de alta<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Incidencias.fecha_estimada" >Data estimada<img src="images/pixel.png" class="@%func:class_searchsort;Incidencias.fecha_estimada;%@" /></a></td>
</tr>
</thead>
<tbody>
