...
<td ><a href="?_search_sort=Articulos.codigo_barras" >C�di de barres<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.codigo_barras;%@" /></a> </td>
...
<td ><a href="?_search_sort=Articulos.nombre" >Nom d�article<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a> </td>
...
<td ><a href="?_search_sort=caducidad" >Data caducitat menor<img src="images/pixel.png" class="@%func:class_searchsort;caducidad;%@" /></a></td>
<td ><a href="?_search_sort=caducidad_mayor" >Data Caducitat Major<img src="images/pixel.png" class="@%func:class_searchsort;caducidad_mayor;%@" /></a></td>
...
@%if:esta_vacio;st[id_alml];%@
	...
	@%if:cambia_var_x;%@
	<thead class="secundario" ><tr><td colspan="5">Zona Magatzem: @%db:Almacenes_logicos.nombre;%@</td>
