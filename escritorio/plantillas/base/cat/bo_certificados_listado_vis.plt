...
<tr> <td bgcolor="#FFFFFF" height="30">
 ...
 <a href="javascript:document.forms['modif_certificados'].submit();" class="accesos">Esborrar seleccionats</a> 
</td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" width="300">Descripció</td>
 <td width="1"></td>
