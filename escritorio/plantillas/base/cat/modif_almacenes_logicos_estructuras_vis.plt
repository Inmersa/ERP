...
<input type="hidden" name="registro[nombre]" value="@%db:Almacenes_logicos.nombre;%@" class="insertext" size="80">
 ...
 <td align="right" bgcolor="#EBECED" width="80">Corredors:</td>
 <td>
 ...
 <td align="right" bgcolor="#EBECED" width="80">Files:</td>
 <td>
 ...
 <td bgcolor="#EBECED" align="right" width="80">Columnes:</td>
 <td>
 ...
 <td height="21" bgcolor="#CCD2D7" width="128" class="etiqueta">Magatzems</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" colspan="2">Adreça:</td>
 <td height="22" width="4" bgcolor="#EBECED" align="right" class="etiqueta"></td>
...
@%db:Almacenes.cp;%@ (@%db:Almacenes.poblacion;%@)</td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" colspan="2">Persona de contacte:</td>
 <td height="22" width="4" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 <td height="22" width="234" class="texto">@%db:Almacenes.persona_contacto;%@ 
(@%db:Almacenes.cargo_persona_contacto;%@)</td>
 <td height="22" width="86" bgcolor="#EBECED" align="right" class="etiqueta">Telèfon:</td>
