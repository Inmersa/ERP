...
<div class="menuitem"> <a href="?seccion=modif_articulos" @%func:querystring_activa;modif_articulos;activo;;%@ >Dades generals</a></div>
@%end-if:%@
@%if:AllowedLink;modif_promociones;%@
<div class="menuitem"> <a href="?seccion=modif_promociones" @%func:querystring_activa;modif_promociones;activo;;%@ >Oferta / Promoció</a></div>
@%end-if:%@
@%if:AllowedLink;bo_localizacion_articulos;%@
<div class="menuitem"> <a href="?seccion=bo_localizacion_articulos" @%func:querystring_activa;bo_localizacion_articulos;activo;;%@ >Localització</a></div>
@%end-if:%@
