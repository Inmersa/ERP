  ...
  <tr> 
    <td height="22" bgcolor="#FFFFFF">
      ...
      <table width="644" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td bgcolor="#CCD2D7" height="22" class="etiqueta" colspan="5" > </td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td class="etiqueta" height="22">&nbsp;@%if:AllowedLink;modif_coordinadores;%@<a href="?seccion=modif_coordinadores&id_coordinador=@%db:Coordinadores.id_usr;%@" class="accesos">@%db:Coordinadores.nombre;%@ 
            @%db:Coordinadores.apellidos;%@</a></td>
			@%end-if:%@
          <td class="etiqueta" height="22"  bgcolor="#DBE0E3" width="1"></td>
        ...
        <tr> 
          <td bgcolor="#DBE0E3" height="1" colspan="5" ></td>
        </tr>
		  @%end-where:%@ 
