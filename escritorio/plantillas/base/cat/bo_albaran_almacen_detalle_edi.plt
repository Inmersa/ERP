...
<li><a href="#" onclick="return SendFormToWindow('bo_albaran_almacen','nuevo_bajas_almacen','BajaLocalizacion','accion_ejecutar','',600);" class="rechazar" ><img src="images/pixel.png" class="icono" /><span>Tornar</span></a></li>
@%end-if:%@

@%if:esta_vacio;preparado;%@
<li><a href="#" onclick="return SendFormToWindow('bo_albaran_almacen','albaran_localizaciones','Localizaciones',null,null,640);" class="verlocalizaciones" ><img src="images/pixel.png" class="icono" /><span>Veure Localitzacions</span></a></li>
