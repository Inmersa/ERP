...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr> <td class="titul1" align="left" width="95">&gt; Adreces de entrega</td>
</tr>
 <tr>
 <td height="10"></td>
 </tr>
...
<tr>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr> <td align="left" class="titul1" width="114">Mig de paga</td>
...
<tr> <td align="left" class="titul1" width="114">@%db:nombre%@</td>
 ...
 <tr> <td align="left" class="titocho" width="114">Base imposable:</td>
 <td class="texto" width="86">@%db:base_imponible%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="114">Retencións:</td>
 <td class="texto" width="86">@%db:retenido%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">Total Descomp.:</td>
 <td class="texto" width="103">@%db:descuentos%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr>
 <td height="10"></td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">Import:</td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
<td class="titocho">Observacions :</td>
</tr>
 <tr>
