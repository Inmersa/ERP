...
<tr><td class="etiqueta" >Quantitat a Servir</td><td colspan="2" >@%db:Detalles_albaran.cantidad;%@</td></tr>
...
<tr><td class="etiqueta" >Agrupar localitzacions en albarans</td><td class="check" 
