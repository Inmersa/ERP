...
@%if:!esta_vacio;id_albaran;%@
	...
	@%if:esta_vacio;es_venta;%@
		<tr><td class="etiqueta" >No modificar el Stock</td>
		...
		<td class="etiquetacheck" >Restablir stock</td></tr>
	@%else:%@
...
<tr><td class="etiqueta"> Quantitat Inicial : </td><td colspan="3" >@%db:cantidad;%@</td></tr>
...
@%if:!esta_vacio;id_albaran;%@
	<table class="full" >
	<caption class="titulotb" >Factures d'Abonament</caption>
	<tr><td class="etiqueta" >Nova</td>
...
<li><a href="#" onClick="return sendForm('nuevo_bajas_almacen');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Guardar</span></a></li>
</ul></div>
</div>
