...
<html>
<head>
<title>Autenticació Requerida</title>
...
<div id="login">
 ...
 <div id="logoproducto" class="nacional"><img src="imag/pxt.gif" class="null"/></div>
 <div id="logomodulo" class="nacional"><img src="imag/pxt.gif" class="null"/></div>

 <form method="post" action="?@%get:_krn_ss_querystring;%@">

Module Unavailable. Please contact your system's administrator.<br/>

 <!-- table >
 <tr><td class="titocho" align="right">Language:</td>
...
<option value="@%db:Idiomas.nemonico;%@">@%db:Idiomas.nombre;%@</option>
 ...
 <tr><td class="titocho" align="right">Usuari:</td>
 <td align="left" ><input type="text" border="cccccc" name="user" class="insertext" size="20"></td>
 </tr>

 <tr><td class="titocho" align="right">Contrasenya:</td>
 ...
 <div id="logoinmersa" class="nacional" ><img src="imag/pxt.gif" class="null"></div>
