...
<td class="caption">Codi de barres</td>
...
<li><a href="#" onclick="return !sendForm('bo_articulos_promocion');" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nou</span></a></li>
</ul></div>
