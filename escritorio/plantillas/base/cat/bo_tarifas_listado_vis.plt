...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta">Primer Descompte</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Segon Descompte</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Quantitat</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Camp acció</td>
