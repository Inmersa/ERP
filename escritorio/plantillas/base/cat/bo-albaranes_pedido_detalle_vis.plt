 ...
 <tr bgcolor="#CCD2D7" align="right"> <td colspan="15" height="22"><a href="" onclick="window.open('?seccion=bo_albaran_envio_print&id_albaran=@%db:Albaranes.id_albaran%@'); return false;" class="accesos">Imprimir enviament</a></td>
 </tr>
 <tr> <td colspan="15" height="1"></td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="1" height="22"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1">Codi</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="75">Data de caducitat</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Lot</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" >Quantitat demanda</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1">Quantitat movida</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="titul1" align="center" >Quantitat rebut </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center" width="60" >Preu</td>
