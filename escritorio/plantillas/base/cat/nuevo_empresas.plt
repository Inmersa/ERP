<table class="full">
 ...
 <td ></td>
 <td ><a href="javascript: history.go(-1);" >Tornar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
@%where:tabla|Grupo_empresas;nolink|1;%@
 ...
 <td width="87" class="etiqueta" >Telèfon 1:</td>
 ...
 <td width="87" class="etiqueta" >Telèfon 2:</td>
...
@%where:tabla|Provincias;order|nombre;nolink|1;%@
 ...
 <tr > 
 <td width="124" class="etiqueta" >Prefix factura:</td>
 <td width="57"> <input type="text" name="registro[prefijo_fact]" class="insertextnumeros" size="6">
 </td>
 <td class="etiqueta" width="124" >Sufix factura:</td>
 ...
 <tr bgcolor="#CCD2D7"> <td colspan="2" class="etiqueta">Altres dates</td>
 </tr>
 ...
 <tr> <td class="etiqueta">Contrasenya:</td>
 <td width="483"> 
 ...
 <tr> <td class="etiqueta">Repetir contrasenya:</td>
 <td width="483"> 
