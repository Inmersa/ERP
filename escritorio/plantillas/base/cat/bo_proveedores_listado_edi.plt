...
<li><a href="?seccion=bo_importar_proveedores" class="importarusuario" ><img src="images/pixel.png" class="icono" /><span>Importar Prove�dor</span></a></li>
@%end-if:%@
<li><a href="#" onclick="return sendForm('bo_proveedores');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Esborrar seleccionats</span></a></li>
</ul></div>
