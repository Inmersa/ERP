...
<input type=hidden name=estado value=1>
 ...
 <tr> <td bgcolor="#EBECED" width="216" class="etiqueta" align="right" height="22">Família de articles:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="216" class="etiqueta" align="right" height="22">Descomptes:</td>
