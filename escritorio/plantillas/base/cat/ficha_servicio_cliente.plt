...
<legend>Fitxa de Servei de Client</legend>
...
<td >Article</td>
<td >Data d�inici</td>
<td >Data Finalitzaci�</td>
<td >Estat de Servei</td>
</tr>
</thead>
...
<ul>
<li ><a href="#" onClick="return sendForm('nuevo');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Guardar</span></li>
</ul>
</div>
