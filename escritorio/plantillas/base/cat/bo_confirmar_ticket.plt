...
@%if:es_presupuesto%@
 ...
 <td width="46" align="center" ><a href="?seccion=hacer_ticket" class="accesos">Tornar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#CCD2D7" class="etiqueta">Consolidar Comanda tipus <input type="checkbox" name="pedido_tipo" value="1">
 </td>
 </tr>
 <tr>
 <td height="10"></td>
 ...
 @%where:nodb|nodb_reciever_data;%@ <tr> <td height="22" align="right" bgcolor="#EBECED" class="etiqueta">Nom:</td>
...
@%end-where:%@
 ...
 <tr> <td width="6"></td>
 <td width="419"></td>
 <td align="center" width="100"><a href="?seccion=hacer_pedido" class="accesos">Afegir article </a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center" width="60"> Desc. </td>
 <td width="1" height="20"></td>
...
@%end-if:%@
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="120">Recàrrec equivalent %</td>
 <td width="1" height="20" bgcolor="#DBE0E3"></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Base imposable</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center">Descomptes</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="80">Import</td>
 <td width="1" bgcolor="#DBE0E3" height="20"></td>
 </tr>
