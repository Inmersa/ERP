...
<table class="full">
<thead><tr>
<td colspan="3"><a href="?_search_sort=Articulos.nombre" class="order" >Nom<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Articulos.codigo_barras" class="order" 
	>Codi de barres<img src="images/pixel.png" class="@%func:class_searchsort;Articulos.codigo_barras;%@" /></a></td>
...
<td colspan="2"><a href="?_search_sort=Empresas_articulos.fecha_baja" class="order" 
	>Data de baixa<img src="images/pixel.png" class="@%func:class_searchsort;Empresas_articulos.fecha_baja;%@" /></a></td>
</tr></thead>
