...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td width="46" align="center" ><a href="javascript:history.go(-1);" class="accesos">Tornar</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
-->
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="etiqueta" height="22">Població:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="etiqueta">Província:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="etiqueta">Telèfon:</td>
...
<tr> <td bgcolor="#EBECED" align="right" class="texto" width="80" height="22">Referència:</td>
...
<!--@%wdb:Pedidos.id_agente%@--> </td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22" colspan="2">Data:</td>
 ...
 <td bgcolor="#EBECED" align="right" class="texto">Forma de paga:</td>
 <td colspan="2">
...
<a href="" onclick="document.forms['anyadir_al_pedido'].submit();return false;" class="accesos">Afegir article </a>
...
<td bgcolor="#DBE0E3"></td>
 ...
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center">Base imposable</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta">%</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta">IVA</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="60">Recàrrec equivalent</td>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="110">Descomptes</td>
 <td width="1"></td>
...
@%func:calcular_total_descuentos%@
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="etiqueta" height="22">Import Total </td>
 </tr>
