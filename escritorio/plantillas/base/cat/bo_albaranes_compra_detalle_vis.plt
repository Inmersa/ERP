...
-->
 ...
 <td bgcolor="#DBE0E3" height="22" class="etiqueta">Magatzem</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">Transportistes</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center" width="125">Ref. Comanda </td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center" width="125">Referència Albarà </td>
 ...
 <tr> <td bgcolor="#DBE0E3" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" colspan="3">Proveïdor</td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">Data </td>
 <td bgcolor="#FFFFFF" height="22" width="1"></td>
 <td bgcolor="#DBE0E3" height="22" class="etiqueta" align="center">Estat</td>
 <td bgcolor="#DBE0E3" height="22" width="1"></td>
 </tr>
 <tr> <td bgcolor="#FFFFFF" height="1" width="1"></td>
 <td bgcolor="#FFFFFF" height="1"></td>
