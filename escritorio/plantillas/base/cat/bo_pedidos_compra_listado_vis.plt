...
<form name="bo_pedidos_compras" method="post" action="">
 ...
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta" height="22">Codi</td>
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="60" class="etiqueta">Quantitat</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="55" class="etiqueta">Albaràns</td>
 <td width="1"></td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="etiqueta">A - <span class="texto">Albaràns</span></td>
