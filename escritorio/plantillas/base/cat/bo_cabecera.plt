...
<a href="?seccion=bo_facturas_compra">Factures de compra</a>
@%end-if:%@
@%if:AllowedLink;bo_facturas_venta;%@
<a href="?seccion=bo_facturas_venta">Factures de venda</a>
@%end-if:%@
...
@%else:%@
 ...
 @%else:%@
 <a href="?seccion=@%get:link_pedido_en_curso;%@">Comanda</a>
 @%end-if:%@
@%end-if:%@
</div>
 ...
 <div id="usuario">Usuari: @%func:get_from_user;user_name;%@</div>
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=modif_miempresa">Empreses</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_proveedores">Prove�dors</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_almacenes">Magatzems</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_pedidos_compras">Compres</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_pedidos_ventas">Vendes</a></li>
	@%end-if:%@
@%end-if:%@
...
@%else:%@
	...
	id="current"
	@%end-if:%@
	><a href="?seccion=bo_maestros">Configuraci�</a></li>
	@%end-if:%@
@%end-if:%@
</ul>
</div>
