...
<table width="726" border="0" cellspacing="0" cellpadding="0" bordercolor="#3F4D83">
 ...
 <span class="maslink">Seleccionar</span> <table width="76" border="0" cellspacing="0" cellpadding="0">
 <tr> <td class="bordes">
 <a href="?seccion=bo_catalogo_ficha&id_imagen=@%db:Catalogo_imagenes.id_imagen%@" class="texto_negrita_sinfondo">Veure </a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr>
 <td class="bordes"><a href="javascript:document.form_cat_radio.submit()" class="texto_negrita_sinfondo">Acceptar</a></td>
 </tr>
 </table>
 </td>
 </tr>
