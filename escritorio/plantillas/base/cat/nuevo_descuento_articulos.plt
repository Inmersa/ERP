...
<div class="tituloseccion">&gt; Afegir articles a client (
...
@%plt:botonera%@
 ...
 <li><a href="#" onClick="return sendForm('nuevo_descuento_articulos');"  class="enviar" ><img src="images/pixel.png" class="icono" /><span>Afegir</span></a></li>
 </ul></div>
