...
@%end-if:%@
<div id="contadorpaginas">Pàgines @%get:pagina_actual;%@ de @%get:paginas_totales;%@</div></div>
...
<tr class="bordes">
 ...
 <td class="@%css:PVP_rec;label;%@" >Preu Rec.</td>
 <td >Article</td>
@%if:!esta_vacio;_aAppConf[print_observaciones_enlinea];%@
 <td > </td>
@%end-if:%@
 <td class="@%css:nombre_marca;label;%@" >Marca</td>
 <td class="@%css:certificado;label;%@" >Aval</td>
 <td >Quantitat</td>
 <td >Preu</td>
 <td class="@%css:descuento;label;%@" >Desc.</td>
 <td >IVA %</td>
 <td >Import</td>
<tr>
</thead>
...
@%end-if:%@
 ...
 <td >Quantitat</td>
 <td >Preu</td>
 <td class="@%db:css:descuento;label;%@" >Desc.</td>
 <td >IVA % </td>
 <td >Import</td>
</tr>
</thead>
