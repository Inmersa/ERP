@%where:tabla|Efectos;where|Efectos.id_efecto= $id_efecto%@
 ...
 <tr> 
 <td height="22" bgcolor="#CCD2D7" class="titocho">>Nueva Liquidación</td>
<td width="1" bgcolor="#CCD2D7"></td>
</tr>
<tr><td>
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr> 
 <td bgcolor="#EBECED" width="139" class="etiqueta" align="center" height="22"> Fecha de Liquidación</td>
 <td bgcolor="#EBECED" width="134" class="etiqueta" align="center" height="22"> Medio pago </td>
 <td bgcolor="#EBECED" width="145" class="etiqueta" align="center" height="22"> Monto </td>
...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 <tr> <td bgcolor="#EBECED" width="134" class="etiqueta" align="center" height="30"> Nombre Banco </td>
<td>
