<table class="full">
 ...
 <tr> <td width="6" ></td>
 <td class="titocho" >&gt; NUEVA LOCALIZACION DE ARTICULO</td>
 ...
 <tr> <td colspan="13" class="etiqueta" bgcolor="#CCD2D7">Orden de fabricación: <select name="registro[lote]" >
@%where:tabla|Ordenes_fabricacion;nolink|1;%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" >Lote propio </td>
 <td ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Planta</td>
 <td ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Pasillo</td>
 <td class="etiqueta" ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Fila</td>
 <td ></td>
 <td bgcolor="#DBE0E3" class="etiqueta" >Colum.</td>
 <td ></td>
 <td class="etiqueta" bgcolor="#DBE0E3" >Cantidad</td>
