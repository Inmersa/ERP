...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="100">Referencia</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Nombre</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Fecha</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="140">Dirección de entrega </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="91" height="22" align="center" class="etiqueta">Monto</td>
