...
<input type="hidden" name="accion_ejecutar" value="Modificar">
 ...
 <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Nombre:</td>
...
<input type="hidden" name="registro[nombre]" class="insertext" size="30" value="@%db:Proveedores.nombre;%@"/>
 ...
 <td width="87" class="etiqueta" align="right" bgcolor="#EBECED">NIF intracom.:</td>
...
<input type="hidden" name="registro[razon_social]" class="insertext" size="30" value="@%db:Proveedores.razon_social;%@"/>
 ...
 <td bgcolor="#EBECED" width="87" class="etiqueta" align="right">NIF - CIF:</td>
...
<input type="hidden" name="registro[cif]" value="@%db:Proveedores.cif;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Domicilio:</td>
...
<input type="hidden" name="registro[domicilio]" value="@%db:Proveedores.domicilio;%@" class="insertext" size="30"/>
 ...
 <td bgcolor="#EBECED" width="87" align="right" class="etiqueta">Población:</td>
...
<input type="hidden" name="registro[cp]" value="@%db:Proveedores.cp;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Persona de contacto:</td>
...
<input type="hidden" name="registro[telefono1]" value="@%db:Proveedores.telefono1;%@" class="insertext" size="20"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Cargo Contacto:</td>
...
<input type="hidden" name="registro[fax]" value="@%db:Proveedores.fax;%@" class="insertext" size="20"/>
 ...
 <tr> <td width="161" height="22" align="right" bgcolor="#EBECED" class="etiqueta">Fecha alta:</td>
...
<input type=hidden name=registro2[id_usr] value="@%db:Proveedores_empresas.id_usr%@">
 ...
 <td class="etiqueta" height="20" >Datos para esta Empresa</td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td align="right" height="22" bgcolor="#EBECED" class="etiqueta" width="161">Forma de pago:</td>
...
@%end-where:%@
 ...
 <tr> <td class="etiqueta" height="22" bgcolor="#EBECED" align="right" width="161">Divisa:</td>
...
@%end-where:%@
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta">Retención:</td>
