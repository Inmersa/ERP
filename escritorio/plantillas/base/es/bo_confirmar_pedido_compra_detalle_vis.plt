 ...
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="90">Importe</td>
 ...
 @%where:nodb|nodb_confirmar_pedido;%@ <!-- @%db:Lineas_detalle.id_articulo;%@-->
 ...
 @%where:nodb|detalle_IVA;%@ <!-- @%db:base_imponible;%@ -->
