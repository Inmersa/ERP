...
<li><a href="?seccion=nuevo_promociones" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Añadir</span></a></li>
</ul></div> 
@%end-if:%@
...
<li><a href="?seccion=bo_articulos_promocion&id_promocion=@%db:Promociones.id_promocion%@" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Añadir artículo</span></a></li>
