...
<div class="alinder"><a href="javascript: history.go(-1);">Volver</a>
</div>
</div>
<form name="rappel_cliente" method="post" action="?seccion=bo_rappel_cliente">
<div class="barraoscurai">Finalizado 12 meses</div>
<table class="full">
<tr>
<td colspan="2">
</td>
<td class="etiqueta">Fecha de inicio
</td>
...
<div class="enviar"><a href="" onClick="document.forms['rappel_cliente'].submit();return false;">Añadir</a>
</div>
</form>
