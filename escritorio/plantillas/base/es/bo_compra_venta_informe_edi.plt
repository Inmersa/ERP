...
@%plt:botonera%@ 
 ...
 <tr> <td class="etiqueta" bgcolor="#CCD2D7" height="22">Informes de clientes</td>
 </tr>
 <tr> <td height="10"></td>
 </tr>
 ...
 <td bgcolor="#CCD2D7" class="etiqueta">Nombre</td>
 <td height="22" width="1"></td>
 <td bgcolor="#CCD2D7" class="etiqueta" width="70" align="center">Fecha</td>
 <td height="22" width="1"></td>
 <td bgcolor="#CCD2D7" width="50" class="etiqueta" align="center">Dto</td>
 <td height="22" width="1"></td>
 <td bgcolor="#CCD2D7" align="center" width="85" class="etiqueta">B. imponible</td>
 <td height="22" width="1"></td>
 <td bgcolor="#CCD2D7" width="80" class="etiqueta" align="center">T. impuesto</td>
 <td height="22" width="1"></td>
 <td bgcolor="#CCD2D7" width="90" align="center" class="etiqueta">Monto Total</td>
 <td height="22" width="1"></td>
 </tr>
 ...
 <br>
 <table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr> <td class="etiqueta" bgcolor="#CCD2D7" height="22">Informes de proveedores</td>
 </tr>
 <tr> <td height="10"></td>
 </tr>
 </table>
 ...
 <td class="texto" width="80"><a href="?seccion=bo_factura_cliente&id_factura=@%db:Facturas.id_factura;%@" class="accesos">@%db:Facturas.referencia;%@</a></td>
...
<!--@%func:acumula%@-->
 ...
 <tr> <td></td>
 <td bgcolor="#CCD2D7" width="1"></td>
 <td align="right" class="etiqueta" width="240" height="22" bgcolor="#CCD2D7">Total monto clientes y proveedores:</td>
 <td bgcolor="#CCD2D7" width="1"></td>
