...
<form method="post" action="?seccion=pda_cliente" name="clienteid">
 <td class="acceso_directo" align="left">Pedido-ID Cliente:</td>
 <td><input type="text" border="cccccc" name="id_cliente" class="insertext" size="5"><input type="submit" value="Enviar">
 </td>
</form>
 </tr>
<tr> 
...
<input type="hidden" name="nom_bus" value="recorridos_search">
 <td class="acceso_directo" align="left">Fecha Ruta :</td>
 <td><input type="text" border="cccccc" name="fecha" class="insertext" size="10"
 value="@%get:st_fecha;%@"><input type="submit" value="Enviar"></td>
</form>
 </tr>
<tr>
<td height="10">
...
<a href="?seccion=pda_cierre_ruta&id_recorrido=@%get:id_recorrido_act;%@" class="accesos">Cierre de ruta</a>
...
<td height="10"></td>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
<td class="titul1" align="left">Clientes en ruta:</td>
</tr>
<tr>
<td height="10"></td>
</tr>
...
<tr> <td class="accesos" align="right">
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
<td class="titul1" align="left" colspan="2">Otros Recorridos:</td>
</tr>
<tr>
