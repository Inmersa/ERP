...
<td class="caption">Porcentaje</td>
<td class="caption">Recargo de equivalencia</td>
 </tr>
...
@%plt:botonera%@
<div class="enviar"><a href="#" onClick="return sendForm('modif_tipos_iva');">Borrar seleccionados</a></div>
