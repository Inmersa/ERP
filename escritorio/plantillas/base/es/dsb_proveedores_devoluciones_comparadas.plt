...
<table class="full" >
@%set:dsb_resultados=devoluciones_comparadas;%@
@%set:dsb_rs_limit=7;%@
@%set:dsb_an_limit=3;%@
...
<!-- @%set:_iterate_reset=1;%@ @%set:_dsb_resultados_anual_valor=devoluciones;%@ -->
@%where:nodb|nodb_iterate;%@
...
@%func:dsb_grfx_comparadas;devoluciones_comparadas;devoluciones;%@
