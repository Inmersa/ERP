 ...
 <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Nombre:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Razón social:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="titul1" height="22">Domicilio:</td>
 <td width="228"> <input type="text" name="registro[domicilio]" value="@%db:Proveedores.domicilio;%@" class="insertext" size="30"/>
 </td>
 <td bgcolor="#EBECED" width="87" align="right" class="titul1">Población:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Provincia:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Persona de contacto:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="titul1" align="right" height="22">Cargo Contacto:</td>
 ...
 <tr> <td width="161" height="22" align="right" bgcolor="#EBECED" class="titul1">Fecha alta:</td>
...
<input type=hidden name=registro2[id_usr] value="@%db:Proveedores_empresas.id_usr%@">
 ...
 <td class="titul1" height="20" >Datos para esta Empresa</td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td align="right" height="22" bgcolor="#EBECED" class="titul1" width="161">Forma de pago:</td>
...
@%end-where:%@
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="titul1">Retención:</td>
