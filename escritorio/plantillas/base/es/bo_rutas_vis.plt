...
@%plt:botonera%@
 ...
 <tr> <td align="left">
<a href="" class="accesos">Añadir</a>
</td>
<td width="20" align="center"></td>
 <td align="center">
<a href="#" onClick="return onHrefClick('bo_rutas','accion_ejecutar', 'Generar');" class="accesos">Generar Recorridos</a>
</td>
<td ></td>
 <td width="146" align="right">
<a href="#" onClick="return onHrefClick('bo_rutas','accion_ejecutar', 'Borrar');" class="accesos">Borrar seleccionados</a>
</td>
 <td width="4"></td>
 </tr>
 </table>
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="288">Ruta</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Frecuencia / Días</td>
 <td width="1"></td>

 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Fecha última </td>
 <td width="1"></td>

 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="264">Nº Clientes</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="257" align="center">Agente </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="176">Fecha Próxima</td>
 <td width="1"></td>
 </tr>
