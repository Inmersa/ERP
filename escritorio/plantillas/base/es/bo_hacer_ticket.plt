 ...
 <td class="titocho" >&gt; SELECCIONAR DE ARTICULOS DE TICKET</td>
 <td align="right" > <a href="#" onclick="return abrir_ventana('?seccion=hacer_ticket_codbarras',400,200);" class="accesos">Cod. barras</a>
 </td>
