...
<!--@%Transportistas.id_transportista;%@-->
 ...
 <tr> <td width="161" class="etiqueta" align="right" height="22" bgcolor="#EBECED">Dirección:</td>
...
@%where:tabla|Provincias;nolink|1;%@
 ...
 <tr> <td width="161" height="22" bgcolor="#EBECED" class="etiqueta" align="right">Cuenta Bancaria IBAN:</td>
