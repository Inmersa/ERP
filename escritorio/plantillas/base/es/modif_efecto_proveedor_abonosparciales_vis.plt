...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 <tr> 
 <td height="22" align="left" bgcolor="#CCD2D7" class="titocho">>Liquidaciones Parciales</td>
<td width="1" bgcolor="#CCD2D7"></td>
 ...
 <tr> 
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="100">Fecha de Liquidación</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="100">Medio pago</td>
 <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="80">Monto</td> <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" width="80">Nombre Banco</td> <td bgcolor="#DBE0E3" width="1"></td>
 <td bgcolor="#EBECED" class="etiqueta" align="center" >Notas</td>
 <td width="1" bgcolor="#CCD2D7"></td>
 </tr>
