...
<form name="bo_pedidos_compras" method="post" action="">
 ...
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta" height="22">Código</td>
 <td bgcolor="#DBE0E3" width="22" class="etiqueta"></td>
 <td bgcolor="#DBE0E3" align="center" width="20" class="etiqueta">P</td>
 <td bgcolor="#DBE0E3" align="center" width="20" class="etiqueta">A</td>
 <td bgcolor="#DBE0E3" align="center" width="20" class="etiqueta">F</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Cliente</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="90" class="etiqueta">Fecha</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="60" class="etiqueta">Monto</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="55" class="etiqueta">Albarán</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="55" class="etiqueta">Factura</td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="etiqueta" colspan="9" height="20" bgcolor="#DBE0E3">Leyenda</td>
 ...
 <tr> <td class="etiqueta" bgcolor="#DBE0E3"></td>
 <td class="etiqueta" height="20"></td>
 <td class="etiqueta">F - <span class="texto">Factura</span></td>
 <td><img src="imag/verde.gif" width="14" height="14"></td>
 <td class="texto">Emitido</td>
 <td><img src="imag/amarillo.gif" width="14" height="14"></td>
 <td class="texto">Sin Emitir</td>
 <td><img src="imag/rojo.gif" width="14" height="14"></td>
 <td class="texto">Sin Factura</td>
 <td ></td>
 <td class="texto"></td>
 <td class="texto" bgcolor="#DBE0E3"></td>
 </tr>
