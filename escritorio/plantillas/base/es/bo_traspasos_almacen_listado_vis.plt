...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Almacén origen</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Almacén destino </td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="120">Transportista</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="120">Observaciones</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="75" height="22" class="etiqueta" align="center">Fecha trasp.</td>
 <td width="1"></td>
