...
@%if:nuevo_proveedor%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Razón social</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="110">Código</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="80">Riesgo</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="55">Demora</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="100" align="center">Mto. Cuenta</td>
...
@%else:%@
 ...
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22">Concepto</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Medio Pago</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Vencimiento</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">Total</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" height="22" align="center">T. Pagado </td>
 <td bgcolor="#DBE0E3" width="1"></td>
