...
class="tituloseccion"
@%end-if:%@
>&gt; MODIFICAR EFECTO (ID: @%db:Clientes.id_cliente;%@) @%db:Clientes.razon_social;%@</div>
...
<li><a href="#" onClick="return sendForm('efecto');" class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Deshacer Cambios</span></a></li>
