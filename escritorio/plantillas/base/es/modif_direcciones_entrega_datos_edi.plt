...
<tbody>
 ...
 <td class="etiqueta">Cargo de contacto:</td>
 ...
 <tr><td class="etiqueta" >Transportista:</td>
 <td colspan="3" ><!-- @%set:_selected_value=Direcciones_entrega.id_transportista;%@ @%db:Direcciones_entrega.id_transportista;%@ -->
 <select name="registro_dir[id_transportista]" ><option value="null" >PreDef</option>
...
<li><a href="#" onclick="return sendForm('modif_direcciones_entrega');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modificar</span></a></li>
</div>
