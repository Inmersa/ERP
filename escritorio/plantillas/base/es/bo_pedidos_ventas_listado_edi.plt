...
<li><a href="#Generar Albaranes" 
	...
	class="generaralbaranes" ><img src="images/pixel.png" class="icono" /><span>Generar albaranes</span></a></li>
...
<thead>
<tr>
<td ><a href="?_search_sort=Pedidos.referencia" class="order" >C�digo<img src="images/pixel.png" class="@%func:class_searchsort;Pedidos.referencia;%@" /></a></td>
...
<td ><a href="?_search_sort=Pedidos.fecha" class="order" >Fecha<img src="images/pixel.png" class="@%func:class_searchsort;Pedidos.fecha;%@" /></a></td>
<td ><a href="?_search_sort=monto_pedido" class="order" >Monto<img src="images/pixel.png" class="@%func:class_searchsort;monto_pedido;%@" /></a></td>
