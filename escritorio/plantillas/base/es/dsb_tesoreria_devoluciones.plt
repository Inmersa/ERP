...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Devoluciones de Cobro</td>
<td colspan="@%get:_iterate_times;%@" >Devoluciones de Pago</td></td>
...
<!-- 
@%set:grafica[titulo] = Devoluciones de Cobro;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Devoluciones de Pago;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
