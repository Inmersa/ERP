...
@%end-if:%@
<tr><td class="etiqueta"> Localización : 
</td><td >
Planta: @%db:Bajas_localizacion.planta;%@
Pasillo: @%db:Bajas_localizacion.pasillo;%@
Fila: @%db:Bajas_localizacion.fila;%@
Colum.: @%db:Bajas_localizacion.columna;%@
</td></tr>

<tr><td class="etiqueta"> Producto (Lote / F.Cad) : </td>
<td >@%db:Bajas_localizacion.lote;%@ @%db:colocar_fecha{Bajas_localizacion.fecha_caducidad};%@</td></tr>

<tr><td class="etiqueta"> Cantidad : </td>
<td >@%db:Bajas_localizacion.cantidad;%@</td></tr>

<tr><td class="etiqueta">Tipo de Baja:</td>
<td>
...
<li><a href="#" onClick="return sendForm('bajas_localizacion');"  class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Deshacer Cambios</span></a></li>
