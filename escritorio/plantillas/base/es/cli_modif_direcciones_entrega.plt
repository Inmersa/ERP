...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" >&gt; EDITAR DIRECCION DE ENTREGA</td>
 <td width="46" align="center" ><a href="?seccion=cli_modif_clientes" class="accesos">Volver</a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <tr> <td class="texto" valign="top">Rellena este formulario para modificar</td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 </table>
 ...
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Dirección:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Población:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
...
@%where:tabla|Provincias;order|nombre;nolink|1;%@
 ...
 <tr> <td height="22" bgcolor="#EBECED" align="right" class="etiqueta" width="5"></td>
 <td height="22" bgcolor="#EBECED" align="right" class="texto" width="185">Teléfono:</td>
 <td height="22" width="6" bgcolor="#EBECED" align="right" class="etiqueta"></td>
 ...
 <td colspan="4" height="22" bgcolor="#CCD2D7"> <a href="" onclick="document.forms['modif_direcciones_entrega'].submit();return false;" class="accesos">Modificar</a> </td>
 </tr>
 </form>
 </table>
 </td>
