...
Nombre promoción</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" align="center" class="etiqueta">Artículo</td>
 <td width="1"></td>
 <td width="80" bgcolor="#DBE0E3" align="center" class="etiqueta">Fecha inicio</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" class="etiqueta" width="80">Fecha Fin</td>
 </tr>
...
<input type="text" name="registro[fecha_inicio]" value="@%db:colocar_fecha{Promociones.fecha_inicio};%@" size="10" class="insertextnumeros">
 Fecha Finalización<input type="text" name="registro[fecha_fin]" value="@%db:colocar_fecha{Promociones.fecha_fin};%@" size="10" class="insertextnumeros">


<a href="" onclick="return onHRefClick('modif_promociones','accion_ejecutar','Modificar');" class="accesos">Activo</a>
