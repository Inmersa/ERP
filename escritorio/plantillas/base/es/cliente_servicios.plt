...
<div class="tituloseccion">Servicios de Cliente 
...
<li><a href="?seccion=bo_articulos&modo_seleccion=1&many=1&target=nuevo_servicio_cliente&recursos=NOTNULL" class="nuevo"
	><img src="imag/pixel.png" class="icono" /><span>Nuevo</span></a></li>
@%end-if:%@
...
@%if:AllowedAction;Clientes_recursos;del;%@
 <td >&nbsp;</td>
@%end-if:%@
 <td ><a href="?_search_sort=Recursos.nombre" >Recurso<img src="imag/pixel.png" class="@%func:class_searchsort;Recursos.nombre;%@" /></a></td>
 ...
 <td ><a href="?_search_sort=Clientes_recursos.fecha_inicio" >Fecha inicio<img src="imag/pixel.png" 
 	class="@%func:class_searchsort;Clientes_recursos.fecha_inicio;%@" /></a></td>
 <td ><a href="?_search_sort=Clientes_recursos.fecha_fin" >Fecha Finalización<img src="imag/pixel.png" 
 	class="@%func:class_searchsort;Clientes_recursos.fecha_fin;%@" /></a></td>
 <td ><a href="?_search_sort=Estados_servicio.nombre" >Estado de Servicio<img src="imag/pixel.png" class="@%func:class_searchsort;Estados_servicio.nombre;%@" /></a></td>
</tr>
</thead>
<tbody>
