...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Pendiente de Cobro</td>
<td colspan="@%get:_iterate_times;%@" >Pendiente de Pago</td></td>
...
<!-- 
@%set:grafica[titulo] = Pendiente de Cobro;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Pendiente de Pago;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
