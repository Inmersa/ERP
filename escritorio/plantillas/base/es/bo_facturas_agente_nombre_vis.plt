...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" width="180">Referencia</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Fecha</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Ref. externa</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="110">Importe Comisión</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" align="center" class="etiqueta">Monto Cuenta </td>
 <td width="1" height="22"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" class="etiqueta" align="center">Monto Total </td>
