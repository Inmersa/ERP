...
<li class="noicon" >Desde: <input type="text" name="generar_desde" value="dd/mm/aaaa" size="12" maxlength="10" /> </li>
<li class="noicon" >Hasta: <input type="text" name="generar_hasta" value="dd/mm/aaaa" size="12" maxlength="10" /></li>
<li><a href="#" onClick="return onHRefClick('bo_rutas','accion_ejecutar', 'Generar');" class="generar" 
	><img src="imag/pixel.png" class="icono" /><span>Generar</span></a></li>
<li><a href="?seccion=nuevo_rutas" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Añadir</span></a></li>
<li><a href="#" onClick="return onHRefClick('bo_rutas','accion_ejecutar', 'Borrar_rutas');" class="borrar" 
	><img src="imag/pixel.png" class="icono" /><span>Borrar</span></a></li>
</ul></div>
...
<td ><a href="?_search_sort=Rutas.nombre" class="order" >Ruta<img src="imag/pixel.png" class="@%func:class_searchsort;Rutas.nombre;%@" /></a></td>
...
<td ><a href="?_search_sort=Rutas.descripcion" class="order" >Desc<img src="imag/pixel.png" class="@%func:class_searchsort;Rutas.descripcion;%@" /></a></td>
<td ><a href="?_search_sort=Rutas.d_frecuencia" class="order" >Frecuencia / Días<img src="imag/pixel.png" class="@%func:class_searchsort;Rutas.d_frecuencia;%@" /></a></td>
