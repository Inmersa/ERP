...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" width="215" class="etiqueta" align="right" height="22">Nombre:</td>
 ...
 <tr align="center"> <td height="22" bgcolor="#CCD2D7" colspan="3"><a href="javascript:document.forms['modif_grupo_rutas'].submit();" class="accesos">Guardar</a> <a href="javascript:document.forms['modif_grupo_rutas'].reset();" class="accesos">Deshacer Cambios</a> <a href="?seccion=bo_grupos_rutas&estado=2&registro[id_grupo_ruta]=@%db:Grupo_rutas.id_grupo_ruta%@" onClick="return confirm('Esta ud. seguro de que de desea borrar el registro?');return false;" class="accesos">Borrar</a> </td>
 </tr>
 </form>
 </table>
 </td>
