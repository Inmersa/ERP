...
<li><a href="?seccion=nuevo_familia_articulos" class="accesos" class="nuevo" ><img src="images/pixel.png" class="icono" /><span> Nuevo</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_familia_articulos');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Borrar seleccionados</span></a></li>
</ul></div>
...
<tr>
<td></td>
<td class="caption">Nombre de familia</td>
</tr>
</thead>
<tbody>
