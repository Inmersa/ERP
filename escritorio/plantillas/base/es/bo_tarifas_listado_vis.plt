...
@%plt:botonera%@
 ...
 <td bgcolor="#DBE0E3" class="etiqueta">Dto Primero</td>
 <td class="etiqueta" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Dto Segundo</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Monto</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta">Campo de acción</td>
