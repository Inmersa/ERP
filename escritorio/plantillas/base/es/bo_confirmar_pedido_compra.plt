...
@%if:esta_vacio;es_factura;%@
 PRESUPUESTO @%set:send_form_to=bo_presupuestos_compras;%@
 @%else:%@ 
 Factura @%set:send_form_to=bo_facturas_compra;%@
 @%end-if:%@ 
@%else:%@ 
Pedido @%set:send_form_to=bo_pedidos_compras;%@
@%end-if:%@ 
</td>
 <td width="46" align="center" ><a href="?seccion=hacer_pedido_compra" class="accesos">Volver</a></td>
 </tr>
 </table>
 </td>
 </tr>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#CCD2D7" class="titul1">Convertir en pedido tipo <input type="checkbox" name="pedido_tipo" value="1">
 </td>
 </tr>
 <tr>
 <td height="10"></td>
...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#CCD2D7" height="22" class="titul1">Proveedor</td>
 </tr>
 ...
 <tr> <td height="22" align="right" bgcolor="#EBECED" class="titul1">Nombre:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Código:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Domicilio:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" class="titul1" height="22">Población:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">Provincia:</td>
 ...
 <tr> <td align="right" bgcolor="#EBECED" height="22" class="titul1">Telefono:</td>
...
@%set:observaciones_en_totales=observaciones;%@
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" width="112" height="22">Nombre Documento :</td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22" width="112">Forma de pago:</td>
 <td width="217">
...
@%if:esta_vacio;es_pedido%@
@%else:%@
 <tr> <td bgcolor="#EBECED" width="112" class="texto">Dir. entrega:</td>
...
>@%db:Almacenes.nombre;%@ @%db:Almacenes.direccion;%@</option>
 ...
 <td bgcolor="#EBECED" class="texto" width="95" align="right">Realizado por:</td>
 <td width="220">
...
@%end-where:%@
 ...
 <tr> <td width="6"></td>
 <td width="419"></td>
 <td align="center" width="100"><a href="?seccion=hacer_pedido_compra" class="accesos">Añadir artículo </a></td>
 </tr>
 </table>
 </td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" height="20" class="titul1">Nombre</td>
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Cant.</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="60">Precio</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="titul1" align="center" width="60">IVA</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center" width="60"> Dtos </td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="110">Importe</td>
...
@%end-if:%@
 ...
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center">Base imponible</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1">IVA %</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="120">R. equiv. %</td>
 <td width="1" height="20" bgcolor="#DBE0E3"></td>
 </tr>
 ...
 <td bgcolor="#DBE0E3" class="titul1" align="center">Base imponible</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="titul1" align="center">Descuento</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="titul1" width="80">Importe</td>
 <td width="1" bgcolor="#DBE0E3" height="20"></td>
 </tr>
 ...
 <tr> <td align="right" class="texto" width="112" bgcolor="#EBECED">T.B. Imponible:</td>
 <td width="81" height="22" class="texto"> @%db:base_imponible;%@</td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="112">T. Impuestos:</td>
 <td width="81" height="22" class="texto"> @%db:impuestos;%@</td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="112">Retención:</td>
 <td width="81" height="22" class="texto"> @%db:retenido;%@ </td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="112">Recargo equiv:</td>
 <td width="81" height="22" class="texto"> @%db:recargos;%@</td>
 </tr>
 <tr> <td colspan="2" bgcolor="#DBE0E3" height="1" align="right"></td>
 </tr>
 <tr> <td align="right" class="texto" bgcolor="#EBECED" width="112">Total descuento:</td>
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="titul1" height="22">Importe Total </td>
 </tr>
...
<br><br>
 ...
 <tr align="center"> <td colspan="3" bgcolor="#CCD2D7" class="titul1" height="22">Importe en @%db:divisa_cliente_nombre%@</td>
 </tr>
 <tr> <td bgcolor="#DBE0E3" width="1"></td>
