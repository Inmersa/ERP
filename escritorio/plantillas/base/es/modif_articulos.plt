...
<div class="tituloseccion">&gt; FICHA DE ARTICULO</div>

@%if:AllowedLink;nuevo_articulos;%@
<div id="AccionesEncabezado"><ul>
	@%if:AllowedAction;Articulos;new;%@
	<li><a href="?seccion=nuevo_articulos"  class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Nuevo artículo</span></a></li>
	@%end-if:%@
</ul></div> 
@%end-if:%@
...
<li><a href="#" onclick="return onHRefClick('modif_articulos','accion_ejecutar','Modificar');" class="guardar"><img src="imag/pixel.png" class="icono" /><span>Modificar</span></a></li>
</ul></div>
@%end-if:%@
