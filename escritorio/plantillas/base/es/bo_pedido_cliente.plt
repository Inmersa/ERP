...
<div class="tituloseccion">&gt; Pedido :@%db:nombre;%@</div>
...
<li><a href="?seccion=bo_facturas_pedido_venta&id_pedido=@%db:id_pedido;%@" class="verfras" ><img src="images/pixel.png" class="icono" /><span>Ver facturas</span></a></li>
@%else:%@
