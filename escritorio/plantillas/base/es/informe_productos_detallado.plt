...
@%where:tabla|Articulos;nombre|busc;no_results|1;%@
	...
	<table class="full">
	<tr> 
	<td class="titulotb" align="right">Marca:</td>
	...
	<table class="full">
	<tr> 
	<td class="titulotb" align="right">Familia:</td>
	...
	<table class="full">
	<tr> 
	<td class="titulotb" align="right">Agente:</td>
	...
	<table class="full">
	<tr> 
	<td class="titulotb" align="right">Cliente:</td>
	...
	<td ><a href="?_search_sort=Articulos.nombre">Artículo<img src="imag/pixel.png" class="@%func:class_searchsort;Articulos.nombre;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_pedida">Pedida<img src="imag/pixel.png" class="@%func:class_searchsort;cantidad_pedida;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_recibida">Recibido<img src="imag/pixel.png" class="@%func:class_searchsort;cantidad_recibida;%@" /></a></td>
	<td ><a href="?_search_sort=cantidad_facturada">Facturado<img src="imag/pixel.png" class="@%func:class_searchsort;cantidad_facturada;%@" /></a></td>
	<td ><a href="?_search_sort=precio_medio">Pr. Medio<img src="imag/pixel.png" class="@%func:class_searchsort;precio_medio;%@" /></a></td>
	<td ><a href="?_search_sort=precio_maximo">Pr. Máximo<img src="imag/pixel.png" class="@%func:class_searchsort;precio_maximo;%@" /></a></td>
	<td ><a href="?_search_sort=precio_minimo">Pr. Mínimo<img src="imag/pixel.png" class="@%func:class_searchsort;precio_minimo;%@" /></a></td>
	</tr>
	</thead>
	<tbody class="informe" >
	@%else:%@
