...
<li><a href="?seccion=nuevo_coordinadores" class="nuevo"><img src="images/pixel.png" class="icono" /><span>Nuevo Coordinador</span></a></li>
@%end-if:%@
<li><a href="#" onclick="return confirmForm('coordinadores','�Est� ud. seguro de que desea borrar los registros seleccionados?');" class="borrar" 
