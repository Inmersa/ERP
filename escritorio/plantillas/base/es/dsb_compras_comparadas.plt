...
<legend>Compras Comparadas</legend>
...
<tr><td ></td>
<td colspan="@%get:_iterate_times;%@" >Compras</td>
<td colspan="@%get:_iterate_times;%@" >Cobrado</td></td>
...
<!-- 
@%set:grafica[titulo] = Compras Comparadas;%@
...
@%if:!esta_vacio;mostrar_grafica;%@
<!-- 
@%set:grafica[titulo] = Cobrado Comparado;%@
@%set:grafica[limit] = dsb_rs_limit;%@
-->
@%plt:Grafica;%@
@%end-if:%@
