<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="90">Fecha</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" align="center" height="20" class="etiqueta" width="90">B. imponible</td>
 <td width="1" height="20"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center" width="90">Impuestos</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" height="20" class="etiqueta" align="center" width="90">Total</td>
 <td width="1" height="20"></td>
...
<!-- @%db:Pedidos_facturas.id_pedido;%@ -->
 ...
 <td class="texto" height="24"><a href="?seccion=bo_factura_proveedor&id_factura=@%db:Facturas.id_factura;%@" class="accesos">@%db:Facturas.referencia;%@</a></td>
 ...
 <td class="etiqueta"><span class="texto">Factura</span></td>
 <td><img src="imag/verde.gif" width="14" height="14"></td>
 <td class="texto">Emitida</td>
