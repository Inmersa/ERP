...
<!-- li><a href="?seccion=bo_importar_almacenes" class="importaralmacen"><img src="images/pixel.png" class="icono" /><span>Importar registros</span></a></li -->
@%end-if:%@
@%if:AllowedLink;nuevo_almacenes;%@
<li><a href="?seccion=nuevo_almacenes" class="nuevo"><img src="images/pixel.png" class="icono" /><span>Nuevo Almac�n</span></a></li>
@%end-if:%@
