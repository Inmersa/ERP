...
<input type=hidden name=estado value=4>
 ...
 <td class="titocho" >&gt; FICHA DE EMPRESA</td>
 <td align="right" ><a href="../?seccion=bo_empresas" class="accesos">Listado de empresas</a></td>
...
<a href="javascript:document.forms['modif_empresas'].submit();" class="accesos">Modificar</a>
<a href="javascript:document.forms['modif_empresas'].reset();" class="accesos">Deshacer Cambios</a> 
