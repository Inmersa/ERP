...
<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22"> Cliente: </td>
 <td class="texto">@%db:Proveedores.razon_social%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Concepto: </td>
 <td class="texto">@%db:Efectos.concepto%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Ref. Factura: </td>
 <td class="texto">@%db:Facturas.referencia%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Pago cobro: </td>
 <td class="texto">@%db:Efectos.pago_cobro%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Cuenta Bancaria IBAN: </td>
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Forma de pago: </td>
...
@%end-where:%@ 
 ...
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Medio pago: </td>
 <td class="texto">@%db:Efectos.medio_pago%@</td>
 <td width="1" bgcolor="#CCCCCC"></td>
 </tr>
 <tr> <td height="1" colspan="3" bgcolor="#CCD2D7"></td>
 </tr>
 <tr> <td bgcolor="#EBECED" class="etiqueta" align="right" height="22">Fecha Vencimiento: </td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="etiqueta" height="22">T. Pagado: </td>
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="etiqueta" height="22">Estado:</td>
