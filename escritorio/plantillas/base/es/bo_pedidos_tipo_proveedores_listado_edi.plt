...
<li><a href="#" onClick="return onHRefClick('pedidos_tipo_proveedor',null,null,'hacer_pedido_compra&tipo=1&nuevo=1&pedido=1');" class="nuevo" 
	><img src="images/pixel.png" class="icono" /><span>Hacer pedido</span></a></li>
@%set:permitir_selecciones = 1;%@
@%end-if:%@
@%if:AllowedAction;Pedidos_tipo_proveedor;del;%@
<li><a href="#" onclick="return sendForm('pedidos_tipo_proveedor');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Borrar seleccionados</span></a></li>
@%set:permitir_selecciones = 1;%@
@%end-if:%@
</ul></div>
...
<thead>
<tr>
<td ><a href="?_search_sort=Pedidos.referencia" >Ref. propia<img src="images/pixel.png" class="@%func:class_searchsort;Pedidos.referencia;%@" /></a></td>
 @%if:!esta_vacio;permitir_selecciones;%@
 <td ></td>
 @%end-if:%@
<td ><a href="?_search_sort=Pedidos_tipo_proveedor.nombre" >Nombre<img src="images/pixel.png" class="@%func:class_searchsort;Pedidos_tipo_proveedor.nombre;%@" /></a></td>
<td ><a href="?_search_sort=Pedidos.fecha" >Fecha<img src="images/pixel.png" class="@%func:class_searchsort;Pedidos.fecha;%@" /></a></td>
<td ><a href="?_search_sort=Pedidos.referencia_externa" >Ref. externa<img src="images/pixel.png" class="@%func:class_searchsort;Pedidos.referencia_externa;%@" /></a></td>
<td ><a href="?_search_sort=monto_pedido" >Importe<img src="images/pixel.png" class="@%func:class_searchsort;monto_pedido;%@" /></a></td>
</tr>
</thead>
