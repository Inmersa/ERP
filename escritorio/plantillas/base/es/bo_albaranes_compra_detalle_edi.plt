...
<tr>
<td >Estado</td>
<td ><a href="?_search_sort=Almacenes.nombre" >Almac�n<img src="images/pixel.png" class="@%func:class_searchsort;Almacenes.nombre;%@" /></a></td>
<td colspan="2"><a href="?_search_sort=Proveedores.nombre" >Proveedor<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.nombre;%@" /></a></td>
