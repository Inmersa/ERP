...
@%if:AllowedLink;seleccionar_servicio;%@
	...
	<li><a href="?seccion=seleccionar_servicio" class="nuevo" ><img src="imag/pixel.png" class="icono" /><span>Añadir</span></a></li> 
	@%end-if:%@
@%end-if:%@
@%if:AllowedAction;Empresas_servicios;del;%@
<li><a href="#" onClick="return onHRefClick('modif_articulos','accion_ejecutar','Borrar_servicios');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Borrar</span></a></li>
...
checked="checked"
@%end-if:%@
 /></td><td class="etiqueta" style="text-align:left;">Precios para un periodo de</td>
...
<td >Facturación de Servicio por Adelantado</td>
</tr>
</thead>
<tbody>
...
<td>@%db:Servicios.duracion;%@ Días</td>
<td>@%db:Servicios.plazo_factura;%@ Días</td>
<td class="check">
