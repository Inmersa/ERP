...
<table class="full">
 ...
 <a href="?seccion=crm_seleccionar_empleado&id=@%get:usuario_actual;%@" >Asignar</a>
 @%end-if:%@
...
<ul>
 <li><a href="#" onClick="return sendForm('modif_coordinadores');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Guardar</span></a></li>
<li><a href="#" onClick="return resetForm('modif_coordinadores');" class="deshacer" ><img src="imag/pixel.png" class="icono" /><span>Deshacer Cambios</span></a></li>
</ul>
</div>
