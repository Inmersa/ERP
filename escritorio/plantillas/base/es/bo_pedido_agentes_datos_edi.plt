...
<tr> <td bgcolor="#EBECED" align="right" class="texto" width="80" height="22">Referencia:</td>
 ...
 <td bgcolor="#EBECED" class="texto" align="right">Realizado por:</td>
...
@%db:Agentes.nombre;%@ @%db:Agentes.apellidos;%@ 
 ...
 <tr> <td bgcolor="#EBECED" align="right" class="texto" height="22">Fecha:</td>
 ...
 <td bgcolor="#EBECED" align="right" class="texto" width="95">Forma de pago:</td>
 <td colspan="2">
