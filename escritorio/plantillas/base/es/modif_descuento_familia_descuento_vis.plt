...
<input type=hidden name=estado value=1>
 ...
 <tr> <td bgcolor="#EBECED" width="216" class="etiqueta" align="right" height="22">Familia de artículos:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="216" class="etiqueta" align="right" height="22">Descuento:</td>
