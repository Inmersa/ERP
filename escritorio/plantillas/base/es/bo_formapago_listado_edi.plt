...
<td class="caption">Nº de efectos</td>
<td class="caption">Días entre efectos</td>
</tr>
...
@%plt:botonera%@
<div class="enviar"><a href="javascript:document.forms['modif_forma_pago'].submit();">Borrar seleccionados</a></div>
