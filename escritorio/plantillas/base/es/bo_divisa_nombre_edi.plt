...
<li><a href="?seccion=nuevo_divisa" class="nuevo" ><img src="images/pixel.png" class="icono" /><span>Nuevo</span></a></li>
@%end-if:%@
<li><a href="#" onClick="return sendForm('modif_divisa');" class="borrar" ><img src="images/pixel.png" class="icono" /><span>Borrar seleccionados</span></a></li>
</ul></div>
