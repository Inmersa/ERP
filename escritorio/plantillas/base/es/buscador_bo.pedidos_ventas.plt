...
Pedidos Residuales <input type="checkbox" name="residuales" value="1" @%func:check_flag;st[residuales];%@ />
Excluir Pedidos Residuales <input type="checkbox" name="sin_residuales" value="1" @%func:check_flag;st[sin_residuales];%@ />
Excluir Consolidados <input type="checkbox" name="sin_consolidados" value="1" @%func:check_flag;st[sin_consolidados];%@ />
 ...
 <br/>
 Razón Social<input type="text" name="razons" size="20" value="@%get:st[razons];%@" />
