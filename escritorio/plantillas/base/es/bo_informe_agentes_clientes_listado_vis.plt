...
@%plt:botonera%@
 ...
 <td height="22" bgcolor="#DBE0E3" class="etiqueta">Nombre cliente</td>
 <td width="1"></td>
 <td height="22" bgcolor="#DBE0E3" align="center" class="etiqueta" width="70">Facturas</td>
 <td width="1"></td>
 <td height="22" bgcolor="#DBE0E3" align="center" class="etiqueta" width="100">Facturado</td>
 <td width="1"></td>
 <td height="22" bgcolor="#DBE0E3" align="center" class="etiqueta" width="100">Comisiones</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="100" class="etiqueta" align="center">Cobrado</td>
...
<tr> <td width="1" bgcolor="#DBE0E3" height="22"></td>
 ...
 <tr> <td height="22"></td>
 <td bgcolor="#DBE0E3" align="center" class="etiqueta">Total</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Facturado</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Comisiones </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" align="center" width="100" class="etiqueta">Cobrado</td>
