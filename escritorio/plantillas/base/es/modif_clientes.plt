...
<li><a href="?seccion=nuevo_clientes" class="nuevo"><img src="imag/pixel.png" class="icono" /><span>Nuevo Cliente</span></a></li>
@%end-if:%@
@%if:AllowedLink;bo_importar_clientes;%@
<li><a href="?seccion=bo_importar_clientes" class="importarusuario"><img src="imag/pixel.png" class="icono" /><span>Importar cliente</span></a></li>
@%end-if:%@
</ul></div>
...
><div name="Acceso_Sistema" >Accesos</div
@%end-if:%@
@%if:AllowedPII;Direccion_Entrega;%@
><div name="Direccion_Entrega" >Direcciones</div
@%end-if:%@
@%if:AllowedPII;Cliente_Agente;%@
><div name="Cliente_Agente" >Agentes</div
@%end-if:%@
@%if:AllowedPII;Cliente_Empresa;%@
><div name="Cliente_Empresa" class="activo" >Condiciones</div
@%end-if:%@
></div>
...
><div name="Cuentas_Contables" >Financiero</div
@%end-if:%@
@%if:AllowedPII;Efectos_Pendientes;%@
><div name="EfectosPendientes" >Efectos Pendientes</div
@%end-if:%@
@%if:AllowedPII;Mostrar_Ofertas;%@
><div name="Mostrar_Ofertas" >Comercial</div
@%end-if:%@
@%if:AllowedPII;Cliente_Observaciones;%@
><div name="Cliente_Observaciones" >Observaciones</div
@%end-if:%@
@%if:AllowedPII;Enlaces;%@
><div name="Enlaces" >Enlaces</div
@%end-if:%@
></div>
