...
@%where:tabla|Factura;nombre|busc;no_results|1;%@
	...
	<table class="full">
	<tr> 
	<td class="titulotb">Proveedor:</td>
	...
	<tr> 
	<td class="titulotb">CIF:</td>
	<td >@%db:Proveedores.cif;%@</td>
	<td class="titulotb">Dirección:</td>
	...
	<thead class="informe">
	<tr> 
	<td ><a href="?_search_sort=Facturas.fecha" class="order" >Fecha<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.fecha;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.id_factura" class="order" >ID<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.id_factura;%@" /></a></td>
	...
	<td ><a href="?_search_sort=Facturas.base_imponible" class="order" 
		>Base Imp.<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.base_imponible;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.total_impuestos" class="order" 
		>T. Impuestos<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.total_impuestos;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.retenido" class="order" >Retenido<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.retenido;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.total_bruto" class="order" 
		>Total Bruto<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.total_bruto;%@" /></a></td>
	<td ><a href="?_search_sort=Facturas.monto_total" class="order" 
		>Importe Total<img src="imag/pixel.png" class="@%func:class_searchsort;Facturas.monto_total;%@" /></a></td>
  	@%if:esta_vacio;st[ef_search];%@
	@%else:%@
	<td ><a href="?_search_sort=Efectos.monto" class="order" >Importe de Efectos<img src="imag/pixel.png" class="@%func:class_searchsort;Efectos.monto;%@" /></a></td>
	<td ><a href="?_search_sort=Efectos.monto_pagado" class="order" 
		>T. Pagado<img src="imag/pixel.png" class="@%func:class_searchsort;Efectos.monto_pagado;%@" /></a></td>
	@%end-if:%@
  	@%if:esta_vacio;st[ic_search];%@
	@%else:%@
	<td ><a href="?_search_sort=numero_incidencias" class="order" 
		>Nº Incidencias<img src="imag/pixel.png" class="@%func:class_searchsort;numero_incidencias;%@" /></a></td>
	@%end-if:%@
	</tr>
	</thead>
	<tbody class="informe" >
