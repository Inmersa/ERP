...
<div class="titsuperior">&gt; NUEVO DESCUENTO DE FAMILIA (
...
<div class="enviar"><a href="#" onClick="document.forms['nuevo_descuento_familia_articulos'].submit();return false;">Añadir</a>
</div>
</form>
