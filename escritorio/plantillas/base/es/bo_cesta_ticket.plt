...
<table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr> 
<td height="22" align="left" bgcolor="#CCD2D7" class="etiqueta"> Selecciones actuales</td>
...
<td colspan="3"> 
 ...
 <td bgcolor="#DBE0E3" class="etiqueta" colspan="2">Artículo </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="left" width="250">Marca</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3">Cantidad</td>
 <td width="1"></td>
 <td align="center" class="etiqueta" bgcolor="#DBE0E3">Precio</td>
...
class="accesos">Finalizar</a> 
<!--onclick="return SendFormToWindow('ticket_print&printit=1&reloadit=1',400);" class="accesos">Finalizar</a --> <a href="?@%env:QUERY_STRING%@&vaciar_pedido=1" class="accesos">Vaciar Pedido</a> <input type="hidden" name="Finalizar" value="Finalizar"></td>
 </tr>
</form>
 </table>
 </td>
