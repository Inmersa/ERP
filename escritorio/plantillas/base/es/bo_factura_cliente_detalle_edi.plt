...
@%else:%@
	...
	<li><a href="?seccion=hacer_pedido" class="editar" 
		><img src="images/pixel.png" class="icono" /><span>Modificar Detalle de Factura</span></a></li> 
	@%end-if:%@
	@%end-if:%@
	@%if:AllowedAction;Facturas_detalle;del;%@
	<li><a href="#" onclick="return onHRefClick('factura','accion_ejecutar','Borrar');" class="borrar" 
		><img src="images/pixel.png" class="icono" /><span>Borrar art�culo(s)</span></a></li>
	@%end-if:%@
...
<td class="etiqueta" >Borrar Todos</td>
