...
><img src="imag/pixel.png" class="icono" /><span>Revisar</span></a></li>
@%end-if:%@
@%end-if:%@
...
><img src="imag/pixel.png" class="icono" /><span>Aprobar</span></a></li>

<li><a href="#Rechazar Seleccionados" onclick="return onHRefClick('pedido','accion_ejecutar','Rechazar');" class="rechazar"
><img src="imag/pixel.png" class="icono" /><span>Rechazar</span></a></li>
@%end-if:%@
@%end-if:%@
...
<li><a href="#" onclick="return sendForm('pedido');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Guardar Cambios</span></a></li>
</ul></div>
@%end-if:%@ 
