...
<table class="full">
 ...
 <a href="?seccion=crm_seleccionar_usuario&id=@%get:usuario_actual;%@" >Asignar</a>
 @%end-if:%@
 ...
 <tr>
 <td class="etiqueta">Cliente recomendado por:</td>
 <td>
 ...
 <a href="?seccion=bo_importar_recomendador" >Asignar</a>
 @%end-if:%@
