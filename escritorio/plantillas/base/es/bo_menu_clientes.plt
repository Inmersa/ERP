...
<div class="menuitem"> <a href="?seccion=modif_clientes" @%func:querystring_activa;modif_clientes;activo;;%@ >Datos Generales</a></div>
@%end-if:%@
...
<div class="menuitem"><a href="?seccion=cliente_servicios" @%func:querystring_activa;cliente_servicios;activo;;%@ >Servicios de Cliente</a></div>
@%end-if:%@
@%if:AllowedLink;bo_pedidos_tipo_cliente;%@
<div class="menuitem"> <a href="?seccion=bo_pedidos_tipo_cliente" @%func:querystring_activa;bo_pedidos_tipo_cliente;activo;;%@ >Pedidos tipo</a></div>
@%end-if:%@

@%if:esta_vacio;LinkCRM;%@
@%else:%@
	@%if:AllowedLink;incidencias;%@
	<div class="menuitem"><a href="?seccion=incidencias" @%func:querystring_activa;incidencias;activo;;%@ >Incidencias</a></div>
	@%end-if:%@
	@%if:AllowedLink;rfqs;%@
...
<div class="menuitem"> <a href="?seccion=bo_pedidos_cliente" @%func:querystring_activa;bo_pedidos_cliente;activo;;%@ >Histórico de Pedidos</a></div>
@%end-if:%@
@%if:AllowedLink;bo_proformas_cliente;%@
<div class="menuitem"><a href="?seccion=bo_proformas_cliente" @%func:querystring_activa;bo_proformas_cliente;activo;;%@ >Histórico de Proformas</a></div>
@%end-if:%@
@%if:AllowedLink;bo_presupuestos_cliente;%@
<div class="menuitem"><a href="?seccion=bo_presupuestos_cliente" @%func:querystring_activa;bo_presupuestos_cliente;activo;;%@ >Hist. de presupuestos</a></div>
@%end-if:%@
...
<div class="menuitem"> <a href="?seccion=bo_descuento_familia_articulos" @%func:querystring_activa;bo_descuento_familia_articulos;activo;;%@ >Dto. por familia</a></div>
@%end-if:%@
@%if:AllowedLink;bo_descuento_articulos;%@
<div class="menuitem"><a href="?seccion=bo_descuento_articulos" @%func:querystring_activa;bo_descuento_articulos;activo;;%@ >Artículos de Cliente</a></div>
@%end-if:%@
...
@%else:%@
	...
	<div class="menuitem"><a href="?seccion=rfq&nuevo=1" @%func:querystring_activa;rfq&nuevo=1;activo;;%@ >Nuevo RFQ</a></div>
	@%end-if:%@
@%end-if:%@
