 ...
 <td class="etiqueta" bgcolor="#CCD2D7" >Cuentas contables:</td>
 </tr>
 </table>
 <table width="644" border="0" cellspacing="0" cellpadding="0">
...
<input type="hidden" name="registro2[cc_compras]" value="@%db:Proveedores_empresas.cc_compras;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <tr> <td bgcolor="#EBECED" width="161" align="right" class="etiqueta" height="22">Descuentos:</td>
...
<input type="hidden" name="registro2[cc_gastos]" value="@%db:Proveedores_empresas.cc_gastos;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta" width="161">Retenciones:</td>
...
<input type="hidden" name="registro2[cc_retenciones]" value="@%db:Proveedores_empresas.cc_retenciones;%@" class="insertext" size="10" maxlength="10">
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">Efectos:</td>
...
<input type="hidden" name="registro2[cc_efectos]" value="@%db:Proveedores_empresas.cc_efectos;%@" class="insertext" size="10" maxlength="10"/>
 ...
 <td height="22" width="68" align="center">ENTIDAD</td>
 <td height="22" width="65" align="center">Oficina</td>
 <td height="22">DC / Nº Cuenta</td>
 </tr>
 <tr> 
 <td width="161" align="right" bgcolor="#EBECED" height="22">Cuenta Bancaria IBAN:</td>
 ...
 <tr> <td align="right" class="etiqueta" height="22" bgcolor="#EBECED">Fecha de alta:</td>
 ...
 <tr> <td bgcolor="#EBECED" height="22" align="right" class="etiqueta" valign="top">Observaciones:</td>
 ...
 <tr> <td bgcolor="#EBECED" width="161" class="etiqueta" align="right" height="22">% Dto:</td>
...
<input type="hidden" name="registro2[descuento]" value="@%db:Proveedores_empresas.descuento;%@" class="insertext" size="4">
 ...
 <tr> <td width="162" bgcolor="#EBECED" align="right" class="etiqueta">Aplicar Recargo :</td>
 <td> <!--@%db:Proveedores.aplicar_recargo;%@-->
 </td>
 <td bgcolor="#EBECED" align="right" width="200" class="etiqueta">Aplicar Iva (extracomunitario):</td>
 <td>
...
<table width="644" border="0" height="22" cellspacing="0" cellpadding="0">
 <tr> 
 <td class="etiqueta" align0"right" width="200" bgcolor="#EBECED">Descuento financiero:</td>
...
<tr><td height="22">
 ...
 <tr> 
 <td class="etiqueta" height="20" width="172" >Días de Pago</td>
 </tr>
 </table>
 <table width="644" border="0" cellspacing="0" cellpadding="0">
 <tr>
