...
<li><a href="#" onClick="return onHRefClick('bo_recorridos','accion_ejecutar', 'Borrar');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Borrar seleccionados</span></a></li>
</ul></div>
...
<tr>
<td></td>
<td ><a href="?_search_sort=Rutas.nombre" >Ruta<img src="imag/pixel.png" class="@%func:class_searchsort;Rutas.nombre;%@" /></a></td>
<td ><a href="?_search_sort=efectividad" >% Efectividad<img src="imag/pixel.png" class="@%func:class_searchsort;efectividad;%@" /></a></td>
<td ><a href="?_search_sort=Recorridos.fecha" >Fecha<img src="imag/pixel.png" class="@%func:class_searchsort;Recorridos.fecha;%@" /></a> </td>
<td ><a href="?_search_sort=numero_clientes" >Nº Clientes<img src="imag/pixel.png" class="@%func:class_searchsort;numero_clientes;%@" /></a></td>
<td ><a href="?_search_sort=Agentes.nombre" >Agente<img src="imag/pixel.png" class="@%func:class_searchsort;Agentes.nombre;%@" /></a> </td>
<td ><a href="?_search_sort=numero_pedidos" >Nº Pedidos<img src="imag/pixel.png" class="@%func:class_searchsort;numero_pedidos;%@" /></a> </td>
<td >T.B. Imponible</td>
</tr>
</thead>
<tbody>
...
<li><a href="#" onClick="return sendForm('bo_recorridos');" class="guardar" ><img src="imag/pixel.png" class="icono" /><span>Modificar</span></a></li>
</ul></div>
