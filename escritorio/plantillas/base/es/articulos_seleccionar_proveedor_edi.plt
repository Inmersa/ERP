...
<li><a href="#" onclick="return onHRefClick('proveedores','accion_ejecutar','asociar_proveedores');" class="enviar" 
	><img src="images/pixel.png" class="icono" /><span> Asociar Seleccionados</span></a></li>
</ul></div>
...
<thead>
<tr>
<td class="estado" ><img src="images/pixel.png" class="marcartodos" onclick="return formCheckAll('proveedores_seleccionados');"  /></td>
<td ><a href="?_search_sort=Proveedores.nombre" >Nombre<img src="images/pixel.png" class="@%func:class_searchsort;Proveedores.nombre;%@" /></a></td>
<td >Precio</td>
<td >Pr. Rt Oficial</td>
