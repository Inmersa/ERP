...
<li><a href="#" onClick="return sendForm('modif_unidades_medida');" class="borrar" ><img src="imag/pixel.png" class="icono" /><span>Borrar seleccionados</span></a></li>
</ul></div>
