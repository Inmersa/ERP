...
<input type="hidden" name="accion_ejecutar" value="0">
 ...
 <tr> <td colspan="15" bgcolor="#CCD2D7" height="22" class="etiqueta" align="right"> <a href="" onClick="return onHRefClick('agentes_clientes','accion_ejecutar','Borrar');" class="accesos">Borrar seleccionados</a></td>
 </tr>
 ...
 <td align="center" width="1"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" width="150">Nombre</td>
 <td width="1" align="center"></td>
 <td bgcolor="#DBE0E3" class="etiqueta" align="center">Dir. entrega</td>
 <td width="1" align="center"></td>
 <td class="etiqueta" bgcolor="#DBE0E3" align="center" width="100">Fecha captación </td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" align="center" class="etiqueta">Comisión</td>
 <td width="1"></td>
 <td bgcolor="#DBE0E3" width="80" height="22" align="center" class="etiqueta">Comisión repartida</td>
