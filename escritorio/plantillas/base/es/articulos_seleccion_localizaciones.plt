...
<table class="full" >
<tbody>
<tr><td class="etiqueta" >Art�culo</td><td colspan="2" >@%db:Articulos.nombre;%@ (@%db:Articulos.id_articulo;%@)</td></tr>
<tr><td class="etiqueta" >Cantidad a Servir</td><td colspan="2" >@%db:Detalles_albaran.cantidad;%@</td></tr>
<tr><td class="etiqueta" >Agrupar</td><td class="check" ><input type="checkbox" name="detalles_localizacion[@%get:idx_albaran;%@][agrupar]" value="1" /></td>
<tr><td class="etiqueta" >Agrupar localizaciones en albaranes</td><td class="check" 
...
<li><a href="#" onClick="return sendForm('localizaciones_actuales');" class="guardar" ><img src="images/pixel.png" class="icono" /><span>Guardar</span></a></li>
</ul></div>
</div>
