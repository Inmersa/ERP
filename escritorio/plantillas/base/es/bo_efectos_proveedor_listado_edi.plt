...
<li><a href="#" onClick="return onHRefClick('listado_efectos','accion_ejecutar','Devolver');" class="devolverabono" 
	><img src="images/pixel.png" class="icono" /><span>Devolver</span></a></li>
...
<td >Demora</td>
<td >Mto. Cuenta</td>
<td >Cuenta Bancaria IBAN</td>
</tr></thead>

<tbody><tr>
<td>@%db:Proveedores_empresas.riesgo%@</td>
<td>@%db:Proveedores_empresas.plazo_demora%@ D�a(s)</td>
...
<td ><a href="?_search_sort=Facturas.referencia_externa" class="order" 
	>Referencia Externa<img src="images/pixel.png" class="@%func:class_searchsort;Facturas.referencia_externa;%@" /></a></td>
