<table width="647" border="0" cellspacing="0" cellpadding="0">
 ...
 <td class="titocho" >&gt; TRASPASOS DE ALMACEN</td>
 <td align="right" >@%if:AllowedLink;nuevo_traspasos_almacen;%@<a href="../?seccion=nuevo_traspasos_almacen" class="accesos">Nuevo Traspaso</a><a href="../?seccion=modif_almacenes_logicos" class="accesos">Volver</a></td>
@%end-if:%@
 </tr>
 </table>
 </td>
 ...
 <tr> 
 <td class="texto">Resultados obtenidos: @%func:numero_resultados;%@</td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 <tr> 
 <td class="texto">Criterio de búsqueda: </td>
 </tr>
 <tr> <td height="5"></td>
 </tr>
 </table>
