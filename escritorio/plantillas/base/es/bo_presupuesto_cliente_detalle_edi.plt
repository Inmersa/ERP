...
<div class="AccionesFicha">
	...
	@%if:AllowedLink;hacer_pedido;%@
		...
		<li><a href="?seccion=hacer_pedido" class="editar" ><img src="imag/pixel.png" class="icono" /><span>Modificar detalle de pedido</span></a> 
		@%end-if:%@
	@%end-if:%@
	...
	<li><a href="#" onclick="return onHRefClick('pedido','accion_ejecutar','Borrar');" class="borrar" ><img src="imag/pixel.png" 
		class="icono" /><span>Borrar artículo(s)</span></a>
