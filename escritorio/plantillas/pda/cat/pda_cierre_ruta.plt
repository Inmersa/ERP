<html>
<head>
<title>Tancar Recorreguts</title>
...
<tr> <td class="accesos" align="right"><input type="submit" value="Tancar ruta">
<!-- a href="javascript:document.forms['cierre_ruta'].submit();" class="accesos">Tancar ruta</a --> </td>
 </tr>
<tr>
<td height="10"></td>
</tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr>
 <td class="accesos2" align="left">Despeses ruta</td>
</tr>
...
<tr> <td class="acceso_directo" align="left">Observacions Ruta:</td>
 </tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr>
 <td class="accesos2" align="left">Data Próxima Ruta</td>
 </tr>
 <tr>
