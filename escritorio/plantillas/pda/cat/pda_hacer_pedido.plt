...
<tr> <td class="accesos" align="right"><!-- a href="javascript: document.forms['cesta'].submit();" class="accesos">Finalitzar</a --><input type="submit" 
name="Finalizar" value="Finalitzar">
 <input type="submit" name="Anyadir" value="Afegir">
 <!-- a href="" onClick="document.forms['hacer_pedido'].submit();return false;"class="accesos">Afegir</a -->
 </td>
 </tr>
<tr>
<td height="10"></td>
...
<tr> <td class="acceso_directo" align="center" width="95">ID</td>
 <td class="acceso_directo" align="center" width="56">Quantitat</td>
 <td class="acceso_directo" align="center" width="49">Paquets</td>
 </tr>
 </table>
 <table width="200" border="0" cellspacing="0" cellpadding="0">
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <td class="accesos2" align="left">Articles Selecció<input type="submit" name="Anyadir" value="Afegir">
</td>
 <tr>
<td height="10"></td>
</tr>
...
<td height="10"></td>
 ...
 <tr> <td class="titocho" align="center" width="114">Base imposable:</td>
...
class="accesos">Home</a>&nbsp;<a href="?seccion=pda_hacer_pedido&vaciar_pedido=1" class="accesos">Buidar Comanda</a> 
<input type="submit" name="Finalizar" value="Finalitzar">
<!-- a href="javascript: document.forms['cesta'].submit();" class="accesos">Finalitzar</a -->
</form>
</td>
 </tr>
<tr><td colspan="3"><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr><td height="22" class="texto" align="right" >Ref. des:</td>
 <td class="texto" align="left"><input type="text" size="14" maxlength="14" name="repo[fecha]" class="insertext"
value="dd/mm/aaaa"><input type="submit" value="Confirmar">
 </tr>
</table>
</form>
</td></tr>
<tr>
 <td class="accesos2" align="left" colspan="3">Llegenda :</td>
</tr>
 <tr> <td height="10" width="114"></td>
 </tr>
<tr> <td class="acceso_directo" align="center" width="27">
<input type="checkbox" name="legend[]" value="" checked>
 ...
 <td class="texto" align="center" width="65">Nom d´article</td>
 <td class="texto" align="center" width="108">ID</td>
 </tr>
 <tr> <td class="texto" align="center" width="27">Stock</td>
 <td class="texto" align="center" width="65">Base imposable</td>
 <td class="texto" align="center" width="108">Quantitat</td>
 </tr>
 <tr>
<td height="10"></td>
</tr>
