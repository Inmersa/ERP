...
<tr> <td class="accesos" align="right"><!-- a href="javascript: document.forms['cesta'].submit();" class="accesos">Finish</a --><input type="submit" 
name="Finalizar" value="Finish">
 <input type="submit" name="Anyadir" value="Add">
 <!-- a href="" onClick="document.forms['hacer_pedido'].submit();return false;"class="accesos">Add</a -->
 </td>
 </tr>
<tr>
<td height="10"></td>
...
<tr> <td class="acceso_directo" align="center" width="95">ID</td>
 <td class="acceso_directo" align="center" width="56">Amount</td>
 <td class="acceso_directo" align="center" width="49">Packages</td>
 </tr>
 </table>
 <table width="200" border="0" cellspacing="0" cellpadding="0">
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
 <td class="accesos2" align="left">Selected Articles<input type="submit" name="Anyadir" value="Add">
</td>
 <tr>
<td height="10"></td>
</tr>
...
<td height="10"></td>
 ...
 <tr> <td class="titocho" align="center" width="114">Taxable Income:</td>
...
class="accesos">Home</a>&nbsp;<a href="?seccion=pda_hacer_pedido&vaciar_pedido=1" class="accesos">Clear Order</a> 
<input type="submit" name="Finalizar" value="Finish">
<!-- a href="javascript: document.forms['cesta'].submit();" class="accesos">Finish</a -->
</form>
</td>
 </tr>
<tr><td colspan="3"><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr><td height="22" class="texto" align="right" >Ref. from:</td>
 <td class="texto" align="left"><input type="text" size="14" maxlength="14" name="repo[fecha]" class="insertext"
value="dd/mm/aaaa"><input type="submit" value="Send">
 </tr>
</table>
</form>
</td></tr>
<tr>
 <td class="accesos2" align="left" colspan="3">Caption :</td>
</tr>
 <tr> <td height="10" width="114"></td>
 </tr>
<tr> <td class="acceso_directo" align="center" width="27">
<input type="checkbox" name="legend[]" value="" checked>
 ...
 <td class="texto" align="center" width="65">Article name</td>
 <td class="texto" align="center" width="108">ID</td>
 </tr>
 <tr> <td class="texto" align="center" width="27">Stock</td>
 <td class="texto" align="center" width="65">Taxable Income</td>
 <td class="texto" align="center" width="108">Amount</td>
 </tr>
 <tr>
<td height="10"></td>
</tr>
