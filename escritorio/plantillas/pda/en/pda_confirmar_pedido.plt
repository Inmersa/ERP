...
class="accesos">Confirm</a--><input type="submit" value="Confirm"><a href="?seccion=pda_hacer_pedido" class="accesos"
>Return</a></td>
 </tr>
<tr>
<td height="10"></td>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
<tr> <td class="titul1" align="left" width="95">&gt; Delivery addresses</td>
</tr>
 <tr>
 <td height="10"></td>
 </tr>
...
<tr>
 ...
 <table width="200" border="0" cellspacing="0" cellpadding="0">
 <tr> <td align="left" class="titul1" width="114">Payment Rules</td>
...
<tr> <td align="left" class="titul1" width="114">Currency</td>
 <td class="texto" width="86">
...
<tr> <td align="left" class="titul1" width="114">@%db:nombre%@</td>
 ...
 <tr> <td align="left" class="titocho" width="114">Gross Total:</td>
 <td class="texto" width="86">@%db:bruto%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="114">Taxable Income:</td>
 <td class="texto" width="86">@%db:base_imponible%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="114">Deductions:</td>
 <td class="texto" width="86">@%db:retenido%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">Total Disc.:</td>
 <td class="texto" width="103">@%db:descuentos%@ @%db:leyenda_divisa%@</td>
 </tr>
 <tr>
 <td height="10"></td>
 </tr>
 <tr> <td align="left" class="titocho" width="97">Amount:</td>
